/* lib/src/__config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Define to 1 if struct stat has usec members. */
#undef HAVE_STRUCT_STAT_USEC
