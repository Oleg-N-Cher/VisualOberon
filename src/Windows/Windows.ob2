...
TYPE
    ...
    PWCHAR* = POINTER [ CSTRING ] TO ARRAY OF WCHAR;
    ...
    _SINGLE_LIST_ENTRY_struct* = RECORD
    ...
    _FLOATING_SAVE_AREA_struct* = RECORD
      ControlWord* : DWORD;
      StatusWord* : DWORD;
      TagWord* : DWORD;
      ErrorOffset* : DWORD;
    ...
    _EXCEPTION_POINTERS_struct* = RECORD
    ...
    _GENERIC_MAPPING_struct* = RECORD
    ...
    _SID_IDENTIFIER_AUTHORITY_struct* = RECORD
    ...
    _SID_AND_ATTRIBUTES_struct* = RECORD
      Sid* : PSID;
      Attributes* : DWORD
    END;
    ...
    _ACCESS_ALLOWED_ACE_struct* = RECORD
      Header* : ACE_HEADER;
      Mask* : ACCESS_MASK;
      SidStart* : DWORD
    END;
    ...
    _ACCESS_DENIED_ACE_struct* = RECORD
      Header* : ACE_HEADER;
      Mask* : ACCESS_MASK;
      SidStart* : DWORD
    END;
    ...
    _SYSTEM_AUDIT_ACE_struct* = RECORD
      Header* : ACE_HEADER;
      Mask* : ACCESS_MASK;
      SidStart* : DWORD
    END;
    ...
    _SYSTEM_ALARM_ACE_struct* = RECORD
      Header* : ACE_HEADER;
      Mask* : ACCESS_MASK;
      SidStart* : DWORD
    END;
    ...
    _ACCESS_ALLOWED_OBJECT_ACE_struct* = RECORD
      Header* : ACE_HEADER;
      Mask* : ACCESS_MASK;
      Flags* : DWORD;
      ObjectType* : GUID;
    ...
    _ACCESS_DENIED_OBJECT_ACE_struct* = RECORD
      Header* : ACE_HEADER;
      Mask* : ACCESS_MASK;
      Flags* : DWORD;
      ObjectType* : GUID;
    ...
    _SYSTEM_AUDIT_OBJECT_ACE_struct* = RECORD
      Header* : ACE_HEADER;
      Mask* : ACCESS_MASK;
      Flags* : DWORD;
      ObjectType* : GUID;
    ...
    _SYSTEM_ALARM_OBJECT_ACE_struct* = RECORD
      Header* : ACE_HEADER;
      Mask* : ACCESS_MASK;
      Flags* : DWORD;
      ObjectType* : GUID;
    ...
    _ACL_REVISION_INFORMATION_struct* = RECORD
      AclRevision* : DWORD
    END;
    ...
    _ACL_SIZE_INFORMATION_struct* = RECORD
      AceCount* : DWORD;
      AclBytesInUse* : DWORD;
      AclBytesFree* : DWORD
    END;
    ...
    _SECURITY_DESCRIPTOR_RELATIVE_struct* = RECORD
      Revision* : BYTE;
      Sbz1* : BYTE;
    ...
    _SECURITY_DESCRIPTOR_struct* = RECORD
      Revision* : BYTE;
      Sbz1* : BYTE;
      Control* : SECURITY_DESCRIPTOR_CONTROL;
      Owner* : PSID;
    ...
    _OBJECT_TYPE_LIST_struct* = RECORD
      Level* : WORD;
      Sbz* : WORD;
    ...
    _TOKEN_PRIVILEGES_struct* = RECORD
      PrivilegeCount* : DWORD;
    ...
    _TOKEN_PRIMARY_GROUP_struct* = RECORD
      PrimaryGroup* : PSID
    END;
    ...
    _TOKEN_DEFAULT_DACL_struct* = RECORD
      DefaultDacl* : PACL
    END;
    ...
    _TOKEN_STATISTICS_struct* = RECORD
      TokenId* : LUID;
    ...
    _SECURITY_QUALITY_OF_SERVICE_struct* = RECORD
      Length* : DWORD;
      ImpersonationLevel* : SECURITY_IMPERSONATION_LEVEL;
    ...
    _SE_IMPERSONATION_STATE_struct* = RECORD
      Token* : PACCESS_TOKEN;
      CopyOnOpen* : BOOLEAN;
      EffectiveOnly* : BOOLEAN;
    ...
    _JOBOBJECT_BASIC_ACCOUNTING_INFORMATION_struct* = RECORD
    ...
    _JOBOBJECT_BASIC_LIMIT_INFORMATION_struct* = RECORD
    ...
    _JOBOBJECT_BASIC_PROCESS_ID_LIST_struct* = RECORD
    ...
    _JOBOBJECT_BASIC_UI_RESTRICTIONS_struct* = RECORD
    ...
    _JOBOBJECT_SECURITY_LIMIT_INFORMATION_struct* = RECORD
    ...
    _JOBOBJECT_END_OF_JOB_TIME_INFORMATION_struct* = RECORD
    ...
    _JOBOBJECT_ASSOCIATE_COMPLETION_PORT_struct* = RECORD
      CompletionKey* : PVOID;
    ...
    _MEMORY_BASIC_INFORMATION_struct* = RECORD
      BaseAddress* : PVOID;
    ...
    _MEMORY_BASIC_INFORMATION_VLM_struct* = RECORD
      noname0* : RECORD [UNION]
        BaseAddress* : PVOID64;
    ...
    _FILE_NOTIFY_INFORMATION_struct* = RECORD
    ...
    _REPARSE_DATA_BUFFER_struct* = RECORD
      ReparseTag* : DWORD;
    ...
    _REPARSE_GUID_DATA_BUFFER_struct* = RECORD
      ReparseTag* : DWORD;
      ReparseDataLength* : WORD;
      Reserved* : WORD;
      ReparseGuid* : GUID;
    ...
    _REPARSE_POINT_INFORMATION_struct* = RECORD
      ReparseDataLength* : WORD;
    ...
    _POWER_DEVICE_TIMEOUTS_struct* = RECORD
    ...
    IMPORT_OBJECT_HEADER_struct* = RECORD
      Sig1* : WORD;
      Sig2* : WORD;
      Version* : WORD;
      Machine* : WORD;
    ...
    _MESSAGE_RESOURCE_ENTRY_struct* = RECORD
      Length* : WORD;
      Flags* : WORD;
    ...
    _MESSAGE_RESOURCE_BLOCK_struct* = RECORD
      LowId* : DWORD;
      HighId* : DWORD;
    ...
    _MESSAGE_RESOURCE_DATA_struct* = RECORD
    ...
    _RTL_CRITICAL_SECTION_DEBUG_struct* = RECORD
      Type* : WORD;
    ...
    _RTL_CRITICAL_SECTION_struct* = RECORD
    ...
    _EVENTSFORLOGFILE_struct* = RECORD
      ulSize* : DWORD;
    ...
    _PACKEDEVENTINFO_struct* = RECORD
      ulSize* : DWORD;
    ...
    _TAPE_WRITE_MARKS_struct* = RECORD
      Type* : DWORD;
      Count* : DWORD;
      Immediate* : BOOLEAN
    END;
    ...
    _TAPE_GET_POSITION_struct* = RECORD
      Type* : DWORD;
      Partition* : DWORD;
    ...
    _TAPE_SET_POSITION_struct* = RECORD
      Method* : DWORD;
      Partition* : DWORD;
      Offset* : LARGE_INTEGER;
      Immediate* : BOOLEAN
    ...
    _TAPE_GET_DRIVE_PARAMETERS_struct* = RECORD
      ECC* : BOOLEAN;
      Compression* : BOOLEAN;
      DataPadding* : BOOLEAN;
    ...
    _TAPE_SET_DRIVE_PARAMETERS_struct* = RECORD
      ECC* : BOOLEAN;
      Compression* : BOOLEAN;
      DataPadding* : BOOLEAN;
      ReportSetmarks* : BOOLEAN;
    ...
    _TAPE_GET_MEDIA_PARAMETERS_struct* = RECORD
    ...
    _TAPE_SET_MEDIA_PARAMETERS_struct* = RECORD
      BlockSize* : DWORD
    END;
    ...
    _TAPE_CREATE_PARTITION_struct* = RECORD
      Method* : DWORD;
      Count* : DWORD;
      Size* : DWORD
    END;
    ...
    _SECURITY_ATTRIBUTES_struct* = RECORD
      nLength* : DWORD;
    ...
    _PROCESS_INFORMATION_struct* = RECORD
      hProcess* : HANDLE;
      hThread* : HANDLE;
      dwProcessId* : DWORD;
      dwThreadId* : DWORD
    ...
    _EXCEPTION_DEBUG_INFO_struct* = RECORD
    ...
    _CREATE_THREAD_DEBUG_INFO_struct* = RECORD
      hThread* : HANDLE;
    ...
    _CREATE_PROCESS_DEBUG_INFO_struct* = RECORD
      hFile* : HANDLE;
      hProcess* : HANDLE;
      hThread* : HANDLE;
    ...
    _EXIT_THREAD_DEBUG_INFO_struct* = RECORD
      dwExitCode* : DWORD
    END;
    ...
    _EXIT_PROCESS_DEBUG_INFO_struct* = RECORD
      dwExitCode* : DWORD
    END;
    ...
    _LOAD_DLL_DEBUG_INFO_struct* = RECORD
      hFile* : HANDLE;
      lpBaseOfDll* : LPVOID;
      dwDebugInfoFileOffset* : DWORD;
      nDebugInfoSize* : DWORD;
    ...
    _UNLOAD_DLL_DEBUG_INFO_struct* = RECORD
      lpBaseOfDll* : LPVOID
    END;
    ...
    _OUTPUT_DEBUG_STRING_INFO_struct* = RECORD
    ...
    _PROCESS_HEAP_ENTRY_struct* = RECORD
      lpData* : PVOID;
      cbData* : DWORD;
      cbOverhead* : BYTE;
      iRegionIndex* : BYTE;
    ...
    PTOP_LEVEL_EXCEPTION_FILTER* = PROCEDURE (VAR ExceptionInfo [NIL_COMPAT]  : _EXCEPTION_POINTERS_struct) : LONG;

    LPTOP_LEVEL_EXCEPTION_FILTER* = PTOP_LEVEL_EXCEPTION_FILTER;

    PAPCFUNC* = WORKERCALLBACKFUNC;

    _BY_HANDLE_FILE_INFORMATION_struct* = RECORD
    ...
    _TIME_ZONE_INFORMATION_struct* = RECORD
      Bias* : LONG;
    ...
    _RECOVERY_AGENT_INFORMATIONA_struct* = RECORD
      NextEntryOffset* : DWORD;
    ...
    _RECOVERY_AGENT_INFORMATIONW_struct* = RECORD
      NextEntryOffset* : DWORD;
      AgentNameLength* : DWORD;
    ...
    LPOVERLAPPED_COMPLETION_ROUTINE* = PROCEDURE (dwErrorCode : DWORD; dwNumberOfBytesTransfered : DWORD; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct);

    _WIN32_STREAM_ID_struct* = RECORD
      dwStreamId* : DWORD;
    ...
    _WIN32_FIND_DATAA_struct* = RECORD
      dwFileAttributes* : DWORD;
      ftCreationTime* : FILETIME;
      ftLastAccessTime* : FILETIME;
      ftLastWriteTime* : FILETIME;
    ...
    _WIN32_FIND_DATAW_struct* = RECORD
      dwFileAttributes* : DWORD;
      ftCreationTime* : FILETIME;
      ftLastAccessTime* : FILETIME;
      ftLastWriteTime* : FILETIME;
    ...
    _WIN32_FILE_ATTRIBUTE_DATA_struct* = RECORD
      dwFileAttributes* : DWORD;
      ftCreationTime* : FILETIME;
      ftLastAccessTime* : FILETIME;
      ftLastWriteTime* : FILETIME;
    ...
    tagHW_PROFILE_INFOA_struct* = RECORD
      dwDockInfo* : DWORD;
    ...
    tagHW_PROFILE_INFOW_struct* = RECORD
      dwDockInfo* : DWORD;
    ...
    _OSVERSIONINFOEXA_struct* = RECORD
      dwOSVersionInfoSize* : DWORD;
      dwMajorVersion* : DWORD;
      dwMinorVersion* : DWORD;
      dwBuildNumber* : DWORD;
    ...
    _OSVERSIONINFOEXW_struct* = RECORD
      dwOSVersionInfoSize* : DWORD;
      dwMajorVersion* : DWORD;
      dwMinorVersion* : DWORD;
      dwBuildNumber* : DWORD;
    ...
    _SYSTEM_POWER_STATUS_struct* = RECORD
      ACLineStatus* : BYTE;
      BatteryFlag* : BYTE;
    ...
    _WIN_CERTIFICATE_struct* = RECORD
      dwLength* : DWORD;
      wRevision* : WORD;
    ...
    _WIN_TRUST_ACTDATA_CONTEXT_WITH_SUBJECT_struct* = RECORD
      hClientToken* : HANDLE;
    ...
    _WIN_TRUST_ACTDATA_SUBJECT_ONLY_struct* = RECORD
      SubjectType* : AutoPtr_GUID;
      Subject* : WIN_TRUST_SUBJECT
    END;
    ...
    _WIN_TRUST_SUBJECT_FILE_struct* = RECORD
      hFile* : HANDLE;
      lpPath* : LPCWSTR
    END;
    ...
    _WIN_TRUST_SUBJECT_FILE_AND_DISPLAY_struct* = RECORD
      hFile* : HANDLE;
      lpPath* : LPCWSTR;
    ...
    _WIN_SPUB_TRUSTED_PUBLISHER_DATA_struct* = RECORD
      hClientToken* : HANDLE;
    ...
    tagLOGCOLORSPACEA_struct* = RECORD
      lcsSignature* : DWORD;
      lcsVersion* : DWORD;
      lcsSize* : DWORD;
      lcsCSType* : LCSCSTYPE;
    ...
    tagLOGCOLORSPACEW_struct* = RECORD
      lcsSignature* : DWORD;
      lcsVersion* : DWORD;
      lcsSize* : DWORD;
      lcsCSType* : LCSCSTYPE;
    ...
    tagBITMAPCOREHEADER_struct* = RECORD
      bcSize* : DWORD;
      bcWidth* : WORD;
      bcHeight* : WORD;
      bcPlanes* : WORD;
    ...
    tagBITMAPINFOHEADER_struct* = RECORD
      biSize* : DWORD;
      biWidth* : LONG;
      biHeight* : LONG;
      biPlanes* : WORD;
    ...
    LPBITMAPV4HEADER* = POINTER TO RECORD
      bV4Size* : DWORD;
      bV4Width* : LONG;
      bV4Height* : LONG;
      bV4Planes* : WORD;
    ...
    tagBITMAPCOREINFO_struct* = RECORD
    ...
    tagFONTSIGNATURE_struct* = RECORD
    ...
    tagLOCALESIGNATURE_struct* = RECORD
    ...
    tagENHMETARECORD_struct* = RECORD
      iType* : DWORD;
      nSize* : DWORD;
    ...
    tagENHMETAHEADER_struct* = RECORD
      iType* : DWORD;
      nSize* : DWORD;
      rclBounds* : RECTL;
      rclFrame* : RECTL;
    ...
    tagNEWTEXTMETRICEXA_struct* = RECORD
    ...
    tagNEWTEXTMETRICEXW_struct* = RECORD
    ...
    tagENUMLOGFONTEXA_struct* = RECORD
      elfLogFont* : LOGFONTA;
      elfFullName* : ARRAY 64 OF BYTE;
      elfStyle* : ARRAY 32 OF BYTE;
    ...
    tagENUMLOGFONTEXW_struct* = RECORD
      elfLogFont* : LOGFONTW;
      elfFullName* : ARRAY 64 OF WCHAR;
      elfStyle* : ARRAY 32 OF WCHAR;
    ...
    _DISPLAY_DEVICEA_struct* = RECORD
      cb* : DWORD;
    ...
    _DISPLAY_DEVICEW_struct* = RECORD
      cb* : DWORD;
    ...
    _OUTLINETEXTMETRICA_struct* = RECORD
      otmSize* : UINT;
    ...
    _OUTLINETEXTMETRICW_struct* = RECORD
      otmSize* : UINT;
    ...
    tagTTPOLYGONHEADER_struct* = RECORD
      cb* : DWORD;
      dwType* : DWORD;
      pfxStart* : POINTFX
    END;
    ...
    _RASTERIZER_STATUS_struct* = RECORD
      nSize* : INTEGER;
      wFlags* : INTEGER;
      nLanguageID* : INTEGER
    END;
    ...
    tagPIXELFORMATDESCRIPTOR_struct* = RECORD
      nSize* : WORD;
      nVersion* : WORD;
      dwFlags* : DWORD;
      iPixelType* : BYTE;
    ...
    LPFNDEVMODE* = PROCEDURE (p0 : HWND; p1 : HMODULE; VAR p2 [NIL_COMPAT]  : _devicemodeA_struct; p3 : LPSTR; p4 : LPSTR; VAR p5 [NIL_COMPAT]  : _devicemodeA_struct; p6 : LPSTR; p7 : UINT) : UINT;

    LPFNDEVCAPS* = PROCEDURE (p0 : LPSTR; p1 : LPSTR; p2 : UINT; p3 : LPSTR; VAR p4 [NIL_COMPAT]  : _devicemodeA_struct) : DWORD;

    COLOR16* = USHORT;

    _TRIVERTEX_struct* = RECORD
      x* : LONG;
      y* : LONG;
      Red* : COLOR16;
      Green* : COLOR16;
    ...
    _GRADIENT_TRIANGLE_struct* = RECORD
      Vertex1* : ULONG;
      Vertex2* : ULONG;
      Vertex3* : ULONG
    END;
    ...
    MFENUMPROC* = PROCEDURE (p0 : HDC; VAR p1 [NIL_COMPAT]  : HANDLETABLE; VAR p2 [NIL_COMPAT]  : METARECORD; p3 : LONGINT; p4 : LPARAM) : LONGINT;

    AutoPtr_ENHMETARECORD* = POINTER TO ENHMETARECORD;

    ENHMFENUMPROC* = PROCEDURE (p0 : HDC; VAR p1 [NIL_COMPAT]  : HANDLETABLE; VAR p2 [NIL_COMPAT]  : ENHMETARECORD; p3 : LONGINT; p4 : LPARAM) : LONGINT;

    tagDIBSECTION_struct* = RECORD
      dsBm* : BITMAP;
    ...
    tagCOLORADJUSTMENT_struct* = RECORD
      caSize* : WORD;
      caFlags* : WORD;
    ...
    tagEMRSELECTCLIPPATH_struct* = RECORD
      emr* : EMR;
      iMode* : DWORD
    END;
    ...
    tagEMRSETMITERLIMIT_struct* = RECORD
      emr* : EMR;
      eMiterLimit* : FLOAT
    END;
    ...
    tagEMRSETARCDIRECTION_struct* = RECORD
      emr* : EMR;
      iArcDirection* : DWORD
    END;
    ...
    tagEMRSETMAPPERFLAGS_struct* = RECORD
      emr* : EMR;
      dwFlags* : DWORD
    END;
    ...
    tagEMRSETTEXTCOLOR_struct* = RECORD
      emr* : EMR;
      crColor* : COLORREF
    END;
    ...
    tagEMRSELECTOBJECT_struct* = RECORD
      emr* : EMR;
      ihObject* : DWORD
    END;
    ...
    tagEMRSELECTCOLORSPACE_struct* = RECORD
      emr* : EMR;
      ihCS* : DWORD
    END;
    ...
    tagEMRSELECTPALETTE_struct* = RECORD
      emr* : EMR;
      ihPal* : DWORD
    END;
    ...
    tagEMRRESIZEPALETTE_struct* = RECORD
      emr* : EMR;
      ihPal* : DWORD;
      cEntries* : DWORD
    END;
    ...
    tagEMRSETPALETTEENTRIES_struct* = RECORD
      emr* : EMR;
      ihPal* : DWORD;
      iStart* : DWORD;
      cEntries* : DWORD;
    ...
    tagEMRSETCOLORADJUSTMENT_struct* = RECORD
      emr* : EMR;
    ...
    tagEMRGDICOMMENT_struct* = RECORD
      emr* : EMR;
      cbData* : DWORD;
      Data* : ARRAY 1 OF BYTE
    END;
    ...
    tagEMROFFSETCLIPRGN_struct* = RECORD
      emr* : EMR;
      ptlOffset* : POINTL
    END;
    ...
    tagEMREXCLUDECLIPRECT_struct* = RECORD
      emr* : EMR;
      rclClip* : RECTL
    END;
    ...
    tagEMRSETVIEWPORTORGEX_struct* = RECORD
      emr* : EMR;
      ptlOrigin* : POINTL
    END;
    ...
    tagEMRSETVIEWPORTEXTEX_struct* = RECORD
      emr* : EMR;
      szlExtent* : SIZEL
    END;
    ...
    tagEMRSCALEVIEWPORTEXTEX_struct* = RECORD
      emr* : EMR;
      xNum* : LONG;
      xDenom* : LONG;
      yNum* : LONG;
    ...
    tagEMRSETWORLDTRANSFORM_struct* = RECORD
      emr* : EMR;
      xform* : XFORM
    END;
    ...
    tagEMRMODIFYWORLDTRANSFORM_struct* = RECORD
      emr* : EMR;
      xform* : XFORM;
      iMode* : DWORD
    END;
    ...
    tagEMREXTFLOODFILL_struct* = RECORD
      emr* : EMR;
      ptlStart* : POINTL;
      crColor* : COLORREF;
      iMode* : DWORD
    ...
    tagEMRPOLYLINE16_struct* = RECORD
      emr* : EMR;
      rclBounds* : RECTL;
      cpts* : DWORD;
    ...
    tagEMRPOLYDRAW16_struct* = RECORD
      emr* : EMR;
      rclBounds* : RECTL;
      cpts* : DWORD;
      apts* : ARRAY 1 OF POINTS;
    ...
    tagEMRPOLYPOLYLINE_struct* = RECORD
      emr* : EMR;
      rclBounds* : RECTL;
      nPolys* : DWORD;
      cptl* : DWORD;
    ...
    tagEMRPOLYPOLYLINE16_struct* = RECORD
      emr* : EMR;
      rclBounds* : RECTL;
      nPolys* : DWORD;
      cpts* : DWORD;
    ...
    tagEMREXTSELECTCLIPRGN_struct* = RECORD
      emr* : EMR;
      cbRgnData* : DWORD;
      iMode* : DWORD;
      RgnData* : ARRAY 1 OF BYTE
    ...
    tagEMREXTTEXTOUTA_struct* = RECORD
      emr* : EMR;
      rclBounds* : RECTL;
      iGraphicsMode* : DWORD;
      exScale* : FLOAT;
    ...
    tagEMRPOLYTEXTOUTA_struct* = RECORD
      emr* : EMR;
      rclBounds* : RECTL;
      iGraphicsMode* : DWORD;
      exScale* : FLOAT;
    ...
    tagEMRSTRETCHBLT_struct* = RECORD
      emr* : EMR;
      rclBounds* : RECTL;
      xDest* : LONG;
      yDest* : LONG;
    ...
    tagEMRSETDIBITSTODEVICE_struct* = RECORD
      emr* : EMR;
      rclBounds* : RECTL;
      xDest* : LONG;
      yDest* : LONG;
    ...
    tagEMRSTRETCHDIBITS_struct* = RECORD
      emr* : EMR;
      rclBounds* : RECTL;
      xDest* : LONG;
      yDest* : LONG;
    ...
    tagEMREXTCREATEFONTINDIRECTW_struct* = RECORD
      emr* : EMR;
      ihFont* : DWORD;
      elfw* : EXTLOGFONTW
    END;
    ...
    tagEMRCREATEPALETTE_struct* = RECORD
      emr* : EMR;
      ihPal* : DWORD;
      lgpl* : LOGPALETTE
    END;
    ...
    tagEMRCREATECOLORSPACE_struct* = RECORD
      emr* : EMR;
      ihCS* : DWORD;
      lcs* : LOGCOLORSPACEW
    END;
    ...
    tagEMREXTCREATEPEN_struct* = RECORD
      emr* : EMR;
      ihPen* : DWORD;
      offBmi* : DWORD;
      cbBmi* : DWORD;
    ...
    tagEMRCREATEBRUSHINDIRECT_struct* = RECORD
      emr* : EMR;
      ihBrush* : DWORD;
      lb* : LOGBRUSH
    END;
    ...
    tagEMRCREATEMONOBRUSH_struct* = RECORD
      emr* : EMR;
      ihBrush* : DWORD;
      iUsage* : DWORD;
      offBmi* : DWORD;
    ...
    tagEMRCREATEDIBPATTERNBRUSHPT_struct* = RECORD
      emr* : EMR;
      ihBrush* : DWORD;
      iUsage* : DWORD;
      offBmi* : DWORD;
    ...
    tagEMRGLSBOUNDEDRECORD_struct* = RECORD
      emr* : EMR;
      rclBounds* : RECTL;
      cbData* : DWORD;
      Data* : ARRAY 1 OF BYTE
    ...
    tagEMRPIXELFORMAT_struct* = RECORD
      emr* : EMR;
    ...
    tagEMRSETICMPROFILE_struct* = RECORD
      emr* : EMR;
      dwFlags* : DWORD;
      cbName* : DWORD;
      cbData* : DWORD;
    ...
    _GLYPHMETRICSFLOAT_struct* = RECORD
      gmfBlackBoxX* : FLOAT;
      gmfBlackBoxY* : FLOAT;
    ...
    tagLAYERPLANEDESCRIPTOR_struct* = RECORD
      nSize* : WORD;
      nVersion* : WORD;
      dwFlags* : DWORD;
      iPixelType* : BYTE;
    ...
    tagCBT_CREATEWNDA_struct* = RECORD
    ...
    tagCBT_CREATEWNDW_struct* = RECORD
    ...
    tagCBTACTIVATESTRUCT_struct* = RECORD
      fMouse* : BOOL;
      hWndActive* : HWND
    END;
    ...
    tagKBDLLHOOKSTRUCT_struct* = RECORD
      vkCode* : DWORD;
      scanCode* : DWORD;
      flags* : DWORD;
      time* : DWORD;
    ...
    tagMSLLHOOKSTRUCT_struct* = RECORD
      pt* : POINT;
      mouseData* : DWORD;
      flags* : DWORD;
      time* : DWORD;
    ...
    tagDEBUGHOOKINFO_struct* = RECORD
      idThread* : DWORD;
    ...
    tagMOUSEHOOKSTRUCT_struct* = RECORD
      pt* : POINT;
      hwnd* : HWND;
      wHitTestCode* : UINT;
      dwExtraInfo* : DWORD
    ...
    tagHARDWAREHOOKSTRUCT_struct* = RECORD
      hwnd* : HWND;
      message* : UINT;
      wParam* : WPARAM;
      lParam* : LPARAM
    ...
    tagUSEROBJECTFLAGS_struct* = RECORD
      fInherit* : BOOL;
      fReserved* : BOOL;
      dwFlags* : DWORD
    END;
    ...
    tagCOPYDATASTRUCT_struct* = RECORD
      dwData* : DWORD;
      cbData* : DWORD;
      lpData* : PVOID
    END;
    ...
    tagNCCALCSIZE_PARAMS_struct* = RECORD
    ...
    tagTRACKMOUSEEVENT_struct* = RECORD
      cbSize* : DWORD;
      dwFlags* : DWORD;
      hwndTrack* : HWND;
      dwHoverTime* : DWORD
    ...
    tagCREATESTRUCTA_struct* = RECORD
    ...
    tagCREATESTRUCTW_struct* = RECORD
      lpCreateParams* : LPVOID;
      hInstance* : HINSTANCE;
      hMenu* : HMENU;
      hwndParent* : HWND;
    ...
    tagWINDOWPLACEMENT_struct* = RECORD
      length* : UINT;
      flags* : UINT;
      showCmd* : UINT;
      ptMinPosition* : POINT;
    ...
    tagMEASUREITEMSTRUCT_struct* = RECORD
      CtlType* : UINT;
      CtlID* : UINT;
      itemID* : UINT;
      itemWidth* : UINT;
    ...
    tagDRAWITEMSTRUCT_struct* = RECORD
      CtlType* : UINT;
      CtlID* : UINT;
      itemID* : UINT;
      itemAction* : UINT;
    ...
    tagDELETEITEMSTRUCT_struct* = RECORD
      CtlType* : UINT;
      CtlID* : UINT;
      itemID* : UINT;
      hwndItem* : HWND;
    ...
    tagCOMPAREITEMSTRUCT_struct* = RECORD
      CtlType* : UINT;
      CtlID* : UINT;
      hwndItem* : HWND;
      itemID1* : UINT;
    ...
    tagMENUITEMINFOA_struct* = RECORD
      cbSize* : UINT;
      fMask* : UINT;
      fType* : UINT;
      fState* : UINT;
    ...
    tagMENUITEMINFOW_struct* = RECORD
      cbSize* : UINT;
      fMask* : UINT;
      fType* : UINT;
      fState* : UINT;
    ...
    tagDRAWTEXTPARAMS_struct* = RECORD
      cbSize* : UINT;
      iTabLength* : LONGINT;
      iLeftMargin* : LONGINT;
    ...
    tagMSGBOXPARAMSA_struct* = RECORD
      cbSize* : UINT;
      hwndOwner* : HWND;
      hInstance* : HINSTANCE;
      lpszText* : LPCSTR;
    ...
    tagMSGBOXPARAMSW_struct* = RECORD
      cbSize* : UINT;
      hwndOwner* : HWND;
      hInstance* : HINSTANCE;
      lpszText* : LPCWSTR;
    ...
    PMENUITEMTEMPLATEHEADER* = POINTER TO RECORD
      versionNumber* : WORD;
      offset* : WORD
    END;
    ...
    PMENUITEMTEMPLATE* = POINTER TO RECORD
      mtOption* : WORD;
      mtID* : WORD;
      mtString* : ARRAY 1 OF WCHAR
    END;

    _ICONINFO_struct* = RECORD
      fIcon* : BOOL;
      xHotspot* : DWORD;
      yHotspot* : DWORD;
      hbmMask* : HBITMAP;
    ...
    tagMDICREATESTRUCTA_struct* = RECORD
      szClass* : LPCSTR;
      szTitle* : LPCSTR;
      hOwner* : HANDLE;
      x* : LONGINT;
    ...
    tagMDICREATESTRUCTW_struct* = RECORD
      szClass* : LPCWSTR;
      szTitle* : LPCWSTR;
      hOwner* : HANDLE;
      x* : LONGINT;
    ...
    tagCLIENTCREATESTRUCT_struct* = RECORD
      hWindowMenu* : HANDLE;
      idFirstChild* : UINT
    END;
    ...
    tagMULTIKEYHELPA_struct* = RECORD
      mkSize* : DWORD;
      mkKeylist* : CHAR;
    ...
    tagMULTIKEYHELPW_struct* = RECORD
      mkSize* : DWORD;
      mkKeylist* : WCHAR;
    ...
    tagNONCLIENTMETRICSA_struct* = RECORD
      cbSize* : UINT;
    ...
    tagNONCLIENTMETRICSW_struct* = RECORD
      cbSize* : UINT;
      iBorderWidth* : LONGINT;
      iScrollWidth* : LONGINT;
      iScrollHeight* : LONGINT;
    ...
    tagMINIMIZEDMETRICS_struct* = RECORD
      cbSize* : UINT;
      iWidth* : LONGINT;
      iHorzGap* : LONGINT;
      iVertGap* : LONGINT;
    ...
    tagANIMATIONINFO_struct* = RECORD
      cbSize* : UINT;
      iMinAnimate* : LONGINT
    END;
    ...
    tagHIGHCONTRASTA_struct* = RECORD
      cbSize* : UINT;
      dwFlags* : DWORD;
    ...
    tagHIGHCONTRASTW_struct* = RECORD
      cbSize* : UINT;
      dwFlags* : DWORD;
    ...
    tagACCESSTIMEOUT_struct* = RECORD
      cbSize* : UINT;
      dwFlags* : DWORD;
      iTimeOutMSec* : DWORD
    END;
    ...
    _KEY_EVENT_RECORD_struct* = RECORD
      bKeyDown* : BOOL;
      wRepeatCount* : WORD;
    ...
    _MOUSE_EVENT_RECORD_struct* = RECORD
    ...
    _WINDOW_BUFFER_SIZE_RECORD_struct* = RECORD
      dwSize* : COORD
    END;
    ...
    _MENU_EVENT_RECORD_struct* = RECORD
      dwCommandId* : UINT
    END;
    ...
    _FOCUS_EVENT_RECORD_struct* = RECORD
      bSetFocus* : BOOL
    END;
    ...
    _CONSOLE_SCREEN_BUFFER_INFO_struct* = RECORD
      dwSize* : COORD;
    ...
    _CONSOLE_CURSOR_INFO_struct* = RECORD
      dwSize* : DWORD;
      bVisible* : BOOL
    END;
    ...
    tagVS_FIXEDFILEINFO_struct* = RECORD
      dwSignature* : DWORD;
    ...
    PQUERYHANDLER* = PROCEDURE (keycontext : LPVOID; VAR val_list [NIL_COMPAT]  : val_context_struct; num_vals : DWORD; outputbuffer : LPVOID; VAR total_outlen [NIL_COMPAT]  : DWORD; input_blen : DWORD) : DWORD;

    provider_info_struct* = RECORD
    ...
    _CONNECTDLGSTRUCTA_struct* = RECORD
      cbStructure* : DWORD;
      hwndOwner* : HWND;
    ...
    _CONNECTDLGSTRUCTW_struct* = RECORD
      cbStructure* : DWORD;
      hwndOwner* : HWND;
    ...
    _UNIVERSAL_NAME_INFOA_struct* = RECORD
    ...
    _UNIVERSAL_NAME_INFOW_struct* = RECORD
    ...
    _REMOTE_NAME_INFOA_struct* = RECORD
      lpUniversalName* : LPSTR;
    ...
    _REMOTE_NAME_INFOW_struct* = RECORD
      lpUniversalName* : LPWSTR;
    ...
    _NETCONNECTINFOSTRUCT_struct* = RECORD
      cbStructure* : DWORD;
      dwFlags* : DWORD;
      dwSpeed* : DWORD;
      dwDelay* : DWORD;
    ...
    _SERVICE_DESCRIPTIONA_struct* = RECORD
      lpDescription* : LPSTR
    END;
    ...
    _SERVICE_DESCRIPTIONW_struct* = RECORD
    ...
    _SERVICE_FAILURE_ACTIONSA_struct* = RECORD
      dwResetPeriod* : DWORD;
      lpRebootMsg* : LPSTR;
      lpCommand* : LPSTR;
      cActions* : DWORD;
    ...
    _SERVICE_FAILURE_ACTIONSW_struct* = RECORD
      dwResetPeriod* : DWORD;
      lpRebootMsg* : LPWSTR;
      lpCommand* : LPWSTR;
      cActions* : DWORD;
    ...
    _ENUM_SERVICE_STATUSA_struct* = RECORD
      lpServiceName* : LPSTR;
      lpDisplayName* : LPSTR;
    ...
    _ENUM_SERVICE_STATUSW_struct* = RECORD
    ...
    _QUERY_SERVICE_LOCK_STATUSA_struct* = RECORD
      fIsLocked* : DWORD;
      lpLockOwner* : LPSTR;
    ...
    _QUERY_SERVICE_LOCK_STATUSW_struct* = RECORD
      fIsLocked* : DWORD;
      lpLockOwner* : LPWSTR;
      dwLockDuration* : DWORD
    END;
    ...
    _QUERY_SERVICE_CONFIGA_struct* = RECORD
      dwServiceType* : DWORD;
      dwStartType* : DWORD;
    ...
    _QUERY_SERVICE_CONFIGW_struct* = RECORD
      dwServiceType* : DWORD;
      dwStartType* : DWORD;
      dwErrorControl* : DWORD;
    ...
    LPSERVICE_MAIN_FUNCTIONW* = PROCEDURE (dwNumServicesArgs : DWORD; VAR lpServiceArgVectors [NIL_COMPAT]  : LPWSTR);

    LPSERVICE_MAIN_FUNCTIONA* = LPSERVICE_MAIN_FUNCTIONW;

    _SERVICE_TABLE_ENTRYA_struct* = RECORD
      lpServiceName* : LPSTR;
    ...
    _SERVICE_TABLE_ENTRYW_struct* = RECORD
      lpServiceName* : LPWSTR;
    ...
    tagCOMPOSITIONFORM_struct* = RECORD
      dwStyle* : DWORD;
      ptCurrentPos* : POINT;
      rcArea* : RECT
    END;
    ...
    tagCANDIDATEFORM_struct* = RECORD
      dwIndex* : DWORD;
      dwStyle* : DWORD;
      ptCurrentPos* : POINT;
      rcArea* : RECT
    ...
    tagCANDIDATELIST_struct* = RECORD
      dwSize* : DWORD;
      dwStyle* : DWORD;
      dwCount* : DWORD;
      dwSelection* : DWORD;
    ...
    tagREGISTERWORDA_struct* = RECORD
      lpReading* : LPSTR;
      lpWord* : LPSTR
    END;
    ...
    tagREGISTERWORDW_struct* = RECORD
      lpReading* : LPWSTR;
      lpWord* : LPWSTR
    END;
    ...
    _EXCEPTION_REGISTRATION_RECORD_struct* = RECORD
    END;
    ...
    PROCEDURE InterlockedIncrement* (VAR lpAddend [NIL_COMPAT]  : LONGINT) : LONG;
    PROCEDURE InterlockedDecrement* (VAR lpAddend [NIL_COMPAT]  : LONGINT) : LONG;
    PROCEDURE InterlockedExchange* (VAR Target [NIL_COMPAT]  : LONGINT; Value : LONG) : LONG;
    PROCEDURE InterlockedExchangeAdd* (VAR Addend [NIL_COMPAT]  : LONGINT; Value : LONG) : LONG;
    PROCEDURE InterlockedCompareExchange* (VAR Destination [NIL_COMPAT]  : PVOID; Exchange : PVOID; Comperand : PVOID) : PVOID;
    ...
    PROCEDURE GlobalMemoryStatus* (VAR lpBuffer [NIL_COMPAT]  : _MEMORYSTATUS_struct);
    ...
    PROCEDURE VirtualProtect* (lpAddress : LPVOID; dwSize : DWORD; flNewProtect : DWORD; VAR lpflOldProtect [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE VirtualQuery* (lpAddress : LPCVOID; VAR lpBuffer [NIL_COMPAT]  : _MEMORY_BASIC_INFORMATION_struct; dwLength : DWORD) : DWORD;
    ...
    PROCEDURE VirtualProtectEx* (hProcess : HANDLE; lpAddress : LPVOID; dwSize : DWORD; flNewProtect : DWORD; VAR lpflOldProtect [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE VirtualQueryEx* (hProcess : HANDLE; lpAddress : LPCVOID; VAR lpBuffer [NIL_COMPAT]  : _MEMORY_BASIC_INFORMATION_struct; dwLength : DWORD) : DWORD;
    ...
    PROCEDURE GetProcessHeaps* (NumberOfHeaps : DWORD; VAR ProcessHeaps [NIL_COMPAT]  : HANDLE) : DWORD;
    PROCEDURE HeapLock* (hHeap : HANDLE) : BOOL;
    PROCEDURE HeapUnlock* (hHeap : HANDLE) : BOOL;
    PROCEDURE HeapWalk* (hHeap : HANDLE; VAR lpEntry [NIL_COMPAT]  : _PROCESS_HEAP_ENTRY_struct) : BOOL;
    PROCEDURE GetBinaryTypeA* (lpApplicationName : LPCSTR; VAR lpBinaryType [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetBinaryTypeW* (lpApplicationName : LPCWSTR; VAR lpBinaryType [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE GetProcessAffinityMask* (hProcess : HANDLE; VAR lpProcessAffinityMask [NIL_COMPAT]  : DWORD; VAR lpSystemAffinityMask [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE SetProcessAffinityMask* (hProcess : HANDLE; dwProcessAffinityMask : DWORD) : BOOL;
    PROCEDURE GetProcessTimes* (hProcess : HANDLE; VAR lpCreationTime [NIL_COMPAT]  : _FILETIME_struct; VAR lpExitTime [NIL_COMPAT]  : _FILETIME_struct; VAR lpKernelTime [NIL_COMPAT]  : _FILETIME_struct; VAR lpUserTime [NIL_COMPAT]  : _FILETIME_struct) : BOOL;
    PROCEDURE GetProcessWorkingSetSize* (hProcess : HANDLE; VAR lpMinimumWorkingSetSize [NIL_COMPAT]  : DWORD; VAR lpMaximumWorkingSetSize [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE GetExitCodeProcess* (hProcess : HANDLE; VAR lpExitCode [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE RaiseException* (dwExceptionCode : DWORD; dwExceptionFlags : DWORD; nNumberOfArguments : DWORD; VAR lpArguments [NIL_COMPAT]  : DWORD);
    PROCEDURE UnhandledExceptionFilter* (VAR ExceptionInfo [NIL_COMPAT]  : _EXCEPTION_POINTERS_struct) : LONG;
    ...
    PROCEDURE CreateThread* (VAR lpThreadAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; dwStackSize : DWORD; lpStartAddress : LPTHREAD_START_ROUTINE; lpParameter : LPVOID; dwCreationFlags : DWORD; VAR lpThreadId [NIL_COMPAT]  : DWORD) : HANDLE;
    PROCEDURE CreateRemoteThread* (hProcess : HANDLE; VAR lpThreadAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; dwStackSize : DWORD; lpStartAddress : LPTHREAD_START_ROUTINE; lpParameter : LPVOID; dwCreationFlags : DWORD; VAR lpThreadId [NIL_COMPAT]  : DWORD) : HANDLE;
    ...
    PROCEDURE GetProcessPriorityBoost* (hProcess : HANDLE; VAR pDisablePriorityBoost [NIL_COMPAT]  : BOOL) : BOOL;
    ...
    PROCEDURE GetThreadPriorityBoost* (hThread : HANDLE; VAR pDisablePriorityBoost [NIL_COMPAT]  : BOOL) : BOOL;
    PROCEDURE GetThreadPriority* (hThread : HANDLE) : LONGINT;
    PROCEDURE GetThreadTimes* (hThread : HANDLE; VAR lpCreationTime [NIL_COMPAT]  : _FILETIME_struct; VAR lpExitTime [NIL_COMPAT]  : _FILETIME_struct; VAR lpKernelTime [NIL_COMPAT]  : _FILETIME_struct; VAR lpUserTime [NIL_COMPAT]  : _FILETIME_struct) : BOOL;
    PROCEDURE ExitThread* (dwExitCode : DWORD);
    PROCEDURE TerminateThread* (hThread : HANDLE; dwExitCode : DWORD) : BOOL;
    PROCEDURE GetExitCodeThread* (hThread : HANDLE; VAR lpExitCode [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetThreadSelectorEntry* (hThread : HANDLE; dwSelector : DWORD; VAR lpSelectorEntry [NIL_COMPAT]  : _LDT_ENTRY_struct) : BOOL;
    PROCEDURE SetThreadExecutionState* (esFlags : EXECUTION_STATE) : EXECUTION_STATE;
    PROCEDURE GetLastError* () : DWORD;
    PROCEDURE SetLastError* (dwErrCode : DWORD);
    PROCEDURE GetOverlappedResult* (hFile : HANDLE; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct; VAR lpNumberOfBytesTransferred [NIL_COMPAT]  : DWORD; bWait : BOOL) : BOOL;
    ...
    PROCEDURE GetQueuedCompletionStatus* (CompletionPort : HANDLE; VAR lpNumberOfBytesTransferred [NIL_COMPAT]  : DWORD; VAR lpCompletionKey [NIL_COMPAT]  : DWORD; VAR lpOverlapped [NIL_COMPAT]  : LPOVERLAPPED; dwMilliseconds : DWORD) : BOOL;
    PROCEDURE PostQueuedCompletionStatus* (CompletionPort : HANDLE; dwNumberOfBytesTransferred : DWORD; dwCompletionKey : DWORD; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct) : BOOL;
    PROCEDURE SetErrorMode* (uMode : UINT) : UINT;
    PROCEDURE ReadProcessMemory* (hProcess : HANDLE; lpBaseAddress : LPCVOID; lpBuffer : LPVOID; nSize : DWORD; VAR lpNumberOfBytesRead [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE WriteProcessMemory* (hProcess : HANDLE; lpBaseAddress : LPVOID; lpBuffer : LPVOID; nSize : DWORD; VAR lpNumberOfBytesWritten [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetThreadContext* (hThread : HANDLE; VAR lpContext [NIL_COMPAT]  : CONTEXT) : BOOL;
    PROCEDURE SetThreadContext* (hThread : HANDLE; VAR lpContext [NIL_COMPAT]  : CONTEXT) : BOOL;
    ...
    PROCEDURE WaitForDebugEvent* (VAR lpDebugEvent [NIL_COMPAT]  : _DEBUG_EVENT_struct; dwMilliseconds : DWORD) : BOOL;
    ...
    PROCEDURE InitializeCriticalSection* (VAR lpCriticalSection [NIL_COMPAT]  : _RTL_CRITICAL_SECTION_struct);
    PROCEDURE EnterCriticalSection* (VAR lpCriticalSection [NIL_COMPAT]  : _RTL_CRITICAL_SECTION_struct);
    PROCEDURE LeaveCriticalSection* (VAR lpCriticalSection [NIL_COMPAT]  : _RTL_CRITICAL_SECTION_struct);
    PROCEDURE TryEnterCriticalSection* (VAR lpCriticalSection [NIL_COMPAT]  : _RTL_CRITICAL_SECTION_struct) : BOOL;
    PROCEDURE DeleteCriticalSection* (VAR lpCriticalSection [NIL_COMPAT]  : _RTL_CRITICAL_SECTION_struct);
    PROCEDURE SetEvent* (hEvent : HANDLE) : BOOL;
    PROCEDURE ResetEvent* (hEvent : HANDLE) : BOOL;
    PROCEDURE PulseEvent* (hEvent : HANDLE) : BOOL;
    PROCEDURE ReleaseSemaphore* (hSemaphore : HANDLE; lReleaseCount : LONG; VAR lpPreviousCount [NIL_COMPAT]  : LONGINT) : BOOL;
    PROCEDURE ReleaseMutex* (hMutex : HANDLE) : BOOL;
    PROCEDURE WaitForSingleObject* (hHandle : HANDLE; dwMilliseconds : DWORD) : DWORD;
    PROCEDURE WaitForMultipleObjects* (nCount : DWORD; VAR lpHandles [NIL_COMPAT]  : HANDLE; bWaitAll : BOOL; dwMilliseconds : DWORD) : DWORD;
    ...
    PROCEDURE LockFileEx* (hFile : HANDLE; dwFlags : DWORD; dwReserved : DWORD; nNumberOfBytesToLockLow : DWORD; nNumberOfBytesToLockHigh : DWORD; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct) : BOOL;
    PROCEDURE UnlockFileEx* (hFile : HANDLE; dwReserved : DWORD; nNumberOfBytesToUnlockLow : DWORD; nNumberOfBytesToUnlockHigh : DWORD; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct) : BOOL;
    PROCEDURE GetFileInformationByHandle* (hFile : HANDLE; VAR lpFileInformation [NIL_COMPAT]  : _BY_HANDLE_FILE_INFORMATION_struct) : BOOL;
    PROCEDURE GetFileType* (hFile : HANDLE) : DWORD;
    PROCEDURE GetFileSize* (hFile : HANDLE; VAR lpFileSizeHigh [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE GetStdHandle* (nStdHandle : DWORD) : HANDLE;
    PROCEDURE SetStdHandle* (nStdHandle : DWORD; hHandle : HANDLE) : BOOL;
    PROCEDURE WriteFile* (hFile : HANDLE; lpBuffer : LPCVOID; nNumberOfBytesToWrite : DWORD; VAR lpNumberOfBytesWritten [NIL_COMPAT]  : DWORD; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct) : BOOL;
    PROCEDURE ReadFile* (hFile : HANDLE; lpBuffer : LPVOID; nNumberOfBytesToRead : DWORD; VAR lpNumberOfBytesRead [NIL_COMPAT]  : DWORD; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct) : BOOL;
    PROCEDURE FlushFileBuffers* (hFile : HANDLE) : BOOL;
    PROCEDURE DeviceIoControl* (hDevice : HANDLE; dwIoControlCode : DWORD; lpInBuffer : LPVOID; nInBufferSize : DWORD; lpOutBuffer : LPVOID; nOutBufferSize : DWORD; VAR lpBytesReturned [NIL_COMPAT]  : DWORD; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct) : BOOL;
    PROCEDURE GetDevicePowerState* (hFile : HANDLE) : BOOL;
    PROCEDURE SetEndOfFile* (hFile : HANDLE) : BOOL;
    PROCEDURE SetFilePointer* (hFile : HANDLE; lDistanceToMove : LONG; VAR lpDistanceToMoveHigh [NIL_COMPAT]  : LONG; dwMoveMethod : DWORD) : DWORD;
    PROCEDURE FindClose* (hFindFile : HANDLE) : BOOL;
    PROCEDURE GetFileTime* (hFile : HANDLE; VAR lpCreationTime [NIL_COMPAT]  : _FILETIME_struct; VAR lpLastAccessTime [NIL_COMPAT]  : _FILETIME_struct; VAR lpLastWriteTime [NIL_COMPAT]  : _FILETIME_struct) : BOOL;
    PROCEDURE SetFileTime* (hFile : HANDLE; VAR lpCreationTime [NIL_COMPAT]  : FILETIME; VAR lpLastAccessTime [NIL_COMPAT]  : FILETIME; VAR lpLastWriteTime [NIL_COMPAT]  : FILETIME) : BOOL;
    PROCEDURE CloseHandle* (hObject : HANDLE) : BOOL;
    PROCEDURE DuplicateHandle* (hSourceProcessHandle : HANDLE; hSourceHandle : HANDLE; hTargetProcessHandle : HANDLE; VAR lpTargetHandle [NIL_COMPAT]  : HANDLE; dwDesiredAccess : DWORD; bInheritHandle : BOOL; dwOptions : DWORD) : BOOL;
    PROCEDURE GetHandleInformation* (hObject : HANDLE; VAR lpdwFlags [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE ClearCommError* (hFile : HANDLE; VAR lpErrors [NIL_COMPAT]  : DWORD; VAR lpStat [NIL_COMPAT]  : _COMSTAT_struct) : BOOL;
    ...
    PROCEDURE GetCommConfig* (hCommDev : HANDLE; VAR lpCC [NIL_COMPAT]  : _COMMCONFIG_struct; VAR lpdwSize [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetCommMask* (hFile : HANDLE; VAR lpEvtMask [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetCommProperties* (hFile : HANDLE; VAR lpCommProp [NIL_COMPAT]  : _COMMPROP_struct) : BOOL;
    PROCEDURE GetCommModemStatus* (hFile : HANDLE; VAR lpModemStat [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetCommState* (hFile : HANDLE; VAR lpDCB [NIL_COMPAT]  : _DCB_struct) : BOOL;
    PROCEDURE GetCommTimeouts* (hFile : HANDLE; VAR lpCommTimeouts [NIL_COMPAT]  : _COMMTIMEOUTS_struct) : BOOL;
    PROCEDURE PurgeComm* (hFile : HANDLE; dwFlags : DWORD) : BOOL;
    PROCEDURE SetCommBreak* (hFile : HANDLE) : BOOL;
    PROCEDURE SetCommConfig* (hCommDev : HANDLE; VAR lpCC [NIL_COMPAT]  : _COMMCONFIG_struct; dwSize : DWORD) : BOOL;
    PROCEDURE SetCommMask* (hFile : HANDLE; dwEvtMask : DWORD) : BOOL;
    PROCEDURE SetCommState* (hFile : HANDLE; VAR lpDCB [NIL_COMPAT]  : _DCB_struct) : BOOL;
    PROCEDURE SetCommTimeouts* (hFile : HANDLE; VAR lpCommTimeouts [NIL_COMPAT]  : _COMMTIMEOUTS_struct) : BOOL;
    PROCEDURE TransmitCommChar* (hFile : HANDLE; cChar : CHAR) : BOOL;
    PROCEDURE WaitCommEvent* (hFile : HANDLE; VAR lpEvtMask [NIL_COMPAT]  : DWORD; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct) : BOOL;
    ...
    PROCEDURE GetTapePosition* (hDevice : HANDLE; dwPositionType : DWORD; VAR lpdwPartition [NIL_COMPAT]  : DWORD; VAR lpdwOffsetLow [NIL_COMPAT]  : DWORD; VAR lpdwOffsetHigh [NIL_COMPAT]  : DWORD) : DWORD;
    ...
    PROCEDURE GetTapeParameters* (hDevice : HANDLE; dwOperation : DWORD; VAR lpdwSize [NIL_COMPAT]  : DWORD; lpTapeInformation : LPVOID) : DWORD;
    ...
    PROCEDURE GetSystemTime* (VAR lpSystemTime [NIL_COMPAT]  : _SYSTEMTIME_struct);
    PROCEDURE GetSystemTimeAsFileTime* (VAR lpSystemTimeAsFileTime [NIL_COMPAT]  : _FILETIME_struct);
    PROCEDURE SetSystemTime* (VAR lpSystemTime [NIL_COMPAT]  : SYSTEMTIME) : BOOL;
    PROCEDURE GetLocalTime* (VAR lpSystemTime [NIL_COMPAT]  : _SYSTEMTIME_struct);
    PROCEDURE SetLocalTime* (VAR lpSystemTime [NIL_COMPAT]  : SYSTEMTIME) : BOOL;
    PROCEDURE GetSystemInfo* (VAR lpSystemInfo [NIL_COMPAT]  : _SYSTEM_INFO_struct);
    PROCEDURE IsProcessorFeaturePresent* (ProcessorFeature : DWORD) : BOOL;
    PROCEDURE SystemTimeToTzSpecificLocalTime* (VAR lpTimeZoneInformation [NIL_COMPAT]  : _TIME_ZONE_INFORMATION_struct; VAR lpUniversalTime [NIL_COMPAT]  : _SYSTEMTIME_struct; VAR lpLocalTime [NIL_COMPAT]  : _SYSTEMTIME_struct) : BOOL;
    PROCEDURE GetTimeZoneInformation* (VAR lpTimeZoneInformation [NIL_COMPAT]  : _TIME_ZONE_INFORMATION_struct) : DWORD;
    PROCEDURE SetTimeZoneInformation* (VAR lpTimeZoneInformation [NIL_COMPAT]  : TIME_ZONE_INFORMATION) : BOOL;
    PROCEDURE SystemTimeToFileTime* (VAR lpSystemTime [NIL_COMPAT]  : SYSTEMTIME; VAR lpFileTime [NIL_COMPAT]  : _FILETIME_struct) : BOOL;
    PROCEDURE FileTimeToLocalFileTime* (VAR lpFileTime [NIL_COMPAT]  : FILETIME; VAR lpLocalFileTime [NIL_COMPAT]  : _FILETIME_struct) : BOOL;
    PROCEDURE LocalFileTimeToFileTime* (VAR lpLocalFileTime [NIL_COMPAT]  : FILETIME; VAR lpFileTime [NIL_COMPAT]  : _FILETIME_struct) : BOOL;
    PROCEDURE FileTimeToSystemTime* (VAR lpFileTime [NIL_COMPAT]  : FILETIME; VAR lpSystemTime [NIL_COMPAT]  : _SYSTEMTIME_struct) : BOOL;
    PROCEDURE CompareFileTime* (VAR lpFileTime1 [NIL_COMPAT]  : FILETIME; VAR lpFileTime2 [NIL_COMPAT]  : FILETIME) : LONG;
    PROCEDURE FileTimeToDosDateTime* (VAR lpFileTime [NIL_COMPAT]  : FILETIME; VAR lpFatDate [NIL_COMPAT]  : WORD; VAR lpFatTime [NIL_COMPAT]  : WORD) : BOOL;
    PROCEDURE DosDateTimeToFileTime* (wFatDate : WORD; wFatTime : WORD; VAR lpFileTime [NIL_COMPAT]  : _FILETIME_struct) : BOOL;
    PROCEDURE GetTickCount* () : DWORD;
    PROCEDURE SetSystemTimeAdjustment* (dwTimeAdjustment : DWORD; bTimeAdjustmentDisabled : BOOL) : BOOL;
    PROCEDURE GetSystemTimeAdjustment* (VAR lpTimeAdjustment [NIL_COMPAT]  : DWORD; VAR lpTimeIncrement [NIL_COMPAT]  : DWORD; VAR lpTimeAdjustmentDisabled [NIL_COMPAT]  : BOOL) : BOOL;
    PROCEDURE FormatMessageA* (dwFlags : DWORD; lpSource : LPCVOID; dwMessageId : DWORD; dwLanguageId : DWORD; lpBuffer : LPSTR; nSize : DWORD; VAR Arguments [NIL_COMPAT]  : va_list) : DWORD;
    PROCEDURE FormatMessageW* (dwFlags : DWORD; lpSource : LPCVOID; dwMessageId : DWORD; dwLanguageId : DWORD; lpBuffer : LPWSTR; nSize : DWORD; VAR Arguments [NIL_COMPAT]  : va_list) : DWORD;
    PROCEDURE CreatePipe* (VAR hReadPipe [NIL_COMPAT]  : HANDLE; VAR hWritePipe [NIL_COMPAT]  : HANDLE; VAR lpPipeAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; nSize : DWORD) : BOOL;
    PROCEDURE ConnectNamedPipe* (hNamedPipe : HANDLE; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct) : BOOL;
    PROCEDURE DisconnectNamedPipe* (hNamedPipe : HANDLE) : BOOL;
    PROCEDURE SetNamedPipeHandleState* (hNamedPipe : HANDLE; VAR lpMode [NIL_COMPAT]  : DWORD; VAR lpMaxCollectionCount [NIL_COMPAT]  : DWORD; VAR lpCollectDataTimeout [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetNamedPipeInfo* (hNamedPipe : HANDLE; VAR lpFlags [NIL_COMPAT]  : DWORD; VAR lpOutBufferSize [NIL_COMPAT]  : DWORD; VAR lpInBufferSize [NIL_COMPAT]  : DWORD; VAR lpMaxInstances [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE PeekNamedPipe* (hNamedPipe : HANDLE; lpBuffer : LPVOID; nBufferSize : DWORD; VAR lpBytesRead [NIL_COMPAT]  : DWORD; VAR lpTotalBytesAvail [NIL_COMPAT]  : DWORD; VAR lpBytesLeftThisMessage [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE TransactNamedPipe* (hNamedPipe : HANDLE; lpInBuffer : LPVOID; nInBufferSize : DWORD; lpOutBuffer : LPVOID; nOutBufferSize : DWORD; VAR lpBytesRead [NIL_COMPAT]  : DWORD; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct) : BOOL;
    PROCEDURE CreateMailslotA* (lpName : LPCSTR; nMaxMessageSize : DWORD; lReadTimeout : DWORD; VAR lpSecurityAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct) : HANDLE;
    PROCEDURE CreateMailslotW* (lpName : LPCWSTR; nMaxMessageSize : DWORD; lReadTimeout : DWORD; VAR lpSecurityAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct) : HANDLE;
    PROCEDURE GetMailslotInfo* (hMailslot : HANDLE; VAR lpMaxMessageSize [NIL_COMPAT]  : DWORD; VAR lpNextSize [NIL_COMPAT]  : DWORD; VAR lpMessageCount [NIL_COMPAT]  : DWORD; VAR lpReadTimeout [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE OpenRawA* (lpFileName : LPCSTR; ulFlags : ULONG; VAR pvContext [NIL_COMPAT]  : PVOID) : DWORD;
    PROCEDURE OpenRawW* (lpFileName : LPCWSTR; ulFlags : ULONG; VAR pvContext [NIL_COMPAT]  : PVOID) : DWORD;
    ...
    PROCEDURE QueryRecoveryAgentsA* (lpFileName : LPCSTR; VAR AgentCount [NIL_COMPAT]  : DWORD; VAR RecoveryAgentInformation [NIL_COMPAT]  : LPRECOVERY_AGENT_INFORMATIONA) : DWORD;
    PROCEDURE QueryRecoveryAgentsW* (lpFileName : LPCWSTR; VAR AgentCount [NIL_COMPAT]  : DWORD; VAR RecoveryAgentInformation [NIL_COMPAT]  : LPRECOVERY_AGENT_INFORMATIONW) : DWORD;
    ...
    PROCEDURE OpenFile* (lpFileName : LPCSTR; VAR lpReOpenBuff [NIL_COMPAT]  : _OFSTRUCT_struct; uStyle : UINT) : HFILE;
    ...
    PROCEDURE IsTextUnicode* (lpBuffer : LPVOID; cb : LONGINT; VAR lpi [NIL_COMPAT]  : LONGINT) : BOOL;
    ...
    PROCEDURE WaitForMultipleObjectsEx* (nCount : DWORD; VAR lpHandles [NIL_COMPAT]  : HANDLE; bWaitAll : BOOL; dwMilliseconds : DWORD; bAlertable : BOOL) : DWORD;
    PROCEDURE SignalObjectAndWait* (hObjectToSignal : HANDLE; hObjectToWaitOn : HANDLE; dwMilliseconds : DWORD; bAlertable : BOOL) : DWORD;
    PROCEDURE ReadFileEx* (hFile : HANDLE; lpBuffer : LPVOID; nNumberOfBytesToRead : DWORD; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct; lpCompletionRoutine : LPOVERLAPPED_COMPLETION_ROUTINE) : BOOL;
    PROCEDURE WriteFileEx* (hFile : HANDLE; lpBuffer : LPCVOID; nNumberOfBytesToWrite : DWORD; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct; lpCompletionRoutine : LPOVERLAPPED_COMPLETION_ROUTINE) : BOOL;
    PROCEDURE BackupRead* (hFile : HANDLE; lpBuffer : LPBYTE; nNumberOfBytesToRead : DWORD; VAR lpNumberOfBytesRead [NIL_COMPAT]  : DWORD; bAbort : BOOL; bProcessSecurity : BOOL; VAR lpContext [NIL_COMPAT]  : LPVOID) : BOOL;
    PROCEDURE BackupSeek* (hFile : HANDLE; dwLowBytesToSeek : DWORD; dwHighBytesToSeek : DWORD; VAR lpdwLowByteSeeked [NIL_COMPAT]  : DWORD; VAR lpdwHighByteSeeked [NIL_COMPAT]  : DWORD; VAR lpContext [NIL_COMPAT]  : LPVOID) : BOOL;
    PROCEDURE BackupWrite* (hFile : HANDLE; lpBuffer : LPBYTE; nNumberOfBytesToWrite : DWORD; VAR lpNumberOfBytesWritten [NIL_COMPAT]  : DWORD; bAbort : BOOL; bProcessSecurity : BOOL; VAR lpContext [NIL_COMPAT]  : LPVOID) : BOOL;
    PROCEDURE ReadFileScatter* (hFile : HANDLE; aSegmentArray : ARRAY  OF FILE_SEGMENT_ELEMENT; nNumberOfBytesToRead : DWORD; VAR lpReserved [NIL_COMPAT]  : DWORD; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct) : BOOL;
    PROCEDURE WriteFileGather* (hFile : HANDLE; aSegmentArray : ARRAY  OF FILE_SEGMENT_ELEMENT; nNumberOfBytesToWrite : DWORD; VAR lpReserved [NIL_COMPAT]  : DWORD; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct) : BOOL;
    PROCEDURE CreateMutexA* (VAR lpMutexAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; bInitialOwner : BOOL; lpName : LPCSTR) : HANDLE;
    PROCEDURE CreateMutexW* (VAR lpMutexAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; bInitialOwner : BOOL; lpName : LPCWSTR) : HANDLE;
    ...
    PROCEDURE CreateEventA* (VAR lpEventAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; bManualReset : BOOL; bInitialState : BOOL; lpName : LPCSTR) : HANDLE;
    PROCEDURE CreateEventW* (VAR lpEventAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; bManualReset : BOOL; bInitialState : BOOL; lpName : LPCWSTR) : HANDLE;
    ...
    PROCEDURE CreateSemaphoreA* (VAR lpSemaphoreAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; lInitialCount : LONG; lMaximumCount : LONG; lpName : LPCSTR) : HANDLE;
    PROCEDURE CreateSemaphoreW* (VAR lpSemaphoreAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; lInitialCount : LONG; lMaximumCount : LONG; lpName : LPCWSTR) : HANDLE;
    ...
    PROCEDURE CreateWaitableTimerA* (VAR lpTimerAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; bManualReset : BOOL; lpTimerName : LPCSTR) : HANDLE;
    PROCEDURE CreateWaitableTimerW* (VAR lpTimerAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; bManualReset : BOOL; lpTimerName : LPCWSTR) : HANDLE;
    ...
    PROCEDURE SetWaitableTimer* (hTimer : HANDLE; VAR lpDueTime [NIL_COMPAT]  : LARGE_INTEGER; lPeriod : LONG; pfnCompletionRoutine : PTIMERAPCROUTINE; lpArgToCompletionRoutine : LPVOID; fResume : BOOL) : BOOL;
    PROCEDURE CancelWaitableTimer* (hTimer : HANDLE) : BOOL;
    PROCEDURE CreateFileMappingA* (hFile : HANDLE; VAR lpFileMappingAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; flProtect : DWORD; dwMaximumSizeHigh : DWORD; dwMaximumSizeLow : DWORD; lpName : LPCSTR) : HANDLE;
    PROCEDURE CreateFileMappingW* (hFile : HANDLE; VAR lpFileMappingAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; flProtect : DWORD; dwMaximumSizeHigh : DWORD; dwMaximumSizeLow : DWORD; lpName : LPCWSTR) : HANDLE;
    ...
    PROCEDURE CreateProcessA* (lpApplicationName : LPCSTR; lpCommandLine : LPSTR; VAR lpProcessAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; VAR lpThreadAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; bInheritHandles : BOOL; dwCreationFlags : DWORD; lpEnvironment : LPVOID; lpCurrentDirectory : LPCSTR; VAR lpStartupInfo [NIL_COMPAT]  : _STARTUPINFOA_struct; VAR lpProcessInformation [NIL_COMPAT]  : _PROCESS_INFORMATION_struct) : BOOL;
    PROCEDURE CreateProcessW* (lpApplicationName : LPCWSTR; lpCommandLine : LPWSTR; VAR lpProcessAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; VAR lpThreadAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; bInheritHandles : BOOL; dwCreationFlags : DWORD; lpEnvironment : LPVOID; lpCurrentDirectory : LPCWSTR; VAR lpStartupInfo [NIL_COMPAT]  : _STARTUPINFOW_struct; VAR lpProcessInformation [NIL_COMPAT]  : _PROCESS_INFORMATION_struct) : BOOL;
    PROCEDURE SetProcessShutdownParameters* (dwLevel : DWORD; dwFlags : DWORD) : BOOL;
    PROCEDURE GetProcessShutdownParameters* (VAR lpdwLevel [NIL_COMPAT]  : DWORD; VAR lpdwFlags [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE GetStartupInfoA* (VAR lpStartupInfo [NIL_COMPAT]  : _STARTUPINFOA_struct);
    PROCEDURE GetStartupInfoW* (VAR lpStartupInfo [NIL_COMPAT]  : _STARTUPINFOW_struct);
    ...
    PROCEDURE GetDiskFreeSpaceA* (lpRootPathName : LPCSTR; VAR lpSectorsPerCluster [NIL_COMPAT]  : DWORD; VAR lpBytesPerSector [NIL_COMPAT]  : DWORD; VAR lpNumberOfFreeClusters [NIL_COMPAT]  : DWORD; VAR lpTotalNumberOfClusters [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetDiskFreeSpaceW* (lpRootPathName : LPCWSTR; VAR lpSectorsPerCluster [NIL_COMPAT]  : DWORD; VAR lpBytesPerSector [NIL_COMPAT]  : DWORD; VAR lpNumberOfFreeClusters [NIL_COMPAT]  : DWORD; VAR lpTotalNumberOfClusters [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetDiskFreeSpaceExA* (lpDirectoryName : LPCSTR; VAR lpFreeBytesAvailableToCaller [NIL_COMPAT]  : ULARGE_INTEGER; VAR lpTotalNumberOfBytes [NIL_COMPAT]  : ULARGE_INTEGER; VAR lpTotalNumberOfFreeBytes [NIL_COMPAT]  : ULARGE_INTEGER) : BOOL;
    PROCEDURE GetDiskFreeSpaceExW* (lpDirectoryName : LPCWSTR; VAR lpFreeBytesAvailableToCaller [NIL_COMPAT]  : ULARGE_INTEGER; VAR lpTotalNumberOfBytes [NIL_COMPAT]  : ULARGE_INTEGER; VAR lpTotalNumberOfFreeBytes [NIL_COMPAT]  : ULARGE_INTEGER) : BOOL;
    PROCEDURE CreateDirectoryA* (lpPathName : LPCSTR; VAR lpSecurityAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct) : BOOL;
    PROCEDURE CreateDirectoryW* (lpPathName : LPCWSTR; VAR lpSecurityAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct) : BOOL;
    PROCEDURE CreateDirectoryExA* (lpTemplateDirectory : LPCSTR; lpNewDirectory : LPCSTR; VAR lpSecurityAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct) : BOOL;
    PROCEDURE CreateDirectoryExW* (lpTemplateDirectory : LPCWSTR; lpNewDirectory : LPCWSTR; VAR lpSecurityAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct) : BOOL;
    PROCEDURE RemoveDirectoryA* (lpPathName : LPCSTR) : BOOL;
    PROCEDURE RemoveDirectoryW* (lpPathName : LPCWSTR) : BOOL;
    PROCEDURE GetFullPathNameA* (lpFileName : LPCSTR; nBufferLength : DWORD; lpBuffer : LPSTR; VAR lpFilePart [NIL_COMPAT]  : LPSTR) : DWORD;
    PROCEDURE GetFullPathNameW* (lpFileName : LPCWSTR; nBufferLength : DWORD; lpBuffer : LPWSTR; VAR lpFilePart [NIL_COMPAT]  : LPWSTR) : DWORD;
    ...
    PROCEDURE CreateFileA* (lpFileName : LPCSTR; dwDesiredAccess : DWORD; dwShareMode : DWORD; VAR lpSecurityAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; dwCreationDisposition : DWORD; dwFlagsAndAttributes : DWORD; hTemplateFile : HANDLE) : HANDLE;
    PROCEDURE CreateFileW* (lpFileName : LPCWSTR; dwDesiredAccess : DWORD; dwShareMode : DWORD; VAR lpSecurityAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; dwCreationDisposition : DWORD; dwFlagsAndAttributes : DWORD; hTemplateFile : HANDLE) : HANDLE;
    ...
    PROCEDURE GetCompressedFileSizeA* (lpFileName : LPCSTR; VAR lpFileSizeHigh [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE GetCompressedFileSizeW* (lpFileName : LPCWSTR; VAR lpFileSizeHigh [NIL_COMPAT]  : DWORD) : DWORD;
    ...
    PROCEDURE FindFirstFileA* (lpFileName : LPCSTR; VAR lpFindFileData [NIL_COMPAT]  : _WIN32_FIND_DATAA_struct) : HANDLE;
    PROCEDURE FindFirstFileW* (lpFileName : LPCWSTR; VAR lpFindFileData [NIL_COMPAT]  : _WIN32_FIND_DATAW_struct) : HANDLE;
    PROCEDURE FindNextFileA* (hFindFile : HANDLE; VAR lpFindFileData [NIL_COMPAT]  : _WIN32_FIND_DATAA_struct) : BOOL;
    PROCEDURE FindNextFileW* (hFindFile : HANDLE; VAR lpFindFileData [NIL_COMPAT]  : _WIN32_FIND_DATAW_struct) : BOOL;
    PROCEDURE SearchPathA* (lpPath : LPCSTR; lpFileName : LPCSTR; lpExtension : LPCSTR; nBufferLength : DWORD; lpBuffer : LPSTR; VAR lpFilePart [NIL_COMPAT]  : LPSTR) : DWORD;
    PROCEDURE SearchPathW* (lpPath : LPCWSTR; lpFileName : LPCWSTR; lpExtension : LPCWSTR; nBufferLength : DWORD; lpBuffer : LPWSTR; VAR lpFilePart [NIL_COMPAT]  : LPWSTR) : DWORD;
    ...
    PROCEDURE CopyFileExA* (lpExistingFileName : LPCSTR; lpNewFileName : LPCSTR; lpProgressRoutine : LPPROGRESS_ROUTINE; lpData : LPVOID; VAR pbCancel [NIL_COMPAT]  : BOOL; dwCopyFlags : DWORD) : BOOL;
    PROCEDURE CopyFileExW* (lpExistingFileName : LPCWSTR; lpNewFileName : LPCWSTR; lpProgressRoutine : LPPROGRESS_ROUTINE; lpData : LPVOID; VAR pbCancel [NIL_COMPAT]  : BOOL; dwCopyFlags : DWORD) : BOOL;
    ...
    PROCEDURE CreateNamedPipeA* (lpName : LPCSTR; dwOpenMode : DWORD; dwPipeMode : DWORD; nMaxInstances : DWORD; nOutBufferSize : DWORD; nInBufferSize : DWORD; nDefaultTimeOut : DWORD; VAR lpSecurityAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct) : HANDLE;
    PROCEDURE CreateNamedPipeW* (lpName : LPCWSTR; dwOpenMode : DWORD; dwPipeMode : DWORD; nMaxInstances : DWORD; nOutBufferSize : DWORD; nInBufferSize : DWORD; nDefaultTimeOut : DWORD; VAR lpSecurityAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct) : HANDLE;
    PROCEDURE GetNamedPipeHandleStateA* (hNamedPipe : HANDLE; VAR lpState [NIL_COMPAT]  : DWORD; VAR lpCurInstances [NIL_COMPAT]  : DWORD; VAR lpMaxCollectionCount [NIL_COMPAT]  : DWORD; VAR lpCollectDataTimeout [NIL_COMPAT]  : DWORD; lpUserName : LPSTR; nMaxUserNameSize : DWORD) : BOOL;
    PROCEDURE GetNamedPipeHandleStateW* (hNamedPipe : HANDLE; VAR lpState [NIL_COMPAT]  : DWORD; VAR lpCurInstances [NIL_COMPAT]  : DWORD; VAR lpMaxCollectionCount [NIL_COMPAT]  : DWORD; VAR lpCollectDataTimeout [NIL_COMPAT]  : DWORD; lpUserName : LPWSTR; nMaxUserNameSize : DWORD) : BOOL;
    PROCEDURE CallNamedPipeA* (lpNamedPipeName : LPCSTR; lpInBuffer : LPVOID; nInBufferSize : DWORD; lpOutBuffer : LPVOID; nOutBufferSize : DWORD; VAR lpBytesRead [NIL_COMPAT]  : DWORD; nTimeOut : DWORD) : BOOL;
    PROCEDURE CallNamedPipeW* (lpNamedPipeName : LPCWSTR; lpInBuffer : LPVOID; nInBufferSize : DWORD; lpOutBuffer : LPVOID; nOutBufferSize : DWORD; VAR lpBytesRead [NIL_COMPAT]  : DWORD; nTimeOut : DWORD) : BOOL;
    ...
    PROCEDURE GetVolumeInformationA* (lpRootPathName : LPCSTR; lpVolumeNameBuffer : LPSTR; nVolumeNameSize : DWORD; VAR lpVolumeSerialNumber [NIL_COMPAT]  : DWORD; VAR lpMaximumComponentLength [NIL_COMPAT]  : DWORD; VAR lpFileSystemFlags [NIL_COMPAT]  : DWORD; lpFileSystemNameBuffer : LPSTR; nFileSystemNameSize : DWORD) : BOOL;
    PROCEDURE GetVolumeInformationW* (lpRootPathName : LPCWSTR; lpVolumeNameBuffer : LPWSTR; nVolumeNameSize : DWORD; VAR lpVolumeSerialNumber [NIL_COMPAT]  : DWORD; VAR lpMaximumComponentLength [NIL_COMPAT]  : DWORD; VAR lpFileSystemFlags [NIL_COMPAT]  : DWORD; lpFileSystemNameBuffer : LPWSTR; nFileSystemNameSize : DWORD) : BOOL;
    ...
    PROCEDURE GetNumberOfEventLogRecords* (hEventLog : HANDLE; VAR NumberOfRecords [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetOldestEventLogRecord* (hEventLog : HANDLE; VAR OldestRecord [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE ReadEventLogA* (hEventLog : HANDLE; dwReadFlags : DWORD; dwRecordOffset : DWORD; lpBuffer : LPVOID; nNumberOfBytesToRead : DWORD; VAR pnBytesRead [NIL_COMPAT]  : DWORD; VAR pnMinNumberOfBytesNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE ReadEventLogW* (hEventLog : HANDLE; dwReadFlags : DWORD; dwRecordOffset : DWORD; lpBuffer : LPVOID; nNumberOfBytesToRead : DWORD; VAR pnBytesRead [NIL_COMPAT]  : DWORD; VAR pnMinNumberOfBytesNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE ReportEventA* (hEventLog : HANDLE; wType : WORD; wCategory : WORD; dwEventID : DWORD; lpUserSid : PSID; wNumStrings : WORD; dwDataSize : DWORD; VAR lpStrings [NIL_COMPAT]  : LPCSTR; lpRawData : LPVOID) : BOOL;
    PROCEDURE ReportEventW* (hEventLog : HANDLE; wType : WORD; wCategory : WORD; dwEventID : DWORD; lpUserSid : PSID; wNumStrings : WORD; dwDataSize : DWORD; VAR lpStrings [NIL_COMPAT]  : LPCWSTR; lpRawData : LPVOID) : BOOL;
    PROCEDURE DuplicateToken* (ExistingTokenHandle : HANDLE; ImpersonationLevel : SECURITY_IMPERSONATION_LEVEL; VAR DuplicateTokenHandle [NIL_COMPAT]  : HANDLE) : BOOL;
    PROCEDURE GetKernelObjectSecurity* (Handle : HANDLE; RequestedInformation : SECURITY_INFORMATION; pSecurityDescriptor : PSECURITY_DESCRIPTOR; nLength : DWORD; VAR lpnLengthNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE SetThreadToken* (VAR Thread [NIL_COMPAT]  : HANDLE; Token : HANDLE) : BOOL;
    PROCEDURE AccessCheck* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; ClientToken : HANDLE; DesiredAccess : DWORD; VAR GenericMapping [NIL_COMPAT]  : GENERIC_MAPPING; VAR PrivilegeSet [NIL_COMPAT]  : _PRIVILEGE_SET_struct; VAR PrivilegeSetLength [NIL_COMPAT]  : DWORD; VAR GrantedAccess [NIL_COMPAT]  : DWORD; VAR AccessStatus [NIL_COMPAT]  : BOOL) : BOOL;
    PROCEDURE OpenProcessToken* (ProcessHandle : HANDLE; DesiredAccess : DWORD; VAR TokenHandle [NIL_COMPAT]  : HANDLE) : BOOL;
    PROCEDURE OpenThreadToken* (ThreadHandle : HANDLE; DesiredAccess : DWORD; OpenAsSelf : BOOL; VAR TokenHandle [NIL_COMPAT]  : HANDLE) : BOOL;
    PROCEDURE GetTokenInformation* (TokenHandle : HANDLE; TokenInformationClass : TOKEN_INFORMATION_CLASS; TokenInformation : LPVOID; TokenInformationLength : DWORD; VAR ReturnLength [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE AdjustTokenPrivileges* (TokenHandle : HANDLE; DisableAllPrivileges : BOOL; VAR NewState [NIL_COMPAT]  : _TOKEN_PRIVILEGES_struct; BufferLength : DWORD; VAR PreviousState [NIL_COMPAT]  : _TOKEN_PRIVILEGES_struct; VAR ReturnLength [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE AdjustTokenGroups* (TokenHandle : HANDLE; ResetToDefault : BOOL; VAR NewState [NIL_COMPAT]  : _TOKEN_GROUPS_struct; BufferLength : DWORD; VAR PreviousState [NIL_COMPAT]  : _TOKEN_GROUPS_struct; VAR ReturnLength [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE PrivilegeCheck* (ClientToken : HANDLE; VAR RequiredPrivileges [NIL_COMPAT]  : _PRIVILEGE_SET_struct; VAR pfResult [NIL_COMPAT]  : BOOL) : BOOL;
    PROCEDURE AccessCheckAndAuditAlarmA* (SubsystemName : LPCSTR; HandleId : LPVOID; ObjectTypeName : LPSTR; ObjectName : LPSTR; SecurityDescriptor : PSECURITY_DESCRIPTOR; DesiredAccess : DWORD; VAR GenericMapping [NIL_COMPAT]  : GENERIC_MAPPING; ObjectCreation : BOOL; VAR GrantedAccess [NIL_COMPAT]  : DWORD; VAR AccessStatus [NIL_COMPAT]  : BOOL; VAR pfGenerateOnClose [NIL_COMPAT]  : BOOL) : BOOL;
    PROCEDURE AccessCheckAndAuditAlarmW* (SubsystemName : LPCWSTR; HandleId : LPVOID; ObjectTypeName : LPWSTR; ObjectName : LPWSTR; SecurityDescriptor : PSECURITY_DESCRIPTOR; DesiredAccess : DWORD; VAR GenericMapping [NIL_COMPAT]  : GENERIC_MAPPING; ObjectCreation : BOOL; VAR GrantedAccess [NIL_COMPAT]  : DWORD; VAR AccessStatus [NIL_COMPAT]  : BOOL; VAR pfGenerateOnClose [NIL_COMPAT]  : BOOL) : BOOL;
    PROCEDURE ObjectOpenAuditAlarmA* (SubsystemName : LPCSTR; HandleId : LPVOID; ObjectTypeName : LPSTR; ObjectName : LPSTR; pSecurityDescriptor : PSECURITY_DESCRIPTOR; ClientToken : HANDLE; DesiredAccess : DWORD; GrantedAccess : DWORD; VAR Privileges [NIL_COMPAT]  : _PRIVILEGE_SET_struct; ObjectCreation : BOOL; AccessGranted : BOOL; VAR GenerateOnClose [NIL_COMPAT]  : BOOL) : BOOL;
    PROCEDURE ObjectOpenAuditAlarmW* (SubsystemName : LPCWSTR; HandleId : LPVOID; ObjectTypeName : LPWSTR; ObjectName : LPWSTR; pSecurityDescriptor : PSECURITY_DESCRIPTOR; ClientToken : HANDLE; DesiredAccess : DWORD; GrantedAccess : DWORD; VAR Privileges [NIL_COMPAT]  : _PRIVILEGE_SET_struct; ObjectCreation : BOOL; AccessGranted : BOOL; VAR GenerateOnClose [NIL_COMPAT]  : BOOL) : BOOL;
    PROCEDURE ObjectPrivilegeAuditAlarmA* (SubsystemName : LPCSTR; HandleId : LPVOID; ClientToken : HANDLE; DesiredAccess : DWORD; VAR Privileges [NIL_COMPAT]  : _PRIVILEGE_SET_struct; AccessGranted : BOOL) : BOOL;
    PROCEDURE ObjectPrivilegeAuditAlarmW* (SubsystemName : LPCWSTR; HandleId : LPVOID; ClientToken : HANDLE; DesiredAccess : DWORD; VAR Privileges [NIL_COMPAT]  : _PRIVILEGE_SET_struct; AccessGranted : BOOL) : BOOL;
    ...
    PROCEDURE PrivilegedServiceAuditAlarmA* (SubsystemName : LPCSTR; ServiceName : LPCSTR; ClientToken : HANDLE; VAR Privileges [NIL_COMPAT]  : _PRIVILEGE_SET_struct; AccessGranted : BOOL) : BOOL;
    PROCEDURE PrivilegedServiceAuditAlarmW* (SubsystemName : LPCWSTR; ServiceName : LPCWSTR; ClientToken : HANDLE; VAR Privileges [NIL_COMPAT]  : _PRIVILEGE_SET_struct; AccessGranted : BOOL) : BOOL;
    ...
    PROCEDURE AllocateAndInitializeSid* (VAR pIdentifierAuthority [NIL_COMPAT]  : _SID_IDENTIFIER_AUTHORITY_struct; nSubAuthorityCount : BYTE; nSubAuthority0 : DWORD; nSubAuthority1 : DWORD; nSubAuthority2 : DWORD; nSubAuthority3 : DWORD; nSubAuthority4 : DWORD; nSubAuthority5 : DWORD; nSubAuthority6 : DWORD; nSubAuthority7 : DWORD; VAR pSid [NIL_COMPAT]  : PSID) : BOOL;
    PROCEDURE FreeSid* (pSid : PSID) : PVOID;
    PROCEDURE InitializeSid* (Sid : PSID; VAR pIdentifierAuthority [NIL_COMPAT]  : _SID_IDENTIFIER_AUTHORITY_struct; nSubAuthorityCount : BYTE) : BOOL;
    ...
    PROCEDURE MapGenericMask* (VAR AccessMask [NIL_COMPAT]  : DWORD; VAR GenericMapping [NIL_COMPAT]  : GENERIC_MAPPING);
    PROCEDURE IsValidAcl* (VAR pAcl [NIL_COMPAT]  : ACL) : BOOL;
    PROCEDURE InitializeAcl* (VAR pAcl [NIL_COMPAT]  : ACL; nAclLength : DWORD; dwAclRevision : DWORD) : BOOL;
    PROCEDURE GetAclInformation* (VAR pAcl [NIL_COMPAT]  : ACL; pAclInformation : LPVOID; nAclInformationLength : DWORD; dwAclInformationClass : ACL_INFORMATION_CLASS) : BOOL;
    PROCEDURE SetAclInformation* (VAR pAcl [NIL_COMPAT]  : ACL; pAclInformation : LPVOID; nAclInformationLength : DWORD; dwAclInformationClass : ACL_INFORMATION_CLASS) : BOOL;
    PROCEDURE AddAce* (VAR pAcl [NIL_COMPAT]  : ACL; dwAceRevision : DWORD; dwStartingAceIndex : DWORD; pAceList : LPVOID; nAceListLength : DWORD) : BOOL;
    PROCEDURE DeleteAce* (VAR pAcl [NIL_COMPAT]  : ACL; dwAceIndex : DWORD) : BOOL;
    PROCEDURE GetAce* (VAR pAcl [NIL_COMPAT]  : ACL; dwAceIndex : DWORD; VAR pAce [NIL_COMPAT]  : LPVOID) : BOOL;
    PROCEDURE AddAccessAllowedAce* (VAR pAcl [NIL_COMPAT]  : ACL; dwAceRevision : DWORD; AccessMask : DWORD; pSid : PSID) : BOOL;
    PROCEDURE AddAccessDeniedAce* (VAR pAcl [NIL_COMPAT]  : ACL; dwAceRevision : DWORD; AccessMask : DWORD; pSid : PSID) : BOOL;
    PROCEDURE AddAuditAccessAce* (VAR pAcl [NIL_COMPAT]  : ACL; dwAceRevision : DWORD; dwAccessMask : DWORD; pSid : PSID; bAuditSuccess : BOOL; bAuditFailure : BOOL) : BOOL;
    PROCEDURE FindFirstFreeAce* (VAR pAcl [NIL_COMPAT]  : ACL; VAR pAce [NIL_COMPAT]  : LPVOID) : BOOL;
    ...
    PROCEDURE GetSecurityDescriptorControl* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; VAR pControl [NIL_COMPAT]  : WORD; VAR lpdwRevision [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE SetSecurityDescriptorDacl* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; bDaclPresent : BOOL; VAR pDacl [NIL_COMPAT]  : ACL; bDaclDefaulted : BOOL) : BOOL;
    PROCEDURE GetSecurityDescriptorDacl* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; VAR lpbDaclPresent [NIL_COMPAT]  : BOOL; VAR pDacl [NIL_COMPAT]  : PACL; VAR lpbDaclDefaulted [NIL_COMPAT]  : BOOL) : BOOL;
    PROCEDURE SetSecurityDescriptorSacl* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; bSaclPresent : BOOL; VAR pSacl [NIL_COMPAT]  : ACL; bSaclDefaulted : BOOL) : BOOL;
    PROCEDURE GetSecurityDescriptorSacl* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; VAR lpbSaclPresent [NIL_COMPAT]  : BOOL; VAR pSacl [NIL_COMPAT]  : PACL; VAR lpbSaclDefaulted [NIL_COMPAT]  : BOOL) : BOOL;
    PROCEDURE SetSecurityDescriptorOwner* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; pOwner : PSID; bOwnerDefaulted : BOOL) : BOOL;
    PROCEDURE GetSecurityDescriptorOwner* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; VAR pOwner [NIL_COMPAT]  : PSID; VAR lpbOwnerDefaulted [NIL_COMPAT]  : BOOL) : BOOL;
    PROCEDURE SetSecurityDescriptorGroup* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; pGroup : PSID; bGroupDefaulted : BOOL) : BOOL;
    PROCEDURE GetSecurityDescriptorGroup* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; VAR pGroup [NIL_COMPAT]  : PSID; VAR lpbGroupDefaulted [NIL_COMPAT]  : BOOL) : BOOL;
    PROCEDURE CreatePrivateObjectSecurity* (ParentDescriptor : PSECURITY_DESCRIPTOR; CreatorDescriptor : PSECURITY_DESCRIPTOR; VAR NewDescriptor [NIL_COMPAT]  : PSECURITY_DESCRIPTOR; IsDirectoryObject : BOOL; Token : HANDLE; VAR GenericMapping [NIL_COMPAT]  : GENERIC_MAPPING) : BOOL;
    PROCEDURE SetPrivateObjectSecurity* (SecurityInformation : SECURITY_INFORMATION; ModificationDescriptor : PSECURITY_DESCRIPTOR; VAR ObjectsSecurityDescriptor [NIL_COMPAT]  : PSECURITY_DESCRIPTOR; VAR GenericMapping [NIL_COMPAT]  : GENERIC_MAPPING; Token : HANDLE) : BOOL;
    PROCEDURE GetPrivateObjectSecurity* (ObjectDescriptor : PSECURITY_DESCRIPTOR; SecurityInformation : SECURITY_INFORMATION; ResultantDescriptor : PSECURITY_DESCRIPTOR; DescriptorLength : DWORD; VAR ReturnLength [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE DestroyPrivateObjectSecurity* (VAR ObjectDescriptor [NIL_COMPAT]  : PSECURITY_DESCRIPTOR) : BOOL;
    PROCEDURE MakeSelfRelativeSD* (pAbsoluteSecurityDescriptor : PSECURITY_DESCRIPTOR; pSelfRelativeSecurityDescriptor : PSECURITY_DESCRIPTOR; VAR lpdwBufferLength [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE MakeAbsoluteSD* (pSelfRelativeSecurityDescriptor : PSECURITY_DESCRIPTOR; pAbsoluteSecurityDescriptor : PSECURITY_DESCRIPTOR; VAR lpdwAbsoluteSecurityDescriptorSize [NIL_COMPAT]  : DWORD; VAR pDacl [NIL_COMPAT]  : ACL; VAR lpdwDaclSize [NIL_COMPAT]  : DWORD; VAR pSacl [NIL_COMPAT]  : ACL; VAR lpdwSaclSize [NIL_COMPAT]  : DWORD; pOwner : PSID; VAR lpdwOwnerSize [NIL_COMPAT]  : DWORD; pPrimaryGroup : PSID; VAR lpdwPrimaryGroupSize [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE GetFileSecurityA* (lpFileName : LPCSTR; RequestedInformation : SECURITY_INFORMATION; pSecurityDescriptor : PSECURITY_DESCRIPTOR; nLength : DWORD; VAR lpnLengthNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetFileSecurityW* (lpFileName : LPCWSTR; RequestedInformation : SECURITY_INFORMATION; pSecurityDescriptor : PSECURITY_DESCRIPTOR; nLength : DWORD; VAR lpnLengthNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE ReadDirectoryChangesW* (hDirectory : HANDLE; lpBuffer : LPVOID; nBufferLength : DWORD; bWatchSubtree : BOOL; dwNotifyFilter : DWORD; VAR lpBytesReturned [NIL_COMPAT]  : DWORD; VAR lpOverlapped [NIL_COMPAT]  : _OVERLAPPED_struct; lpCompletionRoutine : LPOVERLAPPED_COMPLETION_ROUTINE) : BOOL;
    ...
    PROCEDURE LookupAccountSidA* (lpSystemName : LPCSTR; Sid : PSID; Name : LPSTR; VAR cbName [NIL_COMPAT]  : DWORD; ReferencedDomainName : LPSTR; VAR cbReferencedDomainName [NIL_COMPAT]  : DWORD; peUse : PSID_NAME_USE) : BOOL;
    PROCEDURE LookupAccountSidW* (lpSystemName : LPCWSTR; Sid : PSID; Name : LPWSTR; VAR cbName [NIL_COMPAT]  : DWORD; ReferencedDomainName : LPWSTR; VAR cbReferencedDomainName [NIL_COMPAT]  : DWORD; peUse : PSID_NAME_USE) : BOOL;
    PROCEDURE LookupAccountNameA* (lpSystemName : LPCSTR; lpAccountName : LPCSTR; Sid : PSID; VAR cbSid [NIL_COMPAT]  : DWORD; ReferencedDomainName : LPSTR; VAR cbReferencedDomainName [NIL_COMPAT]  : DWORD; peUse : PSID_NAME_USE) : BOOL;
    PROCEDURE LookupAccountNameW* (lpSystemName : LPCWSTR; lpAccountName : LPCWSTR; Sid : PSID; VAR cbSid [NIL_COMPAT]  : DWORD; ReferencedDomainName : LPWSTR; VAR cbReferencedDomainName [NIL_COMPAT]  : DWORD; peUse : PSID_NAME_USE) : BOOL;
    PROCEDURE LookupPrivilegeValueA* (lpSystemName : LPCSTR; lpName : LPCSTR; VAR lpLuid [NIL_COMPAT]  : _LUID_struct) : BOOL;
    PROCEDURE LookupPrivilegeValueW* (lpSystemName : LPCWSTR; lpName : LPCWSTR; VAR lpLuid [NIL_COMPAT]  : _LUID_struct) : BOOL;
    PROCEDURE LookupPrivilegeNameA* (lpSystemName : LPCSTR; VAR lpLuid [NIL_COMPAT]  : _LUID_struct; lpName : LPSTR; VAR cbName [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE LookupPrivilegeNameW* (lpSystemName : LPCWSTR; VAR lpLuid [NIL_COMPAT]  : _LUID_struct; lpName : LPWSTR; VAR cbName [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE LookupPrivilegeDisplayNameA* (lpSystemName : LPCSTR; lpName : LPCSTR; lpDisplayName : LPSTR; VAR cbDisplayName [NIL_COMPAT]  : DWORD; VAR lpLanguageId [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE LookupPrivilegeDisplayNameW* (lpSystemName : LPCWSTR; lpName : LPCWSTR; lpDisplayName : LPWSTR; VAR cbDisplayName [NIL_COMPAT]  : DWORD; VAR lpLanguageId [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE AllocateLocallyUniqueId* (VAR Luid [NIL_COMPAT]  : _LUID_struct) : BOOL;
    PROCEDURE BuildCommDCBA* (lpDef : LPCSTR; VAR lpDCB [NIL_COMPAT]  : _DCB_struct) : BOOL;
    PROCEDURE BuildCommDCBW* (lpDef : LPCWSTR; VAR lpDCB [NIL_COMPAT]  : _DCB_struct) : BOOL;
    PROCEDURE BuildCommDCBAndTimeoutsA* (lpDef : LPCSTR; VAR lpDCB [NIL_COMPAT]  : _DCB_struct; VAR lpCommTimeouts [NIL_COMPAT]  : _COMMTIMEOUTS_struct) : BOOL;
    PROCEDURE BuildCommDCBAndTimeoutsW* (lpDef : LPCWSTR; VAR lpDCB [NIL_COMPAT]  : _DCB_struct; VAR lpCommTimeouts [NIL_COMPAT]  : _COMMTIMEOUTS_struct) : BOOL;
    PROCEDURE CommConfigDialogA* (lpszName : LPCSTR; hWnd : HWND; VAR lpCC [NIL_COMPAT]  : _COMMCONFIG_struct) : BOOL;
    PROCEDURE CommConfigDialogW* (lpszName : LPCWSTR; hWnd : HWND; VAR lpCC [NIL_COMPAT]  : _COMMCONFIG_struct) : BOOL;
    PROCEDURE GetDefaultCommConfigA* (lpszName : LPCSTR; VAR lpCC [NIL_COMPAT]  : _COMMCONFIG_struct; VAR lpdwSize [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetDefaultCommConfigW* (lpszName : LPCWSTR; VAR lpCC [NIL_COMPAT]  : _COMMCONFIG_struct; VAR lpdwSize [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE SetDefaultCommConfigA* (lpszName : LPCSTR; VAR lpCC [NIL_COMPAT]  : _COMMCONFIG_struct; dwSize : DWORD) : BOOL;
    PROCEDURE SetDefaultCommConfigW* (lpszName : LPCWSTR; VAR lpCC [NIL_COMPAT]  : _COMMCONFIG_struct; dwSize : DWORD) : BOOL;
    PROCEDURE GetComputerNameA* (lpBuffer : LPSTR; VAR nSize [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetComputerNameW* (lpBuffer : LPWSTR; VAR nSize [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE SetComputerNameA* (lpComputerName : LPCSTR) : BOOL;
    PROCEDURE SetComputerNameW* (lpComputerName : LPCWSTR) : BOOL;
    PROCEDURE GetUserNameA* (lpBuffer : LPSTR; VAR nSize [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetUserNameW* (lpBuffer : LPWSTR; VAR nSize [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE LogonUserA* (lpszUsername : LPSTR; lpszDomain : LPSTR; lpszPassword : LPSTR; dwLogonType : DWORD; dwLogonProvider : DWORD; VAR phToken [NIL_COMPAT]  : HANDLE) : BOOL;
    PROCEDURE LogonUserW* (lpszUsername : LPWSTR; lpszDomain : LPWSTR; lpszPassword : LPWSTR; dwLogonType : DWORD; dwLogonProvider : DWORD; VAR phToken [NIL_COMPAT]  : HANDLE) : BOOL;
    PROCEDURE ImpersonateLoggedOnUser* (hToken : HANDLE) : BOOL;
    PROCEDURE CreateProcessAsUserA* (hToken : HANDLE; lpApplicationName : LPCSTR; lpCommandLine : LPSTR; VAR lpProcessAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; VAR lpThreadAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; bInheritHandles : BOOL; dwCreationFlags : DWORD; lpEnvironment : LPVOID; lpCurrentDirectory : LPCSTR; VAR lpStartupInfo [NIL_COMPAT]  : _STARTUPINFOA_struct; VAR lpProcessInformation [NIL_COMPAT]  : _PROCESS_INFORMATION_struct) : BOOL;
    PROCEDURE CreateProcessAsUserW* (hToken : HANDLE; lpApplicationName : LPCWSTR; lpCommandLine : LPWSTR; VAR lpProcessAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; VAR lpThreadAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; bInheritHandles : BOOL; dwCreationFlags : DWORD; lpEnvironment : LPVOID; lpCurrentDirectory : LPCWSTR; VAR lpStartupInfo [NIL_COMPAT]  : _STARTUPINFOW_struct; VAR lpProcessInformation [NIL_COMPAT]  : _PROCESS_INFORMATION_struct) : BOOL;
    PROCEDURE DuplicateTokenEx* (hExistingToken : HANDLE; dwDesiredAccess : DWORD; VAR lpTokenAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; ImpersonationLevel : SECURITY_IMPERSONATION_LEVEL; TokenType : TOKEN_TYPE; VAR phNewToken [NIL_COMPAT]  : HANDLE) : BOOL;
    PROCEDURE CreateRestrictedToken* (ExistingTokenHandle : HANDLE; Flags : DWORD; DisableSidCount : DWORD; VAR SidsToDisable [NIL_COMPAT]  : _SID_AND_ATTRIBUTES_struct; DeletePrivilegeCount : DWORD; VAR PrivilegesToDelete [NIL_COMPAT]  : _LUID_AND_ATTRIBUTES_struct; RestrictedSidCount : DWORD; VAR SidsToRestrict [NIL_COMPAT]  : _SID_AND_ATTRIBUTES_struct; VAR NewTokenHandle [NIL_COMPAT]  : HANDLE) : BOOL;
    PROCEDURE IsTokenRestricted* (TokenHandle : HANDLE) : BOOL;
    PROCEDURE GetCurrentHwProfileA* (VAR lpHwProfileInfo [NIL_COMPAT]  : tagHW_PROFILE_INFOA_struct) : BOOL;
    PROCEDURE GetCurrentHwProfileW* (VAR lpHwProfileInfo [NIL_COMPAT]  : tagHW_PROFILE_INFOW_struct) : BOOL;
    PROCEDURE QueryPerformanceCounter* (VAR lpPerformanceCount [NIL_COMPAT]  : LARGE_INTEGER) : BOOL;
    PROCEDURE QueryPerformanceFrequency* (VAR lpFrequency [NIL_COMPAT]  : LARGE_INTEGER) : BOOL;
    PROCEDURE GetVersionExA* (VAR lpVersionInformation [NIL_COMPAT]  : _OSVERSIONINFOA_struct) : BOOL;
    PROCEDURE GetVersionExW* (VAR lpVersionInformation [NIL_COMPAT]  : _OSVERSIONINFOW_struct) : BOOL;
    PROCEDURE GetSystemPowerStatus* (VAR lpSystemPowerStatus [NIL_COMPAT]  : _SYSTEM_POWER_STATUS_struct) : BOOL;
    PROCEDURE SetSystemPowerState* (fSuspend : BOOL; fForce : BOOL) : BOOL;
    PROCEDURE WinSubmitCertificate* (VAR lpCertificate [NIL_COMPAT]  : _WIN_CERTIFICATE_struct) : BOOL;
    PROCEDURE WinVerifyTrust* (hwnd : HWND; VAR ActionID [NIL_COMPAT]  : GUID; ActionData : LPVOID) : LONG;
    PROCEDURE WinLoadTrustProvider* (VAR ActionID [NIL_COMPAT]  : GUID) : BOOL;
    PROCEDURE AddFontResourceA* (p0 : LPCSTR) : LONGINT;
    PROCEDURE AddFontResourceW* (p0 : LPCWSTR) : LONGINT;
    PROCEDURE AnimatePalette* (p0 : HPALETTE; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : PALETTEENTRY) : BOOL;
    ...
    PROCEDURE ChoosePixelFormat* (p0 : HDC; VAR p1 [NIL_COMPAT]  : PIXELFORMATDESCRIPTOR) : LONGINT;
    ...
    PROCEDURE CreateBitmapIndirect* (VAR p0 [NIL_COMPAT]  : BITMAP) : HBITMAP;
    PROCEDURE CreateBrushIndirect* (VAR p0 [NIL_COMPAT]  : LOGBRUSH) : HBRUSH;
    ...
    PROCEDURE CreateDCA* (p0 : LPCSTR; p1 : LPCSTR; p2 : LPCSTR; VAR p3 [NIL_COMPAT]  : DEVMODEA) : HDC;
    PROCEDURE CreateDCW* (p0 : LPCWSTR; p1 : LPCWSTR; p2 : LPCWSTR; VAR p3 [NIL_COMPAT]  : DEVMODEW) : HDC;
    PROCEDURE CreateDIBitmap* (p0 : HDC; VAR p1 [NIL_COMPAT]  : BITMAPINFOHEADER; p2 : DWORD; p3 : LPVOID; VAR p4 [NIL_COMPAT]  : BITMAPINFO; p5 : UINT) : HBITMAP;
    ...
    PROCEDURE CreateEllipticRgnIndirect* (VAR p0 [NIL_COMPAT]  : RECT) : HRGN;
    PROCEDURE CreateFontIndirectA* (VAR p0 [NIL_COMPAT]  : LOGFONTA) : HFONT;
    PROCEDURE CreateFontIndirectW* (VAR p0 [NIL_COMPAT]  : LOGFONTW) : HFONT;
    ...
    PROCEDURE CreateICA* (p0 : LPCSTR; p1 : LPCSTR; p2 : LPCSTR; VAR p3 [NIL_COMPAT]  : DEVMODEA) : HDC;
    PROCEDURE CreateICW* (p0 : LPCWSTR; p1 : LPCWSTR; p2 : LPCWSTR; VAR p3 [NIL_COMPAT]  : DEVMODEW) : HDC;
    PROCEDURE CreateMetaFileA* (p0 : LPCSTR) : HDC;
    PROCEDURE CreateMetaFileW* (p0 : LPCWSTR) : HDC;
    PROCEDURE CreatePalette* (VAR p0 [NIL_COMPAT]  : LOGPALETTE) : HPALETTE;
    PROCEDURE CreatePen* (p0 : LONGINT; p1 : LONGINT; p2 : COLORREF) : HPEN;
    PROCEDURE CreatePenIndirect* (VAR p0 [NIL_COMPAT]  : LOGPEN) : HPEN;
    PROCEDURE CreatePolyPolygonRgn* (VAR p0 [NIL_COMPAT]  : POINT; VAR p1 [NIL_COMPAT]  : INT; p2 : LONGINT; p3 : LONGINT) : HRGN;
    PROCEDURE CreatePatternBrush* (p0 : HBITMAP) : HBRUSH;
    PROCEDURE CreateRectRgn* (p0 : LONGINT; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT) : HRGN;
    PROCEDURE CreateRectRgnIndirect* (VAR p0 [NIL_COMPAT]  : RECT) : HRGN;
    ...
    PROCEDURE DescribePixelFormat* (p0 : HDC; p1 : LONGINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : tagPIXELFORMATDESCRIPTOR_struct) : LONGINT;
    PROCEDURE DeviceCapabilitiesA* (p0 : LPCSTR; p1 : LPCSTR; p2 : WORD; p3 : LPSTR; VAR p4 [NIL_COMPAT]  : DEVMODEA) : LONGINT;
    PROCEDURE DeviceCapabilitiesW* (p0 : LPCWSTR; p1 : LPCWSTR; p2 : WORD; p3 : LPWSTR; VAR p4 [NIL_COMPAT]  : DEVMODEW) : LONGINT;
    ...
    PROCEDURE EnumFontFamiliesExA* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagLOGFONTA_struct; p2 : FONTENUMPROCA; p3 : LPARAM; p4 : DWORD) : LONGINT;
    PROCEDURE EnumFontFamiliesExW* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagLOGFONTW_struct; p2 : FONTENUMPROCW; p3 : LPARAM; p4 : DWORD) : LONGINT;
    ...
    PROCEDURE ExtCreateRegion* (VAR p0 [NIL_COMPAT]  : XFORM; p1 : DWORD; VAR p2 [NIL_COMPAT]  : RGNDATA) : HRGN;
    ...
    PROCEDURE GetAspectRatioFilterEx* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    ...
    PROCEDURE GetBitmapDimensionEx* (p0 : HBITMAP; VAR p1 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    PROCEDURE GetBoundsRect* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagRECT_struct; p2 : UINT) : UINT;
    PROCEDURE GetBrushOrgEx* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE GetCharWidthA* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : LONGINT) : BOOL;
    PROCEDURE GetCharWidthW* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : LONGINT) : BOOL;
    PROCEDURE GetCharWidth32A* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : LONGINT) : BOOL;
    PROCEDURE GetCharWidth32W* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : LONGINT) : BOOL;
    PROCEDURE GetCharWidthFloatA* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : FLOAT) : BOOL;
    PROCEDURE GetCharWidthFloatW* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : FLOAT) : BOOL;
    PROCEDURE GetCharABCWidthsA* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : _ABC_struct) : BOOL;
    PROCEDURE GetCharABCWidthsW* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : _ABC_struct) : BOOL;
    PROCEDURE GetCharABCWidthsFloatA* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : _ABCFLOAT_struct) : BOOL;
    PROCEDURE GetCharABCWidthsFloatW* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : _ABCFLOAT_struct) : BOOL;
    PROCEDURE GetClipBox* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagRECT_struct) : LONGINT;
    ...
    PROCEDURE GetCurrentPositionEx* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE GetDeviceCaps* (p0 : HDC; p1 : LONGINT) : LONGINT;
    PROCEDURE GetDIBits* (p0 : HDC; p1 : HBITMAP; p2 : UINT; p3 : UINT; p4 : LPVOID; VAR p5 [NIL_COMPAT]  : tagBITMAPINFO_struct; p6 : UINT) : LONGINT;
    PROCEDURE GetFontData* (p0 : HDC; p1 : DWORD; p2 : DWORD; p3 : LPVOID; p4 : DWORD) : DWORD;
    PROCEDURE GetGlyphOutlineA* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : _GLYPHMETRICS_struct; p4 : DWORD; p5 : LPVOID; VAR p6 [NIL_COMPAT]  : MAT2) : DWORD;
    PROCEDURE GetGlyphOutlineW* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : _GLYPHMETRICS_struct; p4 : DWORD; p5 : LPVOID; VAR p6 [NIL_COMPAT]  : MAT2) : DWORD;
    ...
    PROCEDURE GetOutlineTextMetricsA* (p0 : HDC; p1 : UINT; VAR p2 [NIL_COMPAT]  : _OUTLINETEXTMETRICA_struct) : UINT;
    PROCEDURE GetOutlineTextMetricsW* (p0 : HDC; p1 : UINT; VAR p2 [NIL_COMPAT]  : _OUTLINETEXTMETRICW_struct) : UINT;
    PROCEDURE GetPaletteEntries* (p0 : HPALETTE; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : tagPALETTEENTRY_struct) : UINT;
    ...
    PROCEDURE GetRasterizerCaps* (VAR p0 [NIL_COMPAT]  : _RASTERIZER_STATUS_struct; p1 : UINT) : BOOL;
    PROCEDURE GetRegionData* (p0 : HRGN; p1 : DWORD; VAR p2 [NIL_COMPAT]  : _RGNDATA_struct) : DWORD;
    PROCEDURE GetRgnBox* (p0 : HRGN; VAR p1 [NIL_COMPAT]  : tagRECT_struct) : LONGINT;
    PROCEDURE GetStockObject* (p0 : LONGINT) : HGDIOBJ;
    PROCEDURE GetStretchBltMode* (p0 : HDC) : LONGINT;
    PROCEDURE GetSystemPaletteEntries* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : tagPALETTEENTRY_struct) : UINT;
    ...
    PROCEDURE GetTextExtentPointA* (p0 : HDC; p1 : LPCSTR; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    PROCEDURE GetTextExtentPointW* (p0 : HDC; p1 : LPCWSTR; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    PROCEDURE GetTextExtentPoint32A* (p0 : HDC; p1 : LPCSTR; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    PROCEDURE GetTextExtentPoint32W* (p0 : HDC; p1 : LPCWSTR; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    PROCEDURE GetTextExtentExPointA* (p0 : HDC; p1 : LPCSTR; p2 : LONGINT; p3 : LONGINT; VAR p4 [NIL_COMPAT]  : LONGINT; VAR p5 [NIL_COMPAT]  : LONGINT; VAR p6 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    PROCEDURE GetTextExtentExPointW* (p0 : HDC; p1 : LPCWSTR; p2 : LONGINT; p3 : LONGINT; VAR p4 [NIL_COMPAT]  : LONGINT; VAR p5 [NIL_COMPAT]  : LONGINT; VAR p6 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    PROCEDURE GetTextCharset* (hdc : HDC) : LONGINT;
    PROCEDURE GetTextCharsetInfo* (hdc : HDC; VAR lpSig [NIL_COMPAT]  : tagFONTSIGNATURE_struct; dwFlags : DWORD) : LONGINT;
    PROCEDURE TranslateCharsetInfo* (VAR lpSrc [NIL_COMPAT]  : DWORD; VAR lpCs [NIL_COMPAT]  : tagCHARSETINFO_struct; dwFlags : DWORD) : BOOL;
    PROCEDURE GetFontLanguageInfo* (p0 : HDC) : DWORD;
    PROCEDURE GetCharacterPlacementA* (p0 : HDC; p1 : LPCSTR; p2 : LONGINT; p3 : LONGINT; VAR p4 [NIL_COMPAT]  : tagGCP_RESULTSA_struct; p5 : DWORD) : DWORD;
    PROCEDURE GetCharacterPlacementW* (p0 : HDC; p1 : LPCWSTR; p2 : LONGINT; p3 : LONGINT; VAR p4 [NIL_COMPAT]  : tagGCP_RESULTSW_struct; p5 : DWORD) : DWORD;
    PROCEDURE GetViewportExtEx* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    PROCEDURE GetViewportOrgEx* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE GetWindowExtEx* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    PROCEDURE GetWindowOrgEx* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    ...
    PROCEDURE PlgBlt* (p0 : HDC; VAR p1 [NIL_COMPAT]  : POINT; p2 : HDC; p3 : LONGINT; p4 : LONGINT; p5 : LONGINT; p6 : LONGINT; p7 : HBITMAP; p8 : LONGINT; p9 : LONGINT) : BOOL;
    ...
    PROCEDURE PolyPolygon* (p0 : HDC; VAR p1 [NIL_COMPAT]  : POINT; VAR p2 [NIL_COMPAT]  : INT; p3 : LONGINT) : BOOL;
    PROCEDURE PtInRegion* (p0 : HRGN; p1 : LONGINT; p2 : LONGINT) : BOOL;
    PROCEDURE PtVisible* (p0 : HDC; p1 : LONGINT; p2 : LONGINT) : BOOL;
    PROCEDURE RectInRegion* (p0 : HRGN; VAR p1 [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE RectVisible* (p0 : HDC; VAR p1 [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE Rectangle* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT) : BOOL;
    PROCEDURE RestoreDC* (p0 : HDC; p1 : LONGINT) : BOOL;
    PROCEDURE ResetDCA* (p0 : HDC; VAR p1 [NIL_COMPAT]  : DEVMODEA) : HDC;
    PROCEDURE ResetDCW* (p0 : HDC; VAR p1 [NIL_COMPAT]  : DEVMODEW) : HDC;
    ...
    PROCEDURE SetBoundsRect* (p0 : HDC; VAR p1 [NIL_COMPAT]  : RECT; p2 : UINT) : UINT;
    PROCEDURE SetDIBits* (p0 : HDC; p1 : HBITMAP; p2 : UINT; p3 : UINT; p4 : LPVOID; VAR p5 [NIL_COMPAT]  : BITMAPINFO; p6 : UINT) : LONGINT;
    PROCEDURE SetDIBitsToDevice* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : DWORD; p4 : DWORD; p5 : LONGINT; p6 : LONGINT; p7 : UINT; p8 : UINT; p9 : LPVOID; VAR p10 [NIL_COMPAT]  : BITMAPINFO; p11 : UINT) : LONGINT;
    ...
    PROCEDURE SetPaletteEntries* (p0 : HPALETTE; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : PALETTEENTRY) : UINT;
    ...
    PROCEDURE SetPixelFormat* (p0 : HDC; p1 : LONGINT; VAR p2 [NIL_COMPAT]  : PIXELFORMATDESCRIPTOR) : BOOL;
    ...
    PROCEDURE StretchDIBits* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : LONGINT; p6 : LONGINT; p7 : LONGINT; p8 : LONGINT; p9 : LPVOID; VAR p10 [NIL_COMPAT]  : BITMAPINFO; p11 : UINT; p12 : DWORD) : LONGINT;
    ...
    PROCEDURE AlphaDIBBlend* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : LPVOID; VAR p6 [NIL_COMPAT]  : BITMAPINFO; p7 : UINT; p8 : LONGINT; p9 : LONGINT; p10 : LONGINT; p11 : LONGINT; p12 : BLENDFUNCTION) : BOOL;
    ...
    PROCEDURE TransparentDIBits* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : LPVOID; VAR p6 [NIL_COMPAT]  : BITMAPINFO; p7 : UINT; p8 : LONGINT; p9 : LONGINT; p10 : LONGINT; p11 : LONGINT; p12 : UINT) : BOOL;
    PROCEDURE GradientFill* (p0 : HDC; VAR p1 [NIL_COMPAT]  : _TRIVERTEX_struct; p2 : ULONG; p3 : PVOID; p4 : ULONG; p5 : ULONG) : BOOL;
    PROCEDURE PlayMetaFileRecord* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagHANDLETABLE_struct; VAR p2 [NIL_COMPAT]  : tagMETARECORD_struct; p3 : UINT) : BOOL;
    ...
    PROCEDURE CreateEnhMetaFileA* (p0 : HDC; p1 : LPCSTR; VAR p2 [NIL_COMPAT]  : RECT; p3 : LPCSTR) : HDC;
    PROCEDURE CreateEnhMetaFileW* (p0 : HDC; p1 : LPCWSTR; VAR p2 [NIL_COMPAT]  : RECT; p3 : LPCWSTR) : HDC;
    PROCEDURE DeleteEnhMetaFile* (p0 : HENHMETAFILE) : BOOL;
    PROCEDURE EnumEnhMetaFile* (p0 : HDC; p1 : HENHMETAFILE; p2 : ENHMFENUMPROC; p3 : LPVOID; VAR p4 [NIL_COMPAT]  : RECT) : BOOL;
    ...
    PROCEDURE GetEnhMetaFileHeader* (p0 : HENHMETAFILE; p1 : UINT; VAR p2 [NIL_COMPAT]  : tagENHMETAHEADER_struct) : UINT;
    PROCEDURE GetEnhMetaFilePaletteEntries* (p0 : HENHMETAFILE; p1 : UINT; VAR p2 [NIL_COMPAT]  : tagPALETTEENTRY_struct) : UINT;
    PROCEDURE GetEnhMetaFilePixelFormat* (p0 : HENHMETAFILE; p1 : UINT; VAR p2 [NIL_COMPAT]  : PIXELFORMATDESCRIPTOR) : UINT;
    PROCEDURE GetWinMetaFileBits* (p0 : HENHMETAFILE; p1 : UINT; p2 : LPBYTE; p3 : INT; p4 : HDC) : UINT;
    PROCEDURE PlayEnhMetaFile* (p0 : HDC; p1 : HENHMETAFILE; VAR p2 [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE PlayEnhMetaFileRecord* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagHANDLETABLE_struct; VAR p2 [NIL_COMPAT]  : ENHMETARECORD; p3 : UINT) : BOOL;
    PROCEDURE SetEnhMetaFileBits* (p0 : UINT; p1 : PBYTE) : HENHMETAFILE;
    PROCEDURE SetWinMetaFileBits* (p0 : UINT; p1 : PBYTE; p2 : HDC; VAR p3 [NIL_COMPAT]  : METAFILEPICT) : HENHMETAFILE;
    PROCEDURE GdiComment* (p0 : HDC; p1 : UINT; p2 : PBYTE) : BOOL;
    PROCEDURE GetTextMetricsA* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagTEXTMETRICA_struct) : BOOL;
    PROCEDURE GetTextMetricsW* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagTEXTMETRICW_struct) : BOOL;
    PROCEDURE AngleArc* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : DWORD; p4 : FLOAT; p5 : FLOAT) : BOOL;
    PROCEDURE PolyPolyline* (p0 : HDC; VAR p1 [NIL_COMPAT]  : POINT; VAR p2 [NIL_COMPAT]  : DWORD; p3 : DWORD) : BOOL;
    PROCEDURE GetWorldTransform* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagXFORM_struct) : BOOL;
    PROCEDURE SetWorldTransform* (p0 : HDC; VAR p1 [NIL_COMPAT]  : XFORM) : BOOL;
    PROCEDURE ModifyWorldTransform* (p0 : HDC; VAR p1 [NIL_COMPAT]  : XFORM; p2 : DWORD) : BOOL;
    PROCEDURE CombineTransform* (VAR p0 [NIL_COMPAT]  : tagXFORM_struct; VAR p1 [NIL_COMPAT]  : XFORM; VAR p2 [NIL_COMPAT]  : XFORM) : BOOL;
    PROCEDURE CreateDIBSection* (p0 : HDC; VAR p1 [NIL_COMPAT]  : BITMAPINFO; p2 : UINT; VAR p3 [NIL_COMPAT]  : LPVOID; p4 : HANDLE; p5 : DWORD) : HBITMAP;
    PROCEDURE GetDIBColorTable* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : RGBQUAD) : UINT;
    PROCEDURE SetDIBColorTable* (p0 : HDC; p1 : UINT; p2 : UINT; VAR p3 [NIL_COMPAT]  : RGBQUAD) : UINT;
    PROCEDURE SetColorAdjustment* (p0 : HDC; VAR p1 [NIL_COMPAT]  : COLORADJUSTMENT) : BOOL;
    PROCEDURE GetColorAdjustment* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagCOLORADJUSTMENT_struct) : BOOL;
    PROCEDURE CreateHalftonePalette* (p0 : HDC) : HPALETTE;
    PROCEDURE StartDocA* (p0 : HDC; VAR p1 [NIL_COMPAT]  : DOCINFOA) : LONGINT;
    PROCEDURE StartDocW* (p0 : HDC; VAR p1 [NIL_COMPAT]  : DOCINFOW) : LONGINT;
    ...
    PROCEDURE GetPath* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagPOINT_struct; p2 : LPBYTE; p3 : LONGINT) : LONGINT;
    PROCEDURE PathToRegion* (p0 : HDC) : HRGN;
    PROCEDURE PolyDraw* (p0 : HDC; VAR p1 [NIL_COMPAT]  : POINT; p2 : PBYTE; p3 : LONGINT) : BOOL;
    PROCEDURE SelectClipPath* (p0 : HDC; p1 : LONGINT) : BOOL;
    PROCEDURE SetArcDirection* (p0 : HDC; p1 : LONGINT) : LONGINT;
    PROCEDURE SetMiterLimit* (p0 : HDC; p1 : FLOAT; VAR p2 [NIL_COMPAT]  : FLOAT) : BOOL;
    PROCEDURE StrokeAndFillPath* (p0 : HDC) : BOOL;
    PROCEDURE StrokePath* (p0 : HDC) : BOOL;
    PROCEDURE WidenPath* (p0 : HDC) : BOOL;
    PROCEDURE ExtCreatePen* (p0 : DWORD; p1 : DWORD; VAR p2 [NIL_COMPAT]  : LOGBRUSH; p3 : DWORD; VAR p4 [NIL_COMPAT]  : DWORD) : HPEN;
    PROCEDURE GetMiterLimit* (p0 : HDC; VAR p1 [NIL_COMPAT]  : FLOAT) : BOOL;
    ...
    PROCEDURE MoveToEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    ...
    PROCEDURE ExtTextOutA* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : UINT; VAR p4 [NIL_COMPAT]  : RECT; p5 : LPCSTR; p6 : UINT; VAR p7 [NIL_COMPAT]  : INT) : BOOL;
    PROCEDURE ExtTextOutW* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : UINT; VAR p4 [NIL_COMPAT]  : RECT; p5 : LPCWSTR; p6 : UINT; VAR p7 [NIL_COMPAT]  : INT) : BOOL;
    PROCEDURE PolyTextOutA* (p0 : HDC; VAR p1 [NIL_COMPAT]  : POLYTEXTA; p2 : LONGINT) : BOOL;
    PROCEDURE PolyTextOutW* (p0 : HDC; VAR p1 [NIL_COMPAT]  : POLYTEXTW; p2 : LONGINT) : BOOL;
    PROCEDURE CreatePolygonRgn* (VAR p0 [NIL_COMPAT]  : POINT; p1 : LONGINT; p2 : LONGINT) : HRGN;
    PROCEDURE DPtoLP* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagPOINT_struct; p2 : LONGINT) : BOOL;
    PROCEDURE LPtoDP* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagPOINT_struct; p2 : LONGINT) : BOOL;
    PROCEDURE Polygon* (p0 : HDC; VAR p1 [NIL_COMPAT]  : POINT; p2 : LONGINT) : BOOL;
    PROCEDURE Polyline* (p0 : HDC; VAR p1 [NIL_COMPAT]  : POINT; p2 : LONGINT) : BOOL;
    PROCEDURE PolyBezier* (p0 : HDC; VAR p1 [NIL_COMPAT]  : POINT; p2 : DWORD) : BOOL;
    PROCEDURE PolyBezierTo* (p0 : HDC; VAR p1 [NIL_COMPAT]  : POINT; p2 : DWORD) : BOOL;
    PROCEDURE PolylineTo* (p0 : HDC; VAR p1 [NIL_COMPAT]  : POINT; p2 : DWORD) : BOOL;
    PROCEDURE SetViewportExtEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    PROCEDURE SetViewportOrgEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE SetWindowExtEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    PROCEDURE SetWindowOrgEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE OffsetViewportOrgEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE OffsetWindowOrgEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE ScaleViewportExtEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; VAR p5 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    PROCEDURE ScaleWindowExtEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; VAR p5 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    PROCEDURE SetBitmapDimensionEx* (p0 : HBITMAP; p1 : LONGINT; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagSIZE_struct) : BOOL;
    PROCEDURE SetBrushOrgEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE GetTextFaceA* (p0 : HDC; p1 : LONGINT; p2 : LPSTR) : LONGINT;
    PROCEDURE GetTextFaceW* (p0 : HDC; p1 : LONGINT; p2 : LPWSTR) : LONGINT;
    PROCEDURE GetKerningPairsA* (p0 : HDC; p1 : DWORD; VAR p2 [NIL_COMPAT]  : tagKERNINGPAIR_struct) : DWORD;
    PROCEDURE GetKerningPairsW* (p0 : HDC; p1 : DWORD; VAR p2 [NIL_COMPAT]  : tagKERNINGPAIR_struct) : DWORD;
    PROCEDURE GetDCOrgEx* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE FixBrushOrgEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    ...
    PROCEDURE GetLogColorSpaceA* (p0 : HCOLORSPACE; VAR p1 [NIL_COMPAT]  : tagLOGCOLORSPACEA_struct; p2 : DWORD) : BOOL;
    PROCEDURE GetLogColorSpaceW* (p0 : HCOLORSPACE; VAR p1 [NIL_COMPAT]  : tagLOGCOLORSPACEW_struct; p2 : DWORD) : BOOL;
    PROCEDURE CreateColorSpaceA* (VAR p0 [NIL_COMPAT]  : tagLOGCOLORSPACEA_struct) : HCOLORSPACE;
    PROCEDURE CreateColorSpaceW* (VAR p0 [NIL_COMPAT]  : tagLOGCOLORSPACEW_struct) : HCOLORSPACE;
    PROCEDURE SetColorSpace* (p0 : HDC; p1 : HCOLORSPACE) : HCOLORSPACE;
    PROCEDURE DeleteColorSpace* (p0 : HCOLORSPACE) : BOOL;
    PROCEDURE GetICMProfileA* (p0 : HDC; VAR p1 [NIL_COMPAT]  : DWORD; p2 : LPSTR) : BOOL;
    PROCEDURE GetICMProfileW* (p0 : HDC; VAR p1 [NIL_COMPAT]  : DWORD; p2 : LPWSTR) : BOOL;
    ...
    PROCEDURE wglUseFontOutlinesA* (p0 : HDC; p1 : DWORD; p2 : DWORD; p3 : DWORD; p4 : FLOAT; p5 : FLOAT; p6 : LONGINT; VAR p7 [NIL_COMPAT]  : _GLYPHMETRICSFLOAT_struct) : BOOL;
    PROCEDURE wglUseFontOutlinesW* (p0 : HDC; p1 : DWORD; p2 : DWORD; p3 : DWORD; p4 : FLOAT; p5 : FLOAT; p6 : LONGINT; VAR p7 [NIL_COMPAT]  : _GLYPHMETRICSFLOAT_struct) : BOOL;
    PROCEDURE wglDescribeLayerPlane* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : UINT; VAR p4 [NIL_COMPAT]  : tagLAYERPLANEDESCRIPTOR_struct) : BOOL;
    PROCEDURE wglSetLayerPaletteEntries* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; VAR p4 [NIL_COMPAT]  : COLORREF) : LONGINT;
    PROCEDURE wglGetLayerPaletteEntries* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; VAR p4 [NIL_COMPAT]  : COLORREF) : LONGINT;
    ...
    PROCEDURE GetKeyboardLayoutList* (nBuff : LONGINT; VAR lpList [NIL_COMPAT]  : HKL) : LONGINT;
    PROCEDURE GetKeyboardLayout* (dwLayout : DWORD) : HKL;
    PROCEDURE CreateDesktopA* (lpszDesktop : LPSTR; lpszDevice : LPSTR; VAR pDevmode [NIL_COMPAT]  : _devicemodeA_struct; dwFlags : DWORD; dwDesiredAccess : ACCESS_MASK; VAR lpsa [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct) : HDESK;
    PROCEDURE CreateDesktopW* (lpszDesktop : LPWSTR; lpszDevice : LPWSTR; VAR pDevmode [NIL_COMPAT]  : _devicemodeW_struct; dwFlags : DWORD; dwDesiredAccess : ACCESS_MASK; VAR lpsa [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct) : HDESK;
    ...
    PROCEDURE CreateWindowStationA* (lpwinsta : LPSTR; dwReserved : DWORD; dwDesiredAccess : ACCESS_MASK; VAR lpsa [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct) : HWINSTA;
    PROCEDURE CreateWindowStationW* (lpwinsta : LPWSTR; dwReserved : DWORD; dwDesiredAccess : ACCESS_MASK; VAR lpsa [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct) : HWINSTA;
    ...
    PROCEDURE SetUserObjectSecurity* (hObj : HANDLE; VAR pSIRequested [NIL_COMPAT]  : DWORD; pSID : PSECURITY_DESCRIPTOR) : BOOL;
    PROCEDURE GetUserObjectSecurity* (hObj : HANDLE; VAR pSIRequested [NIL_COMPAT]  : DWORD; pSID : PSECURITY_DESCRIPTOR; nLength : DWORD; VAR lpnLengthNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetUserObjectInformationA* (hObj : HANDLE; nIndex : LONGINT; pvInfo : PVOID; nLength : DWORD; VAR lpnLengthNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetUserObjectInformationW* (hObj : HANDLE; nIndex : LONGINT; pvInfo : PVOID; nLength : DWORD; VAR lpnLengthNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE TrackMouseEvent* (VAR lpEventTrack [NIL_COMPAT]  : tagTRACKMOUSEEVENT_struct) : BOOL;
    PROCEDURE DrawEdge* (hdc : HDC; VAR qrc [NIL_COMPAT]  : tagRECT_struct; edge : UINT; grfFlags : UINT) : BOOL;
    PROCEDURE DrawFrameControl* (p0 : HDC; VAR p1 [NIL_COMPAT]  : tagRECT_struct; p2 : UINT; p3 : UINT) : BOOL;
    PROCEDURE DrawCaption* (p0 : HWND; p1 : HDC; VAR p2 [NIL_COMPAT]  : RECT; p3 : UINT) : BOOL;
    PROCEDURE DrawAnimatedRects* (hwnd : HWND; idAni : LONGINT; VAR lprcFrom [NIL_COMPAT]  : RECT; VAR lprcTo [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE GetMessageA* (VAR lpMsg [NIL_COMPAT]  : tagMSG_struct; hWnd : HWND; wMsgFilterMin : UINT; wMsgFilterMax : UINT) : BOOL;
    PROCEDURE GetMessageW* (VAR lpMsg [NIL_COMPAT]  : tagMSG_struct; hWnd : HWND; wMsgFilterMin : UINT; wMsgFilterMax : UINT) : BOOL;
    PROCEDURE TranslateMessage* (VAR lpMsg [NIL_COMPAT]  : MSG) : BOOL;
    PROCEDURE DispatchMessageA* (VAR lpMsg [NIL_COMPAT]  : MSG) : LONG;
    PROCEDURE DispatchMessageW* (VAR lpMsg [NIL_COMPAT]  : MSG) : LONG;
    PROCEDURE SetMessageQueue* (cMessagesMax : LONGINT) : BOOL;
    PROCEDURE PeekMessageA* (VAR lpMsg [NIL_COMPAT]  : tagMSG_struct; hWnd : HWND; wMsgFilterMin : UINT; wMsgFilterMax : UINT; wRemoveMsg : UINT) : BOOL;
    PROCEDURE PeekMessageW* (VAR lpMsg [NIL_COMPAT]  : tagMSG_struct; hWnd : HWND; wMsgFilterMin : UINT; wMsgFilterMax : UINT; wRemoveMsg : UINT) : BOOL;
    ...
    PROCEDURE SendMessageTimeoutA* (hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM; fuFlags : UINT; uTimeout : UINT; VAR lpdwResult [NIL_COMPAT]  : DWORD) : LRESULT;
    PROCEDURE SendMessageTimeoutW* (hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM; fuFlags : UINT; uTimeout : UINT; VAR lpdwResult [NIL_COMPAT]  : DWORD) : LRESULT;
    ...
    PROCEDURE BroadcastSystemMessageA* (p0 : DWORD; VAR p1 [NIL_COMPAT]  : DWORD; p2 : UINT; p3 : WPARAM; p4 : LPARAM) : LONGINT;
    PROCEDURE BroadcastSystemMessageW* (p0 : DWORD; VAR p1 [NIL_COMPAT]  : DWORD; p2 : UINT; p3 : WPARAM; p4 : LPARAM) : LONGINT;
    ...
    PROCEDURE RegisterClassA* (VAR lpWndClass [NIL_COMPAT]  : WNDCLASSA) : ATOM;
    PROCEDURE RegisterClassW* (VAR lpWndClass [NIL_COMPAT]  : WNDCLASSW) : ATOM;
    ...
    PROCEDURE GetClassInfoA* (hInstance : HINSTANCE; lpClassName : LPCSTR; VAR lpWndClass [NIL_COMPAT]  : tagWNDCLASSA_struct) : BOOL;
    PROCEDURE GetClassInfoW* (hInstance : HINSTANCE; lpClassName : LPCWSTR; VAR lpWndClass [NIL_COMPAT]  : tagWNDCLASSW_struct) : BOOL;
    PROCEDURE RegisterClassExA* (VAR p0 [NIL_COMPAT]  : WNDCLASSEXA) : ATOM;
    PROCEDURE RegisterClassExW* (VAR p0 [NIL_COMPAT]  : WNDCLASSEXW) : ATOM;
    PROCEDURE GetClassInfoExA* (p0 : HINSTANCE; p1 : LPCSTR; VAR p2 [NIL_COMPAT]  : tagWNDCLASSEXA_struct) : BOOL;
    PROCEDURE GetClassInfoExW* (p0 : HINSTANCE; p1 : LPCWSTR; VAR p2 [NIL_COMPAT]  : tagWNDCLASSEXW_struct) : BOOL;
    ...
    PROCEDURE GetWindowPlacement* (hWnd : HWND; VAR lpwndpl [NIL_COMPAT]  : WINDOWPLACEMENT) : BOOL;
    PROCEDURE SetWindowPlacement* (hWnd : HWND; VAR lpwndpl [NIL_COMPAT]  : WINDOWPLACEMENT) : BOOL;
    ...
    PROCEDURE CreateDialogIndirectParamA* (hInstance : HINSTANCE; VAR lpTemplate [NIL_COMPAT]  : DLGTEMPLATE; hWndParent : HWND; lpDialogFunc : DLGPROC; dwInitParam : LPARAM) : HWND;
    PROCEDURE CreateDialogIndirectParamW* (hInstance : HINSTANCE; VAR lpTemplate [NIL_COMPAT]  : DLGTEMPLATE; hWndParent : HWND; lpDialogFunc : DLGPROC; dwInitParam : LPARAM) : HWND;
    ...
    PROCEDURE DialogBoxIndirectParamA* (hInstance : HINSTANCE; VAR hDialogTemplate [NIL_COMPAT]  : DLGTEMPLATE; hWndParent : HWND; lpDialogFunc : DLGPROC; dwInitParam : LPARAM) : LONGINT;
    PROCEDURE DialogBoxIndirectParamW* (hInstance : HINSTANCE; VAR hDialogTemplate [NIL_COMPAT]  : DLGTEMPLATE; hWndParent : HWND; lpDialogFunc : DLGPROC; dwInitParam : LPARAM) : LONGINT;
    ...
    PROCEDURE GetDlgItemInt* (hDlg : HWND; nIDDlgItem : LONGINT; VAR lpTranslated [NIL_COMPAT]  : BOOL; bSigned : BOOL) : UINT;
    ...
    PROCEDURE CallMsgFilterA* (VAR lpMsg [NIL_COMPAT]  : tagMSG_struct; nCode : LONGINT) : BOOL;
    PROCEDURE CallMsgFilterW* (VAR lpMsg [NIL_COMPAT]  : tagMSG_struct; nCode : LONGINT) : BOOL;
    ...
    PROCEDURE GetPriorityClipboardFormat* (VAR paFormatPriorityList [NIL_COMPAT]  : UINT; cFormats : LONGINT) : LONGINT;
    ...
    PROCEDURE ToAscii* (uVirtKey : UINT; uScanCode : UINT; lpKeyState : PBYTE; VAR lpChar [NIL_COMPAT]  : WORD; uFlags : UINT) : LONGINT;
    PROCEDURE ToAsciiEx* (uVirtKey : UINT; uScanCode : UINT; lpKeyState : PBYTE; VAR lpChar [NIL_COMPAT]  : WORD; uFlags : UINT; dwhkl : HKL) : LONGINT;
    ...
    PROCEDURE MsgWaitForMultipleObjects* (nCount : DWORD; VAR pHandles [NIL_COMPAT]  : HANDLE; fWaitAll : BOOL; dwMilliseconds : DWORD; dwWakeMask : DWORD) : DWORD;
    PROCEDURE MsgWaitForMultipleObjectsEx* (nCount : DWORD; VAR pHandles [NIL_COMPAT]  : HANDLE; dwMilliseconds : DWORD; dwWakeMask : DWORD; dwFlags : DWORD) : DWORD;
    ...
    PROCEDURE CreateAcceleratorTableA* (VAR p0 [NIL_COMPAT]  : tagACCEL_struct; p1 : LONGINT) : HACCEL;
    PROCEDURE CreateAcceleratorTableW* (VAR p0 [NIL_COMPAT]  : tagACCEL_struct; p1 : LONGINT) : HACCEL;
    PROCEDURE DestroyAcceleratorTable* (hAccel : HACCEL) : BOOL;
    PROCEDURE CopyAcceleratorTableA* (hAccelSrc : HACCEL; VAR lpAccelDst [NIL_COMPAT]  : tagACCEL_struct; cAccelEntries : LONGINT) : LONGINT;
    PROCEDURE CopyAcceleratorTableW* (hAccelSrc : HACCEL; VAR lpAccelDst [NIL_COMPAT]  : tagACCEL_struct; cAccelEntries : LONGINT) : LONGINT;
    PROCEDURE TranslateAcceleratorA* (hWnd : HWND; hAccTable : HACCEL; VAR lpMsg [NIL_COMPAT]  : tagMSG_struct) : LONGINT;
    PROCEDURE TranslateAcceleratorW* (hWnd : HWND; hAccTable : HACCEL; VAR lpMsg [NIL_COMPAT]  : tagMSG_struct) : LONGINT;
    ...
    PROCEDURE TrackPopupMenu* (hMenu : HMENU; uFlags : UINT; x : LONGINT; y : LONGINT; nReserved : LONGINT; hWnd : HWND; VAR prcRect [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE TrackPopupMenuEx* (p0 : HMENU; p1 : UINT; p2 : LONGINT; p3 : LONGINT; p4 : HWND; VAR p5 [NIL_COMPAT]  : TPMPARAMS) : BOOL;
    PROCEDURE InsertMenuItemA* (p0 : HMENU; p1 : UINT; p2 : BOOL; VAR p3 [NIL_COMPAT]  : MENUITEMINFOA) : BOOL;
    PROCEDURE InsertMenuItemW* (p0 : HMENU; p1 : UINT; p2 : BOOL; VAR p3 [NIL_COMPAT]  : MENUITEMINFOW) : BOOL;
    PROCEDURE GetMenuItemInfoA* (p0 : HMENU; p1 : UINT; p2 : BOOL; VAR p3 [NIL_COMPAT]  : tagMENUITEMINFOA_struct) : BOOL;
    PROCEDURE GetMenuItemInfoW* (p0 : HMENU; p1 : UINT; p2 : BOOL; VAR p3 [NIL_COMPAT]  : tagMENUITEMINFOW_struct) : BOOL;
    PROCEDURE SetMenuItemInfoA* (p0 : HMENU; p1 : UINT; p2 : BOOL; VAR p3 [NIL_COMPAT]  : MENUITEMINFOA) : BOOL;
    PROCEDURE SetMenuItemInfoW* (p0 : HMENU; p1 : UINT; p2 : BOOL; VAR p3 [NIL_COMPAT]  : MENUITEMINFOW) : BOOL;
    ...
    PROCEDURE GetMenuItemRect* (hWnd : HWND; hMenu : HMENU; uItem : UINT; VAR lprcItem [NIL_COMPAT]  : tagRECT_struct) : BOOL;
    ...
    PROCEDURE DrawTextA* (hDC : HDC; lpString : LPCSTR; nCount : LONGINT; VAR lpRect [NIL_COMPAT]  : tagRECT_struct; uFormat : UINT) : LONGINT;
    PROCEDURE DrawTextW* (hDC : HDC; lpString : LPCWSTR; nCount : LONGINT; VAR lpRect [NIL_COMPAT]  : tagRECT_struct; uFormat : UINT) : LONGINT;
    PROCEDURE DrawTextExA* (p0 : HDC; p1 : LPSTR; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagRECT_struct; p4 : UINT; VAR p5 [NIL_COMPAT]  : tagDRAWTEXTPARAMS_struct) : LONGINT;
    PROCEDURE DrawTextExW* (p0 : HDC; p1 : LPWSTR; p2 : LONGINT; VAR p3 [NIL_COMPAT]  : tagRECT_struct; p4 : UINT; VAR p5 [NIL_COMPAT]  : tagDRAWTEXTPARAMS_struct) : LONGINT;
    ...
    PROCEDURE TabbedTextOutA* (hDC : HDC; X : LONGINT; Y : LONGINT; lpString : LPCSTR; nCount : LONGINT; nTabPositions : LONGINT; VAR lpnTabStopPositions [NIL_COMPAT]  : LONGINT; nTabOrigin : LONGINT) : LONG;
    PROCEDURE TabbedTextOutW* (hDC : HDC; X : LONGINT; Y : LONGINT; lpString : LPCWSTR; nCount : LONGINT; nTabPositions : LONGINT; VAR lpnTabStopPositions [NIL_COMPAT]  : LONGINT; nTabOrigin : LONGINT) : LONG;
    PROCEDURE GetTabbedTextExtentA* (hDC : HDC; lpString : LPCSTR; nCount : LONGINT; nTabPositions : LONGINT; VAR lpnTabStopPositions [NIL_COMPAT]  : LONGINT) : DWORD;
    PROCEDURE GetTabbedTextExtentW* (hDC : HDC; lpString : LPCWSTR; nCount : LONGINT; nTabPositions : LONGINT; VAR lpnTabStopPositions [NIL_COMPAT]  : LONGINT) : DWORD;
    ...
    PROCEDURE AlignRects* (VAR arc [NIL_COMPAT]  : tagRECT_struct; cCount : DWORD; iPrimary : DWORD; dwFlags : DWORD) : BOOL;
    PROCEDURE GetWindowDC* (hWnd : HWND) : HDC;
    PROCEDURE ReleaseDC* (hWnd : HWND; hDC : HDC) : LONGINT;
    PROCEDURE BeginPaint* (hWnd : HWND; VAR lpPaint [NIL_COMPAT]  : tagPAINTSTRUCT_struct) : HDC;
    PROCEDURE EndPaint* (hWnd : HWND; VAR lpPaint [NIL_COMPAT]  : PAINTSTRUCT) : BOOL;
    PROCEDURE GetUpdateRect* (hWnd : HWND; VAR lpRect [NIL_COMPAT]  : tagRECT_struct; bErase : BOOL) : BOOL;
    ...
    PROCEDURE InvalidateRect* (hWnd : HWND; VAR lpRect [NIL_COMPAT]  : RECT; bErase : BOOL) : BOOL;
    PROCEDURE ValidateRect* (hWnd : HWND; VAR lpRect [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE InvalidateRgn* (hWnd : HWND; hRgn : HRGN; bErase : BOOL) : BOOL;
    PROCEDURE ValidateRgn* (hWnd : HWND; hRgn : HRGN) : BOOL;
    PROCEDURE RedrawWindow* (hWnd : HWND; VAR lprcUpdate [NIL_COMPAT]  : RECT; hrgnUpdate : HRGN; flags : UINT) : BOOL;
    PROCEDURE LockWindowUpdate* (hWndLock : HWND) : BOOL;
    PROCEDURE ScrollWindow* (hWnd : HWND; XAmount : LONGINT; YAmount : LONGINT; VAR lpRect [NIL_COMPAT]  : RECT; VAR lpClipRect [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE ScrollDC* (hDC : HDC; dx : LONGINT; dy : LONGINT; VAR lprcScroll [NIL_COMPAT]  : RECT; VAR lprcClip [NIL_COMPAT]  : RECT; hrgnUpdate : HRGN; VAR lprcUpdate [NIL_COMPAT]  : tagRECT_struct) : BOOL;
    PROCEDURE ScrollWindowEx* (hWnd : HWND; dx : LONGINT; dy : LONGINT; VAR prcScroll [NIL_COMPAT]  : RECT; VAR prcClip [NIL_COMPAT]  : RECT; hrgnUpdate : HRGN; VAR prcUpdate [NIL_COMPAT]  : tagRECT_struct; flags : UINT) : LONGINT;
    ...
    PROCEDURE GetScrollRange* (hWnd : HWND; nBar : LONGINT; VAR lpMinPos [NIL_COMPAT]  : LONGINT; VAR lpMaxPos [NIL_COMPAT]  : LONGINT) : BOOL;
    ...
    PROCEDURE GetClientRect* (hWnd : HWND; VAR lpRect [NIL_COMPAT]  : tagRECT_struct) : BOOL;
    PROCEDURE GetWindowRect* (hWnd : HWND; VAR lpRect [NIL_COMPAT]  : tagRECT_struct) : BOOL;
    PROCEDURE AdjustWindowRect* (VAR lpRect [NIL_COMPAT]  : tagRECT_struct; dwStyle : DWORD; bMenu : BOOL) : BOOL;
    PROCEDURE AdjustWindowRectEx* (VAR lpRect [NIL_COMPAT]  : tagRECT_struct; dwStyle : DWORD; bMenu : BOOL; dwExStyle : DWORD) : BOOL;
    ...
    PROCEDURE MessageBoxIndirectA* (VAR p0 [NIL_COMPAT]  : tagMSGBOXPARAMSA_struct) : LONGINT;
    PROCEDURE MessageBoxIndirectW* (VAR p0 [NIL_COMPAT]  : tagMSGBOXPARAMSW_struct) : LONGINT;
    ...
    PROCEDURE GetCursorPos* (VAR lpPoint [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE ClipCursor* (VAR lpRect [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE GetClipCursor* (VAR lpRect [NIL_COMPAT]  : tagRECT_struct) : BOOL;
    ...
    PROCEDURE GetCaretPos* (VAR lpPoint [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE ClientToScreen* (hWnd : HWND; VAR lpPoint [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE ScreenToClient* (hWnd : HWND; VAR lpPoint [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE MapWindowPoints* (hWndFrom : HWND; hWndTo : HWND; VAR lpPoints [NIL_COMPAT]  : tagPOINT_struct; cPoints : UINT) : LONGINT;
    ...
    PROCEDURE SetSysColors* (cElements : LONGINT; VAR lpaElements [NIL_COMPAT]  : INT; VAR lpaRgbValues [NIL_COMPAT]  : COLORREF) : BOOL;
    PROCEDURE DrawFocusRect* (hDC : HDC; VAR lprc [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE FillRect* (hDC : HDC; VAR lprc [NIL_COMPAT]  : RECT; hbr : HBRUSH) : LONGINT;
    PROCEDURE FrameRect* (hDC : HDC; VAR lprc [NIL_COMPAT]  : RECT; hbr : HBRUSH) : LONGINT;
    PROCEDURE InvertRect* (hDC : HDC; VAR lprc [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE SetRect* (VAR lprc [NIL_COMPAT]  : tagRECT_struct; xLeft : LONGINT; yTop : LONGINT; xRight : LONGINT; yBottom : LONGINT) : BOOL;
    PROCEDURE SetRectEmpty* (VAR lprc [NIL_COMPAT]  : tagRECT_struct) : BOOL;
    PROCEDURE CopyRect* (VAR lprcDst [NIL_COMPAT]  : tagRECT_struct; VAR lprcSrc [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE InflateRect* (VAR lprc [NIL_COMPAT]  : tagRECT_struct; dx : LONGINT; dy : LONGINT) : BOOL;
    PROCEDURE IntersectRect* (VAR lprcDst [NIL_COMPAT]  : tagRECT_struct; VAR lprcSrc1 [NIL_COMPAT]  : RECT; VAR lprcSrc2 [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE UnionRect* (VAR lprcDst [NIL_COMPAT]  : tagRECT_struct; VAR lprcSrc1 [NIL_COMPAT]  : RECT; VAR lprcSrc2 [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE SubtractRect* (VAR lprcDst [NIL_COMPAT]  : tagRECT_struct; VAR lprcSrc1 [NIL_COMPAT]  : RECT; VAR lprcSrc2 [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE OffsetRect* (VAR lprc [NIL_COMPAT]  : tagRECT_struct; dx : LONGINT; dy : LONGINT) : BOOL;
    PROCEDURE IsRectEmpty* (VAR lprc [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE EqualRect* (VAR lprc1 [NIL_COMPAT]  : RECT; VAR lprc2 [NIL_COMPAT]  : RECT) : BOOL;
    PROCEDURE PtInRect* (VAR lprc [NIL_COMPAT]  : RECT; pt : POINT) : BOOL;
    ...
    PROCEDURE GetWindowThreadProcessId* (hWnd : HWND; VAR lpdwProcessId [NIL_COMPAT]  : DWORD) : DWORD;
    ...
    PROCEDURE CreateIconIndirect* (VAR piconinfo [NIL_COMPAT]  : ICONINFO) : HICON;
    PROCEDURE CopyIcon* (hIcon : HICON) : HICON;
    PROCEDURE GetIconInfo* (hIcon : HICON; VAR piconinfo [NIL_COMPAT]  : ICONINFO) : BOOL;
    ...
    PROCEDURE IsDialogMessageA* (hDlg : HWND; VAR lpMsg [NIL_COMPAT]  : tagMSG_struct) : BOOL;
    PROCEDURE IsDialogMessageW* (hDlg : HWND; VAR lpMsg [NIL_COMPAT]  : tagMSG_struct) : BOOL;
    PROCEDURE MapDialogRect* (hDlg : HWND; VAR lpRect [NIL_COMPAT]  : tagRECT_struct) : BOOL;
    ...
    PROCEDURE SetScrollInfo* (p0 : HWND; p1 : LONGINT; VAR p2 [NIL_COMPAT]  : SCROLLINFO; p3 : BOOL) : LONGINT;
    PROCEDURE GetScrollInfo* (p0 : HWND; p1 : LONGINT; VAR p2 [NIL_COMPAT]  : tagSCROLLINFO_struct) : BOOL;
    ...
    PROCEDURE TranslateMDISysAccel* (hWndClient : HWND; VAR lpMsg [NIL_COMPAT]  : tagMSG_struct) : BOOL;
    ...
    PROCEDURE TileWindows* (hwndParent : HWND; wHow : UINT; VAR lpRect [NIL_COMPAT]  : RECT; cKids : UINT; VAR lpKids [NIL_COMPAT]  : HWND) : WORD;
    PROCEDURE CascadeWindows* (hwndParent : HWND; wHow : UINT; VAR lpRect [NIL_COMPAT]  : RECT; cKids : UINT; VAR lpKids [NIL_COMPAT]  : HWND) : WORD;
    ...
    PROCEDURE ChangeDisplaySettingsA* (VAR lpDevMode [NIL_COMPAT]  : _devicemodeA_struct; dwFlags : DWORD) : LONG;
    PROCEDURE ChangeDisplaySettingsW* (VAR lpDevMode [NIL_COMPAT]  : _devicemodeW_struct; dwFlags : DWORD) : LONG;
    PROCEDURE ChangeDisplaySettingsExA* (lpszDeviceName : LPCSTR; VAR lpDevMode [NIL_COMPAT]  : _devicemodeA_struct; hwnd : HWND; dwflags : DWORD; lParam : LPVOID) : LONG;
    PROCEDURE ChangeDisplaySettingsExW* (lpszDeviceName : LPCWSTR; VAR lpDevMode [NIL_COMPAT]  : _devicemodeW_struct; hwnd : HWND; dwflags : DWORD; lParam : LPVOID) : LONG;
    PROCEDURE EnumDisplaySettingsA* (lpszDeviceName : LPCSTR; iModeNum : DWORD; VAR lpDevMode [NIL_COMPAT]  : _devicemodeA_struct) : BOOL;
    PROCEDURE EnumDisplaySettingsW* (lpszDeviceName : LPCWSTR; iModeNum : DWORD; VAR lpDevMode [NIL_COMPAT]  : _devicemodeW_struct) : BOOL;
    ...
    PROCEDURE GetCPInfo* (CodePage : UINT; VAR lpCPInfo [NIL_COMPAT]  : _cpinfo_struct) : BOOL;
    PROCEDURE GetCPInfoExA* (CodePage : UINT; dwFlags : DWORD; VAR lpCPInfoEx [NIL_COMPAT]  : _cpinfoexA_struct) : BOOL;
    PROCEDURE GetCPInfoExW* (CodePage : UINT; dwFlags : DWORD; VAR lpCPInfoEx [NIL_COMPAT]  : _cpinfoexW_struct) : BOOL;
    ...
    PROCEDURE WideCharToMultiByte* (CodePage : UINT; dwFlags : DWORD; lpWideCharStr : LPCWSTR; cchWideChar : LONGINT; lpMultiByteStr : LPSTR; cchMultiByte : LONGINT; lpDefaultChar : LPCSTR; VAR lpUsedDefaultChar [NIL_COMPAT]  : BOOL) : LONGINT;
    ...
    PROCEDURE GetTimeFormatA* (Locale : LCID; dwFlags : DWORD; VAR lpTime [NIL_COMPAT]  : SYSTEMTIME; lpFormat : LPCSTR; lpTimeStr : LPSTR; cchTime : LONGINT) : LONGINT;
    PROCEDURE GetTimeFormatW* (Locale : LCID; dwFlags : DWORD; VAR lpTime [NIL_COMPAT]  : SYSTEMTIME; lpFormat : LPCWSTR; lpTimeStr : LPWSTR; cchTime : LONGINT) : LONGINT;
    PROCEDURE GetDateFormatA* (Locale : LCID; dwFlags : DWORD; VAR lpDate [NIL_COMPAT]  : SYSTEMTIME; lpFormat : LPCSTR; lpDateStr : LPSTR; cchDate : LONGINT) : LONGINT;
    PROCEDURE GetDateFormatW* (Locale : LCID; dwFlags : DWORD; VAR lpDate [NIL_COMPAT]  : SYSTEMTIME; lpFormat : LPCWSTR; lpDateStr : LPWSTR; cchDate : LONGINT) : LONGINT;
    PROCEDURE GetNumberFormatA* (Locale : LCID; dwFlags : DWORD; lpValue : LPCSTR; VAR lpFormat [NIL_COMPAT]  : NUMBERFMTA; lpNumberStr : LPSTR; cchNumber : LONGINT) : LONGINT;
    PROCEDURE GetNumberFormatW* (Locale : LCID; dwFlags : DWORD; lpValue : LPCWSTR; VAR lpFormat [NIL_COMPAT]  : NUMBERFMTW; lpNumberStr : LPWSTR; cchNumber : LONGINT) : LONGINT;
    PROCEDURE GetCurrencyFormatA* (Locale : LCID; dwFlags : DWORD; lpValue : LPCSTR; VAR lpFormat [NIL_COMPAT]  : CURRENCYFMTA; lpCurrencyStr : LPSTR; cchCurrency : LONGINT) : LONGINT;
    PROCEDURE GetCurrencyFormatW* (Locale : LCID; dwFlags : DWORD; lpValue : LPCWSTR; VAR lpFormat [NIL_COMPAT]  : CURRENCYFMTW; lpCurrencyStr : LPWSTR; cchCurrency : LONGINT) : LONGINT;
    ...
    PROCEDURE GetStringTypeExA* (Locale : LCID; dwInfoType : DWORD; lpSrcStr : LPCSTR; cchSrc : LONGINT; VAR lpCharType [NIL_COMPAT]  : WORD) : BOOL;
    PROCEDURE GetStringTypeExW* (Locale : LCID; dwInfoType : DWORD; lpSrcStr : LPCWSTR; cchSrc : LONGINT; VAR lpCharType [NIL_COMPAT]  : WORD) : BOOL;
    PROCEDURE GetStringTypeA* (Locale : LCID; dwInfoType : DWORD; lpSrcStr : LPCSTR; cchSrc : LONGINT; VAR lpCharType [NIL_COMPAT]  : WORD) : BOOL;
    PROCEDURE GetStringTypeW* (dwInfoType : DWORD; lpSrcStr : LPCWSTR; cchSrc : LONGINT; VAR lpCharType [NIL_COMPAT]  : WORD) : BOOL;
    ...
    PROCEDURE PeekConsoleInputA* (hConsoleInput : HANDLE; VAR lpBuffer [NIL_COMPAT]  : _INPUT_RECORD_struct; nLength : DWORD; VAR lpNumberOfEventsRead [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE PeekConsoleInputW* (hConsoleInput : HANDLE; VAR lpBuffer [NIL_COMPAT]  : _INPUT_RECORD_struct; nLength : DWORD; VAR lpNumberOfEventsRead [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE ReadConsoleInputA* (hConsoleInput : HANDLE; VAR lpBuffer [NIL_COMPAT]  : _INPUT_RECORD_struct; nLength : DWORD; VAR lpNumberOfEventsRead [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE ReadConsoleInputW* (hConsoleInput : HANDLE; VAR lpBuffer [NIL_COMPAT]  : _INPUT_RECORD_struct; nLength : DWORD; VAR lpNumberOfEventsRead [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE WriteConsoleInputA* (hConsoleInput : HANDLE; VAR lpBuffer [NIL_COMPAT]  : INPUT_RECORD; nLength : DWORD; VAR lpNumberOfEventsWritten [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE WriteConsoleInputW* (hConsoleInput : HANDLE; VAR lpBuffer [NIL_COMPAT]  : INPUT_RECORD; nLength : DWORD; VAR lpNumberOfEventsWritten [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE ReadConsoleOutputA* (hConsoleOutput : HANDLE; VAR lpBuffer [NIL_COMPAT]  : _CHAR_INFO_struct; dwBufferSize : COORD; dwBufferCoord : COORD; VAR lpReadRegion [NIL_COMPAT]  : _SMALL_RECT_struct) : BOOL;
    PROCEDURE ReadConsoleOutputW* (hConsoleOutput : HANDLE; VAR lpBuffer [NIL_COMPAT]  : _CHAR_INFO_struct; dwBufferSize : COORD; dwBufferCoord : COORD; VAR lpReadRegion [NIL_COMPAT]  : _SMALL_RECT_struct) : BOOL;
    PROCEDURE WriteConsoleOutputA* (hConsoleOutput : HANDLE; VAR lpBuffer [NIL_COMPAT]  : CHAR_INFO; dwBufferSize : COORD; dwBufferCoord : COORD; VAR lpWriteRegion [NIL_COMPAT]  : _SMALL_RECT_struct) : BOOL;
    PROCEDURE WriteConsoleOutputW* (hConsoleOutput : HANDLE; VAR lpBuffer [NIL_COMPAT]  : CHAR_INFO; dwBufferSize : COORD; dwBufferCoord : COORD; VAR lpWriteRegion [NIL_COMPAT]  : _SMALL_RECT_struct) : BOOL;
    PROCEDURE ReadConsoleOutputCharacterA* (hConsoleOutput : HANDLE; lpCharacter : LPSTR; nLength : DWORD; dwReadCoord : COORD; VAR lpNumberOfCharsRead [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE ReadConsoleOutputCharacterW* (hConsoleOutput : HANDLE; lpCharacter : LPWSTR; nLength : DWORD; dwReadCoord : COORD; VAR lpNumberOfCharsRead [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE ReadConsoleOutputAttribute* (hConsoleOutput : HANDLE; VAR lpAttribute [NIL_COMPAT]  : WORD; nLength : DWORD; dwReadCoord : COORD; VAR lpNumberOfAttrsRead [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE WriteConsoleOutputCharacterA* (hConsoleOutput : HANDLE; lpCharacter : LPCSTR; nLength : DWORD; dwWriteCoord : COORD; VAR lpNumberOfCharsWritten [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE WriteConsoleOutputCharacterW* (hConsoleOutput : HANDLE; lpCharacter : LPCWSTR; nLength : DWORD; dwWriteCoord : COORD; VAR lpNumberOfCharsWritten [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE WriteConsoleOutputAttribute* (hConsoleOutput : HANDLE; VAR lpAttribute [NIL_COMPAT]  : WORD; nLength : DWORD; dwWriteCoord : COORD; VAR lpNumberOfAttrsWritten [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE FillConsoleOutputCharacterA* (hConsoleOutput : HANDLE; cCharacter : CHAR; nLength : DWORD; dwWriteCoord : COORD; VAR lpNumberOfCharsWritten [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE FillConsoleOutputCharacterW* (hConsoleOutput : HANDLE; cCharacter : WCHAR; nLength : DWORD; dwWriteCoord : COORD; VAR lpNumberOfCharsWritten [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE FillConsoleOutputAttribute* (hConsoleOutput : HANDLE; wAttribute : WORD; nLength : DWORD; dwWriteCoord : COORD; VAR lpNumberOfAttrsWritten [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetConsoleMode* (hConsoleHandle : HANDLE; VAR lpMode [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetNumberOfConsoleInputEvents* (hConsoleInput : HANDLE; VAR lpNumberOfEvents [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetConsoleScreenBufferInfo* (hConsoleOutput : HANDLE; VAR lpConsoleScreenBufferInfo [NIL_COMPAT]  : _CONSOLE_SCREEN_BUFFER_INFO_struct) : BOOL;
    (* H2O: function returns record.
        PROCEDURE GetLargestConsoleWindowSize* (hConsoleOutput : HANDLE) : COORD; *)
    PROCEDURE GetConsoleCursorInfo* (hConsoleOutput : HANDLE; VAR lpConsoleCursorInfo [NIL_COMPAT]  : _CONSOLE_CURSOR_INFO_struct) : BOOL;
    PROCEDURE GetNumberOfConsoleMouseButtons* (VAR lpNumberOfMouseButtons [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE SetConsoleCursorInfo* (hConsoleOutput : HANDLE; VAR lpConsoleCursorInfo [NIL_COMPAT]  : CONSOLE_CURSOR_INFO) : BOOL;
    PROCEDURE ScrollConsoleScreenBufferA* (hConsoleOutput : HANDLE; VAR lpScrollRectangle [NIL_COMPAT]  : SMALL_RECT; VAR lpClipRectangle [NIL_COMPAT]  : SMALL_RECT; dwDestinationOrigin : COORD; VAR lpFill [NIL_COMPAT]  : CHAR_INFO) : BOOL;
    PROCEDURE ScrollConsoleScreenBufferW* (hConsoleOutput : HANDLE; VAR lpScrollRectangle [NIL_COMPAT]  : SMALL_RECT; VAR lpClipRectangle [NIL_COMPAT]  : SMALL_RECT; dwDestinationOrigin : COORD; VAR lpFill [NIL_COMPAT]  : CHAR_INFO) : BOOL;
    PROCEDURE SetConsoleWindowInfo* (hConsoleOutput : HANDLE; bAbsolute : BOOL; VAR lpConsoleWindow [NIL_COMPAT]  : SMALL_RECT) : BOOL;
    ...
    PROCEDURE ReadConsoleA* (hConsoleInput : HANDLE; lpBuffer : LPVOID; nNumberOfCharsToRead : DWORD; VAR lpNumberOfCharsRead [NIL_COMPAT]  : DWORD; lpReserved : LPVOID) : BOOL;
    PROCEDURE ReadConsoleW* (hConsoleInput : HANDLE; lpBuffer : LPVOID; nNumberOfCharsToRead : DWORD; VAR lpNumberOfCharsRead [NIL_COMPAT]  : DWORD; lpReserved : LPVOID) : BOOL;
    PROCEDURE WriteConsoleA* (hConsoleOutput : HANDLE; lpBuffer : LPVOID; nNumberOfCharsToWrite : DWORD; VAR lpNumberOfCharsWritten [NIL_COMPAT]  : DWORD; lpReserved : LPVOID) : BOOL;
    PROCEDURE WriteConsoleW* (hConsoleOutput : HANDLE; lpBuffer : LPVOID; nNumberOfCharsToWrite : DWORD; VAR lpNumberOfCharsWritten [NIL_COMPAT]  : DWORD; lpReserved : LPVOID) : BOOL;
    PROCEDURE CreateConsoleScreenBuffer* (dwDesiredAccess : DWORD; dwShareMode : DWORD; VAR lpSecurityAttributes [NIL_COMPAT]  : SECURITY_ATTRIBUTES; dwFlags : DWORD; lpScreenBufferData : LPVOID) : HANDLE;
    ...
    PROCEDURE VerFindFileA* (uFlags : DWORD; szFileName : LPSTR; szWinDir : LPSTR; szAppDir : LPSTR; szCurDir : LPSTR; VAR lpuCurDirLen [NIL_COMPAT]  : LONGINT; szDestDir : LPSTR; VAR lpuDestDirLen [NIL_COMPAT]  : LONGINT) : DWORD;
    PROCEDURE VerFindFileW* (uFlags : DWORD; szFileName : LPWSTR; szWinDir : LPWSTR; szAppDir : LPWSTR; szCurDir : LPWSTR; VAR lpuCurDirLen [NIL_COMPAT]  : LONGINT; szDestDir : LPWSTR; VAR lpuDestDirLen [NIL_COMPAT]  : LONGINT) : DWORD;
    PROCEDURE VerInstallFileA* (uFlags : DWORD; szSrcFileName : LPSTR; szDestFileName : LPSTR; szSrcDir : LPSTR; szDestDir : LPSTR; szCurDir : LPSTR; szTmpFile : LPSTR; VAR lpuTmpFileLen [NIL_COMPAT]  : LONGINT) : DWORD;
    PROCEDURE VerInstallFileW* (uFlags : DWORD; szSrcFileName : LPWSTR; szDestFileName : LPWSTR; szSrcDir : LPWSTR; szDestDir : LPWSTR; szCurDir : LPWSTR; szTmpFile : LPWSTR; VAR lpuTmpFileLen [NIL_COMPAT]  : LONGINT) : DWORD;
    PROCEDURE GetFileVersionInfoSizeA* (lptstrFilename : LPSTR; VAR lpdwHandle [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE GetFileVersionInfoSizeW* (lptstrFilename : LPWSTR; VAR lpdwHandle [NIL_COMPAT]  : DWORD) : DWORD;
    ...
    PROCEDURE VerQueryValueA* (pBlock : LPVOID; lpSubBlock : LPSTR; VAR lplpBuffer [NIL_COMPAT]  : LPVOID; VAR puLen [NIL_COMPAT]  : LONGINT) : BOOL;
    PROCEDURE VerQueryValueW* (pBlock : LPVOID; lpSubBlock : LPWSTR; VAR lplpBuffer [NIL_COMPAT]  : LPVOID; VAR puLen [NIL_COMPAT]  : LONGINT) : BOOL;
    PROCEDURE RegCloseKey* (hKey : HKEY) : LONG;
    PROCEDURE RegOverridePredefKey* (hKey : HKEY; hNewHKey : HKEY) : LONG;
    PROCEDURE RegConnectRegistryA* (lpMachineName : LPCSTR; hKey : HKEY; VAR phkResult [NIL_COMPAT]  : HKEY) : LONG;
    PROCEDURE RegConnectRegistryW* (lpMachineName : LPCWSTR; hKey : HKEY; VAR phkResult [NIL_COMPAT]  : HKEY) : LONG;
    PROCEDURE RegCreateKeyA* (hKey : HKEY; lpSubKey : LPCSTR; VAR phkResult [NIL_COMPAT]  : HKEY) : LONG;
    PROCEDURE RegCreateKeyW* (hKey : HKEY; lpSubKey : LPCWSTR; VAR phkResult [NIL_COMPAT]  : HKEY) : LONG;
    PROCEDURE RegCreateKeyExA* (hKey : HKEY; lpSubKey : LPCSTR; Reserved : DWORD; lpClass : LPSTR; dwOptions : DWORD; samDesired : REGSAM; VAR lpSecurityAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; VAR phkResult [NIL_COMPAT]  : HKEY; VAR lpdwDisposition [NIL_COMPAT]  : DWORD) : LONG;
    PROCEDURE RegCreateKeyExW* (hKey : HKEY; lpSubKey : LPCWSTR; Reserved : DWORD; lpClass : LPWSTR; dwOptions : DWORD; samDesired : REGSAM; VAR lpSecurityAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct; VAR phkResult [NIL_COMPAT]  : HKEY; VAR lpdwDisposition [NIL_COMPAT]  : DWORD) : LONG;
    ...
    PROCEDURE RegEnumKeyExA* (hKey : HKEY; dwIndex : DWORD; lpName : LPSTR; VAR lpcbName [NIL_COMPAT]  : DWORD; VAR lpReserved [NIL_COMPAT]  : DWORD; lpClass : LPSTR; VAR lpcbClass [NIL_COMPAT]  : DWORD; VAR lpftLastWriteTime [NIL_COMPAT]  : _FILETIME_struct) : LONG;
    PROCEDURE RegEnumKeyExW* (hKey : HKEY; dwIndex : DWORD; lpName : LPWSTR; VAR lpcbName [NIL_COMPAT]  : DWORD; VAR lpReserved [NIL_COMPAT]  : DWORD; lpClass : LPWSTR; VAR lpcbClass [NIL_COMPAT]  : DWORD; VAR lpftLastWriteTime [NIL_COMPAT]  : _FILETIME_struct) : LONG;
    PROCEDURE RegEnumValueA* (hKey : HKEY; dwIndex : DWORD; lpValueName : LPSTR; VAR lpcbValueName [NIL_COMPAT]  : DWORD; VAR lpReserved [NIL_COMPAT]  : DWORD; VAR lpType [NIL_COMPAT]  : DWORD; lpData : LPBYTE; VAR lpcbData [NIL_COMPAT]  : DWORD) : LONG;
    PROCEDURE RegEnumValueW* (hKey : HKEY; dwIndex : DWORD; lpValueName : LPWSTR; VAR lpcbValueName [NIL_COMPAT]  : DWORD; VAR lpReserved [NIL_COMPAT]  : DWORD; VAR lpType [NIL_COMPAT]  : DWORD; lpData : LPBYTE; VAR lpcbData [NIL_COMPAT]  : DWORD) : LONG;
    PROCEDURE RegFlushKey* (hKey : HKEY) : LONG;
    PROCEDURE RegGetKeySecurity* (hKey : HKEY; SecurityInformation : SECURITY_INFORMATION; pSecurityDescriptor : PSECURITY_DESCRIPTOR; VAR lpcbSecurityDescriptor [NIL_COMPAT]  : DWORD) : LONG;
    ...
    PROCEDURE RegOpenKeyA* (hKey : HKEY; lpSubKey : LPCSTR; VAR phkResult [NIL_COMPAT]  : HKEY) : LONG;
    PROCEDURE RegOpenKeyW* (hKey : HKEY; lpSubKey : LPCWSTR; VAR phkResult [NIL_COMPAT]  : HKEY) : LONG;
    PROCEDURE RegOpenKeyExA* (hKey : HKEY; lpSubKey : LPCSTR; ulOptions : DWORD; samDesired : REGSAM; VAR phkResult [NIL_COMPAT]  : HKEY) : LONG;
    PROCEDURE RegOpenKeyExW* (hKey : HKEY; lpSubKey : LPCWSTR; ulOptions : DWORD; samDesired : REGSAM; VAR phkResult [NIL_COMPAT]  : HKEY) : LONG;
    PROCEDURE RegQueryInfoKeyA* (hKey : HKEY; lpClass : LPSTR; VAR lpcbClass [NIL_COMPAT]  : DWORD; VAR lpReserved [NIL_COMPAT]  : DWORD; VAR lpcSubKeys [NIL_COMPAT]  : DWORD; VAR lpcbMaxSubKeyLen [NIL_COMPAT]  : DWORD; VAR lpcbMaxClassLen [NIL_COMPAT]  : DWORD; VAR lpcValues [NIL_COMPAT]  : DWORD; VAR lpcbMaxValueNameLen [NIL_COMPAT]  : DWORD; VAR lpcbMaxValueLen [NIL_COMPAT]  : DWORD; VAR lpcbSecurityDescriptor [NIL_COMPAT]  : DWORD; VAR lpftLastWriteTime [NIL_COMPAT]  : _FILETIME_struct) : LONG;
    PROCEDURE RegQueryInfoKeyW* (hKey : HKEY; lpClass : LPWSTR; VAR lpcbClass [NIL_COMPAT]  : DWORD; VAR lpReserved [NIL_COMPAT]  : DWORD; VAR lpcSubKeys [NIL_COMPAT]  : DWORD; VAR lpcbMaxSubKeyLen [NIL_COMPAT]  : DWORD; VAR lpcbMaxClassLen [NIL_COMPAT]  : DWORD; VAR lpcValues [NIL_COMPAT]  : DWORD; VAR lpcbMaxValueNameLen [NIL_COMPAT]  : DWORD; VAR lpcbMaxValueLen [NIL_COMPAT]  : DWORD; VAR lpcbSecurityDescriptor [NIL_COMPAT]  : DWORD; VAR lpftLastWriteTime [NIL_COMPAT]  : _FILETIME_struct) : LONG;
    PROCEDURE RegQueryValueA* (hKey : HKEY; lpSubKey : LPCSTR; lpValue : LPSTR; VAR lpcbValue [NIL_COMPAT]  : LONG) : LONG;
    PROCEDURE RegQueryValueW* (hKey : HKEY; lpSubKey : LPCWSTR; lpValue : LPWSTR; VAR lpcbValue [NIL_COMPAT]  : LONG) : LONG;
    PROCEDURE RegQueryMultipleValuesA* (hKey : HKEY; VAR val_list [NIL_COMPAT]  : value_entA_struct; num_vals : DWORD; lpValueBuf : LPSTR; VAR ldwTotsize [NIL_COMPAT]  : DWORD) : LONG;
    PROCEDURE RegQueryMultipleValuesW* (hKey : HKEY; VAR val_list [NIL_COMPAT]  : value_entW_struct; num_vals : DWORD; lpValueBuf : LPWSTR; VAR ldwTotsize [NIL_COMPAT]  : DWORD) : LONG;
    PROCEDURE RegQueryValueExA* (hKey : HKEY; lpValueName : LPCSTR; VAR lpReserved [NIL_COMPAT]  : DWORD; VAR lpType [NIL_COMPAT]  : DWORD; lpData : LPBYTE; VAR lpcbData [NIL_COMPAT]  : DWORD) : LONG;
    PROCEDURE RegQueryValueExW* (hKey : HKEY; lpValueName : LPCWSTR; VAR lpReserved [NIL_COMPAT]  : DWORD; VAR lpType [NIL_COMPAT]  : DWORD; lpData : LPBYTE; VAR lpcbData [NIL_COMPAT]  : DWORD) : LONG;
    ...
    PROCEDURE RegSaveKeyA* (hKey : HKEY; lpFile : LPCSTR; VAR lpSecurityAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct) : LONG;
    PROCEDURE RegSaveKeyW* (hKey : HKEY; lpFile : LPCWSTR; VAR lpSecurityAttributes [NIL_COMPAT]  : _SECURITY_ATTRIBUTES_struct) : LONG;
    ...
    PROCEDURE WNetAddConnection2A* (VAR lpNetResource [NIL_COMPAT]  : _NETRESOURCEA_struct; lpPassword : LPCSTR; lpUserName : LPCSTR; dwFlags : DWORD) : DWORD;
    PROCEDURE WNetAddConnection2W* (VAR lpNetResource [NIL_COMPAT]  : _NETRESOURCEW_struct; lpPassword : LPCWSTR; lpUserName : LPCWSTR; dwFlags : DWORD) : DWORD;
    PROCEDURE WNetAddConnection3A* (hwndOwner : HWND; VAR lpNetResource [NIL_COMPAT]  : _NETRESOURCEA_struct; lpPassword : LPCSTR; lpUserName : LPCSTR; dwFlags : DWORD) : DWORD;
    PROCEDURE WNetAddConnection3W* (hwndOwner : HWND; VAR lpNetResource [NIL_COMPAT]  : _NETRESOURCEW_struct; lpPassword : LPCWSTR; lpUserName : LPCWSTR; dwFlags : DWORD) : DWORD;
    ...
    PROCEDURE WNetGetConnectionA* (lpLocalName : LPCSTR; lpRemoteName : LPSTR; VAR lpnLength [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE WNetGetConnectionW* (lpLocalName : LPCWSTR; lpRemoteName : LPWSTR; VAR lpnLength [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE WNetUseConnectionA* (hwndOwner : HWND; VAR lpNetResource [NIL_COMPAT]  : _NETRESOURCEA_struct; lpUserID : LPCSTR; lpPassword : LPCSTR; dwFlags : DWORD; lpAccessName : LPSTR; VAR lpBufferSize [NIL_COMPAT]  : DWORD; VAR lpResult [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE WNetUseConnectionW* (hwndOwner : HWND; VAR lpNetResource [NIL_COMPAT]  : _NETRESOURCEW_struct; lpUserID : LPCWSTR; lpPassword : LPCWSTR; dwFlags : DWORD; lpAccessName : LPWSTR; VAR lpBufferSize [NIL_COMPAT]  : DWORD; VAR lpResult [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE WNetConnectionDialog* (hwnd : HWND; dwType : DWORD) : DWORD;
    PROCEDURE WNetDisconnectDialog* (hwnd : HWND; dwType : DWORD) : DWORD;
    PROCEDURE WNetConnectionDialog1A* (VAR lpConnDlgStruct [NIL_COMPAT]  : _CONNECTDLGSTRUCTA_struct) : DWORD;
    PROCEDURE WNetConnectionDialog1W* (VAR lpConnDlgStruct [NIL_COMPAT]  : _CONNECTDLGSTRUCTW_struct) : DWORD;
    PROCEDURE WNetDisconnectDialog1A* (VAR lpConnDlgStruct [NIL_COMPAT]  : _DISCDLGSTRUCTA_struct) : DWORD;
    PROCEDURE WNetDisconnectDialog1W* (VAR lpConnDlgStruct [NIL_COMPAT]  : _DISCDLGSTRUCTW_struct) : DWORD;
    PROCEDURE WNetOpenEnumA* (dwScope : DWORD; dwType : DWORD; dwUsage : DWORD; VAR lpNetResource [NIL_COMPAT]  : _NETRESOURCEA_struct; VAR lphEnum [NIL_COMPAT]  : HANDLE) : DWORD;
    PROCEDURE WNetOpenEnumW* (dwScope : DWORD; dwType : DWORD; dwUsage : DWORD; VAR lpNetResource [NIL_COMPAT]  : _NETRESOURCEW_struct; VAR lphEnum [NIL_COMPAT]  : HANDLE) : DWORD;
    PROCEDURE WNetEnumResourceA* (hEnum : HANDLE; VAR lpcCount [NIL_COMPAT]  : DWORD; lpBuffer : LPVOID; VAR lpBufferSize [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE WNetEnumResourceW* (hEnum : HANDLE; VAR lpcCount [NIL_COMPAT]  : DWORD; lpBuffer : LPVOID; VAR lpBufferSize [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE WNetCloseEnum* (hEnum : HANDLE) : DWORD;
    PROCEDURE WNetGetUniversalNameA* (lpLocalPath : LPCSTR; dwInfoLevel : DWORD; lpBuffer : LPVOID; VAR lpBufferSize [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE WNetGetUniversalNameW* (lpLocalPath : LPCWSTR; dwInfoLevel : DWORD; lpBuffer : LPVOID; VAR lpBufferSize [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE WNetGetUserA* (lpName : LPCSTR; lpUserName : LPSTR; VAR lpnLength [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE WNetGetUserW* (lpName : LPCWSTR; lpUserName : LPWSTR; VAR lpnLength [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE WNetGetProviderNameA* (dwNetType : DWORD; lpProviderName : LPSTR; VAR lpBufferSize [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE WNetGetProviderNameW* (dwNetType : DWORD; lpProviderName : LPWSTR; VAR lpBufferSize [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE WNetGetNetworkInformationA* (lpProvider : LPCSTR; VAR lpNetInfoStruct [NIL_COMPAT]  : _NETINFOSTRUCT_struct) : DWORD;
    PROCEDURE WNetGetNetworkInformationW* (lpProvider : LPCWSTR; VAR lpNetInfoStruct [NIL_COMPAT]  : _NETINFOSTRUCT_struct) : DWORD;
    PROCEDURE WNetGetLastErrorA* (VAR lpError [NIL_COMPAT]  : DWORD; lpErrorBuf : LPSTR; nErrorBufSize : DWORD; lpNameBuf : LPSTR; nNameBufSize : DWORD) : DWORD;
    PROCEDURE WNetGetLastErrorW* (VAR lpError [NIL_COMPAT]  : DWORD; lpErrorBuf : LPWSTR; nErrorBufSize : DWORD; lpNameBuf : LPWSTR; nNameBufSize : DWORD) : DWORD;
    PROCEDURE MultinetGetConnectionPerformanceA* (VAR lpNetResource [NIL_COMPAT]  : _NETRESOURCEA_struct; VAR lpNetConnectInfoStruct [NIL_COMPAT]  : _NETCONNECTINFOSTRUCT_struct) : DWORD;
    PROCEDURE MultinetGetConnectionPerformanceW* (VAR lpNetResource [NIL_COMPAT]  : _NETRESOURCEW_struct; VAR lpNetConnectInfoStruct [NIL_COMPAT]  : _NETCONNECTINFOSTRUCT_struct) : DWORD;
    PROCEDURE ChangeServiceConfigA* (hService : SC_HANDLE; dwServiceType : DWORD; dwStartType : DWORD; dwErrorControl : DWORD; lpBinaryPathName : LPCSTR; lpLoadOrderGroup : LPCSTR; VAR lpdwTagId [NIL_COMPAT]  : DWORD; lpDependencies : LPCSTR; lpServiceStartName : LPCSTR; lpPassword : LPCSTR; lpDisplayName : LPCSTR) : BOOL;
    PROCEDURE ChangeServiceConfigW* (hService : SC_HANDLE; dwServiceType : DWORD; dwStartType : DWORD; dwErrorControl : DWORD; lpBinaryPathName : LPCWSTR; lpLoadOrderGroup : LPCWSTR; VAR lpdwTagId [NIL_COMPAT]  : DWORD; lpDependencies : LPCWSTR; lpServiceStartName : LPCWSTR; lpPassword : LPCWSTR; lpDisplayName : LPCWSTR) : BOOL;
    ...
    PROCEDURE ControlService* (hService : SC_HANDLE; dwControl : DWORD; VAR lpServiceStatus [NIL_COMPAT]  : _SERVICE_STATUS_struct) : BOOL;
    PROCEDURE CreateServiceA* (hSCManager : SC_HANDLE; lpServiceName : LPCSTR; lpDisplayName : LPCSTR; dwDesiredAccess : DWORD; dwServiceType : DWORD; dwStartType : DWORD; dwErrorControl : DWORD; lpBinaryPathName : LPCSTR; lpLoadOrderGroup : LPCSTR; VAR lpdwTagId [NIL_COMPAT]  : DWORD; lpDependencies : LPCSTR; lpServiceStartName : LPCSTR; lpPassword : LPCSTR) : SC_HANDLE;
    PROCEDURE CreateServiceW* (hSCManager : SC_HANDLE; lpServiceName : LPCWSTR; lpDisplayName : LPCWSTR; dwDesiredAccess : DWORD; dwServiceType : DWORD; dwStartType : DWORD; dwErrorControl : DWORD; lpBinaryPathName : LPCWSTR; lpLoadOrderGroup : LPCWSTR; VAR lpdwTagId [NIL_COMPAT]  : DWORD; lpDependencies : LPCWSTR; lpServiceStartName : LPCWSTR; lpPassword : LPCWSTR) : SC_HANDLE;
    PROCEDURE DeleteService* (hService : SC_HANDLE) : BOOL;
    PROCEDURE EnumDependentServicesA* (hService : SC_HANDLE; dwServiceState : DWORD; VAR lpServices [NIL_COMPAT]  : _ENUM_SERVICE_STATUSA_struct; cbBufSize : DWORD; VAR pcbBytesNeeded [NIL_COMPAT]  : DWORD; VAR lpServicesReturned [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE EnumDependentServicesW* (hService : SC_HANDLE; dwServiceState : DWORD; VAR lpServices [NIL_COMPAT]  : _ENUM_SERVICE_STATUSW_struct; cbBufSize : DWORD; VAR pcbBytesNeeded [NIL_COMPAT]  : DWORD; VAR lpServicesReturned [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE EnumServicesStatusA* (hSCManager : SC_HANDLE; dwServiceType : DWORD; dwServiceState : DWORD; VAR lpServices [NIL_COMPAT]  : _ENUM_SERVICE_STATUSA_struct; cbBufSize : DWORD; VAR pcbBytesNeeded [NIL_COMPAT]  : DWORD; VAR lpServicesReturned [NIL_COMPAT]  : DWORD; VAR lpResumeHandle [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE EnumServicesStatusW* (hSCManager : SC_HANDLE; dwServiceType : DWORD; dwServiceState : DWORD; VAR lpServices [NIL_COMPAT]  : _ENUM_SERVICE_STATUSW_struct; cbBufSize : DWORD; VAR pcbBytesNeeded [NIL_COMPAT]  : DWORD; VAR lpServicesReturned [NIL_COMPAT]  : DWORD; VAR lpResumeHandle [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetServiceKeyNameA* (hSCManager : SC_HANDLE; lpDisplayName : LPCSTR; lpServiceName : LPSTR; VAR lpcchBuffer [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetServiceKeyNameW* (hSCManager : SC_HANDLE; lpDisplayName : LPCWSTR; lpServiceName : LPWSTR; VAR lpcchBuffer [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetServiceDisplayNameA* (hSCManager : SC_HANDLE; lpServiceName : LPCSTR; lpDisplayName : LPSTR; VAR lpcchBuffer [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE GetServiceDisplayNameW* (hSCManager : SC_HANDLE; lpServiceName : LPCWSTR; lpDisplayName : LPWSTR; VAR lpcchBuffer [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE QueryServiceConfigA* (hService : SC_HANDLE; VAR lpServiceConfig [NIL_COMPAT]  : _QUERY_SERVICE_CONFIGA_struct; cbBufSize : DWORD; VAR pcbBytesNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE QueryServiceConfigW* (hService : SC_HANDLE; VAR lpServiceConfig [NIL_COMPAT]  : _QUERY_SERVICE_CONFIGW_struct; cbBufSize : DWORD; VAR pcbBytesNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE QueryServiceConfig2A* (hService : SC_HANDLE; dwInfoLevel : DWORD; lpBuffer : LPBYTE; cbBufSize : DWORD; VAR pcbBytesNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE QueryServiceConfig2W* (hService : SC_HANDLE; dwInfoLevel : DWORD; lpBuffer : LPBYTE; cbBufSize : DWORD; VAR pcbBytesNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE QueryServiceLockStatusA* (hSCManager : SC_HANDLE; VAR lpLockStatus [NIL_COMPAT]  : _QUERY_SERVICE_LOCK_STATUSA_struct; cbBufSize : DWORD; VAR pcbBytesNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE QueryServiceLockStatusW* (hSCManager : SC_HANDLE; VAR lpLockStatus [NIL_COMPAT]  : _QUERY_SERVICE_LOCK_STATUSW_struct; cbBufSize : DWORD; VAR pcbBytesNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE QueryServiceObjectSecurity* (hService : SC_HANDLE; dwSecurityInformation : SECURITY_INFORMATION; lpSecurityDescriptor : PSECURITY_DESCRIPTOR; cbBufSize : DWORD; VAR pcbBytesNeeded [NIL_COMPAT]  : DWORD) : BOOL;
    PROCEDURE QueryServiceStatus* (hService : SC_HANDLE; VAR lpServiceStatus [NIL_COMPAT]  : _SERVICE_STATUS_struct) : BOOL;
    ...
    PROCEDURE SetServiceStatus* (hServiceStatus : SERVICE_STATUS_HANDLE; VAR lpServiceStatus [NIL_COMPAT]  : _SERVICE_STATUS_struct) : BOOL;
    PROCEDURE StartServiceCtrlDispatcherA* (VAR lpServiceStartTable [NIL_COMPAT]  : SERVICE_TABLE_ENTRYA) : BOOL;
    PROCEDURE StartServiceCtrlDispatcherW* (VAR lpServiceStartTable [NIL_COMPAT]  : SERVICE_TABLE_ENTRYW) : BOOL;
    PROCEDURE StartServiceA* (hService : SC_HANDLE; dwNumServiceArgs : DWORD; VAR lpServiceArgVectors [NIL_COMPAT]  : LPCSTR) : BOOL;
    PROCEDURE StartServiceW* (hService : SC_HANDLE; dwNumServiceArgs : DWORD; VAR lpServiceArgVectors [NIL_COMPAT]  : LPCWSTR) : BOOL;
    ...
    PROCEDURE ImmGetCandidateListCountA* (p0 : HIMC; VAR lpdwListCount [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE ImmGetCandidateListCountW* (p0 : HIMC; VAR lpdwListCount [NIL_COMPAT]  : DWORD) : DWORD;
    PROCEDURE ImmGetCandidateListA* (p0 : HIMC; deIndex : DWORD; VAR p2 [NIL_COMPAT]  : tagCANDIDATELIST_struct; dwBufLen : DWORD) : DWORD;
    PROCEDURE ImmGetCandidateListW* (p0 : HIMC; deIndex : DWORD; VAR p2 [NIL_COMPAT]  : tagCANDIDATELIST_struct; dwBufLen : DWORD) : DWORD;
    ...
    PROCEDURE ImmGetConversionStatus* (p0 : HIMC; VAR p1 [NIL_COMPAT]  : DWORD; VAR p2 [NIL_COMPAT]  : DWORD) : BOOL;
    ...
    PROCEDURE ImmGetCompositionFontA* (p0 : HIMC; VAR p1 [NIL_COMPAT]  : tagLOGFONTA_struct) : BOOL;
    PROCEDURE ImmGetCompositionFontW* (p0 : HIMC; VAR p1 [NIL_COMPAT]  : tagLOGFONTW_struct) : BOOL;
    PROCEDURE ImmSetCompositionFontA* (p0 : HIMC; VAR p1 [NIL_COMPAT]  : tagLOGFONTA_struct) : BOOL;
    PROCEDURE ImmSetCompositionFontW* (p0 : HIMC; VAR p1 [NIL_COMPAT]  : tagLOGFONTW_struct) : BOOL;
    ...
    PROCEDURE ImmGetConversionListA* (p0 : HKL; p1 : HIMC; p2 : LPCSTR; VAR p3 [NIL_COMPAT]  : tagCANDIDATELIST_struct; dwBufLen : DWORD; uFlag : UINT) : DWORD;
    PROCEDURE ImmGetConversionListW* (p0 : HKL; p1 : HIMC; p2 : LPCWSTR; VAR p3 [NIL_COMPAT]  : tagCANDIDATELIST_struct; dwBufLen : DWORD; uFlag : UINT) : DWORD;
    PROCEDURE ImmNotifyIME* (p0 : HIMC; dwAction : DWORD; dwIndex : DWORD; dwValue : DWORD) : BOOL;
    PROCEDURE ImmGetStatusWindowPos* (p0 : HIMC; VAR p1 [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE ImmSetStatusWindowPos* (p0 : HIMC; VAR p1 [NIL_COMPAT]  : tagPOINT_struct) : BOOL;
    PROCEDURE ImmGetCompositionWindow* (p0 : HIMC; VAR p1 [NIL_COMPAT]  : tagCOMPOSITIONFORM_struct) : BOOL;
    PROCEDURE ImmSetCompositionWindow* (p0 : HIMC; VAR p1 [NIL_COMPAT]  : tagCOMPOSITIONFORM_struct) : BOOL;
    PROCEDURE ImmGetCandidateWindow* (p0 : HIMC; p1 : DWORD; VAR p2 [NIL_COMPAT]  : tagCANDIDATEFORM_struct) : BOOL;
    PROCEDURE ImmSetCandidateWindow* (p0 : HIMC; VAR p1 [NIL_COMPAT]  : tagCANDIDATEFORM_struct) : BOOL;
    ...
    PROCEDURE ImmGetRegisterWordStyleA* (p0 : HKL; nItem : UINT; VAR p2 [NIL_COMPAT]  : tagSTYLEBUFA_struct) : UINT;
    PROCEDURE ImmGetRegisterWordStyleW* (p0 : HKL; nItem : UINT; VAR p2 [NIL_COMPAT]  : tagSTYLEBUFW_struct) : UINT;
    ...
    PROCEDURE waveOutGetDevCapsA* (uDeviceID : UINT; VAR pwoc [NIL_COMPAT]  : tagWAVEOUTCAPSA_struct; cbwoc : UINT) : MMRESULT;
    PROCEDURE waveOutGetDevCapsW* (uDeviceID : UINT; VAR pwoc [NIL_COMPAT]  : tagWAVEOUTCAPSW_struct; cbwoc : UINT) : MMRESULT;
    PROCEDURE waveOutGetVolume* (hwo : HWAVEOUT; VAR pdwVolume [NIL_COMPAT]  : DWORD) : MMRESULT;
    ...
    PROCEDURE waveOutOpen* (VAR phwo [NIL_COMPAT]  : HWAVEOUT; uDeviceID : UINT; VAR pwfx [NIL_COMPAT]  : WAVEFORMATEX; dwCallback : DWORD; dwInstance : DWORD; fdwOpen : DWORD) : MMRESULT;
    PROCEDURE waveOutClose* (hwo : HWAVEOUT) : MMRESULT;
    PROCEDURE waveOutPrepareHeader* (hwo : HWAVEOUT; VAR pwh [NIL_COMPAT]  : wavehdr_tag_struct; cbwh : UINT) : MMRESULT;
    PROCEDURE waveOutUnprepareHeader* (hwo : HWAVEOUT; VAR pwh [NIL_COMPAT]  : wavehdr_tag_struct; cbwh : UINT) : MMRESULT;
    PROCEDURE waveOutWrite* (hwo : HWAVEOUT; VAR pwh [NIL_COMPAT]  : wavehdr_tag_struct; cbwh : UINT) : MMRESULT;
    ...
    PROCEDURE waveOutGetPosition* (hwo : HWAVEOUT; VAR pmmt [NIL_COMPAT]  : mmtime_tag_struct; cbmmt : UINT) : MMRESULT;
    PROCEDURE waveOutGetPitch* (hwo : HWAVEOUT; VAR pdwPitch [NIL_COMPAT]  : DWORD) : MMRESULT;
    PROCEDURE waveOutSetPitch* (hwo : HWAVEOUT; dwPitch : DWORD) : MMRESULT;
    PROCEDURE waveOutGetPlaybackRate* (hwo : HWAVEOUT; VAR pdwRate [NIL_COMPAT]  : DWORD) : MMRESULT;
    PROCEDURE waveOutSetPlaybackRate* (hwo : HWAVEOUT; dwRate : DWORD) : MMRESULT;
    PROCEDURE waveOutGetID* (hwo : HWAVEOUT; VAR puDeviceID [NIL_COMPAT]  : UINT) : MMRESULT;
    PROCEDURE waveOutMessage* (hwo : HWAVEOUT; uMsg : UINT; dw1 : DWORD; dw2 : DWORD) : MMRESULT;
    PROCEDURE waveInGetNumDevs* () : UINT;
    PROCEDURE waveInGetDevCapsA* (uDeviceID : UINT; VAR pwic [NIL_COMPAT]  : tagWAVEINCAPSA_struct; cbwic : UINT) : MMRESULT;
    PROCEDURE waveInGetDevCapsW* (uDeviceID : UINT; VAR pwic [NIL_COMPAT]  : tagWAVEINCAPSW_struct; cbwic : UINT) : MMRESULT;
    ...
    PROCEDURE waveInOpen* (VAR phwi [NIL_COMPAT]  : HWAVEIN; uDeviceID : UINT; VAR pwfx [NIL_COMPAT]  : WAVEFORMATEX; dwCallback : DWORD; dwInstance : DWORD; fdwOpen : DWORD) : MMRESULT;
    PROCEDURE waveInClose* (hwi : HWAVEIN) : MMRESULT;
    PROCEDURE waveInPrepareHeader* (hwi : HWAVEIN; VAR pwh [NIL_COMPAT]  : wavehdr_tag_struct; cbwh : UINT) : MMRESULT;
    PROCEDURE waveInUnprepareHeader* (hwi : HWAVEIN; VAR pwh [NIL_COMPAT]  : wavehdr_tag_struct; cbwh : UINT) : MMRESULT;
    PROCEDURE waveInAddBuffer* (hwi : HWAVEIN; VAR pwh [NIL_COMPAT]  : wavehdr_tag_struct; cbwh : UINT) : MMRESULT;
    ...
    PROCEDURE waveInGetPosition* (hwi : HWAVEIN; VAR pmmt [NIL_COMPAT]  : mmtime_tag_struct; cbmmt : UINT) : MMRESULT;
    PROCEDURE waveInGetID* (hwi : HWAVEIN; VAR puDeviceID [NIL_COMPAT]  : UINT) : MMRESULT;
    PROCEDURE waveInMessage* (hwi : HWAVEIN; uMsg : UINT; dw1 : DWORD; dw2 : DWORD) : MMRESULT;
    PROCEDURE midiOutGetNumDevs* () : UINT;
    PROCEDURE midiStreamOpen* (VAR phms [NIL_COMPAT]  : HMIDISTRM; VAR puDeviceID [NIL_COMPAT]  : UINT; cMidi : DWORD; dwCallback : DWORD; dwInstance : DWORD; fdwOpen : DWORD) : MMRESULT;
    ...
    PROCEDURE midiStreamPosition* (hms : HMIDISTRM; VAR lpmmt [NIL_COMPAT]  : mmtime_tag_struct; cbmmt : UINT) : MMRESULT;
    PROCEDURE midiStreamOut* (hms : HMIDISTRM; VAR pmh [NIL_COMPAT]  : midihdr_tag_struct; cbmh : UINT) : MMRESULT;
    ...
    PROCEDURE midiOutGetDevCapsA* (uDeviceID : UINT; VAR pmoc [NIL_COMPAT]  : tagMIDIOUTCAPSA_struct; cbmoc : UINT) : MMRESULT;
    PROCEDURE midiOutGetDevCapsW* (uDeviceID : UINT; VAR pmoc [NIL_COMPAT]  : tagMIDIOUTCAPSW_struct; cbmoc : UINT) : MMRESULT;
    PROCEDURE midiOutGetVolume* (hmo : HMIDIOUT; VAR pdwVolume [NIL_COMPAT]  : DWORD) : MMRESULT;
    ...
    PROCEDURE midiOutOpen* (VAR phmo [NIL_COMPAT]  : HMIDIOUT; uDeviceID : UINT; dwCallback : DWORD; dwInstance : DWORD; fdwOpen : DWORD) : MMRESULT;
    PROCEDURE midiOutClose* (hmo : HMIDIOUT) : MMRESULT;
    PROCEDURE midiOutPrepareHeader* (hmo : HMIDIOUT; VAR pmh [NIL_COMPAT]  : midihdr_tag_struct; cbmh : UINT) : MMRESULT;
    PROCEDURE midiOutUnprepareHeader* (hmo : HMIDIOUT; VAR pmh [NIL_COMPAT]  : midihdr_tag_struct; cbmh : UINT) : MMRESULT;
    PROCEDURE midiOutShortMsg* (hmo : HMIDIOUT; dwMsg : DWORD) : MMRESULT;
    PROCEDURE midiOutLongMsg* (hmo : HMIDIOUT; VAR pmh [NIL_COMPAT]  : midihdr_tag_struct; cbmh : UINT) : MMRESULT;
    PROCEDURE midiOutReset* (hmo : HMIDIOUT) : MMRESULT;
    PROCEDURE midiOutCachePatches* (hmo : HMIDIOUT; uBank : UINT; VAR pwpa [NIL_COMPAT]  : WORD; fuCache : UINT) : MMRESULT;
    PROCEDURE midiOutCacheDrumPatches* (hmo : HMIDIOUT; uPatch : UINT; VAR pwkya [NIL_COMPAT]  : WORD; fuCache : UINT) : MMRESULT;
    PROCEDURE midiOutGetID* (hmo : HMIDIOUT; VAR puDeviceID [NIL_COMPAT]  : UINT) : MMRESULT;
    PROCEDURE midiOutMessage* (hmo : HMIDIOUT; uMsg : UINT; dw1 : DWORD; dw2 : DWORD) : MMRESULT;
    PROCEDURE midiInGetNumDevs* () : UINT;
    PROCEDURE midiInGetDevCapsA* (uDeviceID : UINT; VAR pmic [NIL_COMPAT]  : tagMIDIINCAPSA_struct; cbmic : UINT) : MMRESULT;
    PROCEDURE midiInGetDevCapsW* (uDeviceID : UINT; VAR pmic [NIL_COMPAT]  : tagMIDIINCAPSW_struct; cbmic : UINT) : MMRESULT;
    ...
    PROCEDURE midiInOpen* (VAR phmi [NIL_COMPAT]  : HMIDIIN; uDeviceID : UINT; dwCallback : DWORD; dwInstance : DWORD; fdwOpen : DWORD) : MMRESULT;
    PROCEDURE midiInClose* (hmi : HMIDIIN) : MMRESULT;
    PROCEDURE midiInPrepareHeader* (hmi : HMIDIIN; VAR pmh [NIL_COMPAT]  : midihdr_tag_struct; cbmh : UINT) : MMRESULT;
    PROCEDURE midiInUnprepareHeader* (hmi : HMIDIIN; VAR pmh [NIL_COMPAT]  : midihdr_tag_struct; cbmh : UINT) : MMRESULT;
    PROCEDURE midiInAddBuffer* (hmi : HMIDIIN; VAR pmh [NIL_COMPAT]  : midihdr_tag_struct; cbmh : UINT) : MMRESULT;
    ...
    PROCEDURE midiInGetID* (hmi : HMIDIIN; VAR puDeviceID [NIL_COMPAT]  : UINT) : MMRESULT;
    PROCEDURE midiInMessage* (hmi : HMIDIIN; uMsg : UINT; dw1 : DWORD; dw2 : DWORD) : MMRESULT;
    PROCEDURE auxGetNumDevs* () : UINT;
    PROCEDURE auxGetDevCapsA* (uDeviceID : UINT; VAR pac [NIL_COMPAT]  : tagAUXCAPSA_struct; cbac : UINT) : MMRESULT;
    PROCEDURE auxGetDevCapsW* (uDeviceID : UINT; VAR pac [NIL_COMPAT]  : tagAUXCAPSW_struct; cbac : UINT) : MMRESULT;
    PROCEDURE auxSetVolume* (uDeviceID : UINT; dwVolume : DWORD) : MMRESULT;
    PROCEDURE auxGetVolume* (uDeviceID : UINT; VAR pdwVolume [NIL_COMPAT]  : DWORD) : MMRESULT;
    PROCEDURE auxOutMessage* (uDeviceID : UINT; uMsg : UINT; dw1 : DWORD; dw2 : DWORD) : MMRESULT;
    PROCEDURE mixerGetNumDevs* () : UINT;
    PROCEDURE mixerGetDevCapsA* (uMxId : UINT; VAR pmxcaps [NIL_COMPAT]  : tagMIXERCAPSA_struct; cbmxcaps : UINT) : MMRESULT;
    PROCEDURE mixerGetDevCapsW* (uMxId : UINT; VAR pmxcaps [NIL_COMPAT]  : tagMIXERCAPSW_struct; cbmxcaps : UINT) : MMRESULT;
    PROCEDURE mixerOpen* (VAR phmx [NIL_COMPAT]  : HMIXER; uMxId : UINT; dwCallback : DWORD; dwInstance : DWORD; fdwOpen : DWORD) : MMRESULT;
    PROCEDURE mixerClose* (hmx : HMIXER) : MMRESULT;
    PROCEDURE mixerMessage* (hmx : HMIXER; uMsg : UINT; dwParam1 : DWORD; dwParam2 : DWORD) : DWORD;
    PROCEDURE mixerGetLineInfoA* (hmxobj : HMIXEROBJ; VAR pmxl [NIL_COMPAT]  : tagMIXERLINEA_struct; fdwInfo : DWORD) : MMRESULT;
    PROCEDURE mixerGetLineInfoW* (hmxobj : HMIXEROBJ; VAR pmxl [NIL_COMPAT]  : tagMIXERLINEW_struct; fdwInfo : DWORD) : MMRESULT;
    PROCEDURE mixerGetID* (hmxobj : HMIXEROBJ; VAR puMxId [NIL_COMPAT]  : UINT; fdwId : DWORD) : MMRESULT;
    PROCEDURE mixerGetLineControlsA* (hmxobj : HMIXEROBJ; VAR pmxlc [NIL_COMPAT]  : tagMIXERLINECONTROLSA_struct; fdwControls : DWORD) : MMRESULT;
    PROCEDURE mixerGetLineControlsW* (hmxobj : HMIXEROBJ; VAR pmxlc [NIL_COMPAT]  : tagMIXERLINECONTROLSW_struct; fdwControls : DWORD) : MMRESULT;
    PROCEDURE mixerGetControlDetailsA* (hmxobj : HMIXEROBJ; VAR pmxcd [NIL_COMPAT]  : tMIXERCONTROLDETAILS_struct; fdwDetails : DWORD) : MMRESULT;
    PROCEDURE mixerGetControlDetailsW* (hmxobj : HMIXEROBJ; VAR pmxcd [NIL_COMPAT]  : tMIXERCONTROLDETAILS_struct; fdwDetails : DWORD) : MMRESULT;
    PROCEDURE mixerSetControlDetails* (hmxobj : HMIXEROBJ; VAR pmxcd [NIL_COMPAT]  : tMIXERCONTROLDETAILS_struct; fdwDetails : DWORD) : MMRESULT;
    PROCEDURE timeGetSystemTime* (VAR pmmt [NIL_COMPAT]  : mmtime_tag_struct; cbmmt : UINT) : MMRESULT;
    ...
    PROCEDURE timeGetDevCaps* (VAR ptc [NIL_COMPAT]  : timecaps_tag_struct; cbtc : UINT) : MMRESULT;
    PROCEDURE timeBeginPeriod* (uPeriod : UINT) : MMRESULT;
    PROCEDURE timeEndPeriod* (uPeriod : UINT) : MMRESULT;
    PROCEDURE joyGetNumDevs* () : UINT;
    PROCEDURE joyGetDevCapsA* (uJoyID : UINT; VAR pjc [NIL_COMPAT]  : tagJOYCAPSA_struct; cbjc : UINT) : MMRESULT;
    PROCEDURE joyGetDevCapsW* (uJoyID : UINT; VAR pjc [NIL_COMPAT]  : tagJOYCAPSW_struct; cbjc : UINT) : MMRESULT;
    PROCEDURE joyGetPos* (uJoyID : UINT; VAR pji [NIL_COMPAT]  : joyinfo_tag_struct) : MMRESULT;
    PROCEDURE joyGetPosEx* (uJoyID : UINT; VAR pji [NIL_COMPAT]  : joyinfoex_tag_struct) : MMRESULT;
    PROCEDURE joyGetThreshold* (uJoyID : UINT; VAR puThreshold [NIL_COMPAT]  : UINT) : MMRESULT;
    ...
    PROCEDURE mmioOpenA* (pszFileName : LPSTR; VAR pmmioinfo [NIL_COMPAT]  : _MMIOINFO_struct; fdwOpen : DWORD) : HMMIO;
    PROCEDURE mmioOpenW* (pszFileName : LPWSTR; VAR pmmioinfo [NIL_COMPAT]  : _MMIOINFO_struct; fdwOpen : DWORD) : HMMIO;
    PROCEDURE mmioRenameA* (pszFileName : LPCSTR; pszNewFileName : LPCSTR; VAR pmmioinfo [NIL_COMPAT]  : MMIOINFO; fdwRename : DWORD) : MMRESULT;
    PROCEDURE mmioRenameW* (pszFileName : LPCWSTR; pszNewFileName : LPCWSTR; VAR pmmioinfo [NIL_COMPAT]  : MMIOINFO; fdwRename : DWORD) : MMRESULT;
    ...
    PROCEDURE mmioGetInfo* (hmmio : HMMIO; VAR pmmioinfo [NIL_COMPAT]  : _MMIOINFO_struct; fuInfo : UINT) : MMRESULT;
    PROCEDURE mmioSetInfo* (hmmio : HMMIO; VAR pmmioinfo [NIL_COMPAT]  : MMIOINFO; fuInfo : UINT) : MMRESULT;
    ...
    PROCEDURE mmioAdvance* (hmmio : HMMIO; VAR pmmioinfo [NIL_COMPAT]  : _MMIOINFO_struct; fuAdvance : UINT) : MMRESULT;
    PROCEDURE mmioSendMessage* (hmmio : HMMIO; uMsg : UINT; lParam1 : LPARAM; lParam2 : LPARAM) : LRESULT;
    PROCEDURE mmioDescend* (hmmio : HMMIO; VAR pmmcki [NIL_COMPAT]  : _MMCKINFO_struct; VAR pmmckiParent [NIL_COMPAT]  : MMCKINFO; fuDescend : UINT) : MMRESULT;
    PROCEDURE mmioAscend* (hmmio : HMMIO; VAR pmmcki [NIL_COMPAT]  : _MMCKINFO_struct; fuAscend : UINT) : MMRESULT;
    PROCEDURE mmioCreateChunk* (hmmio : HMMIO; VAR pmmcki [NIL_COMPAT]  : _MMCKINFO_struct; fuCreate : UINT) : MMRESULT;
    ...
    PROCEDURE mciGetYieldProc* (mciId : MCIDEVICEID; VAR pdwYieldData [NIL_COMPAT]  : DWORD) : YIELDPROC;
