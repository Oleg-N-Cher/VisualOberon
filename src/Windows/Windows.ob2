...
TYPE
    ...
    PIMAGE_TLS_CALLBACK* = PROCEDURE [stdcall] (DllHandle : PVOID; Reason : DWORD; Reserved : PVOID);
    ...
    WAITORTIMERCALLBACKFUNC* = PROCEDURE [stdcall] (p0 : PVOID; p1 : BOOLEAN);

    WORKERCALLBACKFUNC* = PROCEDURE [stdcall] (p0 : PVOID);
    ...
    FARPROC* = PROCEDURE [stdcall] () : LONGINT;
    ...
    PTHREAD_START_ROUTINE* = PROCEDURE [stdcall] (lpThreadParameter : LPVOID) : DWORD;
    ...
    PTOP_LEVEL_EXCEPTION_FILTER* = PROCEDURE [stdcall] (VAR [nil] ExceptionInfo : _EXCEPTION_POINTERS_struct) : LONG;
    ...
    PFE_EXPORT_FUNC* = PROCEDURE [stdcall] (pbData : PBYTE; pvCallbackContext : PVOID; ulLength : ULONG) : DWORD;
    ...
    LPOVERLAPPED_COMPLETION_ROUTINE* = PROCEDURE [stdcall] (dwErrorCode : DWORD; dwNumberOfBytesTransfered : DWORD; VAR [nil] lpOverlapped : _OVERLAPPED_struct);
    ...
    PTIMERAPCROUTINE* = PROCEDURE [stdcall] (lpArgToCompletionRoutine : LPVOID; dwTimerLowValue : DWORD; dwTimerHighValue : DWORD);
    ...
    LPPROGRESS_ROUTINE* = PROCEDURE [stdcall] (TotalFileSize : LARGE_INTEGER; TotalBytesTransferred : LARGE_INTEGER; StreamSize : LARGE_INTEGER; StreamBytesTransferred : LARGE_INTEGER; dwStreamNumber : DWORD; dwCallbackReason : DWORD; hSourceFile : HANDLE; hDestinationFile : HANDLE; lpData : LPVOID) : DWORD;
    ...
    LPFNDEVMODE* = PROCEDURE [stdcall] (p0 : HWND; p1 : HMODULE; VAR [nil] p2 : _devicemodeA_struct; p3 : LPSTR; p4 : LPSTR; VAR [nil] p5 : _devicemodeA_struct; p6 : LPSTR; p7 : UINT) : UINT;

    LPFNDEVCAPS* = PROCEDURE [stdcall] (p0 : LPSTR; p1 : LPSTR; p2 : UINT; p3 : LPSTR; VAR [nil] p4 : _devicemodeA_struct) : DWORD;
    ...
    MFENUMPROC* = PROCEDURE [stdcall] (p0 : HDC; VAR [nil] p1 : HANDLETABLE; VAR [nil] p2 : METARECORD; p3 : LONGINT; p4 : LPARAM) : LONGINT;

    AutoPtr_ENHMETARECORD* = POINTER TO ENHMETARECORD;

    ENHMFENUMPROC* = PROCEDURE [stdcall] (p0 : HDC; VAR [nil] p1 : HANDLETABLE; VAR [nil] p2 : ENHMETARECORD; p3 : LONGINT; p4 : LPARAM) : LONGINT;
    ...
    ICMENUMPROCA* = PROCEDURE [stdcall] (p0 : LPSTR; p1 : LPARAM) : LONGINT;

    ICMENUMPROCW* = PROCEDURE [stdcall] (p0 : LPWSTR; p1 : LPARAM) : LONGINT;
    ...
    WNDPROC* = PROCEDURE [stdcall] (p0 : HWND; p1 : UINT; p2 : WPARAM; p3 : LPARAM) : LRESULT;
    ...
    PHANDLER_ROUTINE* = PROCEDURE [stdcall] (CtrlType : DWORD) : BOOL;
    ...
    PQUERYHANDLER* = PROCEDURE [stdcall] (keycontext : LPVOID; VAR [nil] val_list : val_context_struct; num_vals : DWORD; outputbuffer : LPVOID; VAR [nil] total_outlen : DWORD; input_blen : DWORD) : DWORD;
    ...
    PFNGETPROFILEPATHA* = PROCEDURE [stdcall] (pszUsername : LPCSTR; pszBuffer : LPSTR; cbBuffer : UINT) : UINT;

    PFNGETPROFILEPATHW* = PROCEDURE [stdcall] (pszUsername : LPCWSTR; pszBuffer : LPWSTR; cbBuffer : UINT) : UINT;

    PFNRECONCILEPROFILEA* = PROCEDURE [stdcall] (pszCentralFile : LPCSTR; pszLocalFile : LPCSTR; dwFlags : DWORD) : UINT;

    PFNRECONCILEPROFILEW* = PROCEDURE [stdcall] (pszCentralFile : LPCWSTR; pszLocalFile : LPCWSTR; dwFlags : DWORD) : UINT;

    PFNPROCESSPOLICIESA* = PROCEDURE [stdcall] (hwnd : HWND; pszPath : LPCSTR; pszUsername : LPCSTR; pszComputerName : LPCSTR; dwFlags : DWORD) : BOOL;

    PFNPROCESSPOLICIESW* = PROCEDURE [stdcall] (hwnd : HWND; pszPath : LPCWSTR; pszUsername : LPCWSTR; pszComputerName : LPCWSTR; dwFlags : DWORD) : BOOL;
    ...
    LPSERVICE_MAIN_FUNCTIONW* = PROCEDURE [stdcall] (dwNumServicesArgs : DWORD; VAR [nil] lpServiceArgVectors : LPWSTR);
    ...
    REGISTERWORDENUMPROCA* = PROCEDURE [stdcall] (p0 : LPCSTR; p1 : DWORD; p2 : LPCSTR; p3 : LPVOID) : LONGINT;

    REGISTERWORDENUMPROCW* = PROCEDURE [stdcall] (p0 : LPCWSTR; p1 : DWORD; p2 : LPCWSTR; p3 : LPVOID) : LONGINT;
    ...
    DRIVERPROC* = PROCEDURE [stdcall] (p0 : DWORD; p1 : HDRVR; p2 : UINT; p3 : LPARAM; p4 : LPARAM) : LRESULT;

    LPDRVCALLBACK* = PROCEDURE [stdcall] (hdrvr : HDRVR; uMsg : UINT; dwUser : DWORD; dw1 : DWORD; dw2 : DWORD);
    ...
    LPWAVECALLBACK* = PROCEDURE [stdcall] (hdrvr : HDRVR; uMsg : UINT; dwUser : DWORD; dw1 : DWORD; dw2 : DWORD);
    ...
    LPMIDICALLBACK* = PROCEDURE [stdcall] (hdrvr : HDRVR; uMsg : UINT; dwUser : DWORD; dw1 : DWORD; dw2 : DWORD);
    ...
    LPTIMECALLBACK* = PROCEDURE [stdcall] (uTimerID : UINT; uMsg : UINT; dwUser : DWORD; dw1 : DWORD; dw2 : DWORD);
    ...
    LPMMIOPROC* = PROCEDURE [stdcall] (lpmmioinfo : LPSTR; uMsg : UINT; lParam1 : LPARAM; lParam2 : LPARAM) : LRESULT;
    ...
    YIELDPROC* = PROCEDURE [stdcall] (mciId : MCIDEVICEID; dwYieldData : DWORD) : UINT;
    ...
    PROCEDURE [stdcall] NtCurrentTeb* () : AutoPtr__TEB;
    PROCEDURE [stdcall] GetFiberData* () : PVOID;
    PROCEDURE [stdcall] GetCurrentFiber* () : PVOID;
    PROCEDURE [stdcall] RtlCompareMemory* (Source1 : LPVOID; Source2 : LPVOID; Length : SIZE_T) : SIZE_T;
    PROCEDURE [stdcall] InterlockedIncrement* (VAR [nil] lpAddend : LONGINT) : LONG;
    PROCEDURE [stdcall] InterlockedDecrement* (VAR [nil] lpAddend : LONGINT) : LONG;
    PROCEDURE [stdcall] InterlockedExchange* (VAR [nil] Target : LONGINT; Value : LONG) : LONG;
    PROCEDURE [stdcall] InterlockedExchangeAdd* (VAR [nil] Addend : LONGINT; Value : LONG) : LONG;
    PROCEDURE [stdcall] InterlockedCompareExchange* (VAR [nil] Destination : PVOID; Exchange : PVOID; Comperand : PVOID) : PVOID;
    PROCEDURE [stdcall] FreeResource* (hResData : HGLOBAL) : BOOL;
    PROCEDURE [stdcall] LockResource* (hResData : HGLOBAL) : LPVOID;
    PROCEDURE [stdcall] WinMain* (hInstance : HINSTANCE; hPrevInstance : HINSTANCE; lpCmdLine : LPSTR; nShowCmd : LONGINT) : LONGINT;
    PROCEDURE [stdcall] FreeLibrary* (hLibModule : HMODULE) : BOOL;
    PROCEDURE [stdcall] FreeLibraryAndExitThread* (hLibModule : HMODULE; dwExitCode : DWORD);
    PROCEDURE [stdcall] DisableThreadLibraryCalls* (hLibModule : HMODULE) : BOOL;
    PROCEDURE [stdcall] GetProcAddress* (hModule : HMODULE; lpProcName : LPCSTR) : FARPROC;
    PROCEDURE [stdcall] GetVersion* () : DWORD;
    PROCEDURE [stdcall] GlobalAlloc* (uFlags : UINT; dwBytes : DWORD) : HGLOBAL;
    PROCEDURE [stdcall] GlobalReAlloc* (hMem : HGLOBAL; dwBytes : DWORD; uFlags : UINT) : HGLOBAL;
    PROCEDURE [stdcall] GlobalSize* (hMem : HGLOBAL) : DWORD;
    PROCEDURE [stdcall] GlobalFlags* (hMem : HGLOBAL) : UINT;
    PROCEDURE [stdcall] GlobalLock* (hMem : HGLOBAL) : LPVOID;
    PROCEDURE [stdcall] GlobalHandle* (pMem : LPCVOID) : HGLOBAL;
    PROCEDURE [stdcall] GlobalUnlock* (hMem : HGLOBAL) : BOOL;
    PROCEDURE [stdcall] GlobalFree* (hMem : HGLOBAL) : HGLOBAL;
    PROCEDURE [stdcall] GlobalCompact* (dwMinFree : DWORD) : UINT;
    PROCEDURE [stdcall] GlobalFix* (hMem : HGLOBAL);
    PROCEDURE [stdcall] GlobalUnfix* (hMem : HGLOBAL);
    PROCEDURE [stdcall] GlobalWire* (hMem : HGLOBAL) : LPVOID;
    PROCEDURE [stdcall] GlobalUnWire* (hMem : HGLOBAL) : BOOL;
    PROCEDURE [stdcall] GlobalMemoryStatus* (VAR [nil] lpBuffer : _MEMORYSTATUS_struct);
    PROCEDURE [stdcall] LocalAlloc* (uFlags : UINT; uBytes : UINT) : HLOCAL;
    PROCEDURE [stdcall] LocalReAlloc* (hMem : HLOCAL; uBytes : UINT; uFlags : UINT) : HLOCAL;
    PROCEDURE [stdcall] LocalLock* (hMem : HLOCAL) : LPVOID;
    PROCEDURE [stdcall] LocalHandle* (pMem : LPCVOID) : HLOCAL;
    PROCEDURE [stdcall] LocalUnlock* (hMem : HLOCAL) : BOOL;
    PROCEDURE [stdcall] LocalSize* (hMem : HLOCAL) : UINT;
    PROCEDURE [stdcall] LocalFlags* (hMem : HLOCAL) : UINT;
    PROCEDURE [stdcall] LocalFree* (hMem : HLOCAL) : HLOCAL;
    PROCEDURE [stdcall] LocalShrink* (hMem : HLOCAL; cbNewSize : UINT) : UINT;
    PROCEDURE [stdcall] LocalCompact* (uMinFree : UINT) : UINT;
    PROCEDURE [stdcall] FlushInstructionCache* (hProcess : HANDLE; lpBaseAddress : LPCVOID; dwSize : DWORD) : BOOL;
    PROCEDURE [stdcall] VirtualAlloc* (lpAddress : LPVOID; dwSize : DWORD; flAllocationType : DWORD; flProtect : DWORD) : LPVOID;
    PROCEDURE [stdcall] VirtualFree* (lpAddress : LPVOID; dwSize : DWORD; dwFreeType : DWORD) : BOOL;
    PROCEDURE [stdcall] VirtualProtect* (lpAddress : LPVOID; dwSize : DWORD; flNewProtect : DWORD; VAR [nil] lpflOldProtect : DWORD) : BOOL;
    PROCEDURE [stdcall] VirtualQuery* (lpAddress : LPCVOID; VAR [nil] lpBuffer : _MEMORY_BASIC_INFORMATION_struct; dwLength : DWORD) : DWORD;
    PROCEDURE [stdcall] VirtualAllocEx* (hProcess : HANDLE; lpAddress : LPVOID; dwSize : DWORD; flAllocationType : DWORD; flProtect : DWORD) : LPVOID;
    PROCEDURE [stdcall] VirtualFreeEx* (hProcess : HANDLE; lpAddress : LPVOID; dwSize : DWORD; dwFreeType : DWORD) : BOOL;
    PROCEDURE [stdcall] VirtualProtectEx* (hProcess : HANDLE; lpAddress : LPVOID; dwSize : DWORD; flNewProtect : DWORD; VAR [nil] lpflOldProtect : DWORD) : BOOL;
    PROCEDURE [stdcall] VirtualQueryEx* (hProcess : HANDLE; lpAddress : LPCVOID; VAR [nil] lpBuffer : _MEMORY_BASIC_INFORMATION_struct; dwLength : DWORD) : DWORD;
    PROCEDURE [stdcall] HeapCreate* (flOptions : DWORD; dwInitialSize : DWORD; dwMaximumSize : DWORD) : HANDLE;
    PROCEDURE [stdcall] HeapDestroy* (hHeap : HANDLE) : BOOL;
    PROCEDURE [stdcall] HeapAlloc* (hHeap : HANDLE; dwFlags : DWORD; dwBytes : DWORD) : LPVOID;
    PROCEDURE [stdcall] HeapReAlloc* (hHeap : HANDLE; dwFlags : DWORD; lpMem : LPVOID; dwBytes : DWORD) : LPVOID;
    PROCEDURE [stdcall] HeapFree* (hHeap : HANDLE; dwFlags : DWORD; lpMem : LPVOID) : BOOL;
    PROCEDURE [stdcall] HeapSize* (hHeap : HANDLE; dwFlags : DWORD; lpMem : LPCVOID) : DWORD;
    PROCEDURE [stdcall] HeapValidate* (hHeap : HANDLE; dwFlags : DWORD; lpMem : LPCVOID) : BOOL;
    PROCEDURE [stdcall] HeapCompact* (hHeap : HANDLE; dwFlags : DWORD) : UINT;
    PROCEDURE [stdcall] GetProcessHeap* () : HANDLE;
    PROCEDURE [stdcall] GetProcessHeaps* (NumberOfHeaps : DWORD; VAR [nil] ProcessHeaps : HANDLE) : DWORD;
    PROCEDURE [stdcall] HeapLock* (hHeap : HANDLE) : BOOL;
    PROCEDURE [stdcall] HeapUnlock* (hHeap : HANDLE) : BOOL;
    PROCEDURE [stdcall] HeapWalk* (hHeap : HANDLE; VAR [nil] lpEntry : _PROCESS_HEAP_ENTRY_struct) : BOOL;
    PROCEDURE [stdcall] GetBinaryTypeA* (lpApplicationName : LPCSTR; VAR [nil] lpBinaryType : DWORD) : BOOL;
    PROCEDURE [stdcall] GetBinaryTypeW* (lpApplicationName : LPCWSTR; VAR [nil] lpBinaryType : DWORD) : BOOL;
    PROCEDURE [stdcall] GetShortPathNameA* (lpszLongPath : LPCSTR; lpszShortPath : LPSTR; cchBuffer : DWORD) : DWORD;
    PROCEDURE [stdcall] GetShortPathNameW* (lpszLongPath : LPCWSTR; lpszShortPath : LPWSTR; cchBuffer : DWORD) : DWORD;
    PROCEDURE [stdcall] GetLongPathNameA* (lpszShortPath : LPCSTR; lpszLongPath : LPSTR; cchBuffer : DWORD) : DWORD;
    PROCEDURE [stdcall] GetLongPathNameW* (lpszShortPath : LPCWSTR; lpszLongPath : LPWSTR; cchBuffer : DWORD) : DWORD;
    PROCEDURE [stdcall] GetProcessAffinityMask* (hProcess : HANDLE; VAR [nil] lpProcessAffinityMask : DWORD; VAR [nil] lpSystemAffinityMask : DWORD) : BOOL;
    PROCEDURE [stdcall] SetProcessAffinityMask* (hProcess : HANDLE; dwProcessAffinityMask : DWORD) : BOOL;
    PROCEDURE [stdcall] GetProcessTimes* (hProcess : HANDLE; VAR [nil] lpCreationTime : _FILETIME_struct; VAR [nil] lpExitTime : _FILETIME_struct; VAR [nil] lpKernelTime : _FILETIME_struct; VAR [nil] lpUserTime : _FILETIME_struct) : BOOL;
    PROCEDURE [stdcall] GetProcessWorkingSetSize* (hProcess : HANDLE; VAR [nil] lpMinimumWorkingSetSize : DWORD; VAR [nil] lpMaximumWorkingSetSize : DWORD) : BOOL;
    PROCEDURE [stdcall] SetProcessWorkingSetSize* (hProcess : HANDLE; dwMinimumWorkingSetSize : DWORD; dwMaximumWorkingSetSize : DWORD) : BOOL;
    PROCEDURE [stdcall] OpenProcess* (dwDesiredAccess : DWORD; bInheritHandle : BOOL; dwProcessId : DWORD) : HANDLE;
    PROCEDURE [stdcall] GetCurrentProcess* () : HANDLE;
    PROCEDURE [stdcall] GetCurrentProcessId* () : DWORD;
    PROCEDURE [stdcall] ExitProcess* (uExitCode : UINT);
    PROCEDURE [stdcall] TerminateProcess* (hProcess : HANDLE; uExitCode : UINT) : BOOL;
    PROCEDURE [stdcall] GetExitCodeProcess* (hProcess : HANDLE; VAR [nil] lpExitCode : DWORD) : BOOL;
    PROCEDURE [stdcall] FatalExit* (ExitCode : LONGINT);
    PROCEDURE [stdcall] GetEnvironmentStrings* () : LPSTR;
    PROCEDURE [stdcall] GetEnvironmentStringsW* () : LPWSTR;
    PROCEDURE [stdcall] FreeEnvironmentStringsA* (p0 : LPSTR) : BOOL;
    PROCEDURE [stdcall] FreeEnvironmentStringsW* (p0 : LPWSTR) : BOOL;
    PROCEDURE [stdcall] RaiseException* (dwExceptionCode : DWORD; dwExceptionFlags : DWORD; nNumberOfArguments : DWORD; VAR [nil] lpArguments : DWORD);
    PROCEDURE [stdcall] UnhandledExceptionFilter* (VAR [nil] ExceptionInfo : _EXCEPTION_POINTERS_struct) : LONG;
    PROCEDURE [stdcall] SetUnhandledExceptionFilter* (lpTopLevelExceptionFilter : LPTOP_LEVEL_EXCEPTION_FILTER) : LPTOP_LEVEL_EXCEPTION_FILTER;
    PROCEDURE [stdcall] CreateFiber* (dwStackSize : DWORD; lpStartAddress : LPFIBER_START_ROUTINE; lpParameter : LPVOID) : LPVOID;
    PROCEDURE [stdcall] DeleteFiber* (lpFiber : LPVOID);
    PROCEDURE [stdcall] ConvertThreadToFiber* (lpParameter : LPVOID) : LPVOID;
    PROCEDURE [stdcall] SwitchToFiber* (lpFiber : LPVOID);
    PROCEDURE [stdcall] SwitchToThread* () : BOOL;
    PROCEDURE [stdcall] CreateThread* (VAR [nil] lpThreadAttributes : _SECURITY_ATTRIBUTES_struct; dwStackSize : DWORD; lpStartAddress : LPTHREAD_START_ROUTINE; lpParameter : LPVOID; dwCreationFlags : DWORD; VAR [nil] lpThreadId : DWORD) : HANDLE;
    PROCEDURE [stdcall] CreateRemoteThread* (hProcess : HANDLE; VAR [nil] lpThreadAttributes : _SECURITY_ATTRIBUTES_struct; dwStackSize : DWORD; lpStartAddress : LPTHREAD_START_ROUTINE; lpParameter : LPVOID; dwCreationFlags : DWORD; VAR [nil] lpThreadId : DWORD) : HANDLE;
    PROCEDURE [stdcall] GetCurrentThread* () : HANDLE;
    PROCEDURE [stdcall] GetCurrentThreadId* () : DWORD;
    PROCEDURE [stdcall] SetThreadAffinityMask* (hThread : HANDLE; dwThreadAffinityMask : DWORD) : DWORD;
    PROCEDURE [stdcall] SetThreadIdealProcessor* (hThread : HANDLE; dwIdealProcessor : DWORD) : DWORD;
    PROCEDURE [stdcall] SetProcessPriorityBoost* (hProcess : HANDLE; bDisablePriorityBoost : BOOL) : BOOL;
    PROCEDURE [stdcall] GetProcessPriorityBoost* (hProcess : HANDLE; VAR [nil] pDisablePriorityBoost : BOOL) : BOOL;
    PROCEDURE [stdcall] RequestWakeupLatency* (latency : LATENCY_TIME) : BOOL;
    PROCEDURE [stdcall] SetThreadPriority* (hThread : HANDLE; nPriority : LONGINT) : BOOL;
    ...
    PROCEDURE [stdcall] GetThreadPriority* (hThread : HANDLE) : LONGINT;
    PROCEDURE [stdcall] GetThreadTimes* (hThread : HANDLE; VAR [nil] lpCreationTime : _FILETIME_struct; VAR [nil] lpExitTime : _FILETIME_struct; VAR [nil] lpKernelTime : _FILETIME_struct; VAR [nil] lpUserTime : _FILETIME_struct) : BOOL;
    PROCEDURE [stdcall] ExitThread* (dwExitCode : DWORD);
    PROCEDURE [stdcall] TerminateThread* (hThread : HANDLE; dwExitCode : DWORD) : BOOL;
    PROCEDURE [stdcall] GetExitCodeThread* (hThread : HANDLE; VAR [nil] lpExitCode : DWORD) : BOOL;
    PROCEDURE [stdcall] GetThreadSelectorEntry* (hThread : HANDLE; dwSelector : DWORD; VAR [nil] lpSelectorEntry : _LDT_ENTRY_struct) : BOOL;
    PROCEDURE [stdcall] SetThreadExecutionState* (esFlags : EXECUTION_STATE) : EXECUTION_STATE;
    PROCEDURE [stdcall] GetLastError* () : DWORD;
    PROCEDURE [stdcall] SetLastError* (dwErrCode : DWORD);
    PROCEDURE [stdcall] GetOverlappedResult* (hFile : HANDLE; VAR [nil] lpOverlapped : _OVERLAPPED_struct; VAR [nil] lpNumberOfBytesTransferred : DWORD; bWait : BOOL) : BOOL;
    PROCEDURE [stdcall] CreateIoCompletionPort* (FileHandle : HANDLE; ExistingCompletionPort : HANDLE; CompletionKey : DWORD; NumberOfConcurrentThreads : DWORD) : HANDLE;
    PROCEDURE [stdcall] GetQueuedCompletionStatus* (CompletionPort : HANDLE; VAR [nil] lpNumberOfBytesTransferred : DWORD; VAR [nil] lpCompletionKey : DWORD; VAR [nil] lpOverlapped : LPOVERLAPPED; dwMilliseconds : DWORD) : BOOL;
    PROCEDURE [stdcall] PostQueuedCompletionStatus* (CompletionPort : HANDLE; dwNumberOfBytesTransferred : DWORD; dwCompletionKey : DWORD; VAR [nil] lpOverlapped : _OVERLAPPED_struct) : BOOL;
    PROCEDURE [stdcall] SetErrorMode* (uMode : UINT) : UINT;
    PROCEDURE [stdcall] ReadProcessMemory* (hProcess : HANDLE; lpBaseAddress : LPCVOID; lpBuffer : LPVOID; nSize : DWORD; VAR [nil] lpNumberOfBytesRead : DWORD) : BOOL;
    PROCEDURE [stdcall] WriteProcessMemory* (hProcess : HANDLE; lpBaseAddress : LPVOID; lpBuffer : LPVOID; nSize : DWORD; VAR [nil] lpNumberOfBytesWritten : DWORD) : BOOL;
    ...
    PROCEDURE [stdcall] SuspendThread* (hThread : HANDLE) : DWORD;
    PROCEDURE [stdcall] ResumeThread* (hThread : HANDLE) : DWORD;
    PROCEDURE [stdcall] QueueUserAPC* (pfnAPC : PAPCFUNC; hThread : HANDLE; dwData : DWORD) : DWORD;
    PROCEDURE [stdcall] IsDebuggerPresent* () : BOOL;
    PROCEDURE [stdcall] DebugBreak* ();
    PROCEDURE [stdcall] WaitForDebugEvent* (VAR [nil] lpDebugEvent : _DEBUG_EVENT_struct; dwMilliseconds : DWORD) : BOOL;
    PROCEDURE [stdcall] ContinueDebugEvent* (dwProcessId : DWORD; dwThreadId : DWORD; dwContinueStatus : DWORD) : BOOL;
    PROCEDURE [stdcall] DebugActiveProcess* (dwProcessId : DWORD) : BOOL;
    PROCEDURE [stdcall] InitializeCriticalSection* (VAR [nil] lpCriticalSection : _RTL_CRITICAL_SECTION_struct);
    PROCEDURE [stdcall] EnterCriticalSection* (VAR [nil] lpCriticalSection : _RTL_CRITICAL_SECTION_struct);
    PROCEDURE [stdcall] LeaveCriticalSection* (VAR [nil] lpCriticalSection : _RTL_CRITICAL_SECTION_struct);
    PROCEDURE [stdcall] TryEnterCriticalSection* (VAR [nil] lpCriticalSection : _RTL_CRITICAL_SECTION_struct) : BOOL;
    PROCEDURE [stdcall] DeleteCriticalSection* (VAR [nil] lpCriticalSection : _RTL_CRITICAL_SECTION_struct);
    ...
    PROCEDURE [stdcall] ReleaseSemaphore* (hSemaphore : HANDLE; lReleaseCount : LONG; VAR [nil] lpPreviousCount : LONGINT) : BOOL;
    PROCEDURE [stdcall] ReleaseMutex* (hMutex : HANDLE) : BOOL;
    PROCEDURE [stdcall] WaitForSingleObject* (hHandle : HANDLE; dwMilliseconds : DWORD) : DWORD;
    PROCEDURE [stdcall] WaitForMultipleObjects* (nCount : DWORD; VAR [nil] lpHandles : HANDLE; bWaitAll : BOOL; dwMilliseconds : DWORD) : DWORD;
    PROCEDURE [stdcall] Sleep* (dwMilliseconds : DWORD);
    PROCEDURE [stdcall] LoadResource* (hModule : HMODULE; hResInfo : HRSRC) : HGLOBAL;
    PROCEDURE [stdcall] SizeofResource* (hModule : HMODULE; hResInfo : HRSRC) : DWORD;
    PROCEDURE [stdcall] GlobalDeleteAtom* (nAtom : ATOM) : ATOM;
    PROCEDURE [stdcall] InitAtomTable* (nSize : DWORD) : BOOL;
    PROCEDURE [stdcall] DeleteAtom* (nAtom : ATOM) : ATOM;
    PROCEDURE [stdcall] SetHandleCount* (uNumber : UINT) : UINT;
    PROCEDURE [stdcall] GetLogicalDrives* () : DWORD;
    PROCEDURE [stdcall] LockFile* (hFile : HANDLE; dwFileOffsetLow : DWORD; dwFileOffsetHigh : DWORD; nNumberOfBytesToLockLow : DWORD; nNumberOfBytesToLockHigh : DWORD) : BOOL;
    PROCEDURE [stdcall] UnlockFile* (hFile : HANDLE; dwFileOffsetLow : DWORD; dwFileOffsetHigh : DWORD; nNumberOfBytesToUnlockLow : DWORD; nNumberOfBytesToUnlockHigh : DWORD) : BOOL;
    PROCEDURE [stdcall] LockFileEx* (hFile : HANDLE; dwFlags : DWORD; dwReserved : DWORD; nNumberOfBytesToLockLow : DWORD; nNumberOfBytesToLockHigh : DWORD; VAR [nil] lpOverlapped : _OVERLAPPED_struct) : BOOL;
    PROCEDURE [stdcall] UnlockFileEx* (hFile : HANDLE; dwReserved : DWORD; nNumberOfBytesToUnlockLow : DWORD; nNumberOfBytesToUnlockHigh : DWORD; VAR [nil] lpOverlapped : _OVERLAPPED_struct) : BOOL;
    PROCEDURE [stdcall] GetFileInformationByHandle* (hFile : HANDLE; VAR [nil] lpFileInformation : _BY_HANDLE_FILE_INFORMATION_struct) : BOOL;
    PROCEDURE [stdcall] GetFileType* (hFile : HANDLE) : DWORD;
    PROCEDURE [stdcall] GetFileSize* (hFile : HANDLE; VAR [nil] lpFileSizeHigh : DWORD) : DWORD;
    PROCEDURE [stdcall] GetStdHandle* (nStdHandle : DWORD) : HANDLE;
    PROCEDURE [stdcall] SetStdHandle* (nStdHandle : DWORD; hHandle : HANDLE) : BOOL;
    PROCEDURE [stdcall] WriteFile* (hFile : HANDLE; lpBuffer : LPCVOID; nNumberOfBytesToWrite : DWORD; VAR [nil] lpNumberOfBytesWritten : DWORD; VAR [nil] lpOverlapped : _OVERLAPPED_struct) : BOOL;
    PROCEDURE [stdcall] ReadFile* (hFile : HANDLE; lpBuffer : LPVOID; nNumberOfBytesToRead : DWORD; VAR [nil] lpNumberOfBytesRead : DWORD; VAR [nil] lpOverlapped : _OVERLAPPED_struct) : BOOL;
    PROCEDURE [stdcall] FlushFileBuffers* (hFile : HANDLE) : BOOL;
    PROCEDURE [stdcall] DeviceIoControl* (hDevice : HANDLE; dwIoControlCode : DWORD; lpInBuffer : LPVOID; nInBufferSize : DWORD; lpOutBuffer : LPVOID; nOutBufferSize : DWORD; VAR [nil] lpBytesReturned : DWORD; VAR [nil] lpOverlapped : _OVERLAPPED_struct) : BOOL;
    PROCEDURE [stdcall] GetDevicePowerState* (hFile : HANDLE) : BOOL;
    PROCEDURE [stdcall] SetEndOfFile* (hFile : HANDLE) : BOOL;
    PROCEDURE [stdcall] SetFilePointer* (hFile : HANDLE; lDistanceToMove : LONG; VAR [nil] lpDistanceToMoveHigh : LONG; dwMoveMethod : DWORD) : DWORD;
    PROCEDURE [stdcall] FindClose* (hFindFile : HANDLE) : BOOL;
    PROCEDURE [stdcall] GetFileTime* (hFile : HANDLE; VAR [nil] lpCreationTime : _FILETIME_struct; VAR [nil] lpLastAccessTime : _FILETIME_struct; VAR [nil] lpLastWriteTime : _FILETIME_struct) : BOOL;
    ...
    PROCEDURE [stdcall] DuplicateHandle* (hSourceProcessHandle : HANDLE; hSourceHandle : HANDLE; hTargetProcessHandle : HANDLE; VAR [nil] lpTargetHandle : HANDLE; dwDesiredAccess : DWORD; bInheritHandle : BOOL; dwOptions : DWORD) : BOOL;
    PROCEDURE [stdcall] GetHandleInformation* (hObject : HANDLE; VAR [nil] lpdwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] SetHandleInformation* (hObject : HANDLE; dwMask : DWORD; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] LoadModule* (lpModuleName : LPCSTR; lpParameterBlock : LPVOID) : DWORD;
    PROCEDURE [stdcall] WinExec* (lpCmdLine : LPCSTR; uCmdShow : UINT) : UINT;
    PROCEDURE [stdcall] ClearCommBreak* (hFile : HANDLE) : BOOL;
    PROCEDURE [stdcall] ClearCommError* (hFile : HANDLE; VAR [nil] lpErrors : DWORD; VAR [nil] lpStat : _COMSTAT_struct) : BOOL;
    PROCEDURE [stdcall] SetupComm* (hFile : HANDLE; dwInQueue : DWORD; dwOutQueue : DWORD) : BOOL;
    PROCEDURE [stdcall] EscapeCommFunction* (hFile : HANDLE; dwFunc : DWORD) : BOOL;
    PROCEDURE [stdcall] GetCommConfig* (hCommDev : HANDLE; VAR [nil] lpCC : _COMMCONFIG_struct; VAR [nil] lpdwSize : DWORD) : BOOL;
    PROCEDURE [stdcall] GetCommMask* (hFile : HANDLE; VAR [nil] lpEvtMask : DWORD) : BOOL;
    PROCEDURE [stdcall] GetCommProperties* (hFile : HANDLE; VAR [nil] lpCommProp : _COMMPROP_struct) : BOOL;
    PROCEDURE [stdcall] GetCommModemStatus* (hFile : HANDLE; VAR [nil] lpModemStat : DWORD) : BOOL;
    PROCEDURE [stdcall] GetCommState* (hFile : HANDLE; VAR [nil] lpDCB : _DCB_struct) : BOOL;
    PROCEDURE [stdcall] GetCommTimeouts* (hFile : HANDLE; VAR [nil] lpCommTimeouts : _COMMTIMEOUTS_struct) : BOOL;
    PROCEDURE [stdcall] PurgeComm* (hFile : HANDLE; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] SetCommBreak* (hFile : HANDLE) : BOOL;
    PROCEDURE [stdcall] SetCommConfig* (hCommDev : HANDLE; VAR [nil] lpCC : _COMMCONFIG_struct; dwSize : DWORD) : BOOL;
    PROCEDURE [stdcall] SetCommMask* (hFile : HANDLE; dwEvtMask : DWORD) : BOOL;
    PROCEDURE [stdcall] SetCommState* (hFile : HANDLE; VAR [nil] lpDCB : _DCB_struct) : BOOL;
    PROCEDURE [stdcall] SetCommTimeouts* (hFile : HANDLE; VAR [nil] lpCommTimeouts : _COMMTIMEOUTS_struct) : BOOL;
    PROCEDURE [stdcall] TransmitCommChar* (hFile : HANDLE; cChar : CHAR) : BOOL;
    PROCEDURE [stdcall] WaitCommEvent* (hFile : HANDLE; VAR [nil] lpEvtMask : DWORD; VAR [nil] lpOverlapped : _OVERLAPPED_struct) : BOOL;
    PROCEDURE [stdcall] SetTapePosition* (hDevice : HANDLE; dwPositionMethod : DWORD; dwPartition : DWORD; dwOffsetLow : DWORD; dwOffsetHigh : DWORD; bImmediate : BOOL) : DWORD;
    PROCEDURE [stdcall] GetTapePosition* (hDevice : HANDLE; dwPositionType : DWORD; VAR [nil] lpdwPartition : DWORD; VAR [nil] lpdwOffsetLow : DWORD; VAR [nil] lpdwOffsetHigh : DWORD) : DWORD;
    PROCEDURE [stdcall] PrepareTape* (hDevice : HANDLE; dwOperation : DWORD; bImmediate : BOOL) : DWORD;
    PROCEDURE [stdcall] EraseTape* (hDevice : HANDLE; dwEraseType : DWORD; bImmediate : BOOL) : DWORD;
    PROCEDURE [stdcall] CreateTapePartition* (hDevice : HANDLE; dwPartitionMethod : DWORD; dwCount : DWORD; dwSize : DWORD) : DWORD;
    PROCEDURE [stdcall] WriteTapemark* (hDevice : HANDLE; dwTapemarkType : DWORD; dwTapemarkCount : DWORD; bImmediate : BOOL) : DWORD;
    PROCEDURE [stdcall] GetTapeStatus* (hDevice : HANDLE) : DWORD;
    PROCEDURE [stdcall] GetTapeParameters* (hDevice : HANDLE; dwOperation : DWORD; VAR [nil] lpdwSize : DWORD; lpTapeInformation : LPVOID) : DWORD;
    PROCEDURE [stdcall] SetTapeParameters* (hDevice : HANDLE; dwOperation : DWORD; lpTapeInformation : LPVOID) : DWORD;
    PROCEDURE [stdcall] Beep* (dwFreq : DWORD; dwDuration : DWORD) : BOOL;
    PROCEDURE [stdcall] MulDiv* (nNumber : LONGINT; nNumerator : LONGINT; nDenominator : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetSystemTime* (VAR [nil] lpSystemTime : _SYSTEMTIME_struct);
    PROCEDURE [stdcall] GetSystemTimeAsFileTime* (VAR [nil] lpSystemTimeAsFileTime : _FILETIME_struct);
    PROCEDURE [stdcall] SetSystemTime* (VAR [nil] lpSystemTime : SYSTEMTIME) : BOOL;
    PROCEDURE [stdcall] GetLocalTime* (VAR [nil] lpSystemTime : _SYSTEMTIME_struct);
    PROCEDURE [stdcall] SetLocalTime* (VAR [nil] lpSystemTime : SYSTEMTIME) : BOOL;
    PROCEDURE [stdcall] GetSystemInfo* (VAR [nil] lpSystemInfo : _SYSTEM_INFO_struct);
    PROCEDURE [stdcall] IsProcessorFeaturePresent* (ProcessorFeature : DWORD) : BOOL;
    PROCEDURE [stdcall] SystemTimeToTzSpecificLocalTime* (VAR [nil] lpTimeZoneInformation : _TIME_ZONE_INFORMATION_struct; VAR [nil] lpUniversalTime : _SYSTEMTIME_struct; VAR [nil] lpLocalTime : _SYSTEMTIME_struct) : BOOL;
    PROCEDURE [stdcall] GetTimeZoneInformation* (VAR [nil] lpTimeZoneInformation : _TIME_ZONE_INFORMATION_struct) : DWORD;
    PROCEDURE [stdcall] SetTimeZoneInformation* (VAR [nil] lpTimeZoneInformation : TIME_ZONE_INFORMATION) : BOOL;
    PROCEDURE [stdcall] SystemTimeToFileTime* (VAR [nil] lpSystemTime : SYSTEMTIME; VAR [nil] lpFileTime : _FILETIME_struct) : BOOL;
    PROCEDURE [stdcall] FileTimeToLocalFileTime* (VAR [nil] lpFileTime : FILETIME; VAR [nil] lpLocalFileTime : _FILETIME_struct) : BOOL;
    PROCEDURE [stdcall] LocalFileTimeToFileTime* (VAR [nil] lpLocalFileTime : FILETIME; VAR [nil] lpFileTime : _FILETIME_struct) : BOOL;
    PROCEDURE [stdcall] FileTimeToSystemTime* (VAR [nil] lpFileTime : FILETIME; VAR [nil] lpSystemTime : _SYSTEMTIME_struct) : BOOL;
    PROCEDURE [stdcall] CompareFileTime* (VAR [nil] lpFileTime1 : FILETIME; VAR [nil] lpFileTime2 : FILETIME) : LONG;
    PROCEDURE [stdcall] FileTimeToDosDateTime* (VAR [nil] lpFileTime : FILETIME; VAR [nil] lpFatDate : WORD; VAR [nil] lpFatTime : WORD) : BOOL;
    PROCEDURE [stdcall] DosDateTimeToFileTime* (wFatDate : WORD; wFatTime : WORD; VAR [nil] lpFileTime : _FILETIME_struct) : BOOL;
    PROCEDURE [stdcall] GetTickCount* () : DWORD;
    PROCEDURE [stdcall] SetSystemTimeAdjustment* (dwTimeAdjustment : DWORD; bTimeAdjustmentDisabled : BOOL) : BOOL;
    PROCEDURE [stdcall] GetSystemTimeAdjustment* (VAR [nil] lpTimeAdjustment : DWORD; VAR [nil] lpTimeIncrement : DWORD; VAR [nil] lpTimeAdjustmentDisabled : BOOL) : BOOL;
    PROCEDURE [stdcall] FormatMessageA* (dwFlags : DWORD; lpSource : LPCVOID; dwMessageId : DWORD; dwLanguageId : DWORD; lpBuffer : LPSTR; nSize : DWORD; VAR [nil] Arguments : va_list) : DWORD;
    PROCEDURE [stdcall] FormatMessageW* (dwFlags : DWORD; lpSource : LPCVOID; dwMessageId : DWORD; dwLanguageId : DWORD; lpBuffer : LPWSTR; nSize : DWORD; VAR [nil] Arguments : va_list) : DWORD;
    PROCEDURE [stdcall] CreatePipe* (VAR [nil] hReadPipe : HANDLE; VAR [nil] hWritePipe : HANDLE; VAR [nil] lpPipeAttributes : _SECURITY_ATTRIBUTES_struct; nSize : DWORD) : BOOL;
    PROCEDURE [stdcall] ConnectNamedPipe* (hNamedPipe : HANDLE; VAR [nil] lpOverlapped : _OVERLAPPED_struct) : BOOL;
    PROCEDURE [stdcall] DisconnectNamedPipe* (hNamedPipe : HANDLE) : BOOL;
    PROCEDURE [stdcall] SetNamedPipeHandleState* (hNamedPipe : HANDLE; VAR [nil] lpMode : DWORD; VAR [nil] lpMaxCollectionCount : DWORD; VAR [nil] lpCollectDataTimeout : DWORD) : BOOL;
    PROCEDURE [stdcall] GetNamedPipeInfo* (hNamedPipe : HANDLE; VAR [nil] lpFlags : DWORD; VAR [nil] lpOutBufferSize : DWORD; VAR [nil] lpInBufferSize : DWORD; VAR [nil] lpMaxInstances : DWORD) : BOOL;
    PROCEDURE [stdcall] PeekNamedPipe* (hNamedPipe : HANDLE; lpBuffer : LPVOID; nBufferSize : DWORD; VAR [nil] lpBytesRead : DWORD; VAR [nil] lpTotalBytesAvail : DWORD; VAR [nil] lpBytesLeftThisMessage : DWORD) : BOOL;
    PROCEDURE [stdcall] TransactNamedPipe* (hNamedPipe : HANDLE; lpInBuffer : LPVOID; nInBufferSize : DWORD; lpOutBuffer : LPVOID; nOutBufferSize : DWORD; VAR [nil] lpBytesRead : DWORD; VAR [nil] lpOverlapped : _OVERLAPPED_struct) : BOOL;
    PROCEDURE [stdcall] CreateMailslotA* (lpName : LPCSTR; nMaxMessageSize : DWORD; lReadTimeout : DWORD; VAR [nil] lpSecurityAttributes : _SECURITY_ATTRIBUTES_struct) : HANDLE;
    PROCEDURE [stdcall] CreateMailslotW* (lpName : LPCWSTR; nMaxMessageSize : DWORD; lReadTimeout : DWORD; VAR [nil] lpSecurityAttributes : _SECURITY_ATTRIBUTES_struct) : HANDLE;
    PROCEDURE [stdcall] GetMailslotInfo* (hMailslot : HANDLE; VAR [nil] lpMaxMessageSize : DWORD; VAR [nil] lpNextSize : DWORD; VAR [nil] lpMessageCount : DWORD; VAR [nil] lpReadTimeout : DWORD) : BOOL;
    PROCEDURE [stdcall] SetMailslotInfo* (hMailslot : HANDLE; lReadTimeout : DWORD) : BOOL;
    PROCEDURE [stdcall] MapViewOfFile* (hFileMappingObject : HANDLE; dwDesiredAccess : DWORD; dwFileOffsetHigh : DWORD; dwFileOffsetLow : DWORD; dwNumberOfBytesToMap : DWORD) : LPVOID;
    PROCEDURE [stdcall] MapViewOfFileVlm* (hFileMappingObject : HANDLE; dwDesiredAccess : DWORD; ulOffset : DWORDLONG; ulNumberOfBytesToMap : DWORDLONG; lpBaseAddress : PVOID64) : PVOID64;
    PROCEDURE [stdcall] FlushViewOfFile* (lpBaseAddress : LPCVOID; dwNumberOfBytesToFlush : DWORD) : BOOL;
    PROCEDURE [stdcall] UnmapViewOfFile* (lpBaseAddress : LPCVOID) : BOOL;
    PROCEDURE [stdcall] UnmapViewOfFileVlm* (lpBaseAddress : PVOID64) : BOOL;
    PROCEDURE [stdcall] EncryptFileA* (lpFileName : LPCSTR) : BOOL;
    PROCEDURE [stdcall] EncryptFileW* (lpFileName : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] DecryptFileA* (lpFileName : LPCSTR; dwReserved : DWORD) : BOOL;
    PROCEDURE [stdcall] DecryptFileW* (lpFileName : LPCWSTR; dwReserved : DWORD) : BOOL;
    PROCEDURE [stdcall] OpenRawA* (lpFileName : LPCSTR; ulFlags : ULONG; VAR [nil] pvContext : PVOID) : DWORD;
    PROCEDURE [stdcall] OpenRawW* (lpFileName : LPCWSTR; ulFlags : ULONG; VAR [nil] pvContext : PVOID) : DWORD;
    PROCEDURE [stdcall] ReadRaw* (pfExportCallback : PFE_EXPORT_FUNC; pvCallbackContext : PVOID; pvContext : PVOID) : DWORD;
    PROCEDURE [stdcall] WriteRaw* (pfImportCallback : PFE_IMPORT_FUNC; pvCallbackContext : PVOID; pvContext : PVOID) : DWORD;
    PROCEDURE [stdcall] CloseRaw* (pvContext : PVOID);
    PROCEDURE [stdcall] QueryRecoveryAgentsA* (lpFileName : LPCSTR; VAR [nil] AgentCount : DWORD; VAR [nil] RecoveryAgentInformation : LPRECOVERY_AGENT_INFORMATIONA) : DWORD;
    PROCEDURE [stdcall] QueryRecoveryAgentsW* (lpFileName : LPCWSTR; VAR [nil] AgentCount : DWORD; VAR [nil] RecoveryAgentInformation : LPRECOVERY_AGENT_INFORMATIONW) : DWORD;
    PROCEDURE [stdcall] lstrcmpA* (lpString1 : LPCSTR; lpString2 : LPCSTR) : LONGINT;
    PROCEDURE [stdcall] lstrcmpW* (lpString1 : LPCWSTR; lpString2 : LPCWSTR) : LONGINT;
    PROCEDURE [stdcall] lstrcmpiA* (lpString1 : LPCSTR; lpString2 : LPCSTR) : LONGINT;
    PROCEDURE [stdcall] lstrcmpiW* (lpString1 : LPCWSTR; lpString2 : LPCWSTR) : LONGINT;
    PROCEDURE [stdcall] lstrcpynA* (lpString1 : LPSTR; lpString2 : LPCSTR; iMaxLength : LONGINT) : LPSTR;
    PROCEDURE [stdcall] lstrcpynW* (lpString1 : LPWSTR; lpString2 : LPCWSTR; iMaxLength : LONGINT) : LPWSTR;
    PROCEDURE [stdcall] lstrcpyA* (lpString1 : LPSTR; lpString2 : LPCSTR) : LPSTR;
    PROCEDURE [stdcall] lstrcpyW* (lpString1 : LPWSTR; lpString2 : LPCWSTR) : LPWSTR;
    PROCEDURE [stdcall] lstrcatA* (lpString1 : LPSTR; lpString2 : LPCSTR) : LPSTR;
    PROCEDURE [stdcall] lstrcatW* (lpString1 : LPWSTR; lpString2 : LPCWSTR) : LPWSTR;
    PROCEDURE [stdcall] lstrlenA* (lpString : LPCSTR) : LONGINT;
    PROCEDURE [stdcall] lstrlenW* (lpString : LPCWSTR) : LONGINT;
    PROCEDURE [stdcall] OpenFile* (lpFileName : LPCSTR; VAR [nil] lpReOpenBuff : _OFSTRUCT_struct; uStyle : UINT) : HFILE;
    PROCEDURE [stdcall] _lopen* (lpPathName : LPCSTR; iReadWrite : LONGINT) : HFILE;
    PROCEDURE [stdcall] _lcreat* (lpPathName : LPCSTR; iAttribute : LONGINT) : HFILE;
    PROCEDURE [stdcall] _lread* (hFile : HFILE; lpBuffer : LPVOID; uBytes : UINT) : UINT;
    PROCEDURE [stdcall] _lwrite* (hFile : HFILE; lpBuffer : LPCSTR; uBytes : UINT) : UINT;
    PROCEDURE [stdcall] _hread* (hFile : HFILE; lpBuffer : LPVOID; lBytes : LONGINT) : LONGINT;
    PROCEDURE [stdcall] _hwrite* (hFile : HFILE; lpBuffer : LPCSTR; lBytes : LONGINT) : LONGINT;
    PROCEDURE [stdcall] _lclose* (hFile : HFILE) : HFILE;
    PROCEDURE [stdcall] _llseek* (hFile : HFILE; lOffset : LONG; iOrigin : LONGINT) : LONG;
    PROCEDURE [stdcall] IsTextUnicode* (lpBuffer : LPVOID; cb : LONGINT; VAR [nil] lpi : LONGINT) : BOOL;
    PROCEDURE [stdcall] TlsAlloc* () : DWORD;
    PROCEDURE [stdcall] TlsGetValue* (dwTlsIndex : DWORD) : LPVOID;
    PROCEDURE [stdcall] TlsSetValue* (dwTlsIndex : DWORD; lpTlsValue : LPVOID) : BOOL;
    PROCEDURE [stdcall] TlsFree* (dwTlsIndex : DWORD) : BOOL;
    PROCEDURE [stdcall] SleepEx* (dwMilliseconds : DWORD; bAlertable : BOOL) : DWORD;
    PROCEDURE [stdcall] WaitForSingleObjectEx* (hHandle : HANDLE; dwMilliseconds : DWORD; bAlertable : BOOL) : DWORD;
    PROCEDURE [stdcall] WaitForMultipleObjectsEx* (nCount : DWORD; VAR [nil] lpHandles : HANDLE; bWaitAll : BOOL; dwMilliseconds : DWORD; bAlertable : BOOL) : DWORD;
    PROCEDURE [stdcall] SignalObjectAndWait* (hObjectToSignal : HANDLE; hObjectToWaitOn : HANDLE; dwMilliseconds : DWORD; bAlertable : BOOL) : DWORD;
    PROCEDURE [stdcall] ReadFileEx* (hFile : HANDLE; lpBuffer : LPVOID; nNumberOfBytesToRead : DWORD; VAR [nil] lpOverlapped : _OVERLAPPED_struct; lpCompletionRoutine : LPOVERLAPPED_COMPLETION_ROUTINE) : BOOL;
    PROCEDURE [stdcall] WriteFileEx* (hFile : HANDLE; lpBuffer : LPCVOID; nNumberOfBytesToWrite : DWORD; VAR [nil] lpOverlapped : _OVERLAPPED_struct; lpCompletionRoutine : LPOVERLAPPED_COMPLETION_ROUTINE) : BOOL;
    PROCEDURE [stdcall] BackupRead* (hFile : HANDLE; lpBuffer : LPBYTE; nNumberOfBytesToRead : DWORD; VAR [nil] lpNumberOfBytesRead : DWORD; bAbort : BOOL; bProcessSecurity : BOOL; VAR [nil] lpContext : LPVOID) : BOOL;
    PROCEDURE [stdcall] BackupSeek* (hFile : HANDLE; dwLowBytesToSeek : DWORD; dwHighBytesToSeek : DWORD; VAR [nil] lpdwLowByteSeeked : DWORD; VAR [nil] lpdwHighByteSeeked : DWORD; VAR [nil] lpContext : LPVOID) : BOOL;
    PROCEDURE [stdcall] BackupWrite* (hFile : HANDLE; lpBuffer : LPBYTE; nNumberOfBytesToWrite : DWORD; VAR [nil] lpNumberOfBytesWritten : DWORD; bAbort : BOOL; bProcessSecurity : BOOL; VAR [nil] lpContext : LPVOID) : BOOL;
    PROCEDURE [stdcall] ReadFileScatter* (hFile : HANDLE; aSegmentArray : ARRAY  OF FILE_SEGMENT_ELEMENT; nNumberOfBytesToRead : DWORD; VAR [nil] lpReserved : DWORD; VAR [nil] lpOverlapped : _OVERLAPPED_struct) : BOOL;
    PROCEDURE [stdcall] WriteFileGather* (hFile : HANDLE; aSegmentArray : ARRAY  OF FILE_SEGMENT_ELEMENT; nNumberOfBytesToWrite : DWORD; VAR [nil] lpReserved : DWORD; VAR [nil] lpOverlapped : _OVERLAPPED_struct) : BOOL;
    PROCEDURE [stdcall] CreateMutexA* (VAR [nil] lpMutexAttributes : _SECURITY_ATTRIBUTES_struct; bInitialOwner : BOOL; lpName : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] CreateMutexW* (VAR [nil] lpMutexAttributes : _SECURITY_ATTRIBUTES_struct; bInitialOwner : BOOL; lpName : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] OpenMutexA* (dwDesiredAccess : DWORD; bInheritHandle : BOOL; lpName : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] OpenMutexW* (dwDesiredAccess : DWORD; bInheritHandle : BOOL; lpName : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] CreateEventA* (VAR [nil] lpEventAttributes : _SECURITY_ATTRIBUTES_struct; bManualReset : BOOL; bInitialState : BOOL; lpName : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] CreateEventW* (VAR [nil] lpEventAttributes : _SECURITY_ATTRIBUTES_struct; bManualReset : BOOL; bInitialState : BOOL; lpName : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] OpenEventA* (dwDesiredAccess : DWORD; bInheritHandle : BOOL; lpName : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] OpenEventW* (dwDesiredAccess : DWORD; bInheritHandle : BOOL; lpName : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] CreateSemaphoreA* (VAR [nil] lpSemaphoreAttributes : _SECURITY_ATTRIBUTES_struct; lInitialCount : LONG; lMaximumCount : LONG; lpName : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] CreateSemaphoreW* (VAR [nil] lpSemaphoreAttributes : _SECURITY_ATTRIBUTES_struct; lInitialCount : LONG; lMaximumCount : LONG; lpName : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] OpenSemaphoreA* (dwDesiredAccess : DWORD; bInheritHandle : BOOL; lpName : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] OpenSemaphoreW* (dwDesiredAccess : DWORD; bInheritHandle : BOOL; lpName : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] CreateWaitableTimerA* (VAR [nil] lpTimerAttributes : _SECURITY_ATTRIBUTES_struct; bManualReset : BOOL; lpTimerName : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] CreateWaitableTimerW* (VAR [nil] lpTimerAttributes : _SECURITY_ATTRIBUTES_struct; bManualReset : BOOL; lpTimerName : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] OpenWaitableTimerA* (dwDesiredAccess : DWORD; bInheritHandle : BOOL; lpTimerName : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] OpenWaitableTimerW* (dwDesiredAccess : DWORD; bInheritHandle : BOOL; lpTimerName : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] SetWaitableTimer* (hTimer : HANDLE; VAR [nil] lpDueTime : LARGE_INTEGER; lPeriod : LONG; pfnCompletionRoutine : PTIMERAPCROUTINE; lpArgToCompletionRoutine : LPVOID; fResume : BOOL) : BOOL;
    PROCEDURE [stdcall] CancelWaitableTimer* (hTimer : HANDLE) : BOOL;
    PROCEDURE [stdcall] CreateFileMappingA* (hFile : HANDLE; VAR [nil] lpFileMappingAttributes : _SECURITY_ATTRIBUTES_struct; flProtect : DWORD; dwMaximumSizeHigh : DWORD; dwMaximumSizeLow : DWORD; lpName : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] CreateFileMappingW* (hFile : HANDLE; VAR [nil] lpFileMappingAttributes : _SECURITY_ATTRIBUTES_struct; flProtect : DWORD; dwMaximumSizeHigh : DWORD; dwMaximumSizeLow : DWORD; lpName : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] OpenFileMappingA* (dwDesiredAccess : DWORD; bInheritHandle : BOOL; lpName : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] OpenFileMappingW* (dwDesiredAccess : DWORD; bInheritHandle : BOOL; lpName : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] GetLogicalDriveStringsA* (nBufferLength : DWORD; lpBuffer : LPSTR) : DWORD;
    PROCEDURE [stdcall] GetLogicalDriveStringsW* (nBufferLength : DWORD; lpBuffer : LPWSTR) : DWORD;
    PROCEDURE [stdcall] LoadLibraryA* (lpLibFileName : LPCSTR) : HMODULE;
    PROCEDURE [stdcall] LoadLibraryW* (lpLibFileName : LPCWSTR) : HMODULE;
    PROCEDURE [stdcall] LoadLibraryExA* (lpLibFileName : LPCSTR; hFile : HANDLE; dwFlags : DWORD) : HMODULE;
    PROCEDURE [stdcall] LoadLibraryExW* (lpLibFileName : LPCWSTR; hFile : HANDLE; dwFlags : DWORD) : HMODULE;
    PROCEDURE [stdcall] GetModuleFileNameA* (hModule : HMODULE; lpFilename : LPSTR; nSize : DWORD) : DWORD;
    PROCEDURE [stdcall] GetModuleFileNameW* (hModule : HMODULE; lpFilename : LPWSTR; nSize : DWORD) : DWORD;
    PROCEDURE [stdcall] GetModuleHandleA* (lpModuleName : LPCSTR) : HMODULE;
    PROCEDURE [stdcall] GetModuleHandleW* (lpModuleName : LPCWSTR) : HMODULE;
    ...
    PROCEDURE [stdcall] SetProcessShutdownParameters* (dwLevel : DWORD; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] GetProcessShutdownParameters* (VAR [nil] lpdwLevel : DWORD; VAR [nil] lpdwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] GetProcessVersion* (ProcessId : DWORD) : DWORD;
    PROCEDURE [stdcall] FatalAppExitA* (uAction : UINT; lpMessageText : LPCSTR);
    PROCEDURE [stdcall] FatalAppExitW* (uAction : UINT; lpMessageText : LPCWSTR);
    PROCEDURE [stdcall] GetStartupInfoA* (VAR [nil] lpStartupInfo : _STARTUPINFOA_struct);
    PROCEDURE [stdcall] GetStartupInfoW* (VAR [nil] lpStartupInfo : _STARTUPINFOW_struct);
    PROCEDURE [stdcall] GetCommandLineA* () : LPSTR;
    PROCEDURE [stdcall] GetCommandLineW* () : LPWSTR;
    PROCEDURE [stdcall] GetEnvironmentVariableA* (lpName : LPCSTR; lpBuffer : LPSTR; nSize : DWORD) : DWORD;
    PROCEDURE [stdcall] GetEnvironmentVariableW* (lpName : LPCWSTR; lpBuffer : LPWSTR; nSize : DWORD) : DWORD;
    PROCEDURE [stdcall] SetEnvironmentVariableA* (lpName : LPCSTR; lpValue : LPCSTR) : BOOL;
    PROCEDURE [stdcall] SetEnvironmentVariableW* (lpName : LPCWSTR; lpValue : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] ExpandEnvironmentStringsA* (lpSrc : LPCSTR; lpDst : LPSTR; nSize : DWORD) : DWORD;
    PROCEDURE [stdcall] ExpandEnvironmentStringsW* (lpSrc : LPCWSTR; lpDst : LPWSTR; nSize : DWORD) : DWORD;
    PROCEDURE [stdcall] OutputDebugStringA* (lpOutputString : LPCSTR);
    PROCEDURE [stdcall] OutputDebugStringW* (lpOutputString : LPCWSTR);
    PROCEDURE [stdcall] FindResourceA* (hModule : HMODULE; lpName : LPCSTR; lpType : LPCSTR) : HRSRC;
    PROCEDURE [stdcall] FindResourceW* (hModule : HMODULE; lpName : LPCWSTR; lpType : LPCWSTR) : HRSRC;
    PROCEDURE [stdcall] FindResourceExA* (hModule : HMODULE; lpType : LPCSTR; lpName : LPCSTR; wLanguage : WORD) : HRSRC;
    PROCEDURE [stdcall] FindResourceExW* (hModule : HMODULE; lpType : LPCWSTR; lpName : LPCWSTR; wLanguage : WORD) : HRSRC;
    PROCEDURE [stdcall] EnumResourceTypesA* (hModule : HMODULE; lpEnumFunc : ENUMRESTYPEPROC; lParam : LONG) : BOOL;
    PROCEDURE [stdcall] EnumResourceTypesW* (hModule : HMODULE; lpEnumFunc : ENUMRESTYPEPROC; lParam : LONG) : BOOL;
    PROCEDURE [stdcall] EnumResourceNamesA* (hModule : HMODULE; lpType : LPCSTR; lpEnumFunc : ENUMRESNAMEPROC; lParam : LONG) : BOOL;
    PROCEDURE [stdcall] EnumResourceNamesW* (hModule : HMODULE; lpType : LPCWSTR; lpEnumFunc : ENUMRESNAMEPROC; lParam : LONG) : BOOL;
    PROCEDURE [stdcall] EnumResourceLanguagesA* (hModule : HMODULE; lpType : LPCSTR; lpName : LPCSTR; lpEnumFunc : ENUMRESLANGPROC; lParam : LONG) : BOOL;
    PROCEDURE [stdcall] EnumResourceLanguagesW* (hModule : HMODULE; lpType : LPCWSTR; lpName : LPCWSTR; lpEnumFunc : ENUMRESLANGPROC; lParam : LONG) : BOOL;
    PROCEDURE [stdcall] BeginUpdateResourceA* (pFileName : LPCSTR; bDeleteExistingResources : BOOL) : HANDLE;
    PROCEDURE [stdcall] BeginUpdateResourceW* (pFileName : LPCWSTR; bDeleteExistingResources : BOOL) : HANDLE;
    PROCEDURE [stdcall] UpdateResourceA* (hUpdate : HANDLE; lpType : LPCSTR; lpName : LPCSTR; wLanguage : WORD; lpData : LPVOID; cbData : DWORD) : BOOL;
    PROCEDURE [stdcall] UpdateResourceW* (hUpdate : HANDLE; lpType : LPCWSTR; lpName : LPCWSTR; wLanguage : WORD; lpData : LPVOID; cbData : DWORD) : BOOL;
    ...
    PROCEDURE [stdcall] GlobalAddAtomA* (lpString : LPCSTR) : ATOM;
    PROCEDURE [stdcall] GlobalAddAtomW* (lpString : LPCWSTR) : ATOM;
    PROCEDURE [stdcall] GlobalFindAtomA* (lpString : LPCSTR) : ATOM;
    PROCEDURE [stdcall] GlobalFindAtomW* (lpString : LPCWSTR) : ATOM;
    PROCEDURE [stdcall] GlobalGetAtomNameA* (nAtom : ATOM; lpBuffer : LPSTR; nSize : LONGINT) : UINT;
    PROCEDURE [stdcall] GlobalGetAtomNameW* (nAtom : ATOM; lpBuffer : LPWSTR; nSize : LONGINT) : UINT;
    PROCEDURE [stdcall] AddAtomA* (lpString : LPCSTR) : ATOM;
    PROCEDURE [stdcall] AddAtomW* (lpString : LPCWSTR) : ATOM;
    PROCEDURE [stdcall] FindAtomA* (lpString : LPCSTR) : ATOM;
    PROCEDURE [stdcall] FindAtomW* (lpString : LPCWSTR) : ATOM;
    PROCEDURE [stdcall] GetAtomNameA* (nAtom : ATOM; lpBuffer : LPSTR; nSize : LONGINT) : UINT;
    PROCEDURE [stdcall] GetAtomNameW* (nAtom : ATOM; lpBuffer : LPWSTR; nSize : LONGINT) : UINT;
    PROCEDURE [stdcall] GetProfileIntA* (lpAppName : LPCSTR; lpKeyName : LPCSTR; nDefault : INT) : UINT;
    PROCEDURE [stdcall] GetProfileIntW* (lpAppName : LPCWSTR; lpKeyName : LPCWSTR; nDefault : INT) : UINT;
    PROCEDURE [stdcall] GetProfileStringA* (lpAppName : LPCSTR; lpKeyName : LPCSTR; lpDefault : LPCSTR; lpReturnedString : LPSTR; nSize : DWORD) : DWORD;
    PROCEDURE [stdcall] GetProfileStringW* (lpAppName : LPCWSTR; lpKeyName : LPCWSTR; lpDefault : LPCWSTR; lpReturnedString : LPWSTR; nSize : DWORD) : DWORD;
    PROCEDURE [stdcall] WriteProfileStringA* (lpAppName : LPCSTR; lpKeyName : LPCSTR; lpString : LPCSTR) : BOOL;
    PROCEDURE [stdcall] WriteProfileStringW* (lpAppName : LPCWSTR; lpKeyName : LPCWSTR; lpString : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] GetProfileSectionA* (lpAppName : LPCSTR; lpReturnedString : LPSTR; nSize : DWORD) : DWORD;
    PROCEDURE [stdcall] GetProfileSectionW* (lpAppName : LPCWSTR; lpReturnedString : LPWSTR; nSize : DWORD) : DWORD;
    PROCEDURE [stdcall] WriteProfileSectionA* (lpAppName : LPCSTR; lpString : LPCSTR) : BOOL;
    PROCEDURE [stdcall] WriteProfileSectionW* (lpAppName : LPCWSTR; lpString : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] GetPrivateProfileIntA* (lpAppName : LPCSTR; lpKeyName : LPCSTR; nDefault : INT; lpFileName : LPCSTR) : UINT;
    PROCEDURE [stdcall] GetPrivateProfileIntW* (lpAppName : LPCWSTR; lpKeyName : LPCWSTR; nDefault : INT; lpFileName : LPCWSTR) : UINT;
    PROCEDURE [stdcall] GetPrivateProfileStringA* (lpAppName : LPCSTR; lpKeyName : LPCSTR; lpDefault : LPCSTR; lpReturnedString : LPSTR; nSize : DWORD; lpFileName : LPCSTR) : DWORD;
    PROCEDURE [stdcall] GetPrivateProfileStringW* (lpAppName : LPCWSTR; lpKeyName : LPCWSTR; lpDefault : LPCWSTR; lpReturnedString : LPWSTR; nSize : DWORD; lpFileName : LPCWSTR) : DWORD;
    PROCEDURE [stdcall] WritePrivateProfileStringA* (lpAppName : LPCSTR; lpKeyName : LPCSTR; lpString : LPCSTR; lpFileName : LPCSTR) : BOOL;
    PROCEDURE [stdcall] WritePrivateProfileStringW* (lpAppName : LPCWSTR; lpKeyName : LPCWSTR; lpString : LPCWSTR; lpFileName : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] GetPrivateProfileSectionA* (lpAppName : LPCSTR; lpReturnedString : LPSTR; nSize : DWORD; lpFileName : LPCSTR) : DWORD;
    PROCEDURE [stdcall] GetPrivateProfileSectionW* (lpAppName : LPCWSTR; lpReturnedString : LPWSTR; nSize : DWORD; lpFileName : LPCWSTR) : DWORD;
    PROCEDURE [stdcall] WritePrivateProfileSectionA* (lpAppName : LPCSTR; lpString : LPCSTR; lpFileName : LPCSTR) : BOOL;
    PROCEDURE [stdcall] WritePrivateProfileSectionW* (lpAppName : LPCWSTR; lpString : LPCWSTR; lpFileName : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] GetPrivateProfileSectionNamesA* (lpszReturnBuffer : LPSTR; nSize : DWORD; lpFileName : LPCSTR) : DWORD;
    PROCEDURE [stdcall] GetPrivateProfileSectionNamesW* (lpszReturnBuffer : LPWSTR; nSize : DWORD; lpFileName : LPCWSTR) : DWORD;
    PROCEDURE [stdcall] GetPrivateProfileStructA* (lpszSection : LPCSTR; lpszKey : LPCSTR; lpStruct : LPVOID; uSizeStruct : UINT; szFile : LPCSTR) : BOOL;
    PROCEDURE [stdcall] GetPrivateProfileStructW* (lpszSection : LPCWSTR; lpszKey : LPCWSTR; lpStruct : LPVOID; uSizeStruct : UINT; szFile : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] WritePrivateProfileStructA* (lpszSection : LPCSTR; lpszKey : LPCSTR; lpStruct : LPVOID; uSizeStruct : UINT; szFile : LPCSTR) : BOOL;
    PROCEDURE [stdcall] WritePrivateProfileStructW* (lpszSection : LPCWSTR; lpszKey : LPCWSTR; lpStruct : LPVOID; uSizeStruct : UINT; szFile : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] GetDriveTypeA* (lpRootPathName : LPCSTR) : UINT;
    PROCEDURE [stdcall] GetDriveTypeW* (lpRootPathName : LPCWSTR) : UINT;
    PROCEDURE [stdcall] GetSystemDirectoryA* (lpBuffer : LPSTR; uSize : UINT) : UINT;
    PROCEDURE [stdcall] GetSystemDirectoryW* (lpBuffer : LPWSTR; uSize : UINT) : UINT;
    PROCEDURE [stdcall] GetTempPathA* (nBufferLength : DWORD; lpBuffer : LPSTR) : DWORD;
    PROCEDURE [stdcall] GetTempPathW* (nBufferLength : DWORD; lpBuffer : LPWSTR) : DWORD;
    PROCEDURE [stdcall] GetTempFileNameA* (lpPathName : LPCSTR; lpPrefixString : LPCSTR; uUnique : UINT; lpTempFileName : LPSTR) : UINT;
    PROCEDURE [stdcall] GetTempFileNameW* (lpPathName : LPCWSTR; lpPrefixString : LPCWSTR; uUnique : UINT; lpTempFileName : LPWSTR) : UINT;
    PROCEDURE [stdcall] GetWindowsDirectoryA* (lpBuffer : LPSTR; uSize : UINT) : UINT;
    PROCEDURE [stdcall] GetWindowsDirectoryW* (lpBuffer : LPWSTR; uSize : UINT) : UINT;
    PROCEDURE [stdcall] SetCurrentDirectoryA* (lpPathName : LPCSTR) : BOOL;
    PROCEDURE [stdcall] SetCurrentDirectoryW* (lpPathName : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] GetCurrentDirectoryA* (nBufferLength : DWORD; lpBuffer : LPSTR) : DWORD;
    PROCEDURE [stdcall] GetCurrentDirectoryW* (nBufferLength : DWORD; lpBuffer : LPWSTR) : DWORD;
    PROCEDURE [stdcall] GetDiskFreeSpaceA* (lpRootPathName : LPCSTR; VAR [nil] lpSectorsPerCluster : DWORD; VAR [nil] lpBytesPerSector : DWORD; VAR [nil] lpNumberOfFreeClusters : DWORD; VAR [nil] lpTotalNumberOfClusters : DWORD) : BOOL;
    PROCEDURE [stdcall] GetDiskFreeSpaceW* (lpRootPathName : LPCWSTR; VAR [nil] lpSectorsPerCluster : DWORD; VAR [nil] lpBytesPerSector : DWORD; VAR [nil] lpNumberOfFreeClusters : DWORD; VAR [nil] lpTotalNumberOfClusters : DWORD) : BOOL;
    PROCEDURE [stdcall] GetDiskFreeSpaceExA* (lpDirectoryName : LPCSTR; VAR [nil] lpFreeBytesAvailableToCaller : ULARGE_INTEGER; VAR [nil] lpTotalNumberOfBytes : ULARGE_INTEGER; VAR [nil] lpTotalNumberOfFreeBytes : ULARGE_INTEGER) : BOOL;
    PROCEDURE [stdcall] GetDiskFreeSpaceExW* (lpDirectoryName : LPCWSTR; VAR [nil] lpFreeBytesAvailableToCaller : ULARGE_INTEGER; VAR [nil] lpTotalNumberOfBytes : ULARGE_INTEGER; VAR [nil] lpTotalNumberOfFreeBytes : ULARGE_INTEGER) : BOOL;
    PROCEDURE [stdcall] CreateDirectoryA* (lpPathName : LPCSTR; VAR [nil] lpSecurityAttributes : _SECURITY_ATTRIBUTES_struct) : BOOL;
    PROCEDURE [stdcall] CreateDirectoryW* (lpPathName : LPCWSTR; VAR [nil] lpSecurityAttributes : _SECURITY_ATTRIBUTES_struct) : BOOL;
    PROCEDURE [stdcall] CreateDirectoryExA* (lpTemplateDirectory : LPCSTR; lpNewDirectory : LPCSTR; VAR [nil] lpSecurityAttributes : _SECURITY_ATTRIBUTES_struct) : BOOL;
    PROCEDURE [stdcall] CreateDirectoryExW* (lpTemplateDirectory : LPCWSTR; lpNewDirectory : LPCWSTR; VAR [nil] lpSecurityAttributes : _SECURITY_ATTRIBUTES_struct) : BOOL;
    PROCEDURE [stdcall] RemoveDirectoryA* (lpPathName : LPCSTR) : BOOL;
    PROCEDURE [stdcall] RemoveDirectoryW* (lpPathName : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] GetFullPathNameA* (lpFileName : LPCSTR; nBufferLength : DWORD; lpBuffer : LPSTR; VAR [nil] lpFilePart : LPSTR) : DWORD;
    PROCEDURE [stdcall] GetFullPathNameW* (lpFileName : LPCWSTR; nBufferLength : DWORD; lpBuffer : LPWSTR; VAR [nil] lpFilePart : LPWSTR) : DWORD;
    PROCEDURE [stdcall] DefineDosDeviceA* (dwFlags : DWORD; lpDeviceName : LPCSTR; lpTargetPath : LPCSTR) : BOOL;
    PROCEDURE [stdcall] DefineDosDeviceW* (dwFlags : DWORD; lpDeviceName : LPCWSTR; lpTargetPath : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] QueryDosDeviceA* (lpDeviceName : LPCSTR; lpTargetPath : LPSTR; ucchMax : DWORD) : DWORD;
    PROCEDURE [stdcall] QueryDosDeviceW* (lpDeviceName : LPCWSTR; lpTargetPath : LPWSTR; ucchMax : DWORD) : DWORD;
    PROCEDURE [stdcall] CreateFileA* (lpFileName : LPCSTR; dwDesiredAccess : DWORD; dwShareMode : DWORD; VAR [nil] lpSecurityAttributes : _SECURITY_ATTRIBUTES_struct; dwCreationDisposition : DWORD; dwFlagsAndAttributes : DWORD; hTemplateFile : HANDLE) : HANDLE;
    PROCEDURE [stdcall] CreateFileW* (lpFileName : LPCWSTR; dwDesiredAccess : DWORD; dwShareMode : DWORD; VAR [nil] lpSecurityAttributes : _SECURITY_ATTRIBUTES_struct; dwCreationDisposition : DWORD; dwFlagsAndAttributes : DWORD; hTemplateFile : HANDLE) : HANDLE;
    PROCEDURE [stdcall] SetFileAttributesA* (lpFileName : LPCSTR; dwFileAttributes : DWORD) : BOOL;
    PROCEDURE [stdcall] SetFileAttributesW* (lpFileName : LPCWSTR; dwFileAttributes : DWORD) : BOOL;
    PROCEDURE [stdcall] GetFileAttributesA* (lpFileName : LPCSTR) : DWORD;
    PROCEDURE [stdcall] GetFileAttributesW* (lpFileName : LPCWSTR) : DWORD;
    PROCEDURE [stdcall] GetFileAttributesExA* (lpFileName : LPCSTR; fInfoLevelId : GET_FILEEX_INFO_LEVELS; lpFileInformation : LPVOID) : BOOL;
    PROCEDURE [stdcall] GetFileAttributesExW* (lpFileName : LPCWSTR; fInfoLevelId : GET_FILEEX_INFO_LEVELS; lpFileInformation : LPVOID) : BOOL;
    PROCEDURE [stdcall] GetCompressedFileSizeA* (lpFileName : LPCSTR; VAR [nil] lpFileSizeHigh : DWORD) : DWORD;
    PROCEDURE [stdcall] GetCompressedFileSizeW* (lpFileName : LPCWSTR; VAR [nil] lpFileSizeHigh : DWORD) : DWORD;
    PROCEDURE [stdcall] DeleteFileA* (lpFileName : LPCSTR) : BOOL;
    PROCEDURE [stdcall] DeleteFileW* (lpFileName : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] FindFirstFileExA* (lpFileName : LPCSTR; fInfoLevelId : FINDEX_INFO_LEVELS; lpFindFileData : LPVOID; fSearchOp : FINDEX_SEARCH_OPS; lpSearchFilter : LPVOID; dwAdditionalFlags : DWORD) : HANDLE;
    PROCEDURE [stdcall] FindFirstFileExW* (lpFileName : LPCWSTR; fInfoLevelId : FINDEX_INFO_LEVELS; lpFindFileData : LPVOID; fSearchOp : FINDEX_SEARCH_OPS; lpSearchFilter : LPVOID; dwAdditionalFlags : DWORD) : HANDLE;
    PROCEDURE [stdcall] FindFirstFileA* (lpFileName : LPCSTR; VAR [nil] lpFindFileData : _WIN32_FIND_DATAA_struct) : HANDLE;
    PROCEDURE [stdcall] FindFirstFileW* (lpFileName : LPCWSTR; VAR [nil] lpFindFileData : _WIN32_FIND_DATAW_struct) : HANDLE;
    PROCEDURE [stdcall] FindNextFileA* (hFindFile : HANDLE; VAR [nil] lpFindFileData : _WIN32_FIND_DATAA_struct) : BOOL;
    PROCEDURE [stdcall] FindNextFileW* (hFindFile : HANDLE; VAR [nil] lpFindFileData : _WIN32_FIND_DATAW_struct) : BOOL;
    PROCEDURE [stdcall] SearchPathA* (lpPath : LPCSTR; lpFileName : LPCSTR; lpExtension : LPCSTR; nBufferLength : DWORD; lpBuffer : LPSTR; VAR [nil] lpFilePart : LPSTR) : DWORD;
    PROCEDURE [stdcall] SearchPathW* (lpPath : LPCWSTR; lpFileName : LPCWSTR; lpExtension : LPCWSTR; nBufferLength : DWORD; lpBuffer : LPWSTR; VAR [nil] lpFilePart : LPWSTR) : DWORD;
    PROCEDURE [stdcall] CopyFileA* (lpExistingFileName : LPCSTR; lpNewFileName : LPCSTR; bFailIfExists : BOOL) : BOOL;
    PROCEDURE [stdcall] CopyFileW* (lpExistingFileName : LPCWSTR; lpNewFileName : LPCWSTR; bFailIfExists : BOOL) : BOOL;
    PROCEDURE [stdcall] CopyFileExA* (lpExistingFileName : LPCSTR; lpNewFileName : LPCSTR; lpProgressRoutine : LPPROGRESS_ROUTINE; lpData : LPVOID; VAR [nil] pbCancel : BOOL; dwCopyFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] CopyFileExW* (lpExistingFileName : LPCWSTR; lpNewFileName : LPCWSTR; lpProgressRoutine : LPPROGRESS_ROUTINE; lpData : LPVOID; VAR [nil] pbCancel : BOOL; dwCopyFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] MoveFileA* (lpExistingFileName : LPCSTR; lpNewFileName : LPCSTR) : BOOL;
    PROCEDURE [stdcall] MoveFileW* (lpExistingFileName : LPCWSTR; lpNewFileName : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] MoveFileExA* (lpExistingFileName : LPCSTR; lpNewFileName : LPCSTR; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] MoveFileExW* (lpExistingFileName : LPCWSTR; lpNewFileName : LPCWSTR; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] CreateNamedPipeA* (lpName : LPCSTR; dwOpenMode : DWORD; dwPipeMode : DWORD; nMaxInstances : DWORD; nOutBufferSize : DWORD; nInBufferSize : DWORD; nDefaultTimeOut : DWORD; VAR [nil] lpSecurityAttributes : _SECURITY_ATTRIBUTES_struct) : HANDLE;
    PROCEDURE [stdcall] CreateNamedPipeW* (lpName : LPCWSTR; dwOpenMode : DWORD; dwPipeMode : DWORD; nMaxInstances : DWORD; nOutBufferSize : DWORD; nInBufferSize : DWORD; nDefaultTimeOut : DWORD; VAR [nil] lpSecurityAttributes : _SECURITY_ATTRIBUTES_struct) : HANDLE;
    PROCEDURE [stdcall] GetNamedPipeHandleStateA* (hNamedPipe : HANDLE; VAR [nil] lpState : DWORD; VAR [nil] lpCurInstances : DWORD; VAR [nil] lpMaxCollectionCount : DWORD; VAR [nil] lpCollectDataTimeout : DWORD; lpUserName : LPSTR; nMaxUserNameSize : DWORD) : BOOL;
    PROCEDURE [stdcall] GetNamedPipeHandleStateW* (hNamedPipe : HANDLE; VAR [nil] lpState : DWORD; VAR [nil] lpCurInstances : DWORD; VAR [nil] lpMaxCollectionCount : DWORD; VAR [nil] lpCollectDataTimeout : DWORD; lpUserName : LPWSTR; nMaxUserNameSize : DWORD) : BOOL;
    PROCEDURE [stdcall] CallNamedPipeA* (lpNamedPipeName : LPCSTR; lpInBuffer : LPVOID; nInBufferSize : DWORD; lpOutBuffer : LPVOID; nOutBufferSize : DWORD; VAR [nil] lpBytesRead : DWORD; nTimeOut : DWORD) : BOOL;
    PROCEDURE [stdcall] CallNamedPipeW* (lpNamedPipeName : LPCWSTR; lpInBuffer : LPVOID; nInBufferSize : DWORD; lpOutBuffer : LPVOID; nOutBufferSize : DWORD; VAR [nil] lpBytesRead : DWORD; nTimeOut : DWORD) : BOOL;
    PROCEDURE [stdcall] WaitNamedPipeA* (lpNamedPipeName : LPCSTR; nTimeOut : DWORD) : BOOL;
    PROCEDURE [stdcall] WaitNamedPipeW* (lpNamedPipeName : LPCWSTR; nTimeOut : DWORD) : BOOL;
    PROCEDURE [stdcall] SetVolumeLabelA* (lpRootPathName : LPCSTR; lpVolumeName : LPCSTR) : BOOL;
    PROCEDURE [stdcall] SetVolumeLabelW* (lpRootPathName : LPCWSTR; lpVolumeName : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] SetFileApisToOEM* ();
    PROCEDURE [stdcall] SetFileApisToANSI* ();
    PROCEDURE [stdcall] AreFileApisANSI* () : BOOL;
    PROCEDURE [stdcall] GetVolumeInformationA* (lpRootPathName : LPCSTR; lpVolumeNameBuffer : LPSTR; nVolumeNameSize : DWORD; VAR [nil] lpVolumeSerialNumber : DWORD; VAR [nil] lpMaximumComponentLength : DWORD; VAR [nil] lpFileSystemFlags : DWORD; lpFileSystemNameBuffer : LPSTR; nFileSystemNameSize : DWORD) : BOOL;
    PROCEDURE [stdcall] GetVolumeInformationW* (lpRootPathName : LPCWSTR; lpVolumeNameBuffer : LPWSTR; nVolumeNameSize : DWORD; VAR [nil] lpVolumeSerialNumber : DWORD; VAR [nil] lpMaximumComponentLength : DWORD; VAR [nil] lpFileSystemFlags : DWORD; lpFileSystemNameBuffer : LPWSTR; nFileSystemNameSize : DWORD) : BOOL;
    PROCEDURE [stdcall] CancelIo* (hFile : HANDLE) : BOOL;
    PROCEDURE [stdcall] ClearEventLogA* (hEventLog : HANDLE; lpBackupFileName : LPCSTR) : BOOL;
    PROCEDURE [stdcall] ClearEventLogW* (hEventLog : HANDLE; lpBackupFileName : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] BackupEventLogA* (hEventLog : HANDLE; lpBackupFileName : LPCSTR) : BOOL;
    PROCEDURE [stdcall] BackupEventLogW* (hEventLog : HANDLE; lpBackupFileName : LPCWSTR) : BOOL;
    ...
    PROCEDURE [stdcall] GetNumberOfEventLogRecords* (hEventLog : HANDLE; VAR [nil] NumberOfRecords : DWORD) : BOOL;
    PROCEDURE [stdcall] GetOldestEventLogRecord* (hEventLog : HANDLE; VAR [nil] OldestRecord : DWORD) : BOOL;
    PROCEDURE [stdcall] OpenEventLogA* (lpUNCServerName : LPCSTR; lpSourceName : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] OpenEventLogW* (lpUNCServerName : LPCWSTR; lpSourceName : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] RegisterEventSourceA* (lpUNCServerName : LPCSTR; lpSourceName : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] RegisterEventSourceW* (lpUNCServerName : LPCWSTR; lpSourceName : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] OpenBackupEventLogA* (lpUNCServerName : LPCSTR; lpFileName : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] OpenBackupEventLogW* (lpUNCServerName : LPCWSTR; lpFileName : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] ReadEventLogA* (hEventLog : HANDLE; dwReadFlags : DWORD; dwRecordOffset : DWORD; lpBuffer : LPVOID; nNumberOfBytesToRead : DWORD; VAR [nil] pnBytesRead : DWORD; VAR [nil] pnMinNumberOfBytesNeeded : DWORD) : BOOL;
    PROCEDURE [stdcall] ReadEventLogW* (hEventLog : HANDLE; dwReadFlags : DWORD; dwRecordOffset : DWORD; lpBuffer : LPVOID; nNumberOfBytesToRead : DWORD; VAR [nil] pnBytesRead : DWORD; VAR [nil] pnMinNumberOfBytesNeeded : DWORD) : BOOL;
    PROCEDURE [stdcall] ReportEventA* (hEventLog : HANDLE; wType : WORD; wCategory : WORD; dwEventID : DWORD; lpUserSid : PSID; wNumStrings : WORD; dwDataSize : DWORD; VAR [nil] lpStrings : LPCSTR; lpRawData : LPVOID) : BOOL;
    PROCEDURE [stdcall] ReportEventW* (hEventLog : HANDLE; wType : WORD; wCategory : WORD; dwEventID : DWORD; lpUserSid : PSID; wNumStrings : WORD; dwDataSize : DWORD; VAR [nil] lpStrings : LPCWSTR; lpRawData : LPVOID) : BOOL;
    ...
    PROCEDURE [stdcall] GetKernelObjectSecurity* (Handle : HANDLE; RequestedInformation : SECURITY_INFORMATION; pSecurityDescriptor : PSECURITY_DESCRIPTOR; nLength : DWORD; VAR [nil] lpnLengthNeeded : DWORD) : BOOL;
    ...
    PROCEDURE [stdcall] AccessCheck* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; ClientToken : HANDLE; DesiredAccess : DWORD; VAR [nil] GenericMapping : GENERIC_MAPPING; VAR [nil] PrivilegeSet : _PRIVILEGE_SET_struct; VAR [nil] PrivilegeSetLength : DWORD; VAR [nil] GrantedAccess : DWORD; VAR [nil] AccessStatus : BOOL) : BOOL;
    PROCEDURE [stdcall] OpenProcessToken* (ProcessHandle : HANDLE; DesiredAccess : DWORD; VAR [nil] TokenHandle : HANDLE) : BOOL;
    PROCEDURE [stdcall] OpenThreadToken* (ThreadHandle : HANDLE; DesiredAccess : DWORD; OpenAsSelf : BOOL; VAR [nil] TokenHandle : HANDLE) : BOOL;
    PROCEDURE [stdcall] GetTokenInformation* (TokenHandle : HANDLE; TokenInformationClass : TOKEN_INFORMATION_CLASS; TokenInformation : LPVOID; TokenInformationLength : DWORD; VAR [nil] ReturnLength : DWORD) : BOOL;
    PROCEDURE [stdcall] SetTokenInformation* (TokenHandle : HANDLE; TokenInformationClass : TOKEN_INFORMATION_CLASS; TokenInformation : LPVOID; TokenInformationLength : DWORD) : BOOL;
    PROCEDURE [stdcall] AdjustTokenPrivileges* (TokenHandle : HANDLE; DisableAllPrivileges : BOOL; VAR [nil] NewState : _TOKEN_PRIVILEGES_struct; BufferLength : DWORD; VAR [nil] PreviousState : _TOKEN_PRIVILEGES_struct; VAR [nil] ReturnLength : DWORD) : BOOL;
    PROCEDURE [stdcall] AdjustTokenGroups* (TokenHandle : HANDLE; ResetToDefault : BOOL; VAR [nil] NewState : _TOKEN_GROUPS_struct; BufferLength : DWORD; VAR [nil] PreviousState : _TOKEN_GROUPS_struct; VAR [nil] ReturnLength : DWORD) : BOOL;
    PROCEDURE [stdcall] PrivilegeCheck* (ClientToken : HANDLE; VAR [nil] RequiredPrivileges : _PRIVILEGE_SET_struct; VAR [nil] pfResult : BOOL) : BOOL;
    PROCEDURE [stdcall] AccessCheckAndAuditAlarmA* (SubsystemName : LPCSTR; HandleId : LPVOID; ObjectTypeName : LPSTR; ObjectName : LPSTR; SecurityDescriptor : PSECURITY_DESCRIPTOR; DesiredAccess : DWORD; VAR [nil] GenericMapping : GENERIC_MAPPING; ObjectCreation : BOOL; VAR [nil] GrantedAccess : DWORD; VAR [nil] AccessStatus : BOOL; VAR [nil] pfGenerateOnClose : BOOL) : BOOL;
    PROCEDURE [stdcall] AccessCheckAndAuditAlarmW* (SubsystemName : LPCWSTR; HandleId : LPVOID; ObjectTypeName : LPWSTR; ObjectName : LPWSTR; SecurityDescriptor : PSECURITY_DESCRIPTOR; DesiredAccess : DWORD; VAR [nil] GenericMapping : GENERIC_MAPPING; ObjectCreation : BOOL; VAR [nil] GrantedAccess : DWORD; VAR [nil] AccessStatus : BOOL; VAR [nil] pfGenerateOnClose : BOOL) : BOOL;
    PROCEDURE [stdcall] ObjectOpenAuditAlarmA* (SubsystemName : LPCSTR; HandleId : LPVOID; ObjectTypeName : LPSTR; ObjectName : LPSTR; pSecurityDescriptor : PSECURITY_DESCRIPTOR; ClientToken : HANDLE; DesiredAccess : DWORD; GrantedAccess : DWORD; VAR [nil] Privileges : _PRIVILEGE_SET_struct; ObjectCreation : BOOL; AccessGranted : BOOL; VAR [nil] GenerateOnClose : BOOL) : BOOL;
    ...
    PROCEDURE [stdcall] ObjectPrivilegeAuditAlarmA* (SubsystemName : LPCSTR; HandleId : LPVOID; ClientToken : HANDLE; DesiredAccess : DWORD; VAR [nil] Privileges : _PRIVILEGE_SET_struct; AccessGranted : BOOL) : BOOL;
    PROCEDURE [stdcall] ObjectPrivilegeAuditAlarmW* (SubsystemName : LPCWSTR; HandleId : LPVOID; ClientToken : HANDLE; DesiredAccess : DWORD; VAR [nil] Privileges : _PRIVILEGE_SET_struct; AccessGranted : BOOL) : BOOL;
    PROCEDURE [stdcall] ObjectCloseAuditAlarmA* (SubsystemName : LPCSTR; HandleId : LPVOID; GenerateOnClose : BOOL) : BOOL;
    PROCEDURE [stdcall] ObjectCloseAuditAlarmW* (SubsystemName : LPCWSTR; HandleId : LPVOID; GenerateOnClose : BOOL) : BOOL;
    PROCEDURE [stdcall] ObjectDeleteAuditAlarmA* (SubsystemName : LPCSTR; HandleId : LPVOID; GenerateOnClose : BOOL) : BOOL;
    PROCEDURE [stdcall] ObjectDeleteAuditAlarmW* (SubsystemName : LPCWSTR; HandleId : LPVOID; GenerateOnClose : BOOL) : BOOL;
    PROCEDURE [stdcall] PrivilegedServiceAuditAlarmA* (SubsystemName : LPCSTR; ServiceName : LPCSTR; ClientToken : HANDLE; VAR [nil] Privileges : _PRIVILEGE_SET_struct; AccessGranted : BOOL) : BOOL;
    PROCEDURE [stdcall] PrivilegedServiceAuditAlarmW* (SubsystemName : LPCWSTR; ServiceName : LPCWSTR; ClientToken : HANDLE; VAR [nil] Privileges : _PRIVILEGE_SET_struct; AccessGranted : BOOL) : BOOL;
    ...
    PROCEDURE [stdcall] GetSidLengthRequired* (nSubAuthorityCount : UCHAR) : DWORD;
    ...
    PROCEDURE [stdcall] FreeSid* (pSid : PSID) : PVOID;
    PROCEDURE [stdcall] InitializeSid* (Sid : PSID; VAR [nil] pIdentifierAuthority : _SID_IDENTIFIER_AUTHORITY_struct; nSubAuthorityCount : BYTE) : BOOL;
    PROCEDURE [stdcall] GetSidIdentifierAuthority* (pSid : PSID) : PSID_IDENTIFIER_AUTHORITY;
    PROCEDURE [stdcall] GetSidSubAuthority* (pSid : PSID; nSubAuthority : DWORD) : PDWORD;
    PROCEDURE [stdcall] GetSidSubAuthorityCount* (pSid : PSID) : PUCHAR;
    PROCEDURE [stdcall] GetLengthSid* (pSid : PSID) : DWORD;
    PROCEDURE [stdcall] CopySid* (nDestinationSidLength : DWORD; pDestinationSid : PSID; pSourceSid : PSID) : BOOL;
    PROCEDURE [stdcall] AreAllAccessesGranted* (GrantedAccess : DWORD; DesiredAccess : DWORD) : BOOL;
    PROCEDURE [stdcall] AreAnyAccessesGranted* (GrantedAccess : DWORD; DesiredAccess : DWORD) : BOOL;
    PROCEDURE [stdcall] MapGenericMask* (VAR [nil] AccessMask : DWORD; VAR [nil] GenericMapping : GENERIC_MAPPING);
    PROCEDURE [stdcall] IsValidAcl* (VAR [nil] pAcl : ACL) : BOOL;
    PROCEDURE [stdcall] InitializeAcl* (VAR [nil] pAcl : ACL; nAclLength : DWORD; dwAclRevision : DWORD) : BOOL;
    PROCEDURE [stdcall] GetAclInformation* (VAR [nil] pAcl : ACL; pAclInformation : LPVOID; nAclInformationLength : DWORD; dwAclInformationClass : ACL_INFORMATION_CLASS) : BOOL;
    PROCEDURE [stdcall] SetAclInformation* (VAR [nil] pAcl : ACL; pAclInformation : LPVOID; nAclInformationLength : DWORD; dwAclInformationClass : ACL_INFORMATION_CLASS) : BOOL;
    PROCEDURE [stdcall] AddAce* (VAR [nil] pAcl : ACL; dwAceRevision : DWORD; dwStartingAceIndex : DWORD; pAceList : LPVOID; nAceListLength : DWORD) : BOOL;
    PROCEDURE [stdcall] DeleteAce* (VAR [nil] pAcl : ACL; dwAceIndex : DWORD) : BOOL;
    PROCEDURE [stdcall] GetAce* (VAR [nil] pAcl : ACL; dwAceIndex : DWORD; VAR [nil] pAce : LPVOID) : BOOL;
    PROCEDURE [stdcall] AddAccessAllowedAce* (VAR [nil] pAcl : ACL; dwAceRevision : DWORD; AccessMask : DWORD; pSid : PSID) : BOOL;
    PROCEDURE [stdcall] AddAccessDeniedAce* (VAR [nil] pAcl : ACL; dwAceRevision : DWORD; AccessMask : DWORD; pSid : PSID) : BOOL;
    PROCEDURE [stdcall] AddAuditAccessAce* (VAR [nil] pAcl : ACL; dwAceRevision : DWORD; dwAccessMask : DWORD; pSid : PSID; bAuditSuccess : BOOL; bAuditFailure : BOOL) : BOOL;
    PROCEDURE [stdcall] FindFirstFreeAce* (VAR [nil] pAcl : ACL; VAR [nil] pAce : LPVOID) : BOOL;
    PROCEDURE [stdcall] InitializeSecurityDescriptor* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; dwRevision : DWORD) : BOOL;
    PROCEDURE [stdcall] IsValidSecurityDescriptor* (pSecurityDescriptor : PSECURITY_DESCRIPTOR) : BOOL;
    PROCEDURE [stdcall] GetSecurityDescriptorLength* (pSecurityDescriptor : PSECURITY_DESCRIPTOR) : DWORD;
    PROCEDURE [stdcall] GetSecurityDescriptorControl* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; VAR [nil] pControl : WORD; VAR [nil] lpdwRevision : DWORD) : BOOL;
    ...
    PROCEDURE [stdcall] GetSecurityDescriptorDacl* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; VAR [nil] lpbDaclPresent : BOOL; VAR [nil] pDacl : PACL; VAR [nil] lpbDaclDefaulted : BOOL) : BOOL;
    ...
    PROCEDURE [stdcall] GetSecurityDescriptorSacl* (pSecurityDescriptor : PSECURITY_DESCRIPTOR; VAR [nil] lpbSaclPresent : BOOL; VAR [nil] pSacl : PACL; VAR [nil] lpbSaclDefaulted : BOOL) : BOOL;
    ...
    PROCEDURE [stdcall] GetPrivateObjectSecurity* (ObjectDescriptor : PSECURITY_DESCRIPTOR; SecurityInformation : SECURITY_INFORMATION; ResultantDescriptor : PSECURITY_DESCRIPTOR; DescriptorLength : DWORD; VAR [nil] ReturnLength : DWORD) : BOOL;
    PROCEDURE [stdcall] DestroyPrivateObjectSecurity* (VAR [nil] ObjectDescriptor : PSECURITY_DESCRIPTOR) : BOOL;
    PROCEDURE [stdcall] MakeSelfRelativeSD* (pAbsoluteSecurityDescriptor : PSECURITY_DESCRIPTOR; pSelfRelativeSecurityDescriptor : PSECURITY_DESCRIPTOR; VAR [nil] lpdwBufferLength : DWORD) : BOOL;
    ...
    PROCEDURE [stdcall] SetFileSecurityA* (lpFileName : LPCSTR; SecurityInformation : SECURITY_INFORMATION; pSecurityDescriptor : PSECURITY_DESCRIPTOR) : BOOL;
    PROCEDURE [stdcall] SetFileSecurityW* (lpFileName : LPCWSTR; SecurityInformation : SECURITY_INFORMATION; pSecurityDescriptor : PSECURITY_DESCRIPTOR) : BOOL;
    PROCEDURE [stdcall] GetFileSecurityA* (lpFileName : LPCSTR; RequestedInformation : SECURITY_INFORMATION; pSecurityDescriptor : PSECURITY_DESCRIPTOR; nLength : DWORD; VAR [nil] lpnLengthNeeded : DWORD) : BOOL;
    PROCEDURE [stdcall] GetFileSecurityW* (lpFileName : LPCWSTR; RequestedInformation : SECURITY_INFORMATION; pSecurityDescriptor : PSECURITY_DESCRIPTOR; nLength : DWORD; VAR [nil] lpnLengthNeeded : DWORD) : BOOL;
    ...
    PROCEDURE [stdcall] FindFirstChangeNotificationA* (lpPathName : LPCSTR; bWatchSubtree : BOOL; dwNotifyFilter : DWORD) : HANDLE;
    PROCEDURE [stdcall] FindFirstChangeNotificationW* (lpPathName : LPCWSTR; bWatchSubtree : BOOL; dwNotifyFilter : DWORD) : HANDLE;
    ...
    PROCEDURE [stdcall] ReadDirectoryChangesW* (hDirectory : HANDLE; lpBuffer : LPVOID; nBufferLength : DWORD; bWatchSubtree : BOOL; dwNotifyFilter : DWORD; VAR [nil] lpBytesReturned : DWORD; VAR [nil] lpOverlapped : _OVERLAPPED_struct; lpCompletionRoutine : LPOVERLAPPED_COMPLETION_ROUTINE) : BOOL;
    PROCEDURE [stdcall] VirtualLock* (lpAddress : LPVOID; dwSize : DWORD) : BOOL;
    PROCEDURE [stdcall] VirtualUnlock* (lpAddress : LPVOID; dwSize : DWORD) : BOOL;
    PROCEDURE [stdcall] MapViewOfFileEx* (hFileMappingObject : HANDLE; dwDesiredAccess : DWORD; dwFileOffsetHigh : DWORD; dwFileOffsetLow : DWORD; dwNumberOfBytesToMap : DWORD; lpBaseAddress : LPVOID) : LPVOID;
    PROCEDURE [stdcall] SetPriorityClass* (hProcess : HANDLE; dwPriorityClass : DWORD) : BOOL;
    PROCEDURE [stdcall] GetPriorityClass* (hProcess : HANDLE) : DWORD;
    PROCEDURE [stdcall] IsBadReadPtr* (lp : LPVOID; ucb : UINT) : BOOL;
    PROCEDURE [stdcall] IsBadWritePtr* (lp : LPVOID; ucb : UINT) : BOOL;
    PROCEDURE [stdcall] IsBadHugeReadPtr* (lp : LPVOID; ucb : UINT) : BOOL;
    PROCEDURE [stdcall] IsBadHugeWritePtr* (lp : LPVOID; ucb : UINT) : BOOL;
    PROCEDURE [stdcall] IsBadCodePtr* (lpfn : FARPROC) : BOOL;
    PROCEDURE [stdcall] IsBadStringPtrA* (lpsz : LPCSTR; ucchMax : UINT) : BOOL;
    PROCEDURE [stdcall] IsBadStringPtrW* (lpsz : LPCWSTR; ucchMax : UINT) : BOOL;
    PROCEDURE [stdcall] LookupAccountSidA* (lpSystemName : LPCSTR; Sid : PSID; Name : LPSTR; VAR [nil] cbName : DWORD; ReferencedDomainName : LPSTR; VAR [nil] cbReferencedDomainName : DWORD; peUse : PSID_NAME_USE) : BOOL;
    PROCEDURE [stdcall] LookupAccountSidW* (lpSystemName : LPCWSTR; Sid : PSID; Name : LPWSTR; VAR [nil] cbName : DWORD; ReferencedDomainName : LPWSTR; VAR [nil] cbReferencedDomainName : DWORD; peUse : PSID_NAME_USE) : BOOL;
    PROCEDURE [stdcall] LookupAccountNameA* (lpSystemName : LPCSTR; lpAccountName : LPCSTR; Sid : PSID; VAR [nil] cbSid : DWORD; ReferencedDomainName : LPSTR; VAR [nil] cbReferencedDomainName : DWORD; peUse : PSID_NAME_USE) : BOOL;
    PROCEDURE [stdcall] LookupAccountNameW* (lpSystemName : LPCWSTR; lpAccountName : LPCWSTR; Sid : PSID; VAR [nil] cbSid : DWORD; ReferencedDomainName : LPWSTR; VAR [nil] cbReferencedDomainName : DWORD; peUse : PSID_NAME_USE) : BOOL;
    PROCEDURE [stdcall] LookupPrivilegeValueA* (lpSystemName : LPCSTR; lpName : LPCSTR; VAR [nil] lpLuid : _LUID_struct) : BOOL;
    PROCEDURE [stdcall] LookupPrivilegeValueW* (lpSystemName : LPCWSTR; lpName : LPCWSTR; VAR [nil] lpLuid : _LUID_struct) : BOOL;
    PROCEDURE [stdcall] LookupPrivilegeNameA* (lpSystemName : LPCSTR; VAR [nil] lpLuid : _LUID_struct; lpName : LPSTR; VAR [nil] cbName : DWORD) : BOOL;
    PROCEDURE [stdcall] LookupPrivilegeNameW* (lpSystemName : LPCWSTR; VAR [nil] lpLuid : _LUID_struct; lpName : LPWSTR; VAR [nil] cbName : DWORD) : BOOL;
    PROCEDURE [stdcall] LookupPrivilegeDisplayNameA* (lpSystemName : LPCSTR; lpName : LPCSTR; lpDisplayName : LPSTR; VAR [nil] cbDisplayName : DWORD; VAR [nil] lpLanguageId : DWORD) : BOOL;
    PROCEDURE [stdcall] LookupPrivilegeDisplayNameW* (lpSystemName : LPCWSTR; lpName : LPCWSTR; lpDisplayName : LPWSTR; VAR [nil] cbDisplayName : DWORD; VAR [nil] lpLanguageId : DWORD) : BOOL;
    PROCEDURE [stdcall] AllocateLocallyUniqueId* (VAR [nil] Luid : _LUID_struct) : BOOL;
    PROCEDURE [stdcall] BuildCommDCBA* (lpDef : LPCSTR; VAR [nil] lpDCB : _DCB_struct) : BOOL;
    PROCEDURE [stdcall] BuildCommDCBW* (lpDef : LPCWSTR; VAR [nil] lpDCB : _DCB_struct) : BOOL;
    PROCEDURE [stdcall] BuildCommDCBAndTimeoutsA* (lpDef : LPCSTR; VAR [nil] lpDCB : _DCB_struct; VAR [nil] lpCommTimeouts : _COMMTIMEOUTS_struct) : BOOL;
    PROCEDURE [stdcall] BuildCommDCBAndTimeoutsW* (lpDef : LPCWSTR; VAR [nil] lpDCB : _DCB_struct; VAR [nil] lpCommTimeouts : _COMMTIMEOUTS_struct) : BOOL;
    PROCEDURE [stdcall] CommConfigDialogA* (lpszName : LPCSTR; hWnd : HWND; VAR [nil] lpCC : _COMMCONFIG_struct) : BOOL;
    PROCEDURE [stdcall] CommConfigDialogW* (lpszName : LPCWSTR; hWnd : HWND; VAR [nil] lpCC : _COMMCONFIG_struct) : BOOL;
    PROCEDURE [stdcall] GetDefaultCommConfigA* (lpszName : LPCSTR; VAR [nil] lpCC : _COMMCONFIG_struct; VAR [nil] lpdwSize : DWORD) : BOOL;
    PROCEDURE [stdcall] GetDefaultCommConfigW* (lpszName : LPCWSTR; VAR [nil] lpCC : _COMMCONFIG_struct; VAR [nil] lpdwSize : DWORD) : BOOL;
    PROCEDURE [stdcall] SetDefaultCommConfigA* (lpszName : LPCSTR; VAR [nil] lpCC : _COMMCONFIG_struct; dwSize : DWORD) : BOOL;
    PROCEDURE [stdcall] SetDefaultCommConfigW* (lpszName : LPCWSTR; VAR [nil] lpCC : _COMMCONFIG_struct; dwSize : DWORD) : BOOL;
    PROCEDURE [stdcall] GetComputerNameA* (lpBuffer : LPSTR; VAR [nil] nSize : DWORD) : BOOL;
    PROCEDURE [stdcall] GetComputerNameW* (lpBuffer : LPWSTR; VAR [nil] nSize : DWORD) : BOOL;
    PROCEDURE [stdcall] SetComputerNameA* (lpComputerName : LPCSTR) : BOOL;
    PROCEDURE [stdcall] SetComputerNameW* (lpComputerName : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] GetUserNameA* (lpBuffer : LPSTR; VAR [nil] nSize : DWORD) : BOOL;
    PROCEDURE [stdcall] GetUserNameW* (lpBuffer : LPWSTR; VAR [nil] nSize : DWORD) : BOOL;
    PROCEDURE [stdcall] LogonUserA* (lpszUsername : LPSTR; lpszDomain : LPSTR; lpszPassword : LPSTR; dwLogonType : DWORD; dwLogonProvider : DWORD; VAR [nil] phToken : HANDLE) : BOOL;
    PROCEDURE [stdcall] LogonUserW* (lpszUsername : LPWSTR; lpszDomain : LPWSTR; lpszPassword : LPWSTR; dwLogonType : DWORD; dwLogonProvider : DWORD; VAR [nil] phToken : HANDLE) : BOOL;
    ...
    PROCEDURE [stdcall] DuplicateTokenEx* (hExistingToken : HANDLE; dwDesiredAccess : DWORD; VAR [nil] lpTokenAttributes : _SECURITY_ATTRIBUTES_struct; ImpersonationLevel : SECURITY_IMPERSONATION_LEVEL; TokenType : TOKEN_TYPE; VAR [nil] phNewToken : HANDLE) : BOOL;
    PROCEDURE [stdcall] CreateRestrictedToken* (ExistingTokenHandle : HANDLE; Flags : DWORD; DisableSidCount : DWORD; VAR [nil] SidsToDisable : _SID_AND_ATTRIBUTES_struct; DeletePrivilegeCount : DWORD; VAR [nil] PrivilegesToDelete : _LUID_AND_ATTRIBUTES_struct; RestrictedSidCount : DWORD; VAR [nil] SidsToRestrict : _SID_AND_ATTRIBUTES_struct; VAR [nil] NewTokenHandle : HANDLE) : BOOL;
    PROCEDURE [stdcall] IsTokenRestricted* (TokenHandle : HANDLE) : BOOL;
    PROCEDURE [stdcall] GetCurrentHwProfileA* (VAR [nil] lpHwProfileInfo : tagHW_PROFILE_INFOA_struct) : BOOL;
    PROCEDURE [stdcall] GetCurrentHwProfileW* (VAR [nil] lpHwProfileInfo : tagHW_PROFILE_INFOW_struct) : BOOL;
    PROCEDURE [stdcall] QueryPerformanceCounter* (VAR [nil] lpPerformanceCount : LARGE_INTEGER) : BOOL;
    PROCEDURE [stdcall] QueryPerformanceFrequency* (VAR [nil] lpFrequency : LARGE_INTEGER) : BOOL;
    PROCEDURE [stdcall] GetVersionExA* (VAR [nil] lpVersionInformation : _OSVERSIONINFOA_struct) : BOOL;
    PROCEDURE [stdcall] GetVersionExW* (VAR [nil] lpVersionInformation : _OSVERSIONINFOW_struct) : BOOL;
    PROCEDURE [stdcall] GetSystemPowerStatus* (VAR [nil] lpSystemPowerStatus : _SYSTEM_POWER_STATUS_struct) : BOOL;
    PROCEDURE [stdcall] SetSystemPowerState* (fSuspend : BOOL; fForce : BOOL) : BOOL;
    PROCEDURE [stdcall] WinSubmitCertificate* (VAR [nil] lpCertificate : _WIN_CERTIFICATE_struct) : BOOL;
    PROCEDURE [stdcall] WinVerifyTrust* (hwnd : HWND; VAR [nil] ActionID : GUID; ActionData : LPVOID) : LONG;
    PROCEDURE [stdcall] WinLoadTrustProvider* (VAR [nil] ActionID : GUID) : BOOL;
    PROCEDURE [stdcall] AddFontResourceA* (p0 : LPCSTR) : LONGINT;
    PROCEDURE [stdcall] AddFontResourceW* (p0 : LPCWSTR) : LONGINT;
    PROCEDURE [stdcall] AnimatePalette* (p0 : HPALETTE; p1 : UINT; p2 : UINT; VAR [nil] p3 : PALETTEENTRY) : BOOL;
    PROCEDURE [stdcall] Arc* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : LONGINT; p6 : LONGINT; p7 : LONGINT; p8 : LONGINT) : BOOL;
    PROCEDURE [stdcall] BitBlt* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : HDC; p6 : LONGINT; p7 : LONGINT; p8 : DWORD) : BOOL;
    PROCEDURE [stdcall] CancelDC* (p0 : HDC) : BOOL;
    PROCEDURE [stdcall] Chord* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : LONGINT; p6 : LONGINT; p7 : LONGINT; p8 : LONGINT) : BOOL;
    PROCEDURE [stdcall] ChoosePixelFormat* (p0 : HDC; VAR [nil] p1 : PIXELFORMATDESCRIPTOR) : LONGINT;
    PROCEDURE [stdcall] CloseMetaFile* (p0 : HDC) : HMETAFILE;
    PROCEDURE [stdcall] CombineRgn* (p0 : HRGN; p1 : HRGN; p2 : HRGN; p3 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] CopyMetaFileA* (p0 : HMETAFILE; p1 : LPCSTR) : HMETAFILE;
    PROCEDURE [stdcall] CopyMetaFileW* (p0 : HMETAFILE; p1 : LPCWSTR) : HMETAFILE;
    PROCEDURE [stdcall] CreateBitmap* (p0 : LONGINT; p1 : LONGINT; p2 : UINT; p3 : UINT; p4 : LPVOID) : HBITMAP;
    ...
    PROCEDURE [stdcall] CreateCompatibleBitmap* (p0 : HDC; p1 : LONGINT; p2 : LONGINT) : HBITMAP;
    PROCEDURE [stdcall] CreateDiscardableBitmap* (p0 : HDC; p1 : LONGINT; p2 : LONGINT) : HBITMAP;
    PROCEDURE [stdcall] CreateCompatibleDC* (p0 : HDC) : HDC;
    PROCEDURE [stdcall] CreateDCA* (p0 : LPCSTR; p1 : LPCSTR; p2 : LPCSTR; VAR [nil] p3 : DEVMODEA) : HDC;
    PROCEDURE [stdcall] CreateDCW* (p0 : LPCWSTR; p1 : LPCWSTR; p2 : LPCWSTR; VAR [nil] p3 : DEVMODEW) : HDC;
    PROCEDURE [stdcall] CreateDIBitmap* (p0 : HDC; VAR [nil] p1 : BITMAPINFOHEADER; p2 : DWORD; p3 : LPVOID; VAR [nil] p4 : BITMAPINFO; p5 : UINT) : HBITMAP;
    PROCEDURE [stdcall] CreateDIBPatternBrush* (p0 : HGLOBAL; p1 : UINT) : HBRUSH;
    PROCEDURE [stdcall] CreateDIBPatternBrushPt* (p0 : LPVOID; p1 : UINT) : HBRUSH;
    PROCEDURE [stdcall] CreateEllipticRgn* (p0 : LONGINT; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT) : HRGN;
    ...
    PROCEDURE [stdcall] CreateFontA* (p0 : LONGINT; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : DWORD; p6 : DWORD; p7 : DWORD; p8 : DWORD; p9 : DWORD; p10 : DWORD; p11 : DWORD; p12 : DWORD; p13 : LPCSTR) : HFONT;
    PROCEDURE [stdcall] CreateFontW* (p0 : LONGINT; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : DWORD; p6 : DWORD; p7 : DWORD; p8 : DWORD; p9 : DWORD; p10 : DWORD; p11 : DWORD; p12 : DWORD; p13 : LPCWSTR) : HFONT;
    PROCEDURE [stdcall] CreateHatchBrush* (p0 : LONGINT; p1 : COLORREF) : HBRUSH;
    PROCEDURE [stdcall] CreateICA* (p0 : LPCSTR; p1 : LPCSTR; p2 : LPCSTR; VAR [nil] p3 : DEVMODEA) : HDC;
    PROCEDURE [stdcall] CreateICW* (p0 : LPCWSTR; p1 : LPCWSTR; p2 : LPCWSTR; VAR [nil] p3 : DEVMODEW) : HDC;
    PROCEDURE [stdcall] CreateMetaFileA* (p0 : LPCSTR) : HDC;
    PROCEDURE [stdcall] CreateMetaFileW* (p0 : LPCWSTR) : HDC;
    PROCEDURE [stdcall] CreatePalette* (VAR [nil] p0 : LOGPALETTE) : HPALETTE;
    PROCEDURE [stdcall] CreatePen* (p0 : LONGINT; p1 : LONGINT; p2 : COLORREF) : HPEN;
    PROCEDURE [stdcall] CreatePenIndirect* (VAR [nil] p0 : LOGPEN) : HPEN;
    PROCEDURE [stdcall] CreatePolyPolygonRgn* (VAR [nil] p0 : POINT; VAR [nil] p1 : INT; p2 : LONGINT; p3 : LONGINT) : HRGN;
    PROCEDURE [stdcall] CreatePatternBrush* (p0 : HBITMAP) : HBRUSH;
    PROCEDURE [stdcall] CreateRectRgn* (p0 : LONGINT; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT) : HRGN;
    PROCEDURE [stdcall] CreateRectRgnIndirect* (VAR [nil] p0 : RECT) : HRGN;
    PROCEDURE [stdcall] CreateRoundRectRgn* (p0 : LONGINT; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : LONGINT) : HRGN;
    PROCEDURE [stdcall] CreateScalableFontResourceA* (p0 : DWORD; p1 : LPCSTR; p2 : LPCSTR; p3 : LPCSTR) : BOOL;
    PROCEDURE [stdcall] CreateScalableFontResourceW* (p0 : DWORD; p1 : LPCWSTR; p2 : LPCWSTR; p3 : LPCWSTR) : BOOL;
    ...
    PROCEDURE [stdcall] DescribePixelFormat* (p0 : HDC; p1 : LONGINT; p2 : UINT; VAR [nil] p3 : tagPIXELFORMATDESCRIPTOR_struct) : LONGINT;
    PROCEDURE [stdcall] DeviceCapabilitiesA* (p0 : LPCSTR; p1 : LPCSTR; p2 : WORD; p3 : LPSTR; VAR [nil] p4 : DEVMODEA) : LONGINT;
    PROCEDURE [stdcall] DeviceCapabilitiesW* (p0 : LPCWSTR; p1 : LPCWSTR; p2 : WORD; p3 : LPWSTR; VAR [nil] p4 : DEVMODEW) : LONGINT;
    PROCEDURE [stdcall] DrawEscape* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LPCSTR) : LONGINT;
    PROCEDURE [stdcall] Ellipse* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT) : BOOL;
    PROCEDURE [stdcall] EnumFontFamiliesExA* (p0 : HDC; VAR [nil] p1 : tagLOGFONTA_struct; p2 : FONTENUMPROCA; p3 : LPARAM; p4 : DWORD) : LONGINT;
    PROCEDURE [stdcall] EnumFontFamiliesExW* (p0 : HDC; VAR [nil] p1 : tagLOGFONTW_struct; p2 : FONTENUMPROCW; p3 : LPARAM; p4 : DWORD) : LONGINT;
    PROCEDURE [stdcall] EnumFontFamiliesA* (p0 : HDC; p1 : LPCSTR; p2 : FONTENUMPROCA; p3 : LPARAM) : LONGINT;
    PROCEDURE [stdcall] EnumFontFamiliesW* (p0 : HDC; p1 : LPCWSTR; p2 : FONTENUMPROCW; p3 : LPARAM) : LONGINT;
    PROCEDURE [stdcall] EnumFontsA* (p0 : HDC; p1 : LPCSTR; p2 : FONTENUMPROCA; p3 : LPARAM) : LONGINT;
    PROCEDURE [stdcall] EnumFontsW* (p0 : HDC; p1 : LPCWSTR; p2 : FONTENUMPROCW; p3 : LPARAM) : LONGINT;
    PROCEDURE [stdcall] EnumObjects* (p0 : HDC; p1 : LONGINT; p2 : GOBJENUMPROC; p3 : LPVOID) : LONGINT;
    PROCEDURE [stdcall] EqualRgn* (p0 : HRGN; p1 : HRGN) : BOOL;
    PROCEDURE [stdcall] Escape* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LPCSTR; p4 : LPVOID) : LONGINT;
    PROCEDURE [stdcall] ExtEscape* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LPCSTR; p4 : LONGINT; p5 : LPSTR) : LONGINT;
    PROCEDURE [stdcall] ExcludeClipRect* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] ExtCreateRegion* (VAR [nil] p0 : XFORM; p1 : DWORD; VAR [nil] p2 : RGNDATA) : HRGN;
    PROCEDURE [stdcall] ExtFloodFill* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : COLORREF; p4 : UINT) : BOOL;
    PROCEDURE [stdcall] FillRgn* (p0 : HDC; p1 : HRGN; p2 : HBRUSH) : BOOL;
    PROCEDURE [stdcall] FloodFill* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : COLORREF) : BOOL;
    PROCEDURE [stdcall] FrameRgn* (p0 : HDC; p1 : HRGN; p2 : HBRUSH; p3 : LONGINT; p4 : LONGINT) : BOOL;
    PROCEDURE [stdcall] GetROP2* (p0 : HDC) : LONGINT;
    PROCEDURE [stdcall] GetAspectRatioFilterEx* (p0 : HDC; VAR [nil] p1 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] GetBkColor* (p0 : HDC) : COLORREF;
    PROCEDURE [stdcall] GetBkMode* (p0 : HDC) : LONGINT;
    PROCEDURE [stdcall] GetBitmapBits* (p0 : HBITMAP; p1 : LONG; p2 : LPVOID) : LONG;
    PROCEDURE [stdcall] GetBitmapDimensionEx* (p0 : HBITMAP; VAR [nil] p1 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] GetBoundsRect* (p0 : HDC; VAR [nil] p1 : tagRECT_struct; p2 : UINT) : UINT;
    PROCEDURE [stdcall] GetBrushOrgEx* (p0 : HDC; VAR [nil] p1 : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] GetCharWidthA* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : LONGINT) : BOOL;
    PROCEDURE [stdcall] GetCharWidthW* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : LONGINT) : BOOL;
    PROCEDURE [stdcall] GetCharWidth32A* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : LONGINT) : BOOL;
    PROCEDURE [stdcall] GetCharWidth32W* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : LONGINT) : BOOL;
    PROCEDURE [stdcall] GetCharWidthFloatA* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : FLOAT) : BOOL;
    PROCEDURE [stdcall] GetCharWidthFloatW* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : FLOAT) : BOOL;
    PROCEDURE [stdcall] GetCharABCWidthsA* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : _ABC_struct) : BOOL;
    PROCEDURE [stdcall] GetCharABCWidthsW* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : _ABC_struct) : BOOL;
    PROCEDURE [stdcall] GetCharABCWidthsFloatA* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : _ABCFLOAT_struct) : BOOL;
    PROCEDURE [stdcall] GetCharABCWidthsFloatW* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : _ABCFLOAT_struct) : BOOL;
    PROCEDURE [stdcall] GetClipBox* (p0 : HDC; VAR [nil] p1  : tagRECT_struct) : LONGINT;
    PROCEDURE [stdcall] GetClipRgn* (p0 : HDC; p1 : HRGN) : LONGINT;
    PROCEDURE [stdcall] GetMetaRgn* (p0 : HDC; p1 : HRGN) : LONGINT;
    PROCEDURE [stdcall] GetCurrentObject* (p0 : HDC; p1 : UINT) : HGDIOBJ;
    PROCEDURE [stdcall] GetCurrentPositionEx* (p0 : HDC; VAR [nil] p1 : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] GetDeviceCaps* (p0 : HDC; p1 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetDIBits* (p0 : HDC; p1 : HBITMAP; p2 : UINT; p3 : UINT; p4 : LPVOID; VAR [nil] p5 : tagBITMAPINFO_struct; p6 : UINT) : LONGINT;
    PROCEDURE [stdcall] GetFontData* (p0 : HDC; p1 : DWORD; p2 : DWORD; p3 : LPVOID; p4 : DWORD) : DWORD;
    PROCEDURE [stdcall] GetGlyphOutlineA* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : _GLYPHMETRICS_struct; p4 : DWORD; p5 : LPVOID; VAR [nil] p6 : MAT2) : DWORD;
    PROCEDURE [stdcall] GetGlyphOutlineW* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : _GLYPHMETRICS_struct; p4 : DWORD; p5 : LPVOID; VAR [nil] p6 : MAT2) : DWORD;
    PROCEDURE [stdcall] GetGraphicsMode* (p0 : HDC) : LONGINT;
    PROCEDURE [stdcall] GetMapMode* (p0 : HDC) : LONGINT;
    PROCEDURE [stdcall] GetMetaFileBitsEx* (p0 : HMETAFILE; p1 : UINT; p2 : LPVOID) : UINT;
    PROCEDURE [stdcall] GetMetaFileA* (p0 : LPCSTR) : HMETAFILE;
    PROCEDURE [stdcall] GetMetaFileW* (p0 : LPCWSTR) : HMETAFILE;
    PROCEDURE [stdcall] GetNearestColor* (p0 : HDC; p1 : COLORREF) : COLORREF;
    PROCEDURE [stdcall] GetNearestPaletteIndex* (p0 : HPALETTE; p1 : COLORREF) : UINT;
    PROCEDURE [stdcall] GetObjectType* (h : HGDIOBJ) : DWORD;
    PROCEDURE [stdcall] GetOutlineTextMetricsA* (p0 : HDC; p1 : UINT; VAR [nil] p2 : _OUTLINETEXTMETRICA_struct) : UINT;
    PROCEDURE [stdcall] GetOutlineTextMetricsW* (p0 : HDC; p1 : UINT; VAR [nil] p2 : _OUTLINETEXTMETRICW_struct) : UINT;
    PROCEDURE [stdcall] GetPaletteEntries* (p0 : HPALETTE; p1 : UINT; p2 : UINT; VAR [nil] p3 : tagPALETTEENTRY_struct) : UINT;
    PROCEDURE [stdcall] GetPixel* (p0 : HDC; p1 : LONGINT; p2 : LONGINT) : COLORREF;
    PROCEDURE [stdcall] GetPixelFormat* (p0 : HDC) : LONGINT;
    PROCEDURE [stdcall] GetPolyFillMode* (p0 : HDC) : LONGINT;
    PROCEDURE [stdcall] GetRasterizerCaps* (VAR [nil] p0 : _RASTERIZER_STATUS_struct; p1 : UINT) : BOOL;
    PROCEDURE [stdcall] GetRegionData* (p0 : HRGN; p1 : DWORD; VAR [nil] p2 : _RGNDATA_struct) : DWORD;
    PROCEDURE [stdcall] GetRgnBox* (p0 : HRGN; VAR [nil] p1 : tagRECT_struct) : LONGINT;
    PROCEDURE [stdcall] GetStockObject* (p0 : LONGINT) : HGDIOBJ;
    PROCEDURE [stdcall] GetStretchBltMode* (p0 : HDC) : LONGINT;
    PROCEDURE [stdcall] GetSystemPaletteEntries* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : tagPALETTEENTRY_struct) : UINT;
    PROCEDURE [stdcall] GetSystemPaletteUse* (p0 : HDC) : UINT;
    PROCEDURE [stdcall] GetTextCharacterExtra* (p0 : HDC) : LONGINT;
    PROCEDURE [stdcall] GetTextAlign* (p0 : HDC) : UINT;
    PROCEDURE [stdcall] GetTextColor* (p0 : HDC) : COLORREF;
    PROCEDURE [stdcall] GetTextExtentPointA* (p0 : HDC; p1 : LPCSTR; p2 : LONGINT; VAR [nil] p3 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] GetTextExtentPointW* (p0 : HDC; p1 : LPCWSTR; p2 : LONGINT; VAR [nil] p3 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] GetTextExtentPoint32A* (p0 : HDC; p1 : LPCSTR; p2 : LONGINT; VAR [nil] p3 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] GetTextExtentPoint32W* (p0 : HDC; p1 : LPCWSTR; p2 : LONGINT; VAR [nil] p3 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] GetTextExtentExPointA* (p0 : HDC; p1 : LPCSTR; p2 : LONGINT; p3 : LONGINT; VAR [nil] p4 : LONGINT; VAR [nil] p5 : LONGINT; VAR [nil] p6 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] GetTextExtentExPointW* (p0 : HDC; p1 : LPCWSTR; p2 : LONGINT; p3 : LONGINT; VAR [nil] p4 : LONGINT; VAR [nil] p5 : LONGINT; VAR [nil] p6 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] GetTextCharset* (hdc : HDC) : LONGINT;
    PROCEDURE [stdcall] GetTextCharsetInfo* (hdc : HDC; VAR [nil] lpSig : tagFONTSIGNATURE_struct; dwFlags : DWORD) : LONGINT;
    PROCEDURE [stdcall] TranslateCharsetInfo* (VAR [nil] lpSrc : DWORD; VAR [nil] lpCs : tagCHARSETINFO_struct; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] GetFontLanguageInfo* (p0 : HDC) : DWORD;
    PROCEDURE [stdcall] GetCharacterPlacementA* (p0 : HDC; p1 : LPCSTR; p2 : LONGINT; p3 : LONGINT; VAR [nil] p4 : tagGCP_RESULTSA_struct; p5 : DWORD) : DWORD;
    PROCEDURE [stdcall] GetCharacterPlacementW* (p0 : HDC; p1 : LPCWSTR; p2 : LONGINT; p3 : LONGINT; VAR [nil] p4 : tagGCP_RESULTSW_struct; p5 : DWORD) : DWORD;
    PROCEDURE [stdcall] GetViewportExtEx* (p0 : HDC; VAR [nil] p1 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] GetViewportOrgEx* (p0 : HDC; VAR [nil] p1 : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] GetWindowExtEx* (p0 : HDC; VAR [nil] p1 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] GetWindowOrgEx* (p0 : HDC; VAR [nil] p1 : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] IntersectClipRect* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] InvertRgn* (p0 : HDC; p1 : HRGN) : BOOL;
    PROCEDURE [stdcall] LineDDA* (p0 : LONGINT; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LINEDDAPROC; p5 : LPARAM) : BOOL;
    PROCEDURE [stdcall] LineTo* (p0 : HDC; p1 : LONGINT; p2 : LONGINT) : BOOL;
    PROCEDURE [stdcall] MaskBlt* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : HDC; p6 : LONGINT; p7 : LONGINT; p8 : HBITMAP; p9 : LONGINT; p10 : LONGINT; p11 : DWORD) : BOOL;
    PROCEDURE [stdcall] PlgBlt* (p0 : HDC; VAR [nil] p1 : POINT; p2 : HDC; p3 : LONGINT; p4 : LONGINT; p5 : LONGINT; p6 : LONGINT; p7 : HBITMAP; p8 : LONGINT; p9 : LONGINT) : BOOL;
    PROCEDURE [stdcall] OffsetClipRgn* (p0 : HDC; p1 : LONGINT; p2 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] OffsetRgn* (p0 : HRGN; p1 : LONGINT; p2 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] PatBlt* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : DWORD) : BOOL;
    PROCEDURE [stdcall] Pie* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : LONGINT; p6 : LONGINT; p7 : LONGINT; p8 : LONGINT) : BOOL;
    PROCEDURE [stdcall] PlayMetaFile* (p0 : HDC; p1 : HMETAFILE) : BOOL;
    PROCEDURE [stdcall] PaintRgn* (p0 : HDC; p1 : HRGN) : BOOL;
    PROCEDURE [stdcall] PolyPolygon* (p0 : HDC; VAR [nil] p1 : POINT; VAR [nil] p2 : INT; p3 : LONGINT) : BOOL;
    PROCEDURE [stdcall] PtInRegion* (p0 : HRGN; p1 : LONGINT; p2 : LONGINT) : BOOL;
    PROCEDURE [stdcall] PtVisible* (p0 : HDC; p1 : LONGINT; p2 : LONGINT) : BOOL;
    PROCEDURE [stdcall] RectInRegion* (p0 : HRGN; VAR [nil] p1 : RECT) : BOOL;
    PROCEDURE [stdcall] RectVisible* (p0 : HDC; VAR [nil] p1 : RECT) : BOOL;
    PROCEDURE [stdcall] Rectangle* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT) : BOOL;
    PROCEDURE [stdcall] RestoreDC* (p0 : HDC; p1 : LONGINT) : BOOL;
    PROCEDURE [stdcall] ResetDCA* (p0 : HDC; VAR [nil] p1 : DEVMODEA) : HDC;
    PROCEDURE [stdcall] ResetDCW* (p0 : HDC; VAR [nil] p1 : DEVMODEW) : HDC;
    PROCEDURE [stdcall] RealizePalette* (p0 : HDC) : UINT;
    PROCEDURE [stdcall] RemoveFontResourceA* (p0 : LPCSTR) : BOOL;
    PROCEDURE [stdcall] RemoveFontResourceW* (p0 : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] RoundRect* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : LONGINT; p6 : LONGINT) : BOOL;
    PROCEDURE [stdcall] ResizePalette* (p0 : HPALETTE; p1 : UINT) : BOOL;
    PROCEDURE [stdcall] SaveDC* (p0 : HDC) : LONGINT;
    PROCEDURE [stdcall] SelectClipRgn* (p0 : HDC; p1 : HRGN) : LONGINT;
    PROCEDURE [stdcall] ExtSelectClipRgn* (p0 : HDC; p1 : HRGN; p2 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] SetMetaRgn* (p0 : HDC) : LONGINT;
    ...
    PROCEDURE [stdcall] SetBkMode* (p0 : HDC; p1 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] SetBitmapBits* (p0 : HBITMAP; p1 : DWORD; p2 : LPVOID) : LONG;
    PROCEDURE [stdcall] SetBoundsRect* (p0 : HDC; VAR [nil] p1 : RECT; p2 : UINT) : UINT;
    PROCEDURE [stdcall] SetDIBits* (p0 : HDC; p1 : HBITMAP; p2 : UINT; p3 : UINT; p4 : LPVOID; VAR [nil] p5 : BITMAPINFO; p6 : UINT) : LONGINT;
    PROCEDURE [stdcall] SetDIBitsToDevice* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : DWORD; p4 : DWORD; p5 : LONGINT; p6 : LONGINT; p7 : UINT; p8 : UINT; p9 : LPVOID; VAR [nil] p10 : BITMAPINFO; p11 : UINT) : LONGINT;
    PROCEDURE [stdcall] SetMapperFlags* (p0 : HDC; p1 : DWORD) : DWORD;
    PROCEDURE [stdcall] SetGraphicsMode* (hdc : HDC; iMode : LONGINT) : LONGINT;
    PROCEDURE [stdcall] SetMapMode* (p0 : HDC; p1 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] SetMetaFileBitsEx* (p0 : UINT; p1 : PBYTE) : HMETAFILE;
    PROCEDURE [stdcall] SetPaletteEntries* (p0 : HPALETTE; p1 : UINT; p2 : UINT; VAR [nil] p3 : PALETTEENTRY) : UINT;
    PROCEDURE [stdcall] SetPixel* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : COLORREF) : COLORREF;
    PROCEDURE [stdcall] SetPixelV* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : COLORREF) : BOOL;
    PROCEDURE [stdcall] SetPixelFormat* (p0 : HDC; p1 : LONGINT; VAR [nil] p2 : PIXELFORMATDESCRIPTOR) : BOOL;
    PROCEDURE [stdcall] SetPolyFillMode* (p0 : HDC; p1 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] StretchBlt* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : HDC; p6 : LONGINT; p7 : LONGINT; p8 : LONGINT; p9 : LONGINT; p10 : DWORD) : BOOL;
    PROCEDURE [stdcall] SetRectRgn* (p0 : HRGN; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT) : BOOL;
    PROCEDURE [stdcall] StretchDIBits* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : LONGINT; p6 : LONGINT; p7 : LONGINT; p8 : LONGINT; p9 : LPVOID; VAR [nil] p10 : BITMAPINFO; p11 : UINT; p12 : DWORD) : LONGINT;
    PROCEDURE [stdcall] SetROP2* (p0 : HDC; p1 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] SetStretchBltMode* (p0 : HDC; p1 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] SetSystemPaletteUse* (p0 : HDC; p1 : UINT) : UINT;
    PROCEDURE [stdcall] SetTextCharacterExtra* (p0 : HDC; p1 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] SetTextColor* (p0 : HDC; p1 : COLORREF) : COLORREF;
    PROCEDURE [stdcall] SetTextAlign* (p0 : HDC; p1 : UINT) : UINT;
    PROCEDURE [stdcall] SetTextJustification* (p0 : HDC; p1 : LONGINT; p2 : LONGINT) : BOOL;
    PROCEDURE [stdcall] UpdateColors* (p0 : HDC) : BOOL;
    PROCEDURE [stdcall] AlphaBlend* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : HDC; p6 : LONGINT; p7 : LONGINT; p8 : LONGINT; p9 : LONGINT; p10 : BLENDFUNCTION) : BOOL;
    PROCEDURE [stdcall] AlphaDIBBlend* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : LPVOID; VAR [nil] p6 : BITMAPINFO; p7 : UINT; p8 : LONGINT; p9 : LONGINT; p10 : LONGINT; p11 : LONGINT; p12 : BLENDFUNCTION) : BOOL;
    PROCEDURE [stdcall] TransparentBlt* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : HDC; p6 : LONGINT; p7 : LONGINT; p8 : LONGINT; p9 : LONGINT; p10 : UINT) : BOOL;
    PROCEDURE [stdcall] TransparentDIBits* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : LPVOID; VAR [nil] p6 : BITMAPINFO; p7 : UINT; p8 : LONGINT; p9 : LONGINT; p10 : LONGINT; p11 : LONGINT; p12 : UINT) : BOOL;
    PROCEDURE [stdcall] GradientFill* (p0 : HDC; VAR [nil] p1 : _TRIVERTEX_struct; p2 : ULONG; p3 : PVOID; p4 : ULONG; p5 : ULONG) : BOOL;
    PROCEDURE [stdcall] PlayMetaFileRecord* (p0 : HDC; VAR [nil] p1 : tagHANDLETABLE_struct; VAR [nil] p2 : tagMETARECORD_struct; p3 : UINT) : BOOL;
    ...
    PROCEDURE [stdcall] CopyEnhMetaFileA* (p0 : HENHMETAFILE; p1 : LPCSTR) : HENHMETAFILE;
    PROCEDURE [stdcall] CopyEnhMetaFileW* (p0 : HENHMETAFILE; p1 : LPCWSTR) : HENHMETAFILE;
    PROCEDURE [stdcall] CreateEnhMetaFileA* (p0 : HDC; p1 : LPCSTR; VAR [nil] p2 : RECT; p3 : LPCSTR) : HDC;
    PROCEDURE [stdcall] CreateEnhMetaFileW* (p0 : HDC; p1 : LPCWSTR; VAR [nil] p2 : RECT; p3 : LPCWSTR) : HDC;
    PROCEDURE [stdcall] DeleteEnhMetaFile* (p0 : HENHMETAFILE) : BOOL;
    PROCEDURE [stdcall] EnumEnhMetaFile* (p0 : HDC; p1 : HENHMETAFILE; p2 : ENHMFENUMPROC; p3 : LPVOID; VAR [nil] p4 : RECT) : BOOL;
    PROCEDURE [stdcall] GetEnhMetaFileA* (p0 : LPCSTR) : HENHMETAFILE;
    PROCEDURE [stdcall] GetEnhMetaFileW* (p0 : LPCWSTR) : HENHMETAFILE;
    PROCEDURE [stdcall] GetEnhMetaFileBits* (p0 : HENHMETAFILE; p1 : UINT; p2 : LPBYTE) : UINT;
    PROCEDURE [stdcall] GetEnhMetaFileDescriptionA* (p0 : HENHMETAFILE; p1 : UINT; p2 : LPSTR) : UINT;
    PROCEDURE [stdcall] GetEnhMetaFileDescriptionW* (p0 : HENHMETAFILE; p1 : UINT; p2 : LPWSTR) : UINT;
    PROCEDURE [stdcall] GetEnhMetaFileHeader* (p0 : HENHMETAFILE; p1 : UINT; VAR [nil] p2 : tagENHMETAHEADER_struct) : UINT;
    PROCEDURE [stdcall] GetEnhMetaFilePaletteEntries* (p0 : HENHMETAFILE; p1 : UINT; VAR [nil] p2 : tagPALETTEENTRY_struct) : UINT;
    PROCEDURE [stdcall] GetEnhMetaFilePixelFormat* (p0 : HENHMETAFILE; p1 : UINT; VAR [nil] p2 : PIXELFORMATDESCRIPTOR) : UINT;
    PROCEDURE [stdcall] GetWinMetaFileBits* (p0 : HENHMETAFILE; p1 : UINT; p2 : LPBYTE; p3 : INT; p4 : HDC) : UINT;
    PROCEDURE [stdcall] PlayEnhMetaFile* (p0 : HDC; p1 : HENHMETAFILE; VAR [nil] p2 : RECT) : BOOL;
    PROCEDURE [stdcall] PlayEnhMetaFileRecord* (p0 : HDC; VAR [nil] p1 : tagHANDLETABLE_struct; VAR [nil] p2 : ENHMETARECORD; p3 : UINT) : BOOL;
    PROCEDURE [stdcall] SetEnhMetaFileBits* (p0 : UINT; p1 : PBYTE) : HENHMETAFILE;
    PROCEDURE [stdcall] SetWinMetaFileBits* (p0 : UINT; p1 : PBYTE; p2 : HDC; VAR [nil] p3 : METAFILEPICT) : HENHMETAFILE;
    PROCEDURE [stdcall] GdiComment* (p0 : HDC; p1 : UINT; p2 : PBYTE) : BOOL;
    PROCEDURE [stdcall] GetTextMetricsA* (p0 : HDC; VAR [nil] p1 : tagTEXTMETRICA_struct) : BOOL;
    PROCEDURE [stdcall] GetTextMetricsW* (p0 : HDC; VAR [nil] p1 : tagTEXTMETRICW_struct) : BOOL;
    PROCEDURE [stdcall] AngleArc* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : DWORD; p4 : FLOAT; p5 : FLOAT) : BOOL;
    PROCEDURE [stdcall] PolyPolyline* (p0 : HDC; VAR [nil] p1 : POINT; VAR [nil] p2 : DWORD; p3 : DWORD) : BOOL;
    PROCEDURE [stdcall] GetWorldTransform* (p0 : HDC; VAR [nil] p1 : tagXFORM_struct) : BOOL;
    PROCEDURE [stdcall] SetWorldTransform* (p0 : HDC; VAR [nil] p1 : XFORM) : BOOL;
    PROCEDURE [stdcall] ModifyWorldTransform* (p0 : HDC; VAR [nil] p1 : XFORM; p2 : DWORD) : BOOL;
    PROCEDURE [stdcall] CombineTransform* (VAR [nil] p0 : tagXFORM_struct; VAR [nil] p1 : XFORM; VAR [nil] p2 : XFORM) : BOOL;
    PROCEDURE [stdcall] CreateDIBSection* (p0 : HDC; VAR [nil] p1 : BITMAPINFO; p2 : UINT; VAR [nil] p3 : LPVOID; p4 : HANDLE; p5 : DWORD) : HBITMAP;
    PROCEDURE [stdcall] GetDIBColorTable* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : RGBQUAD) : UINT;
    PROCEDURE [stdcall] SetDIBColorTable* (p0 : HDC; p1 : UINT; p2 : UINT; VAR [nil] p3 : RGBQUAD) : UINT;
    PROCEDURE [stdcall] SetColorAdjustment* (p0 : HDC; VAR [nil] p1 : COLORADJUSTMENT) : BOOL;
    PROCEDURE [stdcall] GetColorAdjustment* (p0 : HDC; VAR [nil] p1 : tagCOLORADJUSTMENT_struct) : BOOL;
    PROCEDURE [stdcall] CreateHalftonePalette* (p0 : HDC) : HPALETTE;
    PROCEDURE [stdcall] StartDocA* (p0 : HDC; VAR [nil] p1 : DOCINFOA) : LONGINT;
    PROCEDURE [stdcall] StartDocW* (p0 : HDC; VAR [nil] p1 : DOCINFOW) : LONGINT;
    PROCEDURE [stdcall] EndDoc* (p0 : HDC) : LONGINT;
    PROCEDURE [stdcall] StartPage* (p0 : HDC) : LONGINT;
    PROCEDURE [stdcall] EndPage* (p0 : HDC) : LONGINT;
    PROCEDURE [stdcall] AbortDoc* (p0 : HDC) : LONGINT;
    PROCEDURE [stdcall] SetAbortProc* (p0 : HDC; p1 : ABORTPROC) : LONGINT;
    PROCEDURE [stdcall] AbortPath* (p0 : HDC) : BOOL;
    PROCEDURE [stdcall] ArcTo* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; p5 : LONGINT; p6 : LONGINT; p7 : LONGINT; p8 : LONGINT) : BOOL;
    ...
    PROCEDURE [stdcall] GetPath* (p0 : HDC; VAR [nil] p1 : tagPOINT_struct; p2 : LPBYTE; p3 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] PathToRegion* (p0 : HDC) : HRGN;
    PROCEDURE [stdcall] PolyDraw* (p0 : HDC; VAR [nil] p1 : POINT; p2 : PBYTE; p3 : LONGINT) : BOOL;
    PROCEDURE [stdcall] SelectClipPath* (p0 : HDC; p1 : LONGINT) : BOOL;
    PROCEDURE [stdcall] SetArcDirection* (p0 : HDC; p1 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] SetMiterLimit* (p0 : HDC; p1 : FLOAT; VAR [nil] p2 : FLOAT) : BOOL;
    ...
    PROCEDURE [stdcall] ExtCreatePen* (p0 : DWORD; p1 : DWORD; VAR [nil] p2 : LOGBRUSH; p3 : DWORD; VAR [nil] p4 : DWORD) : HPEN;
    PROCEDURE [stdcall] GetMiterLimit* (p0 : HDC; VAR [nil] p1 : FLOAT) : BOOL;
    PROCEDURE [stdcall] GetArcDirection* (p0 : HDC) : LONGINT;
    PROCEDURE [stdcall] GetObjectA* (p0 : HGDIOBJ; p1 : LONGINT; p2 : LPVOID) : LONGINT;
    PROCEDURE [stdcall] GetObjectW* (p0 : HGDIOBJ; p1 : LONGINT; p2 : LPVOID) : LONGINT;
    PROCEDURE [stdcall] MoveToEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR [nil] p3 : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] TextOutA* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LPCSTR; p4 : LONGINT) : BOOL;
    PROCEDURE [stdcall] TextOutW* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LPCWSTR; p4 : LONGINT) : BOOL;
    PROCEDURE [stdcall] ExtTextOutA* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : UINT; VAR [nil] p4 : RECT; p5 : LPCSTR; p6 : UINT; VAR [nil] p7 : INT) : BOOL;
    PROCEDURE [stdcall] ExtTextOutW* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : UINT; VAR [nil] p4 : RECT; p5 : LPCWSTR; p6 : UINT; VAR [nil] p7 : INT) : BOOL;
    PROCEDURE [stdcall] PolyTextOutA* (p0 : HDC; VAR [nil] p1 : POLYTEXTA; p2 : LONGINT) : BOOL;
    PROCEDURE [stdcall] PolyTextOutW* (p0 : HDC; VAR [nil] p1 : POLYTEXTW; p2 : LONGINT) : BOOL;
    PROCEDURE [stdcall] CreatePolygonRgn* (VAR [nil] p0 : POINT; p1 : LONGINT; p2 : LONGINT) : HRGN;
    PROCEDURE [stdcall] DPtoLP* (p0 : HDC; VAR [nil] p1 : tagPOINT_struct; p2 : LONGINT) : BOOL;
    PROCEDURE [stdcall] LPtoDP* (p0 : HDC; VAR [nil] p1 : tagPOINT_struct; p2 : LONGINT) : BOOL;
    PROCEDURE [stdcall] Polygon* (p0 : HDC; VAR [nil] p1 : POINT; p2 : LONGINT) : BOOL;
    PROCEDURE [stdcall] Polyline* (p0 : HDC; VAR [nil] p1 : POINT; p2 : LONGINT) : BOOL;
    PROCEDURE [stdcall] PolyBezier* (p0 : HDC; VAR [nil] p1 : POINT; p2 : DWORD) : BOOL;
    PROCEDURE [stdcall] PolyBezierTo* (p0 : HDC; VAR [nil] p1 : POINT; p2 : DWORD) : BOOL;
    PROCEDURE [stdcall] PolylineTo* (p0 : HDC; VAR [nil] p1 : POINT; p2 : DWORD) : BOOL;
    PROCEDURE [stdcall] SetViewportExtEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR [nil] p3 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] SetViewportOrgEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR [nil] p3 : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] SetWindowExtEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR [nil] p3 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] SetWindowOrgEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR [nil] p3 : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] OffsetViewportOrgEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR [nil] p3 : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] OffsetWindowOrgEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR [nil] p3 : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] ScaleViewportExtEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; VAR [nil] p5 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] ScaleWindowExtEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; p4 : LONGINT; VAR [nil] p5 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] SetBitmapDimensionEx* (p0 : HBITMAP; p1 : LONGINT; p2 : LONGINT; VAR [nil] p3 : tagSIZE_struct) : BOOL;
    PROCEDURE [stdcall] SetBrushOrgEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR [nil] p3 : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] GetTextFaceA* (p0 : HDC; p1 : LONGINT; p2 : LPSTR) : LONGINT;
    PROCEDURE [stdcall] GetTextFaceW* (p0 : HDC; p1 : LONGINT; p2 : LPWSTR) : LONGINT;
    PROCEDURE [stdcall] GetKerningPairsA* (p0 : HDC; p1 : DWORD; VAR [nil] p2 : tagKERNINGPAIR_struct) : DWORD;
    PROCEDURE [stdcall] GetKerningPairsW* (p0 : HDC; p1 : DWORD; VAR [nil] p2 : tagKERNINGPAIR_struct) : DWORD;
    PROCEDURE [stdcall] GetDCOrgEx* (p0 : HDC; VAR [nil] p1 : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] FixBrushOrgEx* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; VAR [nil] p3 : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] UnrealizeObject* (p0 : HGDIOBJ) : BOOL;
    PROCEDURE [stdcall] GdiFlush* () : BOOL;
    PROCEDURE [stdcall] GdiSetBatchLimit* (p0 : DWORD) : DWORD;
    PROCEDURE [stdcall] GdiGetBatchLimit* () : DWORD;
    PROCEDURE [stdcall] SetICMMode* (p0 : HDC; p1 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] CheckColorsInGamut* (p0 : HDC; p1 : LPVOID; p2 : LPVOID; p3 : DWORD) : BOOL;
    PROCEDURE [stdcall] GetColorSpace* (p0 : HDC) : HCOLORSPACE;
    PROCEDURE [stdcall] GetLogColorSpaceA* (p0 : HCOLORSPACE; VAR [nil] p1 : tagLOGCOLORSPACEA_struct; p2 : DWORD) : BOOL;
    PROCEDURE [stdcall] GetLogColorSpaceW* (p0 : HCOLORSPACE; VAR [nil] p1 : tagLOGCOLORSPACEW_struct; p2 : DWORD) : BOOL;
    PROCEDURE [stdcall] CreateColorSpaceA* (VAR [nil] p0 : tagLOGCOLORSPACEA_struct) : HCOLORSPACE;
    PROCEDURE [stdcall] CreateColorSpaceW* (VAR [nil] p0 : tagLOGCOLORSPACEW_struct) : HCOLORSPACE;
    PROCEDURE [stdcall] SetColorSpace* (p0 : HDC; p1 : HCOLORSPACE) : HCOLORSPACE;
    PROCEDURE [stdcall] DeleteColorSpace* (p0 : HCOLORSPACE) : BOOL;
    PROCEDURE [stdcall] GetICMProfileA* (p0 : HDC; VAR [nil] p1 : DWORD; p2 : LPSTR) : BOOL;
    PROCEDURE [stdcall] GetICMProfileW* (p0 : HDC; VAR [nil] p1 : DWORD; p2 : LPWSTR) : BOOL;
    PROCEDURE [stdcall] SetICMProfileA* (p0 : HDC; p1 : LPSTR) : BOOL;
    PROCEDURE [stdcall] SetICMProfileW* (p0 : HDC; p1 : LPWSTR) : BOOL;
    PROCEDURE [stdcall] GetDeviceGammaRamp* (p0 : HDC; p1 : LPVOID) : BOOL;
    PROCEDURE [stdcall] SetDeviceGammaRamp* (p0 : HDC; p1 : LPVOID) : BOOL;
    PROCEDURE [stdcall] ColorMatchToTarget* (p0 : HDC; p1 : HDC; p2 : DWORD) : BOOL;
    PROCEDURE [stdcall] EnumICMProfilesA* (p0 : HDC; p1 : ICMENUMPROCA; p2 : LPARAM) : LONGINT;
    PROCEDURE [stdcall] EnumICMProfilesW* (p0 : HDC; p1 : ICMENUMPROCW; p2 : LPARAM) : LONGINT;
    PROCEDURE [stdcall] UpdateICMRegKeyA* (p0 : DWORD; p1 : LPSTR; p2 : LPSTR; p3 : UINT) : BOOL;
    PROCEDURE [stdcall] UpdateICMRegKeyW* (p0 : DWORD; p1 : LPWSTR; p2 : LPWSTR; p3 : UINT) : BOOL;
    PROCEDURE [stdcall] wglCopyContext* (p0 : HGLRC; p1 : HGLRC; p2 : UINT) : BOOL;
    PROCEDURE [stdcall] wglCreateContext* (p0 : HDC) : HGLRC;
    PROCEDURE [stdcall] wglCreateLayerContext* (p0 : HDC; p1 : LONGINT) : HGLRC;
    ...
    PROCEDURE [stdcall] wglGetProcAddress* (p0 : LPCSTR) : PROC;
    PROCEDURE [stdcall] wglMakeCurrent* (p0 : HDC; p1 : HGLRC) : BOOL;
    PROCEDURE [stdcall] wglShareLists* (p0 : HGLRC; p1 : HGLRC) : BOOL;
    PROCEDURE [stdcall] wglUseFontBitmapsA* (p0 : HDC; p1 : DWORD; p2 : DWORD; p3 : DWORD) : BOOL;
    PROCEDURE [stdcall] wglUseFontBitmapsW* (p0 : HDC; p1 : DWORD; p2 : DWORD; p3 : DWORD) : BOOL;
    PROCEDURE [stdcall] SwapBuffers* (p0 : HDC) : BOOL;
    PROCEDURE [stdcall] wglUseFontOutlinesA* (p0 : HDC; p1 : DWORD; p2 : DWORD; p3 : DWORD; p4 : FLOAT; p5 : FLOAT; p6 : LONGINT; VAR [nil] p7 : _GLYPHMETRICSFLOAT_struct) : BOOL;
    PROCEDURE [stdcall] wglUseFontOutlinesW* (p0 : HDC; p1 : DWORD; p2 : DWORD; p3 : DWORD; p4 : FLOAT; p5 : FLOAT; p6 : LONGINT; VAR [nil] p7 : _GLYPHMETRICSFLOAT_struct) : BOOL;
    PROCEDURE [stdcall] wglDescribeLayerPlane* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : UINT; VAR [nil] p4 : tagLAYERPLANEDESCRIPTOR_struct) : BOOL;
    PROCEDURE [stdcall] wglSetLayerPaletteEntries* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; VAR [nil] p4 : COLORREF) : LONGINT;
    PROCEDURE [stdcall] wglGetLayerPaletteEntries* (p0 : HDC; p1 : LONGINT; p2 : LONGINT; p3 : LONGINT; VAR [nil] p4 : COLORREF) : LONGINT;
    PROCEDURE [stdcall] wglRealizeLayerPalette* (p0 : HDC; p1 : LONGINT; p2 : BOOL) : BOOL;
    PROCEDURE [stdcall] wglSwapLayerBuffers* (p0 : HDC; p1 : UINT) : BOOL;
    PROCEDURE wvsprintfA* (*"C"*) (p0 : LPSTR; p1 : LPCSTR; arglist : va_list) : LONGINT;
    PROCEDURE wvsprintfW* (*"C"*) (p0 : LPWSTR; p1 : LPCWSTR; arglist : va_list) : LONGINT;
    PROCEDURE wsprintfA* (*"C"*) (p0 : LPSTR; p1 : LPCSTR (*; ...*)) : LONGINT;
    PROCEDURE wsprintfW* (*"C"*) (p0 : LPWSTR; p1 : LPCWSTR (*; ...*)) : LONGINT;
    PROCEDURE [stdcall] LoadKeyboardLayoutA* (pwszKLID : LPCSTR; Flags : UINT) : HKL;
    PROCEDURE [stdcall] LoadKeyboardLayoutW* (pwszKLID : LPCWSTR; Flags : UINT) : HKL;
    PROCEDURE [stdcall] ActivateKeyboardLayout* (hkl : HKL; Flags : UINT) : HKL;
    PROCEDURE [stdcall] ToUnicodeEx* (wVirtKey : UINT; wScanCode : UINT; lpKeyState : PBYTE; pwszBuff : LPWSTR; cchBuff : LONGINT; wFlags : UINT; dwhkl : HKL) : LONGINT;
    PROCEDURE [stdcall] UnloadKeyboardLayout* (hkl : HKL) : BOOL;
    PROCEDURE [stdcall] GetKeyboardLayoutNameA* (pwszKLID : LPSTR) : BOOL;
    PROCEDURE [stdcall] GetKeyboardLayoutNameW* (pwszKLID : LPWSTR) : BOOL;
    PROCEDURE [stdcall] GetKeyboardLayoutList* (nBuff : LONGINT; VAR [nil] lpList : HKL) : LONGINT;
    PROCEDURE [stdcall] GetKeyboardLayout* (dwLayout : DWORD) : HKL;
    PROCEDURE [stdcall] CreateDesktopA* (lpszDesktop : LPSTR; lpszDevice : LPSTR; VAR [nil] pDevmode : _devicemodeA_struct; dwFlags : DWORD; dwDesiredAccess : ACCESS_MASK; VAR [nil] lpsa : _SECURITY_ATTRIBUTES_struct) : HDESK;
    PROCEDURE [stdcall] CreateDesktopW* (lpszDesktop : LPWSTR; lpszDevice : LPWSTR; VAR [nil] pDevmode : _devicemodeW_struct; dwFlags : DWORD; dwDesiredAccess : ACCESS_MASK; VAR [nil] lpsa : _SECURITY_ATTRIBUTES_struct) : HDESK;
    PROCEDURE [stdcall] OpenDesktopA* (lpszDesktop : LPSTR; dwFlags : DWORD; fInherit : BOOL; dwDesiredAccess : ACCESS_MASK) : HDESK;
    PROCEDURE [stdcall] OpenDesktopW* (lpszDesktop : LPWSTR; dwFlags : DWORD; fInherit : BOOL; dwDesiredAccess : ACCESS_MASK) : HDESK;
    PROCEDURE [stdcall] OpenInputDesktop* (dwFlags : DWORD; fInherit : BOOL; dwDesiredAccess : ACCESS_MASK) : HDESK;
    ...
    PROCEDURE [stdcall] GetThreadDesktop* (dwThreadId : DWORD) : HDESK;
    PROCEDURE [stdcall] CreateWindowStationA* (lpwinsta : LPSTR; dwReserved : DWORD; dwDesiredAccess : ACCESS_MASK; VAR [nil] lpsa : _SECURITY_ATTRIBUTES_struct) : HWINSTA;
    PROCEDURE [stdcall] CreateWindowStationW* (lpwinsta : LPWSTR; dwReserved : DWORD; dwDesiredAccess : ACCESS_MASK; VAR [nil] lpsa : _SECURITY_ATTRIBUTES_struct) : HWINSTA;
    PROCEDURE [stdcall] OpenWindowStationA* (lpszWinSta : LPSTR; fInherit : BOOL; dwDesiredAccess : ACCESS_MASK) : HWINSTA;
    PROCEDURE [stdcall] OpenWindowStationW* (lpszWinSta : LPWSTR; fInherit : BOOL; dwDesiredAccess : ACCESS_MASK) : HWINSTA;
    ...
    PROCEDURE [stdcall] SetUserObjectSecurity* (hObj : HANDLE; VAR [nil] pSIRequested : DWORD; pSID : PSECURITY_DESCRIPTOR) : BOOL;
    PROCEDURE [stdcall] GetUserObjectSecurity* (hObj : HANDLE; VAR [nil] pSIRequested : DWORD; pSID : PSECURITY_DESCRIPTOR; nLength : DWORD; VAR [nil] lpnLengthNeeded : DWORD) : BOOL;
    PROCEDURE [stdcall] GetUserObjectInformationA* (hObj : HANDLE; nIndex : LONGINT; pvInfo : PVOID; nLength : DWORD; VAR [nil] lpnLengthNeeded : DWORD) : BOOL;
    PROCEDURE [stdcall] GetUserObjectInformationW* (hObj : HANDLE; nIndex : LONGINT; pvInfo : PVOID; nLength : DWORD; VAR [nil] lpnLengthNeeded : DWORD) : BOOL;
    PROCEDURE [stdcall] SetUserObjectInformationA* (hObj : HANDLE; nIndex : LONGINT; pvInfo : PVOID; nLength : DWORD) : BOOL;
    PROCEDURE [stdcall] SetUserObjectInformationW* (hObj : HANDLE; nIndex : LONGINT; pvInfo : PVOID; nLength : DWORD) : BOOL;
    PROCEDURE [stdcall] RegisterWindowMessageA* (lpString : LPCSTR) : UINT;
    PROCEDURE [stdcall] RegisterWindowMessageW* (lpString : LPCWSTR) : UINT;
    PROCEDURE [stdcall] TrackMouseEvent* (VAR [nil] lpEventTrack : tagTRACKMOUSEEVENT_struct) : BOOL;
    PROCEDURE [stdcall] DrawEdge* (hdc : HDC; VAR [nil] qrc : tagRECT_struct; edge : UINT; grfFlags : UINT) : BOOL;
    PROCEDURE [stdcall] DrawFrameControl* (p0 : HDC; VAR [nil] p1 : tagRECT_struct; p2 : UINT; p3 : UINT) : BOOL;
    PROCEDURE [stdcall] DrawCaption* (p0 : HWND; p1 : HDC; VAR [nil] p2 : RECT; p3 : UINT) : BOOL;
    PROCEDURE [stdcall] DrawAnimatedRects* (hwnd : HWND; idAni : LONGINT; VAR [nil] lprcFrom : RECT; VAR [nil] lprcTo : RECT) : BOOL;
    PROCEDURE [stdcall] GetMessageA* (VAR [nil] lpMsg : tagMSG_struct; hWnd : HWND; wMsgFilterMin : UINT; wMsgFilterMax : UINT) : BOOL;
    PROCEDURE [stdcall] GetMessageW* (VAR [nil] lpMsg : tagMSG_struct; hWnd : HWND; wMsgFilterMin : UINT; wMsgFilterMax : UINT) : BOOL;
    PROCEDURE [stdcall] TranslateMessage* (VAR [nil] lpMsg : MSG) : BOOL;
    PROCEDURE [stdcall] DispatchMessageA* (VAR [nil] lpMsg : MSG) : LONG;
    PROCEDURE [stdcall] DispatchMessageW* (VAR [nil] lpMsg : MSG) : LONG;
    PROCEDURE [stdcall] SetMessageQueue* (cMessagesMax : LONGINT) : BOOL;
    PROCEDURE [stdcall] PeekMessageA* (VAR [nil] lpMsg : tagMSG_struct; hWnd : HWND; wMsgFilterMin : UINT; wMsgFilterMax : UINT; wRemoveMsg : UINT) : BOOL;
    PROCEDURE [stdcall] PeekMessageW* (VAR [nil] lpMsg : tagMSG_struct; hWnd : HWND; wMsgFilterMin : UINT; wMsgFilterMax : UINT; wRemoveMsg : UINT) : BOOL;
    PROCEDURE [stdcall] RegisterHotKey* (hWnd : HWND; id : LONGINT; fsModifiers : UINT; vk : UINT) : BOOL;
    PROCEDURE [stdcall] UnregisterHotKey* (hWnd : HWND; id : LONGINT) : BOOL;
    PROCEDURE [stdcall] ExitWindowsEx* (uFlags : UINT; dwReserved : DWORD) : BOOL;
    PROCEDURE [stdcall] SwapMouseButton* (fSwap : BOOL) : BOOL;
    PROCEDURE [stdcall] GetMessagePos* () : DWORD;
    PROCEDURE [stdcall] GetMessageTime* () : LONG;
    PROCEDURE [stdcall] GetMessageExtraInfo* () : LONG;
    PROCEDURE [stdcall] SetMessageExtraInfo* (lParam : LPARAM) : LPARAM;
    PROCEDURE [stdcall] SendMessageA* (hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : LRESULT;
    PROCEDURE [stdcall] SendMessageW* (hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : LRESULT;
    PROCEDURE [stdcall] SendMessageTimeoutA* (hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM; fuFlags : UINT; uTimeout : UINT; VAR [nil] lpdwResult : DWORD) : LRESULT;
    PROCEDURE [stdcall] SendMessageTimeoutW* (hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM; fuFlags : UINT; uTimeout : UINT; VAR [nil] lpdwResult : DWORD) : LRESULT;
    PROCEDURE [stdcall] SendNotifyMessageA* (hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : BOOL;
    PROCEDURE [stdcall] SendNotifyMessageW* (hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : BOOL;
    PROCEDURE [stdcall] SendMessageCallbackA* (hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM; lpResultCallBack : SENDASYNCPROC; dwData : DWORD) : BOOL;
    PROCEDURE [stdcall] SendMessageCallbackW* (hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM; lpResultCallBack : SENDASYNCPROC; dwData : DWORD) : BOOL;
    PROCEDURE [stdcall] BroadcastSystemMessageA* (p0 : DWORD; VAR [nil] p1 : DWORD; p2 : UINT; p3 : WPARAM; p4 : LPARAM) : LONGINT;
    PROCEDURE [stdcall] BroadcastSystemMessageW* (p0 : DWORD; VAR [nil] p1 : DWORD; p2 : UINT; p3 : WPARAM; p4 : LPARAM) : LONGINT;
    PROCEDURE [stdcall] PostMessageA* (hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : BOOL;
    PROCEDURE [stdcall] PostMessageW* (hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : BOOL;
    PROCEDURE [stdcall] PostThreadMessageA* (idThread : DWORD; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : BOOL;
    PROCEDURE [stdcall] PostThreadMessageW* (idThread : DWORD; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : BOOL;
    PROCEDURE [stdcall] AttachThreadInput* (idAttach : DWORD; idAttachTo : DWORD; fAttach : BOOL) : BOOL;
    PROCEDURE [stdcall] ReplyMessage* (lResult : LRESULT) : BOOL;
    PROCEDURE [stdcall] WaitMessage* () : BOOL;
    PROCEDURE [stdcall] WaitForInputIdle* (hProcess : HANDLE; dwMilliseconds : DWORD) : DWORD;
    PROCEDURE [stdcall] DefWindowProcA* (hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : LRESULT;
    PROCEDURE [stdcall] DefWindowProcW* (hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : LRESULT;
    PROCEDURE [stdcall] PostQuitMessage* (nExitCode : LONGINT);
    PROCEDURE [stdcall] CallWindowProcA* (lpPrevWndFunc : FARPROC; hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : LRESULT;
    PROCEDURE [stdcall] CallWindowProcW* (lpPrevWndFunc : FARPROC; hWnd : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : LRESULT;
    PROCEDURE [stdcall] InSendMessage* () : BOOL;
    PROCEDURE [stdcall] GetDoubleClickTime* () : UINT;
    PROCEDURE [stdcall] SetDoubleClickTime* (p0 : UINT) : BOOL;
    ...
    PROCEDURE [stdcall] UnregisterClassA* (lpClassName : LPCSTR; hInstance : HINSTANCE) : BOOL;
    PROCEDURE [stdcall] UnregisterClassW* (lpClassName : LPCWSTR; hInstance : HINSTANCE) : BOOL;
    PROCEDURE [stdcall] GetClassInfoA* (hInstance : HINSTANCE; lpClassName : LPCSTR; VAR [nil] lpWndClass : tagWNDCLASSA_struct) : BOOL;
    PROCEDURE [stdcall] GetClassInfoW* (hInstance : HINSTANCE; lpClassName : LPCWSTR; VAR [nil] lpWndClass : tagWNDCLASSW_struct) : BOOL;
    ...
    PROCEDURE [stdcall] GetClassInfoExA* (p0 : HINSTANCE; p1 : LPCSTR; VAR [nil] p2 : tagWNDCLASSEXA_struct) : BOOL;
    PROCEDURE [stdcall] GetClassInfoExW* (p0 : HINSTANCE; p1 : LPCWSTR; VAR [nil] p2 : tagWNDCLASSEXW_struct) : BOOL;
    PROCEDURE [stdcall] CreateWindowExA* (dwExStyle : DWORD; lpClassName : LPCSTR; lpWindowName : LPCSTR; dwStyle : DWORD; X : LONGINT; Y : LONGINT; nWidth : LONGINT; nHeight : LONGINT; hWndParent : HWND; hMenu : HMENU; hInstance : HINSTANCE; lpParam : LPVOID) : HWND;
    PROCEDURE [stdcall] CreateWindowExW* (dwExStyle : DWORD; lpClassName : LPCWSTR; lpWindowName : LPCWSTR; dwStyle : DWORD; X : LONGINT; Y : LONGINT; nWidth : LONGINT; nHeight : LONGINT; hWndParent : HWND; hMenu : HMENU; hInstance : HINSTANCE; lpParam : LPVOID) : HWND;
    ...
    PROCEDURE [stdcall] ShowWindow* (hWnd : HWND; nCmdShow : LONGINT) : BOOL;
    PROCEDURE [stdcall] ShowWindowAsync* (hWnd : HWND; nCmdShow : LONGINT) : BOOL;
    ...
    PROCEDURE [stdcall] MoveWindow* (hWnd : HWND; X : LONGINT; Y : LONGINT; nWidth : LONGINT; nHeight : LONGINT; bRepaint : BOOL) : BOOL;
    PROCEDURE [stdcall] SetWindowPos* (hWnd : HWND; hWndInsertAfter : HWND; X : LONGINT; Y : LONGINT; cx : LONGINT; cy : LONGINT; uFlags : UINT) : BOOL;
    ...
    PROCEDURE [stdcall] BeginDeferWindowPos* (nNumWindows : LONGINT) : HDWP;
    PROCEDURE [stdcall] DeferWindowPos* (hWinPosInfo : HDWP; hWnd : HWND; hWndInsertAfter : HWND; x : LONGINT; y : LONGINT; cx : LONGINT; cy : LONGINT; uFlags : UINT) : HDWP;
    ...
    PROCEDURE [stdcall] CreateDialogParamA* (hInstance : HINSTANCE; lpTemplateName : LPCSTR; hWndParent : HWND; lpDialogFunc : DLGPROC; dwInitParam : LPARAM) : HWND;
    PROCEDURE [stdcall] CreateDialogParamW* (hInstance : HINSTANCE; lpTemplateName : LPCWSTR; hWndParent : HWND; lpDialogFunc : DLGPROC; dwInitParam : LPARAM) : HWND;
    ...
    PROCEDURE [stdcall] DialogBoxParamA* (hInstance : HINSTANCE; lpTemplateName : LPCSTR; hWndParent : HWND; lpDialogFunc : DLGPROC; dwInitParam : LPARAM) : LONGINT;
    PROCEDURE [stdcall] DialogBoxParamW* (hInstance : HINSTANCE; lpTemplateName : LPCWSTR; hWndParent : HWND; lpDialogFunc : DLGPROC; dwInitParam : LPARAM) : LONGINT;
    PROCEDURE [stdcall] DialogBoxIndirectParamA* (hInstance : HINSTANCE; VAR [nil] hDialogTemplate : DLGTEMPLATE; hWndParent : HWND; lpDialogFunc : DLGPROC; dwInitParam : LPARAM) : LONGINT;
    PROCEDURE [stdcall] DialogBoxIndirectParamW* (hInstance : HINSTANCE; VAR [nil] hDialogTemplate : DLGTEMPLATE; hWndParent : HWND; lpDialogFunc : DLGPROC; dwInitParam : LPARAM) : LONGINT;
    PROCEDURE [stdcall] EndDialog* (hDlg : HWND; nResult : LONGINT) : BOOL;
    PROCEDURE [stdcall] GetDlgItem* (hDlg : HWND; nIDDlgItem : LONGINT) : HWND;
    PROCEDURE [stdcall] SetDlgItemInt* (hDlg : HWND; nIDDlgItem : LONGINT; uValue : UINT; bSigned : BOOL) : BOOL;
    PROCEDURE [stdcall] GetDlgItemInt* (hDlg : HWND; nIDDlgItem : LONGINT; VAR [nil] lpTranslated : BOOL; bSigned : BOOL) : UINT;
    PROCEDURE [stdcall] SetDlgItemTextA* (hDlg : HWND; nIDDlgItem : LONGINT; lpString : LPCSTR) : BOOL;
    PROCEDURE [stdcall] SetDlgItemTextW* (hDlg : HWND; nIDDlgItem : LONGINT; lpString : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] GetDlgItemTextA* (hDlg : HWND; nIDDlgItem : LONGINT; lpString : LPSTR; nMaxCount : LONGINT) : UINT;
    PROCEDURE [stdcall] GetDlgItemTextW* (hDlg : HWND; nIDDlgItem : LONGINT; lpString : LPWSTR; nMaxCount : LONGINT) : UINT;
    PROCEDURE [stdcall] CheckDlgButton* (hDlg : HWND; nIDButton : LONGINT; uCheck : UINT) : BOOL;
    PROCEDURE [stdcall] CheckRadioButton* (hDlg : HWND; nIDFirstButton : LONGINT; nIDLastButton : LONGINT; nIDCheckButton : LONGINT) : BOOL;
    PROCEDURE [stdcall] IsDlgButtonChecked* (hDlg : HWND; nIDButton : LONGINT) : UINT;
    PROCEDURE [stdcall] SendDlgItemMessageA* (hDlg : HWND; nIDDlgItem : LONGINT; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : LONG;
    PROCEDURE [stdcall] SendDlgItemMessageW* (hDlg : HWND; nIDDlgItem : LONGINT; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : LONG;
    ...
    PROCEDURE [stdcall] GetDlgCtrlID* (hWnd : HWND) : LONGINT;
    PROCEDURE [stdcall] GetDialogBaseUnits* () : LONGINT;
    PROCEDURE [stdcall] DefDlgProcA* (hDlg : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : LRESULT;
    PROCEDURE [stdcall] DefDlgProcW* (hDlg : HWND; Msg : UINT; wParam : WPARAM; lParam : LPARAM) : LRESULT;
    PROCEDURE [stdcall] CallMsgFilterA* (VAR [nil] lpMsg : tagMSG_struct; nCode : LONGINT) : BOOL;
    PROCEDURE [stdcall] CallMsgFilterW* (VAR [nil] lpMsg : tagMSG_struct; nCode : LONGINT) : BOOL;
    ...
    PROCEDURE [stdcall] SetClipboardData* (uFormat : UINT; hMem : HANDLE) : HANDLE;
    PROCEDURE [stdcall] GetClipboardData* (uFormat : UINT) : HANDLE;
    PROCEDURE [stdcall] RegisterClipboardFormatA* (lpszFormat : LPCSTR) : UINT;
    PROCEDURE [stdcall] RegisterClipboardFormatW* (lpszFormat : LPCWSTR) : UINT;
    PROCEDURE [stdcall] CountClipboardFormats* () : LONGINT;
    PROCEDURE [stdcall] EnumClipboardFormats* (format : UINT) : UINT;
    PROCEDURE [stdcall] GetClipboardFormatNameA* (format : UINT; lpszFormatName : LPSTR; cchMaxCount : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetClipboardFormatNameW* (format : UINT; lpszFormatName : LPWSTR; cchMaxCount : LONGINT) : LONGINT;
    PROCEDURE [stdcall] EmptyClipboard* () : BOOL;
    PROCEDURE [stdcall] IsClipboardFormatAvailable* (format : UINT) : BOOL;
    PROCEDURE [stdcall] GetPriorityClipboardFormat* (VAR [nil] paFormatPriorityList : UINT; cFormats : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetOpenClipboardWindow* () : HWND;
    PROCEDURE [stdcall] CharToOemA* (lpszSrc : LPCSTR; lpszDst : LPSTR) : BOOL;
    PROCEDURE [stdcall] CharToOemW* (lpszSrc : LPCWSTR; lpszDst : LPSTR) : BOOL;
    PROCEDURE [stdcall] OemToCharA* (lpszSrc : LPCSTR; lpszDst : LPSTR) : BOOL;
    PROCEDURE [stdcall] OemToCharW* (lpszSrc : LPCSTR; lpszDst : LPWSTR) : BOOL;
    PROCEDURE [stdcall] CharToOemBuffA* (lpszSrc : LPCSTR; lpszDst : LPSTR; cchDstLength : DWORD) : BOOL;
    PROCEDURE [stdcall] CharToOemBuffW* (lpszSrc : LPCWSTR; lpszDst : LPSTR; cchDstLength : DWORD) : BOOL;
    PROCEDURE [stdcall] OemToCharBuffA* (lpszSrc : LPCSTR; lpszDst : LPSTR; cchDstLength : DWORD) : BOOL;
    PROCEDURE [stdcall] OemToCharBuffW* (lpszSrc : LPCSTR; lpszDst : LPWSTR; cchDstLength : DWORD) : BOOL;
    PROCEDURE [stdcall] CharUpperA* (lpsz : LPSTR) : LPSTR;
    PROCEDURE [stdcall] CharUpperW* (lpsz : LPWSTR) : LPWSTR;
    PROCEDURE [stdcall] CharUpperBuffA* (lpsz : LPSTR; cchLength : DWORD) : DWORD;
    PROCEDURE [stdcall] CharUpperBuffW* (lpsz : LPWSTR; cchLength : DWORD) : DWORD;
    PROCEDURE [stdcall] CharLowerA* (lpsz : LPSTR) : LPSTR;
    PROCEDURE [stdcall] CharLowerW* (lpsz : LPWSTR) : LPWSTR;
    PROCEDURE [stdcall] CharLowerBuffA* (lpsz : LPSTR; cchLength : DWORD) : DWORD;
    PROCEDURE [stdcall] CharLowerBuffW* (lpsz : LPWSTR; cchLength : DWORD) : DWORD;
    PROCEDURE [stdcall] CharNextA* (lpsz : LPCSTR) : LPSTR;
    PROCEDURE [stdcall] CharNextW* (lpsz : LPCWSTR) : LPWSTR;
    PROCEDURE [stdcall] CharPrevA* (lpszStart : LPCSTR; lpszCurrent : LPCSTR) : LPSTR;
    PROCEDURE [stdcall] CharPrevW* (lpszStart : LPCWSTR; lpszCurrent : LPCWSTR) : LPWSTR;
    PROCEDURE [stdcall] CharNextExA* (CodePage : WORD; lpCurrentChar : LPCSTR; dwFlags : DWORD) : LPSTR;
    PROCEDURE [stdcall] CharPrevExA* (CodePage : WORD; lpStart : LPCSTR; lpCurrentChar : LPCSTR; dwFlags : DWORD) : LPSTR;
    PROCEDURE [stdcall] IsCharAlphaA* (ch : CHAR) : BOOL;
    PROCEDURE [stdcall] IsCharAlphaW* (ch : WCHAR) : BOOL;
    PROCEDURE [stdcall] IsCharAlphaNumericA* (ch : CHAR) : BOOL;
    PROCEDURE [stdcall] IsCharAlphaNumericW* (ch : WCHAR) : BOOL;
    PROCEDURE [stdcall] IsCharUpperA* (ch : CHAR) : BOOL;
    PROCEDURE [stdcall] IsCharUpperW* (ch : WCHAR) : BOOL;
    PROCEDURE [stdcall] IsCharLowerA* (ch : CHAR) : BOOL;
    PROCEDURE [stdcall] IsCharLowerW* (ch : WCHAR) : BOOL;
    PROCEDURE [stdcall] SetFocus* (hWnd : HWND) : HWND;
    PROCEDURE [stdcall] GetActiveWindow* () : HWND;
    PROCEDURE [stdcall] GetFocus* () : HWND;
    PROCEDURE [stdcall] GetKBCodePage* () : UINT;
    PROCEDURE [stdcall] GetKeyState* (nVirtKey : LONGINT) : SHORT;
    PROCEDURE [stdcall] GetAsyncKeyState* (vKey : LONGINT) : SHORT;
    PROCEDURE [stdcall] GetKeyboardState* (lpKeyState : PBYTE) : BOOL;
    PROCEDURE [stdcall] SetKeyboardState* (lpKeyState : LPBYTE) : BOOL;
    PROCEDURE [stdcall] GetKeyNameTextA* (lParam : LONG; lpString : LPSTR; nSize : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetKeyNameTextW* (lParam : LONG; lpString : LPWSTR; nSize : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetKeyboardType* (nTypeFlag : LONGINT) : LONGINT;
    PROCEDURE [stdcall] ToAscii* (uVirtKey : UINT; uScanCode : UINT; lpKeyState : PBYTE; VAR [nil] lpChar : WORD; uFlags : UINT) : LONGINT;
    PROCEDURE [stdcall] ToAsciiEx* (uVirtKey : UINT; uScanCode : UINT; lpKeyState : PBYTE; VAR [nil] lpChar : WORD; uFlags : UINT; dwhkl : HKL) : LONGINT;
    PROCEDURE [stdcall] ToUnicode* (wVirtKey : UINT; wScanCode : UINT; lpKeyState : PBYTE; pwszBuff : LPWSTR; cchBuff : LONGINT; wFlags : UINT) : LONGINT;
    PROCEDURE [stdcall] OemKeyScan* (wOemChar : WORD) : DWORD;
    PROCEDURE [stdcall] VkKeyScanA* (ch : CHAR) : SHORT;
    PROCEDURE [stdcall] VkKeyScanW* (ch : WCHAR) : SHORT;
    PROCEDURE [stdcall] VkKeyScanExA* (ch : CHAR; dwhkl : HKL) : SHORT;
    PROCEDURE [stdcall] VkKeyScanExW* (ch : WCHAR; dwhkl : HKL) : SHORT;
    PROCEDURE [stdcall] keybd_event* (bVk : BYTE; bScan : BYTE; dwFlags : DWORD; dwExtraInfo : DWORD);
    PROCEDURE [stdcall] mouse_event* (dwFlags : DWORD; dx : DWORD; dy : DWORD; dwData : DWORD; dwExtraInfo : DWORD);
    PROCEDURE [stdcall] MapVirtualKeyA* (uCode : UINT; uMapType : UINT) : UINT;
    PROCEDURE [stdcall] MapVirtualKeyW* (uCode : UINT; uMapType : UINT) : UINT;
    PROCEDURE [stdcall] MapVirtualKeyExA* (uCode : UINT; uMapType : UINT; dwhkl : HKL) : UINT;
    PROCEDURE [stdcall] MapVirtualKeyExW* (uCode : UINT; uMapType : UINT; dwhkl : HKL) : UINT;
    PROCEDURE [stdcall] GetInputState* () : BOOL;
    PROCEDURE [stdcall] GetQueueStatus* (flags : UINT) : DWORD;
    PROCEDURE [stdcall] GetCapture* () : HWND;
    PROCEDURE [stdcall] SetCapture* (hWnd : HWND) : HWND;
    PROCEDURE [stdcall] ReleaseCapture* () : BOOL;
    PROCEDURE [stdcall] MsgWaitForMultipleObjects* (nCount : DWORD; VAR [nil] pHandles : HANDLE; fWaitAll : BOOL; dwMilliseconds : DWORD; dwWakeMask : DWORD) : DWORD;
    PROCEDURE [stdcall] MsgWaitForMultipleObjectsEx* (nCount : DWORD; VAR [nil] pHandles : HANDLE; dwMilliseconds : DWORD; dwWakeMask : DWORD; dwFlags : DWORD) : DWORD;
    PROCEDURE [stdcall] SetTimer* (hWnd : HWND; nIDEvent : UINT; uElapse : UINT; lpTimerFunc : TIMERPROC) : UINT;
    PROCEDURE [stdcall] KillTimer* (hWnd : HWND; uIDEvent : UINT) : BOOL;
    ...
    PROCEDURE [stdcall] LoadAcceleratorsA* (hInstance : HINSTANCE; lpTableName : LPCSTR) : HACCEL;
    PROCEDURE [stdcall] LoadAcceleratorsW* (hInstance : HINSTANCE; lpTableName : LPCWSTR) : HACCEL;
    PROCEDURE [stdcall] CreateAcceleratorTableA* (VAR [nil] p0 : tagACCEL_struct; p1 : LONGINT) : HACCEL;
    PROCEDURE [stdcall] CreateAcceleratorTableW* (VAR [nil] p0 : tagACCEL_struct; p1 : LONGINT) : HACCEL;
    PROCEDURE [stdcall] DestroyAcceleratorTable* (hAccel : HACCEL) : BOOL;
    PROCEDURE [stdcall] CopyAcceleratorTableA* (hAccelSrc : HACCEL; VAR [nil] lpAccelDst : tagACCEL_struct; cAccelEntries : LONGINT) : LONGINT;
    PROCEDURE [stdcall] CopyAcceleratorTableW* (hAccelSrc : HACCEL; VAR [nil] lpAccelDst : tagACCEL_struct; cAccelEntries : LONGINT) : LONGINT;
    PROCEDURE [stdcall] TranslateAcceleratorA* (hWnd : HWND; hAccTable : HACCEL; VAR [nil] lpMsg : tagMSG_struct) : LONGINT;
    PROCEDURE [stdcall] TranslateAcceleratorW* (hWnd : HWND; hAccTable : HACCEL; VAR [nil] lpMsg : tagMSG_struct) : LONGINT;
    PROCEDURE [stdcall] GetSystemMetrics* (nIndex : LONGINT) : LONGINT;
    PROCEDURE [stdcall] LoadMenuA* (hInstance : HINSTANCE; lpMenuName : LPCSTR) : HMENU;
    PROCEDURE [stdcall] LoadMenuW* (hInstance : HINSTANCE; lpMenuName : LPCWSTR) : HMENU;
    PROCEDURE [stdcall] LoadMenuIndirectA* (lpMenuTemplate : AutoPtr_MENUTEMPLATEA) : HMENU;
    PROCEDURE [stdcall] LoadMenuIndirectW* (lpMenuTemplate : AutoPtr_MENUTEMPLATEW) : HMENU;
    PROCEDURE [stdcall] GetMenu* (hWnd : HWND) : HMENU;
    PROCEDURE [stdcall] SetMenu* (hWnd : HWND; hMenu : HMENU) : BOOL;
    PROCEDURE [stdcall] ChangeMenuA* (hMenu : HMENU; cmd : UINT; lpszNewItem : LPCSTR; cmdInsert : UINT; flags : UINT) : BOOL;
    PROCEDURE [stdcall] ChangeMenuW* (hMenu : HMENU; cmd : UINT; lpszNewItem : LPCWSTR; cmdInsert : UINT; flags : UINT) : BOOL;
    PROCEDURE [stdcall] HiliteMenuItem* (hWnd : HWND; hMenu : HMENU; uIDHiliteItem : UINT; uHilite : UINT) : BOOL;
    PROCEDURE [stdcall] GetMenuStringA* (hMenu : HMENU; uIDItem : UINT; lpString : LPSTR; nMaxCount : LONGINT; uFlag : UINT) : LONGINT;
    PROCEDURE [stdcall] GetMenuStringW* (hMenu : HMENU; uIDItem : UINT; lpString : LPWSTR; nMaxCount : LONGINT; uFlag : UINT) : LONGINT;
    PROCEDURE [stdcall] GetMenuState* (hMenu : HMENU; uId : UINT; uFlags : UINT) : UINT;
    ...
    PROCEDURE [stdcall] CheckMenuItem* (hMenu : HMENU; uIDCheckItem : UINT; uCheck : UINT) : DWORD;
    PROCEDURE [stdcall] EnableMenuItem* (hMenu : HMENU; uIDEnableItem : UINT; uEnable : UINT) : BOOL;
    PROCEDURE [stdcall] GetSubMenu* (hMenu : HMENU; nPos : LONGINT) : HMENU;
    PROCEDURE [stdcall] GetMenuItemID* (hMenu : HMENU; nPos : LONGINT) : UINT;
    PROCEDURE [stdcall] GetMenuItemCount* (hMenu : HMENU) : LONGINT;
    PROCEDURE [stdcall] InsertMenuA* (hMenu : HMENU; uPosition : UINT; uFlags : UINT; uIDNewItem : UINT; lpNewItem : LPCSTR) : BOOL;
    PROCEDURE [stdcall] InsertMenuW* (hMenu : HMENU; uPosition : UINT; uFlags : UINT; uIDNewItem : UINT; lpNewItem : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] AppendMenuA* (hMenu : HMENU; uFlags : UINT; uIDNewItem : UINT; lpNewItem : LPCSTR) : BOOL;
    PROCEDURE [stdcall] AppendMenuW* (hMenu : HMENU; uFlags : UINT; uIDNewItem : UINT; lpNewItem : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] ModifyMenuA* (hMnu : HMENU; uPosition : UINT; uFlags : UINT; uIDNewItem : UINT; lpNewItem : LPCSTR) : BOOL;
    PROCEDURE [stdcall] ModifyMenuW* (hMnu : HMENU; uPosition : UINT; uFlags : UINT; uIDNewItem : UINT; lpNewItem : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] RemoveMenu* (hMenu : HMENU; uPosition : UINT; uFlags : UINT) : BOOL;
    PROCEDURE [stdcall] DeleteMenu* (hMenu : HMENU; uPosition : UINT; uFlags : UINT) : BOOL;
    PROCEDURE [stdcall] SetMenuItemBitmaps* (hMenu : HMENU; uPosition : UINT; uFlags : UINT; hBitmapUnchecked : HBITMAP; hBitmapChecked : HBITMAP) : BOOL;
    PROCEDURE [stdcall] GetMenuCheckMarkDimensions* () : LONG;
    PROCEDURE [stdcall] TrackPopupMenu* (hMenu : HMENU; uFlags : UINT; x : LONGINT; y : LONGINT; nReserved : LONGINT; hWnd : HWND; VAR [nil] prcRect : RECT) : BOOL;
    PROCEDURE [stdcall] TrackPopupMenuEx* (p0 : HMENU; p1 : UINT; p2 : LONGINT; p3 : LONGINT; p4 : HWND; VAR [nil] p5 : TPMPARAMS) : BOOL;
    PROCEDURE [stdcall] InsertMenuItemA* (p0 : HMENU; p1 : UINT; p2 : BOOL; VAR [nil] p3 : MENUITEMINFOA) : BOOL;
    PROCEDURE [stdcall] InsertMenuItemW* (p0 : HMENU; p1 : UINT; p2 : BOOL; VAR [nil] p3 : MENUITEMINFOW) : BOOL;
    PROCEDURE [stdcall] GetMenuItemInfoA* (p0 : HMENU; p1 : UINT; p2 : BOOL; VAR [nil] p3 : tagMENUITEMINFOA_struct) : BOOL;
    PROCEDURE [stdcall] GetMenuItemInfoW* (p0 : HMENU; p1 : UINT; p2 : BOOL; VAR [nil] p3 : tagMENUITEMINFOW_struct) : BOOL;
    PROCEDURE [stdcall] SetMenuItemInfoA* (p0 : HMENU; p1 : UINT; p2 : BOOL; VAR [nil] p3 : MENUITEMINFOA) : BOOL;
    PROCEDURE [stdcall] SetMenuItemInfoW* (p0 : HMENU; p1 : UINT; p2 : BOOL; VAR [nil] p3 : MENUITEMINFOW) : BOOL;
    PROCEDURE [stdcall] GetMenuDefaultItem* (hMenu : HMENU; fByPos : UINT; gmdiFlags : UINT) : UINT;
    PROCEDURE [stdcall] SetMenuDefaultItem* (hMenu : HMENU; uItem : UINT; fByPos : UINT) : BOOL;
    PROCEDURE [stdcall] GetMenuItemRect* (hWnd : HWND; hMenu : HMENU; uItem : UINT; VAR [nil] lprcItem : tagRECT_struct) : BOOL;
    PROCEDURE [stdcall] MenuItemFromPoint* (hWnd : HWND; hMenu : HMENU; ptScreen : POINT) : LONGINT;
    PROCEDURE [stdcall] DragObject* (p0 : HWND; p1 : HWND; p2 : UINT; p3 : DWORD; p4 : HCURSOR) : DWORD;
    PROCEDURE [stdcall] DragDetect* (p0 : HWND; p1 : POINT) : BOOL;
    PROCEDURE [stdcall] DrawIcon* (hDC : HDC; X : LONGINT; Y : LONGINT; hIcon : HICON) : BOOL;
    PROCEDURE [stdcall] DrawTextA* (hDC : HDC; lpString : LPCSTR; nCount : LONGINT; VAR [nil] lpRect : tagRECT_struct; uFormat : UINT) : LONGINT;
    PROCEDURE [stdcall] DrawTextW* (hDC : HDC; lpString : LPCWSTR; nCount : LONGINT; VAR [nil] lpRect : tagRECT_struct; uFormat : UINT) : LONGINT;
    PROCEDURE [stdcall] DrawTextExA* (p0 : HDC; p1 : LPSTR; p2 : LONGINT; VAR [nil] p3 : tagRECT_struct; p4 : UINT; VAR [nil] p5 : tagDRAWTEXTPARAMS_struct) : LONGINT;
    PROCEDURE [stdcall] DrawTextExW* (p0 : HDC; p1 : LPWSTR; p2 : LONGINT; VAR [nil] p3 : tagRECT_struct; p4 : UINT; VAR [nil] p5 : tagDRAWTEXTPARAMS_struct) : LONGINT;
    PROCEDURE [stdcall] GrayStringA* (hDC : HDC; hBrush : HBRUSH; lpOutputFunc : GRAYSTRINGPROC; lpData : LPARAM; nCount : LONGINT; X : LONGINT; Y : LONGINT; nWidth : LONGINT; nHeight : LONGINT) : BOOL;
    PROCEDURE [stdcall] GrayStringW* (hDC : HDC; hBrush : HBRUSH; lpOutputFunc : GRAYSTRINGPROC; lpData : LPARAM; nCount : LONGINT; X : LONGINT; Y : LONGINT; nWidth : LONGINT; nHeight : LONGINT) : BOOL;
    PROCEDURE [stdcall] DrawStateA* (p0 : HDC; p1 : HBRUSH; p2 : DRAWSTATEPROC; p3 : LPARAM; p4 : WPARAM; p5 : LONGINT; p6 : LONGINT; p7 : LONGINT; p8 : LONGINT; p9 : UINT) : BOOL;
    PROCEDURE [stdcall] DrawStateW* (p0 : HDC; p1 : HBRUSH; p2 : DRAWSTATEPROC; p3 : LPARAM; p4 : WPARAM; p5 : LONGINT; p6 : LONGINT; p7 : LONGINT; p8 : LONGINT; p9 : UINT) : BOOL;
    PROCEDURE [stdcall] TabbedTextOutA* (hDC : HDC; X : LONGINT; Y : LONGINT; lpString : LPCSTR; nCount : LONGINT; nTabPositions : LONGINT; VAR [nil] lpnTabStopPositions : LONGINT; nTabOrigin : LONGINT) : LONG;
    PROCEDURE [stdcall] TabbedTextOutW* (hDC : HDC; X : LONGINT; Y : LONGINT; lpString : LPCWSTR; nCount : LONGINT; nTabPositions : LONGINT; VAR [nil] lpnTabStopPositions : LONGINT; nTabOrigin : LONGINT) : LONG;
    PROCEDURE [stdcall] GetTabbedTextExtentA* (hDC : HDC; lpString : LPCSTR; nCount : LONGINT; nTabPositions : LONGINT; VAR [nil] lpnTabStopPositions : LONGINT) : DWORD;
    PROCEDURE [stdcall] GetTabbedTextExtentW* (hDC : HDC; lpString : LPCWSTR; nCount : LONGINT; nTabPositions : LONGINT; VAR [nil] lpnTabStopPositions : LONGINT) : DWORD;
    ...
    PROCEDURE [stdcall] GetDCEx* (hWnd : HWND; hrgnClip : HRGN; flags : DWORD) : HDC;
    PROCEDURE [stdcall] AlignRects* (VAR [nil] arc : tagRECT_struct; cCount : DWORD; iPrimary : DWORD; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] GetWindowDC* (hWnd : HWND) : HDC;
    PROCEDURE [stdcall] ReleaseDC* (hWnd : HWND; hDC : HDC) : LONGINT;
    PROCEDURE [stdcall] BeginPaint* (hWnd : HWND; VAR [nil] lpPaint : tagPAINTSTRUCT_struct) : HDC;
    PROCEDURE [stdcall] EndPaint* (hWnd : HWND; VAR [nil] lpPaint : PAINTSTRUCT) : BOOL;
    PROCEDURE [stdcall] GetUpdateRect* (hWnd : HWND; VAR [nil] lpRect : tagRECT_struct; bErase : BOOL) : BOOL;
    PROCEDURE [stdcall] GetUpdateRgn* (hWnd : HWND; hRgn : HRGN; bErase : BOOL) : LONGINT;
    PROCEDURE [stdcall] SetWindowRgn* (hWnd : HWND; hRgn : HRGN; bRedraw : BOOL) : LONGINT;
    PROCEDURE [stdcall] GetWindowRgn* (hWnd : HWND; hRgn : HRGN) : LONGINT;
    PROCEDURE [stdcall] ExcludeUpdateRgn* (hDC : HDC; hWnd : HWND) : LONGINT;
    ...
    PROCEDURE [stdcall] RedrawWindow* (hWnd : HWND; VAR [nil] lprcUpdate : RECT; hrgnUpdate : HRGN; flags : UINT) : BOOL;
    PROCEDURE [stdcall] LockWindowUpdate* (hWndLock : HWND) : BOOL;
    PROCEDURE [stdcall] ScrollWindow* (hWnd : HWND; XAmount : LONGINT; YAmount : LONGINT; VAR [nil] lpRect : RECT; VAR [nil] lpClipRect : RECT) : BOOL;
    PROCEDURE [stdcall] ScrollDC* (hDC : HDC; dx : LONGINT; dy : LONGINT; VAR [nil] lprcScroll : RECT; VAR [nil] lprcClip : RECT; hrgnUpdate : HRGN; VAR [nil] lprcUpdate : tagRECT_struct) : BOOL;
    PROCEDURE [stdcall] ScrollWindowEx* (hWnd : HWND; dx : LONGINT; dy : LONGINT; VAR [nil] prcScroll : RECT; VAR [nil] prcClip : RECT; hrgnUpdate : HRGN; VAR [nil] prcUpdate : tagRECT_struct; flags : UINT) : LONGINT;
    PROCEDURE [stdcall] SetScrollPos* (hWnd : HWND; nBar : LONGINT; nPos : LONGINT; bRedraw : BOOL) : LONGINT;
    PROCEDURE [stdcall] GetScrollPos* (hWnd : HWND; nBar : LONGINT) : LONGINT;
    PROCEDURE [stdcall] SetScrollRange* (hWnd : HWND; nBar : LONGINT; nMinPos : LONGINT; nMaxPos : LONGINT; bRedraw : BOOL) : BOOL;
    PROCEDURE [stdcall] GetScrollRange* (hWnd : HWND; nBar : LONGINT; VAR [nil] lpMinPos : LONGINT; VAR [nil] lpMaxPos : LONGINT) : BOOL;
    PROCEDURE [stdcall] ShowScrollBar* (hWnd : HWND; wBar : LONGINT; bShow : BOOL) : BOOL;
    PROCEDURE [stdcall] EnableScrollBar* (hWnd : HWND; wSBflags : UINT; wArrows : UINT) : BOOL;
    PROCEDURE [stdcall] SetPropA* (hWnd : HWND; lpString : LPCSTR; hData : HANDLE) : BOOL;
    PROCEDURE [stdcall] SetPropW* (hWnd : HWND; lpString : LPCWSTR; hData : HANDLE) : BOOL;
    PROCEDURE [stdcall] GetPropA* (hWnd : HWND; lpString : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] GetPropW* (hWnd : HWND; lpString : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] RemovePropA* (hWnd : HWND; lpString : LPCSTR) : HANDLE;
    PROCEDURE [stdcall] RemovePropW* (hWnd : HWND; lpString : LPCWSTR) : HANDLE;
    PROCEDURE [stdcall] EnumPropsExA* (hWnd : HWND; lpEnumFunc : PROPENUMPROCEXA; lParam : LPARAM) : LONGINT;
    PROCEDURE [stdcall] EnumPropsExW* (hWnd : HWND; lpEnumFunc : PROPENUMPROCEXW; lParam : LPARAM) : LONGINT;
    PROCEDURE [stdcall] EnumPropsA* (hWnd : HWND; lpEnumFunc : PROPENUMPROCA) : LONGINT;
    PROCEDURE [stdcall] EnumPropsW* (hWnd : HWND; lpEnumFunc : PROPENUMPROCW) : LONGINT;
    PROCEDURE [stdcall] SetWindowTextA* (hWnd : HWND; lpString : LPCSTR) : BOOL;
    PROCEDURE [stdcall] SetWindowTextW* (hWnd : HWND; lpString : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] GetWindowTextA* (hWnd : HWND; lpString : LPSTR; nMaxCount : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetWindowTextW* (hWnd : HWND; lpString : LPWSTR; nMaxCount : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetWindowTextLengthA* (hWnd : HWND) : LONGINT;
    PROCEDURE [stdcall] GetWindowTextLengthW* (hWnd : HWND) : LONGINT;
    PROCEDURE [stdcall] GetClientRect* (hWnd : HWND; VAR [nil] lpRect : tagRECT_struct) : BOOL;
    PROCEDURE [stdcall] GetWindowRect* (hWnd : HWND; VAR [nil] lpRect : tagRECT_struct) : BOOL;
    PROCEDURE [stdcall] AdjustWindowRect* (VAR [nil] lpRect : tagRECT_struct; dwStyle : DWORD; bMenu : BOOL) : BOOL;
    PROCEDURE [stdcall] AdjustWindowRectEx* (VAR [nil] lpRect : tagRECT_struct; dwStyle : DWORD; bMenu : BOOL; dwExStyle : DWORD) : BOOL;
    PROCEDURE [stdcall] SetWindowContextHelpId* (p0 : HWND; p1 : DWORD) : BOOL;
    PROCEDURE [stdcall] GetWindowContextHelpId* (p0 : HWND) : DWORD;
    PROCEDURE [stdcall] SetMenuContextHelpId* (p0 : HMENU; p1 : DWORD) : BOOL;
    PROCEDURE [stdcall] GetMenuContextHelpId* (p0 : HMENU) : DWORD;
    PROCEDURE [stdcall] MessageBoxA* (hWnd : HWND; lpText : LPCSTR; lpCaption : LPCSTR; uType : UINT) : LONGINT;
    PROCEDURE [stdcall] MessageBoxW* (hWnd : HWND; lpText : LPCWSTR; lpCaption : LPCWSTR; uType : UINT) : LONGINT;
    PROCEDURE [stdcall] MessageBoxExA* (hWnd : HWND; lpText : LPCSTR; lpCaption : LPCSTR; uType : UINT; wLanguageId : WORD) : LONGINT;
    PROCEDURE [stdcall] MessageBoxExW* (hWnd : HWND; lpText : LPCWSTR; lpCaption : LPCWSTR; uType : UINT; wLanguageId : WORD) : LONGINT;
    PROCEDURE [stdcall] MessageBoxIndirectA* (VAR [nil] p0 : tagMSGBOXPARAMSA_struct) : LONGINT;
    PROCEDURE [stdcall] MessageBoxIndirectW* (VAR [nil] p0 : tagMSGBOXPARAMSW_struct) : LONGINT;
    PROCEDURE [stdcall] MessageBeep* (uType : UINT) : BOOL;
    PROCEDURE [stdcall] ShowCursor* (bShow : BOOL) : LONGINT;
    PROCEDURE [stdcall] SetCursorPos* (X : LONGINT; Y : LONGINT) : BOOL;
    PROCEDURE [stdcall] SetCursor* (hCursor : HCURSOR) : HCURSOR;
    PROCEDURE [stdcall] GetCursorPos* (VAR [nil] lpPoint : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] ClipCursor* (VAR [nil] lpRect : RECT) : BOOL;
    PROCEDURE [stdcall] GetClipCursor* (VAR [nil] lpRect : tagRECT_struct) : BOOL;
    PROCEDURE [stdcall] GetCursor* () : HCURSOR;
    PROCEDURE [stdcall] CreateCaret* (hWnd : HWND; hBitmap : HBITMAP; nWidth : LONGINT; nHeight : LONGINT) : BOOL;
    PROCEDURE [stdcall] GetCaretBlinkTime* () : UINT;
    PROCEDURE [stdcall] SetCaretBlinkTime* (uMSeconds : UINT) : BOOL;
    PROCEDURE [stdcall] DestroyCaret* () : BOOL;
    PROCEDURE [stdcall] HideCaret* (hWnd : HWND) : BOOL;
    PROCEDURE [stdcall] ShowCaret* (hWnd : HWND) : BOOL;
    PROCEDURE [stdcall] SetCaretPos* (X : LONGINT; Y : LONGINT) : BOOL;
    PROCEDURE [stdcall] GetCaretPos* (VAR [nil] lpPoint : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] ClientToScreen* (hWnd : HWND; VAR [nil] lpPoint : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] ScreenToClient* (hWnd : HWND; VAR [nil] lpPoint : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] MapWindowPoints* (hWndFrom : HWND; hWndTo : HWND; VAR [nil] lpPoints : tagPOINT_struct; cPoints : UINT) : LONGINT;
    ...
    PROCEDURE [stdcall] ChildWindowFromPointEx* (p0 : HWND; p1 : POINT; p2 : UINT) : HWND;
    PROCEDURE [stdcall] GetSysColor* (nIndex : LONGINT) : DWORD;
    PROCEDURE [stdcall] GetSysColorBrush* (nIndex : LONGINT) : HBRUSH;
    PROCEDURE [stdcall] SetSysColors* (cElements : LONGINT; VAR [nil] lpaElements : INT; VAR [nil] lpaRgbValues : COLORREF) : BOOL;
    PROCEDURE [stdcall] DrawFocusRect* (hDC : HDC; VAR [nil] lprc : RECT) : BOOL;
    PROCEDURE [stdcall] FillRect* (hDC : HDC; VAR [nil] lprc : RECT; hbr : HBRUSH) : LONGINT;
    PROCEDURE [stdcall] FrameRect* (hDC : HDC; VAR [nil] lprc : RECT; hbr : HBRUSH) : LONGINT;
    PROCEDURE [stdcall] InvertRect* (hDC : HDC; VAR [nil] lprc : RECT) : BOOL;
    PROCEDURE [stdcall] SetRect* (VAR [nil] lprc : tagRECT_struct; xLeft : LONGINT; yTop : LONGINT; xRight : LONGINT; yBottom : LONGINT) : BOOL;
    PROCEDURE [stdcall] SetRectEmpty* (VAR [nil] lprc : tagRECT_struct) : BOOL;
    PROCEDURE [stdcall] CopyRect* (VAR [nil] lprcDst : tagRECT_struct; VAR [nil] lprcSrc : RECT) : BOOL;
    PROCEDURE [stdcall] InflateRect* (VAR [nil] lprc : tagRECT_struct; dx : LONGINT; dy : LONGINT) : BOOL;
    PROCEDURE [stdcall] IntersectRect* (VAR [nil] lprcDst : tagRECT_struct; VAR [nil] lprcSrc1 : RECT; VAR [nil] lprcSrc2 : RECT) : BOOL;
    PROCEDURE [stdcall] UnionRect* (VAR [nil] lprcDst : tagRECT_struct; VAR [nil] lprcSrc1 : RECT; VAR [nil] lprcSrc2 : RECT) : BOOL;
    PROCEDURE [stdcall] SubtractRect* (VAR [nil] lprcDst : tagRECT_struct; VAR [nil] lprcSrc1 : RECT; VAR [nil] lprcSrc2 : RECT) : BOOL;
    PROCEDURE [stdcall] OffsetRect* (VAR [nil] lprc : tagRECT_struct; dx : LONGINT; dy : LONGINT) : BOOL;
    ...
    PROCEDURE [stdcall] GetWindowWord* (hWnd : HWND; nIndex : LONGINT) : WORD;
    PROCEDURE [stdcall] SetWindowWord* (hWnd : HWND; nIndex : LONGINT; wNewWord : WORD) : WORD;
    PROCEDURE [stdcall] GetWindowLongA* (hWnd : HWND; nIndex : LONGINT) : LONG;
    PROCEDURE [stdcall] GetWindowLongW* (hWnd : HWND; nIndex : LONGINT) : LONG;
    PROCEDURE [stdcall] SetWindowLongA* (hWnd : HWND; nIndex : LONGINT; dwNewLong : LONG) : LONG;
    PROCEDURE [stdcall] SetWindowLongW* (hWnd : HWND; nIndex : LONGINT; dwNewLong : LONG) : LONG;
    PROCEDURE [stdcall] GetClassWord* (hWnd : HWND; nIndex : LONGINT) : WORD;
    PROCEDURE [stdcall] SetClassWord* (hWnd : HWND; nIndex : LONGINT; wNewWord : WORD) : WORD;
    PROCEDURE [stdcall] GetClassLongA* (hWnd : HWND; nIndex : LONGINT) : DWORD;
    PROCEDURE [stdcall] GetClassLongW* (hWnd : HWND; nIndex : LONGINT) : DWORD;
    PROCEDURE [stdcall] SetClassLongA* (hWnd : HWND; nIndex : LONGINT; dwNewLong : LONG) : DWORD;
    PROCEDURE [stdcall] SetClassLongW* (hWnd : HWND; nIndex : LONGINT; dwNewLong : LONG) : DWORD;
    ...
    PROCEDURE [stdcall] FindWindowA* (lpClassName : LPCSTR; lpWindowName : LPCSTR) : HWND;
    PROCEDURE [stdcall] FindWindowW* (lpClassName : LPCWSTR; lpWindowName : LPCWSTR) : HWND;
    PROCEDURE [stdcall] FindWindowExA* (p0 : HWND; p1 : HWND; p2 : LPCSTR; p3 : LPCSTR) : HWND;
    PROCEDURE [stdcall] FindWindowExW* (p0 : HWND; p1 : HWND; p2 : LPCWSTR; p3 : LPCWSTR) : HWND;
    PROCEDURE [stdcall] EnumWindows* (lpEnumFunc : WNDENUMPROC; lParam : LPARAM) : BOOL;
    PROCEDURE [stdcall] EnumThreadWindows* (dwThreadId : DWORD; lpfn : WNDENUMPROC; lParam : LPARAM) : BOOL;
    PROCEDURE [stdcall] GetClassNameA* (hWnd : HWND; lpClassName : LPSTR; nMaxCount : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetClassNameW* (hWnd : HWND; lpClassName : LPWSTR; nMaxCount : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetTopWindow* (hWnd : HWND) : HWND;
    PROCEDURE [stdcall] GetWindowThreadProcessId* (hWnd : HWND; VAR [nil] lpdwProcessId : DWORD) : DWORD;
    PROCEDURE [stdcall] GetLastActivePopup* (hWnd : HWND) : HWND;
    PROCEDURE [stdcall] GetWindow* (hWnd : HWND; uCmd : UINT) : HWND;
    PROCEDURE [stdcall] SetWindowsHookA* (nFilterType : LONGINT; pfnFilterProc : HOOKPROC) : HOOKPROC;
    PROCEDURE [stdcall] SetWindowsHookW* (nFilterType : LONGINT; pfnFilterProc : HOOKPROC) : HOOKPROC;
    PROCEDURE [stdcall] UnhookWindowsHook* (nCode : LONGINT; pfnFilterProc : HOOKPROC) : BOOL;
    PROCEDURE [stdcall] SetWindowsHookExA* (idHook : LONGINT; lpfn : HOOKPROC; hmod : HINSTANCE; dwThreadId : DWORD) : HHOOK;
    PROCEDURE [stdcall] SetWindowsHookExW* (idHook : LONGINT; lpfn : HOOKPROC; hmod : HINSTANCE; dwThreadId : DWORD) : HHOOK;
    PROCEDURE [stdcall] UnhookWindowsHookEx* (hhk : HHOOK) : BOOL;
    PROCEDURE [stdcall] CallNextHookEx* (hhk : HHOOK; nCode : LONGINT; wParam : WPARAM; lParam : LPARAM) : LRESULT;
    PROCEDURE [stdcall] CheckMenuRadioItem* (p0 : HMENU; p1 : UINT; p2 : UINT; p3 : UINT; p4 : UINT) : BOOL;
    PROCEDURE [stdcall] LoadBitmapA* (hInstance : HINSTANCE; lpBitmapName : LPCSTR) : HBITMAP;
    PROCEDURE [stdcall] LoadBitmapW* (hInstance : HINSTANCE; lpBitmapName : LPCWSTR) : HBITMAP;
    PROCEDURE [stdcall] LoadCursorA* (hInstance : HINSTANCE; lpCursorName : LPCSTR) : HCURSOR;
    PROCEDURE [stdcall] LoadCursorW* (hInstance : HINSTANCE; lpCursorName : LPCWSTR) : HCURSOR;
    PROCEDURE [stdcall] LoadCursorFromFileA* (lpFileName : LPCSTR) : HCURSOR;
    PROCEDURE [stdcall] LoadCursorFromFileW* (lpFileName : LPCWSTR) : HCURSOR;
    PROCEDURE [stdcall] CreateCursor* (hInst : HINSTANCE; xHotSpot : LONGINT; yHotSpot : LONGINT; nWidth : LONGINT; nHeight : LONGINT; pvANDPlane : LPVOID; pvXORPlane : LPVOID) : HCURSOR;
    PROCEDURE [stdcall] DestroyCursor* (hCursor : HCURSOR) : BOOL;
    PROCEDURE [stdcall] SetSystemCursor* (hcur : HCURSOR; id : DWORD) : BOOL;
    PROCEDURE [stdcall] LoadIconA* (hInstance : HINSTANCE; lpIconName : LPCSTR) : HICON;
    PROCEDURE [stdcall] LoadIconW* (hInstance : HINSTANCE; lpIconName : LPCWSTR) : HICON;
    PROCEDURE [stdcall] CreateIcon* (hInstance : HINSTANCE; nWidth : LONGINT; nHeight : LONGINT; cPlanes : BYTE; cBitsPixel : BYTE; lpbANDbits : PBYTE; lpbXORbits : PBYTE) : HICON;
    PROCEDURE [stdcall] DestroyIcon* (hIcon : HICON) : BOOL;
    PROCEDURE [stdcall] LookupIconIdFromDirectory* (presbits : PBYTE; fIcon : BOOL) : LONGINT;
    PROCEDURE [stdcall] LookupIconIdFromDirectoryEx* (presbits : PBYTE; fIcon : BOOL; cxDesired : LONGINT; cyDesired : LONGINT; Flags : UINT) : LONGINT;
    PROCEDURE [stdcall] CreateIconFromResource* (presbits : PBYTE; dwResSize : DWORD; fIcon : BOOL; dwVer : DWORD) : HICON;
    PROCEDURE [stdcall] CreateIconFromResourceEx* (presbits : PBYTE; dwResSize : DWORD; fIcon : BOOL; dwVer : DWORD; cxDesired : LONGINT; cyDesired : LONGINT; Flags : UINT) : HICON;
    PROCEDURE [stdcall] LoadImageA* (p0 : HINSTANCE; p1 : LPCSTR; p2 : UINT; p3 : LONGINT; p4 : LONGINT; p5 : UINT) : HANDLE;
    PROCEDURE [stdcall] LoadImageW* (p0 : HINSTANCE; p1 : LPCWSTR; p2 : UINT; p3 : LONGINT; p4 : LONGINT; p5 : UINT) : HANDLE;
    PROCEDURE [stdcall] CopyImage* (p0 : HANDLE; p1 : UINT; p2 : LONGINT; p3 : LONGINT; p4 : UINT) : HANDLE;
    PROCEDURE [stdcall] DrawIconEx* (hdc : HDC; xLeft : LONGINT; yTop : LONGINT; hIcon : HICON; cxWidth : LONGINT; cyWidth : LONGINT; istepIfAniCur : UINT; hbrFlickerFreeDraw : HBRUSH; diFlags : UINT) : BOOL;
    ...
    PROCEDURE [stdcall] LoadStringA* (hInstance : HINSTANCE; uID : UINT; lpBuffer : LPSTR; nBufferMax : LONGINT) : LONGINT;
    PROCEDURE [stdcall] LoadStringW* (hInstance : HINSTANCE; uID : UINT; lpBuffer : LPWSTR; nBufferMax : LONGINT) : LONGINT;
    PROCEDURE [stdcall] IsDialogMessageA* (hDlg : HWND; VAR [nil] lpMsg : tagMSG_struct) : BOOL;
    PROCEDURE [stdcall] IsDialogMessageW* (hDlg : HWND; VAR [nil] lpMsg : tagMSG_struct) : BOOL;
    PROCEDURE [stdcall] MapDialogRect* (hDlg : HWND; VAR [nil] lpRect : tagRECT_struct) : BOOL;
    PROCEDURE [stdcall] DlgDirListA* (hDlg : HWND; lpPathSpec : LPSTR; nIDListBox : LONGINT; nIDStaticPath : LONGINT; uFileType : UINT) : LONGINT;
    PROCEDURE [stdcall] DlgDirListW* (hDlg : HWND; lpPathSpec : LPWSTR; nIDListBox : LONGINT; nIDStaticPath : LONGINT; uFileType : UINT) : LONGINT;
    PROCEDURE [stdcall] DlgDirSelectExA* (hDlg : HWND; lpString : LPSTR; nCount : LONGINT; nIDListBox : LONGINT) : BOOL;
    PROCEDURE [stdcall] DlgDirSelectExW* (hDlg : HWND; lpString : LPWSTR; nCount : LONGINT; nIDListBox : LONGINT) : BOOL;
    PROCEDURE [stdcall] DlgDirListComboBoxA* (hDlg : HWND; lpPathSpec : LPSTR; nIDComboBox : LONGINT; nIDStaticPath : LONGINT; uFiletype : UINT) : LONGINT;
    PROCEDURE [stdcall] DlgDirListComboBoxW* (hDlg : HWND; lpPathSpec : LPWSTR; nIDComboBox : LONGINT; nIDStaticPath : LONGINT; uFiletype : UINT) : LONGINT;
    PROCEDURE [stdcall] DlgDirSelectComboBoxExA* (hDlg : HWND; lpString : LPSTR; nCount : LONGINT; nIDComboBox : LONGINT) : BOOL;
    PROCEDURE [stdcall] DlgDirSelectComboBoxExW* (hDlg : HWND; lpString : LPWSTR; nCount : LONGINT; nIDComboBox : LONGINT) : BOOL;
    PROCEDURE [stdcall] SetScrollInfo* (p0 : HWND; p1 : LONGINT; VAR [nil] p2 : SCROLLINFO; p3 : BOOL) : LONGINT;
    PROCEDURE [stdcall] GetScrollInfo* (p0 : HWND; p1 : LONGINT; VAR [nil] p2 : tagSCROLLINFO_struct) : BOOL;
    PROCEDURE [stdcall] DefFrameProcA* (hWnd : HWND; hWndMDIClient : HWND; uMsg : UINT; wParam : WPARAM; lParam : LPARAM) : LRESULT;
    PROCEDURE [stdcall] DefFrameProcW* (hWnd : HWND; hWndMDIClient : HWND; uMsg : UINT; wParam : WPARAM; lParam : LPARAM) : LRESULT;
    PROCEDURE [stdcall] DefMDIChildProcA* (hWnd : HWND; uMsg : UINT; wParam : WPARAM; lParam : LPARAM) : LRESULT;
    PROCEDURE [stdcall] DefMDIChildProcW* (hWnd : HWND; uMsg : UINT; wParam : WPARAM; lParam : LPARAM) : LRESULT;
    PROCEDURE [stdcall] TranslateMDISysAccel* (hWndClient : HWND; VAR [nil] lpMsg : tagMSG_struct) : BOOL;
    PROCEDURE [stdcall] ArrangeIconicWindows* (hWnd : HWND) : UINT;
    PROCEDURE [stdcall] CreateMDIWindowA* (lpClassName : LPSTR; lpWindowName : LPSTR; dwStyle : DWORD; X : LONGINT; Y : LONGINT; nWidth : LONGINT; nHeight : LONGINT; hWndParent : HWND; hInstance : HINSTANCE; lParam : LPARAM) : HWND;
    PROCEDURE [stdcall] CreateMDIWindowW* (lpClassName : LPWSTR; lpWindowName : LPWSTR; dwStyle : DWORD; X : LONGINT; Y : LONGINT; nWidth : LONGINT; nHeight : LONGINT; hWndParent : HWND; hInstance : HINSTANCE; lParam : LPARAM) : HWND;
    PROCEDURE [stdcall] TileWindows* (hwndParent : HWND; wHow : UINT; VAR [nil] lpRect : RECT; cKids : UINT; VAR [nil] lpKids : HWND) : WORD;
    PROCEDURE [stdcall] CascadeWindows* (hwndParent : HWND; wHow : UINT; VAR [nil] lpRect : RECT; cKids : UINT; VAR [nil] lpKids : HWND) : WORD;
    PROCEDURE [stdcall] WinHelpA* (hWndMain : HWND; lpszHelp : LPCSTR; uCommand : UINT; dwData : DWORD) : BOOL;
    PROCEDURE [stdcall] WinHelpW* (hWndMain : HWND; lpszHelp : LPCWSTR; uCommand : UINT; dwData : DWORD) : BOOL;
    PROCEDURE [stdcall] ChangeDisplaySettingsA* (VAR [nil] lpDevMode : _devicemodeA_struct; dwFlags : DWORD) : LONG;
    PROCEDURE [stdcall] ChangeDisplaySettingsW* (VAR [nil] lpDevMode : _devicemodeW_struct; dwFlags : DWORD) : LONG;
    PROCEDURE [stdcall] ChangeDisplaySettingsExA* (lpszDeviceName : LPCSTR; VAR [nil] lpDevMode : _devicemodeA_struct; hwnd : HWND; dwflags : DWORD; lParam : LPVOID) : LONG;
    PROCEDURE [stdcall] ChangeDisplaySettingsExW* (lpszDeviceName : LPCWSTR; VAR [nil] lpDevMode : _devicemodeW_struct; hwnd : HWND; dwflags : DWORD; lParam : LPVOID) : LONG;
    PROCEDURE [stdcall] EnumDisplaySettingsA* (lpszDeviceName : LPCSTR; iModeNum : DWORD; VAR [nil] lpDevMode : _devicemodeA_struct) : BOOL;
    PROCEDURE [stdcall] EnumDisplaySettingsW* (lpszDeviceName : LPCWSTR; iModeNum : DWORD; VAR [nil] lpDevMode : _devicemodeW_struct) : BOOL;
    PROCEDURE [stdcall] SystemParametersInfoA* (uiAction : UINT; uiParam : UINT; pvParam : PVOID; fWinIni : UINT) : BOOL;
    PROCEDURE [stdcall] SystemParametersInfoW* (uiAction : UINT; uiParam : UINT; pvParam : PVOID; fWinIni : UINT) : BOOL;
    PROCEDURE [stdcall] SetDebugErrorLevel* (dwLevel : DWORD);
    PROCEDURE [stdcall] SetLastErrorEx* (dwErrCode : DWORD; dwType : DWORD);
    PROCEDURE [stdcall] IsValidCodePage* (CodePage : UINT) : BOOL;
    PROCEDURE [stdcall] GetACP* () : UINT;
    PROCEDURE [stdcall] GetOEMCP* () : UINT;
    PROCEDURE [stdcall] GetCPInfo* (CodePage : UINT; VAR [nil] lpCPInfo : _cpinfo_struct) : BOOL;
    PROCEDURE [stdcall] GetCPInfoExA* (CodePage : UINT; dwFlags : DWORD; VAR [nil] lpCPInfoEx : _cpinfoexA_struct) : BOOL;
    PROCEDURE [stdcall] GetCPInfoExW* (CodePage : UINT; dwFlags : DWORD; VAR [nil] lpCPInfoEx : _cpinfoexW_struct) : BOOL;
    PROCEDURE [stdcall] IsDBCSLeadByte* (TestChar : BYTE) : BOOL;
    PROCEDURE [stdcall] IsDBCSLeadByteEx* (CodePage : UINT; TestChar : BYTE) : BOOL;
    PROCEDURE [stdcall] MultiByteToWideChar* (CodePage : UINT; dwFlags : DWORD; lpMultiByteStr : LPCSTR; cchMultiByte : LONGINT; lpWideCharStr : LPWSTR; cchWideChar : LONGINT) : LONGINT;
    PROCEDURE [stdcall] WideCharToMultiByte* (CodePage : UINT; dwFlags : DWORD; lpWideCharStr : LPCWSTR; cchWideChar : LONGINT; lpMultiByteStr : LPSTR; cchMultiByte : LONGINT; lpDefaultChar : LPCSTR; VAR [nil] lpUsedDefaultChar : BOOL) : LONGINT;
    PROCEDURE [stdcall] CompareStringA* (Locale : LCID; dwCmpFlags : DWORD; lpString1 : LPCSTR; cchCount1 : LONGINT; lpString2 : LPCSTR; cchCount2 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] CompareStringW* (Locale : LCID; dwCmpFlags : DWORD; lpString1 : LPCWSTR; cchCount1 : LONGINT; lpString2 : LPCWSTR; cchCount2 : LONGINT) : LONGINT;
    PROCEDURE [stdcall] LCMapStringA* (Locale : LCID; dwMapFlags : DWORD; lpSrcStr : LPCSTR; cchSrc : LONGINT; lpDestStr : LPSTR; cchDest : LONGINT) : LONGINT;
    PROCEDURE [stdcall] LCMapStringW* (Locale : LCID; dwMapFlags : DWORD; lpSrcStr : LPCWSTR; cchSrc : LONGINT; lpDestStr : LPWSTR; cchDest : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetLocaleInfoA* (Locale : LCID; LCType : LCTYPE; lpLCData : LPSTR; cchData : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetLocaleInfoW* (Locale : LCID; LCType : LCTYPE; lpLCData : LPWSTR; cchData : LONGINT) : LONGINT;
    PROCEDURE [stdcall] SetLocaleInfoA* (Locale : LCID; LCType : LCTYPE; lpLCData : LPCSTR) : BOOL;
    PROCEDURE [stdcall] SetLocaleInfoW* (Locale : LCID; LCType : LCTYPE; lpLCData : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] GetTimeFormatA* (Locale : LCID; dwFlags : DWORD; VAR [nil] lpTime : SYSTEMTIME; lpFormat : LPCSTR; lpTimeStr : LPSTR; cchTime : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetTimeFormatW* (Locale : LCID; dwFlags : DWORD; VAR [nil] lpTime : SYSTEMTIME; lpFormat : LPCWSTR; lpTimeStr : LPWSTR; cchTime : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetDateFormatA* (Locale : LCID; dwFlags : DWORD; VAR [nil] lpDate : SYSTEMTIME; lpFormat : LPCSTR; lpDateStr : LPSTR; cchDate : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetDateFormatW* (Locale : LCID; dwFlags : DWORD; VAR [nil] lpDate : SYSTEMTIME; lpFormat : LPCWSTR; lpDateStr : LPWSTR; cchDate : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetNumberFormatA* (Locale : LCID; dwFlags : DWORD; lpValue : LPCSTR; VAR [nil] lpFormat : NUMBERFMTA; lpNumberStr : LPSTR; cchNumber : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetNumberFormatW* (Locale : LCID; dwFlags : DWORD; lpValue : LPCWSTR; VAR [nil] lpFormat : NUMBERFMTW; lpNumberStr : LPWSTR; cchNumber : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetCurrencyFormatA* (Locale : LCID; dwFlags : DWORD; lpValue : LPCSTR; VAR [nil] lpFormat : CURRENCYFMTA; lpCurrencyStr : LPSTR; cchCurrency : LONGINT) : LONGINT;
    PROCEDURE [stdcall] GetCurrencyFormatW* (Locale : LCID; dwFlags : DWORD; lpValue : LPCWSTR; VAR [nil] lpFormat : CURRENCYFMTW; lpCurrencyStr : LPWSTR; cchCurrency : LONGINT) : LONGINT;
    ...
    PROCEDURE [stdcall] EnumTimeFormatsA* (lpTimeFmtEnumProc : TIMEFMT_ENUMPROCA; Locale : LCID; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] EnumTimeFormatsW* (lpTimeFmtEnumProc : TIMEFMT_ENUMPROCW; Locale : LCID; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] EnumDateFormatsA* (lpDateFmtEnumProc : DATEFMT_ENUMPROCA; Locale : LCID; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] EnumDateFormatsW* (lpDateFmtEnumProc : DATEFMT_ENUMPROCW; Locale : LCID; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] IsValidLocale* (Locale : LCID; dwFlags : DWORD) : BOOL;
    ...
    PROCEDURE [stdcall] GetStringTypeExA* (Locale : LCID; dwInfoType : DWORD; lpSrcStr : LPCSTR; cchSrc : LONGINT; VAR [nil] lpCharType : WORD) : BOOL;
    PROCEDURE [stdcall] GetStringTypeExW* (Locale : LCID; dwInfoType : DWORD; lpSrcStr : LPCWSTR; cchSrc : LONGINT; VAR [nil] lpCharType : WORD) : BOOL;
    PROCEDURE [stdcall] GetStringTypeA* (Locale : LCID; dwInfoType : DWORD; lpSrcStr : LPCSTR; cchSrc : LONGINT; VAR [nil] lpCharType : WORD) : BOOL;
    PROCEDURE [stdcall] GetStringTypeW* (dwInfoType : DWORD; lpSrcStr : LPCWSTR; cchSrc : LONGINT; VAR [nil] lpCharType : WORD) : BOOL;
    PROCEDURE [stdcall] FoldStringA* (dwMapFlags : DWORD; lpSrcStr : LPCSTR; cchSrc : LONGINT; lpDestStr : LPSTR; cchDest : LONGINT) : LONGINT;
    PROCEDURE [stdcall] FoldStringW* (dwMapFlags : DWORD; lpSrcStr : LPCWSTR; cchSrc : LONGINT; lpDestStr : LPWSTR; cchDest : LONGINT) : LONGINT;
    PROCEDURE [stdcall] EnumSystemLocalesA* (lpLocaleEnumProc : LOCALE_ENUMPROCA; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] EnumSystemLocalesW* (lpLocaleEnumProc : LOCALE_ENUMPROCW; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] EnumSystemCodePagesA* (lpCodePageEnumProc : CODEPAGE_ENUMPROCA; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] EnumSystemCodePagesW* (lpCodePageEnumProc : CODEPAGE_ENUMPROCW; dwFlags : DWORD) : BOOL;
    PROCEDURE [stdcall] PeekConsoleInputA* (hConsoleInput : HANDLE; VAR [nil] lpBuffer : _INPUT_RECORD_struct; nLength : DWORD; VAR [nil] lpNumberOfEventsRead : DWORD) : BOOL;
    PROCEDURE [stdcall] PeekConsoleInputW* (hConsoleInput : HANDLE; VAR [nil] lpBuffer : _INPUT_RECORD_struct; nLength : DWORD; VAR [nil] lpNumberOfEventsRead : DWORD) : BOOL;
    PROCEDURE [stdcall] ReadConsoleInputA* (hConsoleInput : HANDLE; VAR [nil] lpBuffer : _INPUT_RECORD_struct; nLength : DWORD; VAR [nil] lpNumberOfEventsRead : DWORD) : BOOL;
    PROCEDURE [stdcall] ReadConsoleInputW* (hConsoleInput : HANDLE; VAR [nil] lpBuffer : _INPUT_RECORD_struct; nLength : DWORD; VAR [nil] lpNumberOfEventsRead : DWORD) : BOOL;
    PROCEDURE [stdcall] WriteConsoleInputA* (hConsoleInput : HANDLE; VAR [nil] lpBuffer : INPUT_RECORD; nLength : DWORD; VAR [nil] lpNumberOfEventsWritten : DWORD) : BOOL;
    PROCEDURE [stdcall] WriteConsoleInputW* (hConsoleInput : HANDLE; VAR [nil] lpBuffer : INPUT_RECORD; nLength : DWORD; VAR [nil] lpNumberOfEventsWritten : DWORD) : BOOL;
    PROCEDURE [stdcall] ReadConsoleOutputA* (hConsoleOutput : HANDLE; VAR [nil] lpBuffer : _CHAR_INFO_struct; dwBufferSize : COORD; dwBufferCoord : COORD; VAR [nil] lpReadRegion : _SMALL_RECT_struct) : BOOL;
    PROCEDURE [stdcall] ReadConsoleOutputW* (hConsoleOutput : HANDLE; VAR [nil] lpBuffer : _CHAR_INFO_struct; dwBufferSize : COORD; dwBufferCoord : COORD; VAR [nil] lpReadRegion : _SMALL_RECT_struct) : BOOL;
    PROCEDURE [stdcall] WriteConsoleOutputA* (hConsoleOutput : HANDLE; VAR [nil] lpBuffer : CHAR_INFO; dwBufferSize : COORD; dwBufferCoord : COORD; VAR [nil] lpWriteRegion : _SMALL_RECT_struct) : BOOL;
    PROCEDURE [stdcall] WriteConsoleOutputW* (hConsoleOutput : HANDLE; VAR [nil] lpBuffer : CHAR_INFO; dwBufferSize : COORD; dwBufferCoord : COORD; VAR [nil] lpWriteRegion : _SMALL_RECT_struct) : BOOL;
    PROCEDURE [stdcall] ReadConsoleOutputCharacterA* (hConsoleOutput : HANDLE; lpCharacter : LPSTR; nLength : DWORD; dwReadCoord : COORD; VAR [nil] lpNumberOfCharsRead : DWORD) : BOOL;
    PROCEDURE [stdcall] ReadConsoleOutputCharacterW* (hConsoleOutput : HANDLE; lpCharacter : LPWSTR; nLength : DWORD; dwReadCoord : COORD; VAR [nil] lpNumberOfCharsRead : DWORD) : BOOL;
    PROCEDURE [stdcall] ReadConsoleOutputAttribute* (hConsoleOutput : HANDLE; VAR [nil] lpAttribute : WORD; nLength : DWORD; dwReadCoord : COORD; VAR [nil] lpNumberOfAttrsRead : DWORD) : BOOL;
    PROCEDURE [stdcall] WriteConsoleOutputCharacterA* (hConsoleOutput : HANDLE; lpCharacter : LPCSTR; nLength : DWORD; dwWriteCoord : COORD; VAR [nil] lpNumberOfCharsWritten : DWORD) : BOOL;
    PROCEDURE [stdcall] WriteConsoleOutputCharacterW* (hConsoleOutput : HANDLE; lpCharacter : LPCWSTR; nLength : DWORD; dwWriteCoord : COORD; VAR [nil] lpNumberOfCharsWritten : DWORD) : BOOL;
    PROCEDURE [stdcall] WriteConsoleOutputAttribute* (hConsoleOutput : HANDLE; VAR [nil] lpAttribute : WORD; nLength : DWORD; dwWriteCoord : COORD; VAR [nil] lpNumberOfAttrsWritten : DWORD) : BOOL;
    PROCEDURE [stdcall] FillConsoleOutputCharacterA* (hConsoleOutput : HANDLE; cCharacter : CHAR; nLength : DWORD; dwWriteCoord : COORD; VAR [nil] lpNumberOfCharsWritten : DWORD) : BOOL;
    PROCEDURE [stdcall] FillConsoleOutputCharacterW* (hConsoleOutput : HANDLE; cCharacter : WCHAR; nLength : DWORD; dwWriteCoord : COORD; VAR [nil] lpNumberOfCharsWritten : DWORD) : BOOL;
    PROCEDURE [stdcall] FillConsoleOutputAttribute* (hConsoleOutput : HANDLE; wAttribute : WORD; nLength : DWORD; dwWriteCoord : COORD; VAR [nil] lpNumberOfAttrsWritten : DWORD) : BOOL;
    PROCEDURE [stdcall] GetConsoleMode* (hConsoleHandle : HANDLE; VAR [nil] lpMode : DWORD) : BOOL;
    PROCEDURE [stdcall] GetNumberOfConsoleInputEvents* (hConsoleInput : HANDLE; VAR [nil] lpNumberOfEvents : DWORD) : BOOL;
    PROCEDURE [stdcall] GetConsoleScreenBufferInfo* (hConsoleOutput : HANDLE; VAR [nil] lpConsoleScreenBufferInfo : _CONSOLE_SCREEN_BUFFER_INFO_struct) : BOOL;
    (* H2O: function returns record.
        PROCEDURE [stdcall] GetLargestConsoleWindowSize* (hConsoleOutput : HANDLE) : COORD; *)
    PROCEDURE [stdcall] GetConsoleCursorInfo* (hConsoleOutput : HANDLE; VAR [nil] lpConsoleCursorInfo : _CONSOLE_CURSOR_INFO_struct) : BOOL;
    PROCEDURE [stdcall] GetNumberOfConsoleMouseButtons* (VAR [nil] lpNumberOfMouseButtons : DWORD) : BOOL;
    PROCEDURE [stdcall] SetConsoleMode* (hConsoleHandle : HANDLE; dwMode : DWORD) : BOOL;
    ...
    PROCEDURE [stdcall] SetConsoleTextAttribute* (hConsoleOutput : HANDLE; wAttributes : WORD) : BOOL;
    PROCEDURE [stdcall] SetConsoleCtrlHandler* (HandlerRoutine : PHANDLER_ROUTINE; Add : BOOL) : BOOL;
    PROCEDURE [stdcall] GenerateConsoleCtrlEvent* (dwCtrlEvent : DWORD; dwProcessGroupId : DWORD) : BOOL;
    PROCEDURE [stdcall] AllocConsole* () : BOOL;
    PROCEDURE [stdcall] FreeConsole* () : BOOL;
    PROCEDURE [stdcall] GetConsoleTitleA* (lpConsoleTitle : LPSTR; nSize : DWORD) : DWORD;
    PROCEDURE [stdcall] GetConsoleTitleW* (lpConsoleTitle : LPWSTR; nSize : DWORD) : DWORD;
    PROCEDURE [stdcall] SetConsoleTitleA* (lpConsoleTitle : LPCSTR) : BOOL;
    PROCEDURE [stdcall] SetConsoleTitleW* (lpConsoleTitle : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] ReadConsoleA* (hConsoleInput : HANDLE; lpBuffer : LPVOID; nNumberOfCharsToRead : DWORD; VAR [nil] lpNumberOfCharsRead : DWORD; lpReserved : LPVOID) : BOOL;
    PROCEDURE [stdcall] ReadConsoleW* (hConsoleInput : HANDLE; lpBuffer : LPVOID; nNumberOfCharsToRead : DWORD; VAR [nil] lpNumberOfCharsRead : DWORD; lpReserved : LPVOID) : BOOL;
    PROCEDURE [stdcall] WriteConsoleA* (hConsoleOutput : HANDLE; lpBuffer : LPVOID; nNumberOfCharsToWrite : DWORD; VAR [nil] lpNumberOfCharsWritten : DWORD; lpReserved : LPVOID) : BOOL;
    PROCEDURE [stdcall] WriteConsoleW* (hConsoleOutput : HANDLE; lpBuffer : LPVOID; nNumberOfCharsToWrite : DWORD; VAR [nil] lpNumberOfCharsWritten : DWORD; lpReserved : LPVOID) : BOOL;
    PROCEDURE [stdcall] CreateConsoleScreenBuffer* (dwDesiredAccess : DWORD; dwShareMode : DWORD; VAR [nil] lpSecurityAttributes : SECURITY_ATTRIBUTES; dwFlags : DWORD; lpScreenBufferData : LPVOID) : HANDLE;
    PROCEDURE [stdcall] GetConsoleCP* () : UINT;
    PROCEDURE [stdcall] SetConsoleCP* (wCodePageID : UINT) : BOOL;
    PROCEDURE [stdcall] GetConsoleOutputCP* () : UINT;
    PROCEDURE [stdcall] SetConsoleOutputCP* (wCodePageID : UINT) : BOOL;
    PROCEDURE [stdcall] VerFindFileA* (uFlags : DWORD; szFileName : LPSTR; szWinDir : LPSTR; szAppDir : LPSTR; szCurDir : LPSTR; VAR [nil] lpuCurDirLen : LONGINT; szDestDir : LPSTR; VAR [nil] lpuDestDirLen : LONGINT) : DWORD;
    PROCEDURE [stdcall] VerFindFileW* (uFlags : DWORD; szFileName : LPWSTR; szWinDir : LPWSTR; szAppDir : LPWSTR; szCurDir : LPWSTR; VAR [nil] lpuCurDirLen : LONGINT; szDestDir : LPWSTR; VAR [nil] lpuDestDirLen : LONGINT) : DWORD;
    PROCEDURE [stdcall] VerInstallFileA* (uFlags : DWORD; szSrcFileName : LPSTR; szDestFileName : LPSTR; szSrcDir : LPSTR; szDestDir : LPSTR; szCurDir : LPSTR; szTmpFile : LPSTR; VAR [nil] lpuTmpFileLen : LONGINT) : DWORD;
    PROCEDURE [stdcall] VerInstallFileW* (uFlags : DWORD; szSrcFileName : LPWSTR; szDestFileName : LPWSTR; szSrcDir : LPWSTR; szDestDir : LPWSTR; szCurDir : LPWSTR; szTmpFile : LPWSTR; VAR [nil] lpuTmpFileLen : LONGINT) : DWORD;
    PROCEDURE [stdcall] GetFileVersionInfoSizeA* (lptstrFilename : LPSTR; VAR [nil] lpdwHandle : DWORD) : DWORD;
    PROCEDURE [stdcall] GetFileVersionInfoSizeW* (lptstrFilename : LPWSTR; VAR [nil] lpdwHandle : DWORD) : DWORD;
    PROCEDURE [stdcall] GetFileVersionInfoA* (lptstrFilename : LPSTR; dwHandle : DWORD; dwLen : DWORD; lpData : LPVOID) : BOOL;
    PROCEDURE [stdcall] GetFileVersionInfoW* (lptstrFilename : LPWSTR; dwHandle : DWORD; dwLen : DWORD; lpData : LPVOID) : BOOL;
    PROCEDURE [stdcall] VerLanguageNameA* (wLang : DWORD; szLang : LPSTR; nSize : DWORD) : DWORD;
    PROCEDURE [stdcall] VerLanguageNameW* (wLang : DWORD; szLang : LPWSTR; nSize : DWORD) : DWORD;
    PROCEDURE [stdcall] VerQueryValueA* (pBlock : LPVOID; lpSubBlock : LPSTR; VAR [nil] lplpBuffer : LPVOID; VAR [nil] puLen : LONGINT) : BOOL;
    PROCEDURE [stdcall] VerQueryValueW* (pBlock : LPVOID; lpSubBlock : LPWSTR; VAR [nil] lplpBuffer : LPVOID; VAR [nil] puLen : LONGINT) : BOOL;
    PROCEDURE [stdcall] RegCloseKey* (hKey : HKEY) : LONG;
    PROCEDURE [stdcall] RegOverridePredefKey* (hKey : HKEY; hNewHKey : HKEY) : LONG;
    PROCEDURE [stdcall] RegConnectRegistryA* (lpMachineName : LPCSTR; hKey : HKEY; VAR [nil] phkResult : HKEY) : LONG;
    PROCEDURE [stdcall] RegConnectRegistryW* (lpMachineName : LPCWSTR; hKey : HKEY; VAR [nil] phkResult : HKEY) : LONG;
    PROCEDURE [stdcall] RegCreateKeyA* (hKey : HKEY; lpSubKey : LPCSTR; VAR [nil] phkResult : HKEY) : LONG;
    PROCEDURE [stdcall] RegCreateKeyW* (hKey : HKEY; lpSubKey : LPCWSTR; VAR [nil] phkResult : HKEY) : LONG;
    PROCEDURE [stdcall] RegCreateKeyExA* (hKey : HKEY; lpSubKey : LPCSTR; Reserved : DWORD; lpClass : LPSTR; dwOptions : DWORD; samDesired : REGSAM; VAR [nil] lpSecurityAttributes : _SECURITY_ATTRIBUTES_struct; VAR [nil] phkResult : HKEY; VAR [nil] lpdwDisposition : DWORD) : LONG;
    PROCEDURE [stdcall] RegCreateKeyExW* (hKey : HKEY; lpSubKey : LPCWSTR; Reserved : DWORD; lpClass : LPWSTR; dwOptions : DWORD; samDesired : REGSAM; VAR [nil] lpSecurityAttributes : _SECURITY_ATTRIBUTES_struct; VAR [nil] phkResult : HKEY; VAR [nil] lpdwDisposition : DWORD) : LONG;
    PROCEDURE [stdcall] RegDeleteKeyA* (hKey : HKEY; lpSubKey : LPCSTR) : LONG;
    PROCEDURE [stdcall] RegDeleteKeyW* (hKey : HKEY; lpSubKey : LPCWSTR) : LONG;
    PROCEDURE [stdcall] RegDeleteValueA* (hKey : HKEY; lpValueName : LPCSTR) : LONG;
    PROCEDURE [stdcall] RegDeleteValueW* (hKey : HKEY; lpValueName : LPCWSTR) : LONG;
    PROCEDURE [stdcall] RegEnumKeyA* (hKey : HKEY; dwIndex : DWORD; lpName : LPSTR; cbName : DWORD) : LONG;
    PROCEDURE [stdcall] RegEnumKeyW* (hKey : HKEY; dwIndex : DWORD; lpName : LPWSTR; cbName : DWORD) : LONG;
    PROCEDURE [stdcall] RegEnumKeyExA* (hKey : HKEY; dwIndex : DWORD; lpName : LPSTR; VAR [nil] lpcbName : DWORD; VAR [nil] lpReserved : DWORD; lpClass : LPSTR; VAR [nil] lpcbClass : DWORD; VAR [nil] lpftLastWriteTime : _FILETIME_struct) : LONG;
    PROCEDURE [stdcall] RegEnumKeyExW* (hKey : HKEY; dwIndex : DWORD; lpName : LPWSTR; VAR [nil] lpcbName : DWORD; VAR [nil] lpReserved : DWORD; lpClass : LPWSTR; VAR [nil] lpcbClass : DWORD; VAR [nil] lpftLastWriteTime : _FILETIME_struct) : LONG;
    PROCEDURE [stdcall] RegEnumValueA* (hKey : HKEY; dwIndex : DWORD; lpValueName : LPSTR; VAR [nil] lpcbValueName : DWORD; VAR [nil] lpReserved : DWORD; VAR [nil] lpType : DWORD; lpData : LPBYTE; VAR [nil] lpcbData : DWORD) : LONG;
    PROCEDURE [stdcall] RegEnumValueW* (hKey : HKEY; dwIndex : DWORD; lpValueName : LPWSTR; VAR [nil] lpcbValueName : DWORD; VAR [nil] lpReserved : DWORD; VAR [nil] lpType : DWORD; lpData : LPBYTE; VAR [nil] lpcbData : DWORD) : LONG;
    PROCEDURE [stdcall] RegFlushKey* (hKey : HKEY) : LONG;
    PROCEDURE [stdcall] RegGetKeySecurity* (hKey : HKEY; SecurityInformation : SECURITY_INFORMATION; pSecurityDescriptor : PSECURITY_DESCRIPTOR; VAR [nil] lpcbSecurityDescriptor : DWORD) : LONG;
    PROCEDURE [stdcall] RegLoadKeyA* (hKey : HKEY; lpSubKey : LPCSTR; lpFile : LPCSTR) : LONG;
    PROCEDURE [stdcall] RegLoadKeyW* (hKey : HKEY; lpSubKey : LPCWSTR; lpFile : LPCWSTR) : LONG;
    PROCEDURE [stdcall] RegNotifyChangeKeyValue* (hKey : HKEY; bWatchSubtree : BOOL; dwNotifyFilter : DWORD; hEvent : HANDLE; fAsynchronus : BOOL) : LONG;
    PROCEDURE [stdcall] RegOpenKeyA* (hKey : HKEY; lpSubKey : LPCSTR; VAR [nil] phkResult : HKEY) : LONG;
    PROCEDURE [stdcall] RegOpenKeyW* (hKey : HKEY; lpSubKey : LPCWSTR; VAR [nil] phkResult : HKEY) : LONG;
    PROCEDURE [stdcall] RegOpenKeyExA* (hKey : HKEY; lpSubKey : LPCSTR; ulOptions : DWORD; samDesired : REGSAM; VAR [nil] phkResult : HKEY) : LONG;
    PROCEDURE [stdcall] RegOpenKeyExW* (hKey : HKEY; lpSubKey : LPCWSTR; ulOptions : DWORD; samDesired : REGSAM; VAR [nil] phkResult : HKEY) : LONG;
    PROCEDURE [stdcall] RegQueryInfoKeyA* (hKey : HKEY; lpClass : LPSTR; VAR [nil] lpcbClass : DWORD; VAR [nil] lpReserved : DWORD; VAR [nil] lpcSubKeys : DWORD; VAR [nil] lpcbMaxSubKeyLen : DWORD; VAR [nil] lpcbMaxClassLen : DWORD; VAR [nil] lpcValues : DWORD; VAR [nil] lpcbMaxValueNameLen : DWORD; VAR [nil] lpcbMaxValueLen : DWORD; VAR [nil] lpcbSecurityDescriptor : DWORD; VAR [nil] lpftLastWriteTime : _FILETIME_struct) : LONG;
    PROCEDURE [stdcall] RegQueryInfoKeyW* (hKey : HKEY; lpClass : LPWSTR; VAR [nil] lpcbClass : DWORD; VAR [nil] lpReserved : DWORD; VAR [nil] lpcSubKeys : DWORD; VAR [nil] lpcbMaxSubKeyLen : DWORD; VAR [nil] lpcbMaxClassLen : DWORD; VAR [nil] lpcValues : DWORD; VAR [nil] lpcbMaxValueNameLen : DWORD; VAR [nil] lpcbMaxValueLen : DWORD; VAR [nil] lpcbSecurityDescriptor : DWORD; VAR [nil] lpftLastWriteTime : _FILETIME_struct) : LONG;
    PROCEDURE [stdcall] RegQueryValueA* (hKey : HKEY; lpSubKey : LPCSTR; lpValue : LPSTR; VAR [nil] lpcbValue : LONG) : LONG;
    PROCEDURE [stdcall] RegQueryValueW* (hKey : HKEY; lpSubKey : LPCWSTR; lpValue : LPWSTR; VAR [nil] lpcbValue : LONG) : LONG;
    PROCEDURE [stdcall] RegQueryMultipleValuesA* (hKey : HKEY; VAR [nil] val_list : value_entA_struct; num_vals : DWORD; lpValueBuf : LPSTR; VAR [nil] ldwTotsize : DWORD) : LONG;
    PROCEDURE [stdcall] RegQueryMultipleValuesW* (hKey : HKEY; VAR [nil] val_list : value_entW_struct; num_vals : DWORD; lpValueBuf : LPWSTR; VAR [nil] ldwTotsize : DWORD) : LONG;
    PROCEDURE [stdcall] RegQueryValueExA* (hKey : HKEY; lpValueName : LPCSTR; VAR [nil] lpReserved : DWORD; VAR [nil] lpType : DWORD; lpData : LPBYTE; VAR [nil] lpcbData : DWORD) : LONG;
    PROCEDURE [stdcall] RegQueryValueExW* (hKey : HKEY; lpValueName : LPCWSTR; VAR [nil] lpReserved : DWORD; VAR [nil] lpType : DWORD; lpData : LPBYTE; VAR [nil] lpcbData : DWORD) : LONG;
    PROCEDURE [stdcall] RegReplaceKeyA* (hKey : HKEY; lpSubKey : LPCSTR; lpNewFile : LPCSTR; lpOldFile : LPCSTR) : LONG;
    PROCEDURE [stdcall] RegReplaceKeyW* (hKey : HKEY; lpSubKey : LPCWSTR; lpNewFile : LPCWSTR; lpOldFile : LPCWSTR) : LONG;
    PROCEDURE [stdcall] RegRestoreKeyA* (hKey : HKEY; lpFile : LPCSTR; dwFlags : DWORD) : LONG;
    PROCEDURE [stdcall] RegRestoreKeyW* (hKey : HKEY; lpFile : LPCWSTR; dwFlags : DWORD) : LONG;
    PROCEDURE [stdcall] RegSaveKeyA* (hKey : HKEY; lpFile : LPCSTR; VAR [nil] lpSecurityAttributes : _SECURITY_ATTRIBUTES_struct) : LONG;
    PROCEDURE [stdcall] RegSaveKeyW* (hKey : HKEY; lpFile : LPCWSTR; VAR [nil] lpSecurityAttributes : _SECURITY_ATTRIBUTES_struct) : LONG;
    PROCEDURE [stdcall] RegSetKeySecurity* (hKey : HKEY; SecurityInformation : SECURITY_INFORMATION; pSecurityDescriptor : PSECURITY_DESCRIPTOR) : LONG;
    PROCEDURE [stdcall] RegSetValueA* (hKey : HKEY; lpSubKey : LPCSTR; dwType : DWORD; lpData : LPCSTR; cbData : DWORD) : LONG;
    PROCEDURE [stdcall] RegSetValueW* (hKey : HKEY; lpSubKey : LPCWSTR; dwType : DWORD; lpData : LPCWSTR; cbData : DWORD) : LONG;
    PROCEDURE [stdcall] RegSetValueExA* (hKey : HKEY; lpValueName : LPCSTR; Reserved : DWORD; dwType : DWORD; lpData : PBYTE; cbData : DWORD) : LONG;
    PROCEDURE [stdcall] RegSetValueExW* (hKey : HKEY; lpValueName : LPCWSTR; Reserved : DWORD; dwType : DWORD; lpData : PBYTE; cbData : DWORD) : LONG;
    PROCEDURE [stdcall] RegUnLoadKeyA* (hKey : HKEY; lpSubKey : LPCSTR) : LONG;
    PROCEDURE [stdcall] RegUnLoadKeyW* (hKey : HKEY; lpSubKey : LPCWSTR) : LONG;
    PROCEDURE [stdcall] InitiateSystemShutdownA* (lpMachineName : LPSTR; lpMessage : LPSTR; dwTimeout : DWORD; bForceAppsClosed : BOOL; bRebootAfterShutdown : BOOL) : BOOL;
    PROCEDURE [stdcall] InitiateSystemShutdownW* (lpMachineName : LPWSTR; lpMessage : LPWSTR; dwTimeout : DWORD; bForceAppsClosed : BOOL; bRebootAfterShutdown : BOOL) : BOOL;
    PROCEDURE [stdcall] AbortSystemShutdownA* (lpMachineName : LPSTR) : BOOL;
    PROCEDURE [stdcall] AbortSystemShutdownW* (lpMachineName : LPWSTR) : BOOL;
    PROCEDURE [stdcall] WNetAddConnectionA* (lpRemoteName : LPCSTR; lpPassword : LPCSTR; lpLocalName : LPCSTR) : DWORD;
    PROCEDURE [stdcall] WNetAddConnectionW* (lpRemoteName : LPCWSTR; lpPassword : LPCWSTR; lpLocalName : LPCWSTR) : DWORD;
    PROCEDURE [stdcall] WNetAddConnection2A* (VAR [nil] lpNetResource : _NETRESOURCEA_struct; lpPassword : LPCSTR; lpUserName : LPCSTR; dwFlags : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetAddConnection2W* (VAR [nil] lpNetResource : _NETRESOURCEW_struct; lpPassword : LPCWSTR; lpUserName : LPCWSTR; dwFlags : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetAddConnection3A* (hwndOwner : HWND; VAR [nil] lpNetResource : _NETRESOURCEA_struct; lpPassword : LPCSTR; lpUserName : LPCSTR; dwFlags : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetAddConnection3W* (hwndOwner : HWND; VAR [nil] lpNetResource : _NETRESOURCEW_struct; lpPassword : LPCWSTR; lpUserName : LPCWSTR; dwFlags : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetCancelConnectionA* (lpName : LPCSTR; fForce : BOOL) : DWORD;
    PROCEDURE [stdcall] WNetCancelConnectionW* (lpName : LPCWSTR; fForce : BOOL) : DWORD;
    PROCEDURE [stdcall] WNetCancelConnection2A* (lpName : LPCSTR; dwFlags : DWORD; fForce : BOOL) : DWORD;
    PROCEDURE [stdcall] WNetCancelConnection2W* (lpName : LPCWSTR; dwFlags : DWORD; fForce : BOOL) : DWORD;
    PROCEDURE [stdcall] WNetGetConnectionA* (lpLocalName : LPCSTR; lpRemoteName : LPSTR; VAR [nil] lpnLength : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetGetConnectionW* (lpLocalName : LPCWSTR; lpRemoteName : LPWSTR; VAR [nil] lpnLength : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetUseConnectionA* (hwndOwner : HWND; VAR [nil] lpNetResource : _NETRESOURCEA_struct; lpUserID : LPCSTR; lpPassword : LPCSTR; dwFlags : DWORD; lpAccessName : LPSTR; VAR [nil] lpBufferSize : DWORD; VAR [nil] lpResult : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetUseConnectionW* (hwndOwner : HWND; VAR [nil] lpNetResource : _NETRESOURCEW_struct; lpUserID : LPCWSTR; lpPassword : LPCWSTR; dwFlags : DWORD; lpAccessName : LPWSTR; VAR [nil] lpBufferSize : DWORD; VAR [nil] lpResult : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetConnectionDialog* (hwnd : HWND; dwType : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetDisconnectDialog* (hwnd : HWND; dwType : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetConnectionDialog1A* (VAR [nil] lpConnDlgStruct : _CONNECTDLGSTRUCTA_struct) : DWORD;
    PROCEDURE [stdcall] WNetConnectionDialog1W* (VAR [nil] lpConnDlgStruct : _CONNECTDLGSTRUCTW_struct) : DWORD;
    PROCEDURE [stdcall] WNetDisconnectDialog1A* (VAR [nil] lpConnDlgStruct : _DISCDLGSTRUCTA_struct) : DWORD;
    PROCEDURE [stdcall] WNetDisconnectDialog1W* (VAR [nil] lpConnDlgStruct : _DISCDLGSTRUCTW_struct) : DWORD;
    PROCEDURE [stdcall] WNetOpenEnumA* (dwScope : DWORD; dwType : DWORD; dwUsage : DWORD; VAR [nil] lpNetResource : _NETRESOURCEA_struct; VAR [nil] lphEnum : HANDLE) : DWORD;
    PROCEDURE [stdcall] WNetOpenEnumW* (dwScope : DWORD; dwType : DWORD; dwUsage : DWORD; VAR [nil] lpNetResource : _NETRESOURCEW_struct; VAR [nil] lphEnum : HANDLE) : DWORD;
    PROCEDURE [stdcall] WNetEnumResourceA* (hEnum : HANDLE; VAR [nil] lpcCount : DWORD; lpBuffer : LPVOID; VAR [nil] lpBufferSize : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetEnumResourceW* (hEnum : HANDLE; VAR [nil] lpcCount : DWORD; lpBuffer : LPVOID; VAR [nil] lpBufferSize : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetCloseEnum* (hEnum : HANDLE) : DWORD;
    PROCEDURE [stdcall] WNetGetUniversalNameA* (lpLocalPath : LPCSTR; dwInfoLevel : DWORD; lpBuffer : LPVOID; VAR [nil] lpBufferSize : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetGetUniversalNameW* (lpLocalPath : LPCWSTR; dwInfoLevel : DWORD; lpBuffer : LPVOID; VAR [nil] lpBufferSize : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetGetUserA* (lpName : LPCSTR; lpUserName : LPSTR; VAR [nil] lpnLength : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetGetUserW* (lpName : LPCWSTR; lpUserName : LPWSTR; VAR [nil] lpnLength : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetGetProviderNameA* (dwNetType : DWORD; lpProviderName : LPSTR; VAR [nil] lpBufferSize : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetGetProviderNameW* (dwNetType : DWORD; lpProviderName : LPWSTR; VAR [nil] lpBufferSize : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetGetNetworkInformationA* (lpProvider : LPCSTR; VAR [nil] lpNetInfoStruct : _NETINFOSTRUCT_struct) : DWORD;
    PROCEDURE [stdcall] WNetGetNetworkInformationW* (lpProvider : LPCWSTR; VAR [nil] lpNetInfoStruct : _NETINFOSTRUCT_struct) : DWORD;
    PROCEDURE [stdcall] WNetGetLastErrorA* (VAR [nil] lpError : DWORD; lpErrorBuf : LPSTR; nErrorBufSize : DWORD; lpNameBuf : LPSTR; nNameBufSize : DWORD) : DWORD;
    PROCEDURE [stdcall] WNetGetLastErrorW* (VAR [nil] lpError : DWORD; lpErrorBuf : LPWSTR; nErrorBufSize : DWORD; lpNameBuf : LPWSTR; nNameBufSize : DWORD) : DWORD;
    PROCEDURE [stdcall] MultinetGetConnectionPerformanceA* (VAR [nil] lpNetResource : _NETRESOURCEA_struct; VAR [nil] lpNetConnectInfoStruct : _NETCONNECTINFOSTRUCT_struct) : DWORD;
    PROCEDURE [stdcall] MultinetGetConnectionPerformanceW* (VAR [nil] lpNetResource : _NETRESOURCEW_struct; VAR [nil] lpNetConnectInfoStruct : _NETCONNECTINFOSTRUCT_struct) : DWORD;
    PROCEDURE [stdcall] ChangeServiceConfigA* (hService : SC_HANDLE; dwServiceType : DWORD; dwStartType : DWORD; dwErrorControl : DWORD; lpBinaryPathName : LPCSTR; lpLoadOrderGroup : LPCSTR; VAR [nil] lpdwTagId : DWORD; lpDependencies : LPCSTR; lpServiceStartName : LPCSTR; lpPassword : LPCSTR; lpDisplayName : LPCSTR) : BOOL;
    PROCEDURE [stdcall] ChangeServiceConfigW* (hService : SC_HANDLE; dwServiceType : DWORD; dwStartType : DWORD; dwErrorControl : DWORD; lpBinaryPathName : LPCWSTR; lpLoadOrderGroup : LPCWSTR; VAR [nil] lpdwTagId : DWORD; lpDependencies : LPCWSTR; lpServiceStartName : LPCWSTR; lpPassword : LPCWSTR; lpDisplayName : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] ChangeServiceConfig2A* (hService : SC_HANDLE; dwInfoLevel : DWORD; lpInfo : LPVOID) : BOOL;
    PROCEDURE [stdcall] ChangeServiceConfig2W* (hService : SC_HANDLE; dwInfoLevel : DWORD; lpInfo : LPVOID) : BOOL;
    PROCEDURE [stdcall] CloseServiceHandle* (hSCObject : SC_HANDLE) : BOOL;
    PROCEDURE [stdcall] ControlService* (hService : SC_HANDLE; dwControl : DWORD; VAR [nil] lpServiceStatus : _SERVICE_STATUS_struct) : BOOL;
    ...
    PROCEDURE [stdcall] EnumDependentServicesA* (hService : SC_HANDLE; dwServiceState : DWORD; VAR [nil] lpServices : _ENUM_SERVICE_STATUSA_struct; cbBufSize : DWORD; VAR [nil] pcbBytesNeeded : DWORD; VAR [nil] lpServicesReturned : DWORD) : BOOL;
    PROCEDURE [stdcall] EnumDependentServicesW* (hService : SC_HANDLE; dwServiceState : DWORD; VAR [nil] lpServices : _ENUM_SERVICE_STATUSW_struct; cbBufSize : DWORD; VAR [nil] pcbBytesNeeded : DWORD; VAR [nil] lpServicesReturned : DWORD) : BOOL;
    PROCEDURE [stdcall] EnumServicesStatusA* (hSCManager : SC_HANDLE; dwServiceType : DWORD; dwServiceState : DWORD; VAR [nil] lpServices : _ENUM_SERVICE_STATUSA_struct; cbBufSize : DWORD; VAR [nil] pcbBytesNeeded : DWORD; VAR [nil] lpServicesReturned : DWORD; VAR [nil] lpResumeHandle : DWORD) : BOOL;
    PROCEDURE [stdcall] EnumServicesStatusW* (hSCManager : SC_HANDLE; dwServiceType : DWORD; dwServiceState : DWORD; VAR [nil] lpServices : _ENUM_SERVICE_STATUSW_struct; cbBufSize : DWORD; VAR [nil] pcbBytesNeeded : DWORD; VAR [nil] lpServicesReturned : DWORD; VAR [nil] lpResumeHandle : DWORD) : BOOL;
    PROCEDURE [stdcall] GetServiceKeyNameA* (hSCManager : SC_HANDLE; lpDisplayName : LPCSTR; lpServiceName : LPSTR; VAR [nil] lpcchBuffer : DWORD) : BOOL;
    PROCEDURE [stdcall] GetServiceKeyNameW* (hSCManager : SC_HANDLE; lpDisplayName : LPCWSTR; lpServiceName : LPWSTR; VAR [nil] lpcchBuffer : DWORD) : BOOL;
    PROCEDURE [stdcall] GetServiceDisplayNameA* (hSCManager : SC_HANDLE; lpServiceName : LPCSTR; lpDisplayName : LPSTR; VAR [nil] lpcchBuffer : DWORD) : BOOL;
    PROCEDURE [stdcall] GetServiceDisplayNameW* (hSCManager : SC_HANDLE; lpServiceName : LPCWSTR; lpDisplayName : LPWSTR; VAR [nil] lpcchBuffer : DWORD) : BOOL;
    ...
    PROCEDURE [stdcall] OpenSCManagerA* (lpMachineName : LPCSTR; lpDatabaseName : LPCSTR; dwDesiredAccess : DWORD) : SC_HANDLE;
    PROCEDURE [stdcall] OpenSCManagerW* (lpMachineName : LPCWSTR; lpDatabaseName : LPCWSTR; dwDesiredAccess : DWORD) : SC_HANDLE;
    PROCEDURE [stdcall] OpenServiceA* (hSCManager : SC_HANDLE; lpServiceName : LPCSTR; dwDesiredAccess : DWORD) : SC_HANDLE;
    PROCEDURE [stdcall] OpenServiceW* (hSCManager : SC_HANDLE; lpServiceName : LPCWSTR; dwDesiredAccess : DWORD) : SC_HANDLE;
    PROCEDURE [stdcall] QueryServiceConfigA* (hService : SC_HANDLE; VAR [nil] lpServiceConfig : _QUERY_SERVICE_CONFIGA_struct; cbBufSize : DWORD; VAR [nil] pcbBytesNeeded : DWORD) : BOOL;
    PROCEDURE [stdcall] QueryServiceConfigW* (hService : SC_HANDLE; VAR [nil] lpServiceConfig : _QUERY_SERVICE_CONFIGW_struct; cbBufSize : DWORD; VAR [nil] pcbBytesNeeded : DWORD) : BOOL;
    PROCEDURE [stdcall] QueryServiceConfig2A* (hService : SC_HANDLE; dwInfoLevel : DWORD; lpBuffer : LPBYTE; cbBufSize : DWORD; VAR [nil] pcbBytesNeeded : DWORD) : BOOL;
    PROCEDURE [stdcall] QueryServiceConfig2W* (hService : SC_HANDLE; dwInfoLevel : DWORD; lpBuffer : LPBYTE; cbBufSize : DWORD; VAR [nil] pcbBytesNeeded : DWORD) : BOOL;
    PROCEDURE [stdcall] QueryServiceLockStatusA* (hSCManager : SC_HANDLE; VAR [nil] lpLockStatus : _QUERY_SERVICE_LOCK_STATUSA_struct; cbBufSize : DWORD; VAR [nil] pcbBytesNeeded : DWORD) : BOOL;
    PROCEDURE [stdcall] QueryServiceLockStatusW* (hSCManager : SC_HANDLE; VAR [nil] lpLockStatus : _QUERY_SERVICE_LOCK_STATUSW_struct; cbBufSize : DWORD; VAR [nil] pcbBytesNeeded : DWORD) : BOOL;
    PROCEDURE [stdcall] QueryServiceObjectSecurity* (hService : SC_HANDLE; dwSecurityInformation : SECURITY_INFORMATION; lpSecurityDescriptor : PSECURITY_DESCRIPTOR; cbBufSize : DWORD; VAR [nil] pcbBytesNeeded : DWORD) : BOOL;
    PROCEDURE [stdcall] QueryServiceStatus* (hService : SC_HANDLE; VAR [nil] lpServiceStatus : _SERVICE_STATUS_struct) : BOOL;
    PROCEDURE [stdcall] RegisterServiceCtrlHandlerA* (lpServiceName : LPCSTR; lpHandlerProc : LPHANDLER_FUNCTION) : SERVICE_STATUS_HANDLE;
    PROCEDURE [stdcall] RegisterServiceCtrlHandlerW* (lpServiceName : LPCWSTR; lpHandlerProc : LPHANDLER_FUNCTION) : SERVICE_STATUS_HANDLE;
    ...
    PROCEDURE [stdcall] SetServiceStatus* (hServiceStatus : SERVICE_STATUS_HANDLE; VAR [nil] lpServiceStatus : _SERVICE_STATUS_struct) : BOOL;
    ...
    PROCEDURE [stdcall] StartServiceA* (hService : SC_HANDLE; dwNumServiceArgs : DWORD; VAR [nil] lpServiceArgVectors : LPCSTR) : BOOL;
    PROCEDURE [stdcall] StartServiceW* (hService : SC_HANDLE; dwNumServiceArgs : DWORD; VAR [nil] lpServiceArgVectors : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] UnlockServiceDatabase* (ScLock : SC_LOCK) : BOOL;
    PROCEDURE [stdcall] ImmInstallIMEA* (lpszIMEFileName : LPCSTR; lpszLayoutText : LPCSTR) : HKL;
    PROCEDURE [stdcall] ImmInstallIMEW* (lpszIMEFileName : LPCWSTR; lpszLayoutText : LPCWSTR) : HKL;
    PROCEDURE [stdcall] ImmGetDefaultIMEWnd* (p0 : HWND) : HWND;
    PROCEDURE [stdcall] ImmGetDescriptionA* (p0 : HKL; p1 : LPSTR; uBufLen : UINT) : UINT;
    PROCEDURE [stdcall] ImmGetDescriptionW* (p0 : HKL; p1 : LPWSTR; uBufLen : UINT) : UINT;
    PROCEDURE [stdcall] ImmGetIMEFileNameA* (p0 : HKL; p1 : LPSTR; uBufLen : UINT) : UINT;
    PROCEDURE [stdcall] ImmGetIMEFileNameW* (p0 : HKL; p1 : LPWSTR; uBufLen : UINT) : UINT;
    PROCEDURE [stdcall] ImmGetProperty* (p0 : HKL; p1 : DWORD) : DWORD;
    PROCEDURE [stdcall] ImmIsIME* (p0 : HKL) : BOOL;
    PROCEDURE [stdcall] ImmSimulateHotKey* (p0 : HWND; p1 : DWORD) : BOOL;
    PROCEDURE [stdcall] ImmCreateContext* () : HIMC;
    PROCEDURE [stdcall] ImmDestroyContext* (p0 : HIMC) : BOOL;
    PROCEDURE [stdcall] ImmGetContext* (p0 : HWND) : HIMC;
    PROCEDURE [stdcall] ImmReleaseContext* (p0 : HWND; p1 : HIMC) : BOOL;
    PROCEDURE [stdcall] ImmAssociateContext* (p0 : HWND; p1 : HIMC) : HIMC;
    PROCEDURE [stdcall] ImmGetCompositionStringA* (p0 : HIMC; p1 : DWORD; p2 : LPVOID; p3 : DWORD) : LONG;
    PROCEDURE [stdcall] ImmGetCompositionStringW* (p0 : HIMC; p1 : DWORD; p2 : LPVOID; p3 : DWORD) : LONG;
    PROCEDURE [stdcall] ImmSetCompositionStringA* (p0 : HIMC; dwIndex : DWORD; lpComp : LPCVOID; p3 : DWORD; lpRead : LPCVOID; p5 : DWORD) : BOOL;
    PROCEDURE [stdcall] ImmSetCompositionStringW* (p0 : HIMC; dwIndex : DWORD; lpComp : LPCVOID; p3 : DWORD; lpRead : LPCVOID; p5 : DWORD) : BOOL;
    PROCEDURE [stdcall] ImmGetCandidateListCountA* (p0 : HIMC; VAR [nil] lpdwListCount : DWORD) : DWORD;
    PROCEDURE [stdcall] ImmGetCandidateListCountW* (p0 : HIMC; VAR [nil] lpdwListCount : DWORD) : DWORD;
    PROCEDURE [stdcall] ImmGetCandidateListA* (p0 : HIMC; deIndex : DWORD; VAR [nil] p2 : tagCANDIDATELIST_struct; dwBufLen : DWORD) : DWORD;
    PROCEDURE [stdcall] ImmGetCandidateListW* (p0 : HIMC; deIndex : DWORD; VAR [nil] p2 : tagCANDIDATELIST_struct; dwBufLen : DWORD) : DWORD;
    PROCEDURE [stdcall] ImmGetGuideLineA* (p0 : HIMC; dwIndex : DWORD; p2 : LPSTR; dwBufLen : DWORD) : DWORD;
    PROCEDURE [stdcall] ImmGetGuideLineW* (p0 : HIMC; dwIndex : DWORD; p2 : LPWSTR; dwBufLen : DWORD) : DWORD;
    PROCEDURE [stdcall] ImmGetConversionStatus* (p0 : HIMC; VAR [nil] p1 : DWORD; VAR [nil] p2 : DWORD) : BOOL;
    PROCEDURE [stdcall] ImmSetConversionStatus* (p0 : HIMC; p1 : DWORD; p2 : DWORD) : BOOL;
    PROCEDURE [stdcall] ImmGetOpenStatus* (p0 : HIMC) : BOOL;
    PROCEDURE [stdcall] ImmSetOpenStatus* (p0 : HIMC; p1 : BOOL) : BOOL;
    PROCEDURE [stdcall] ImmGetCompositionFontA* (p0 : HIMC; VAR [nil] p1 : tagLOGFONTA_struct) : BOOL;
    PROCEDURE [stdcall] ImmGetCompositionFontW* (p0 : HIMC; VAR [nil] p1 : tagLOGFONTW_struct) : BOOL;
    PROCEDURE [stdcall] ImmSetCompositionFontA* (p0 : HIMC; VAR [nil] p1 : tagLOGFONTA_struct) : BOOL;
    PROCEDURE [stdcall] ImmSetCompositionFontW* (p0 : HIMC; VAR [nil] p1 : tagLOGFONTW_struct) : BOOL;
    PROCEDURE [stdcall] ImmConfigureIMEA* (p0 : HKL; p1 : HWND; p2 : DWORD; p3 : LPVOID) : BOOL;
    PROCEDURE [stdcall] ImmConfigureIMEW* (p0 : HKL; p1 : HWND; p2 : DWORD; p3 : LPVOID) : BOOL;
    PROCEDURE [stdcall] ImmEscapeA* (p0 : HKL; p1 : HIMC; p2 : UINT; p3 : LPVOID) : LRESULT;
    PROCEDURE [stdcall] ImmEscapeW* (p0 : HKL; p1 : HIMC; p2 : UINT; p3 : LPVOID) : LRESULT;
    PROCEDURE [stdcall] ImmGetConversionListA* (p0 : HKL; p1 : HIMC; p2 : LPCSTR; VAR [nil] p3 : tagCANDIDATELIST_struct; dwBufLen : DWORD; uFlag : UINT) : DWORD;
    PROCEDURE [stdcall] ImmGetConversionListW* (p0 : HKL; p1 : HIMC; p2 : LPCWSTR; VAR [nil] p3 : tagCANDIDATELIST_struct; dwBufLen : DWORD; uFlag : UINT) : DWORD;
    PROCEDURE [stdcall] ImmNotifyIME* (p0 : HIMC; dwAction : DWORD; dwIndex : DWORD; dwValue : DWORD) : BOOL;
    PROCEDURE [stdcall] ImmGetStatusWindowPos* (p0 : HIMC; VAR [nil] p1 : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] ImmSetStatusWindowPos* (p0 : HIMC; VAR [nil] p1 : tagPOINT_struct) : BOOL;
    PROCEDURE [stdcall] ImmGetCompositionWindow* (p0 : HIMC; VAR [nil] p1 : tagCOMPOSITIONFORM_struct) : BOOL;
    PROCEDURE [stdcall] ImmSetCompositionWindow* (p0 : HIMC; VAR [nil] p1 : tagCOMPOSITIONFORM_struct) : BOOL;
    PROCEDURE [stdcall] ImmGetCandidateWindow* (p0 : HIMC; p1 : DWORD; VAR [nil] p2 : tagCANDIDATEFORM_struct) : BOOL;
    PROCEDURE [stdcall] ImmSetCandidateWindow* (p0 : HIMC; VAR [nil] p1 : tagCANDIDATEFORM_struct) : BOOL;
    PROCEDURE [stdcall] ImmIsUIMessageA* (p0 : HWND; p1 : UINT; p2 : WPARAM; p3 : LPARAM) : BOOL;
    PROCEDURE [stdcall] ImmIsUIMessageW* (p0 : HWND; p1 : UINT; p2 : WPARAM; p3 : LPARAM) : BOOL;
    PROCEDURE [stdcall] ImmGetVirtualKey* (p0 : HWND) : UINT;
    PROCEDURE [stdcall] ImmRegisterWordA* (p0 : HKL; lpszReading : LPCSTR; p2 : DWORD; lpszRegister : LPCSTR) : BOOL;
    PROCEDURE [stdcall] ImmRegisterWordW* (p0 : HKL; lpszReading : LPCWSTR; p2 : DWORD; lpszRegister : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] ImmUnregisterWordA* (p0 : HKL; lpszReading : LPCSTR; p2 : DWORD; lpszUnregister : LPCSTR) : BOOL;
    PROCEDURE [stdcall] ImmUnregisterWordW* (p0 : HKL; lpszReading : LPCWSTR; p2 : DWORD; lpszUnregister : LPCWSTR) : BOOL;
    PROCEDURE [stdcall] ImmGetRegisterWordStyleA* (p0 : HKL; nItem : UINT; VAR [nil] p2 : tagSTYLEBUFA_struct) : UINT;
    PROCEDURE [stdcall] ImmGetRegisterWordStyleW* (p0 : HKL; nItem : UINT; VAR [nil] p2 : tagSTYLEBUFW_struct) : UINT;
    PROCEDURE [stdcall] ImmEnumRegisterWordA* (p0 : HKL; p1 : REGISTERWORDENUMPROCA; lpszReading : LPCSTR; p3 : DWORD; lpszRegister : LPCSTR; p5 : LPVOID) : UINT;
    PROCEDURE [stdcall] ImmEnumRegisterWordW* (p0 : HKL; p1 : REGISTERWORDENUMPROCW; lpszReading : LPCWSTR; p3 : DWORD; lpszRegister : LPCWSTR; p5 : LPVOID) : UINT;
    PROCEDURE [stdcall] CloseDriver* (hDriver : HDRVR; lParam1 : LONG; lParam2 : LONG) : LRESULT;
    PROCEDURE [stdcall] OpenDriver* (szDriverName : LPCWSTR; szSectionName : LPCWSTR; lParam2 : LONG) : HDRVR;
    PROCEDURE [stdcall] SendDriverMessage* (hDriver : HDRVR; message : UINT; lParam1 : LONG; lParam2 : LONG) : LRESULT;
    PROCEDURE [stdcall] DrvGetModuleHandle* (hDriver : HDRVR) : HMODULE;
    PROCEDURE [stdcall] GetDriverModuleHandle* (hDriver : HDRVR) : HMODULE;
    PROCEDURE [stdcall] DefDriverProc* (dwDriverIdentifier : DWORD; hdrvr : HDRVR; uMsg : UINT; lParam1 : LPARAM; lParam2 : LPARAM) : LRESULT;
    PROCEDURE [stdcall] sndPlaySoundA* (pszSound : LPCSTR; fuSound : UINT) : BOOL;
    PROCEDURE [stdcall] sndPlaySoundW* (pszSound : LPCWSTR; fuSound : UINT) : BOOL;
    PROCEDURE [stdcall] PlaySoundA* (pszSound : LPCSTR; hmod : HMODULE; fdwSound : DWORD) : BOOL;
    PROCEDURE [stdcall] PlaySoundW* (pszSound : LPCWSTR; hmod : HMODULE; fdwSound : DWORD) : BOOL;
    PROCEDURE [stdcall] waveOutGetNumDevs* () : UINT;
    PROCEDURE [stdcall] waveOutGetDevCapsA* (uDeviceID : UINT; VAR [nil] pwoc : tagWAVEOUTCAPSA_struct; cbwoc : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveOutGetDevCapsW* (uDeviceID : UINT; VAR [nil] pwoc : tagWAVEOUTCAPSW_struct; cbwoc : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveOutGetVolume* (hwo : HWAVEOUT; VAR [nil] pdwVolume : DWORD) : MMRESULT;
    PROCEDURE [stdcall] waveOutSetVolume* (hwo : HWAVEOUT; dwVolume : DWORD) : MMRESULT;
    PROCEDURE [stdcall] waveOutGetErrorTextA* (mmrError : MMRESULT; pszText : LPSTR; cchText : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveOutGetErrorTextW* (mmrError : MMRESULT; pszText : LPWSTR; cchText : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveOutOpen* (VAR [nil] phwo : HWAVEOUT; uDeviceID : UINT; VAR [nil] pwfx : WAVEFORMATEX; dwCallback : DWORD; dwInstance : DWORD; fdwOpen : DWORD) : MMRESULT;
    PROCEDURE [stdcall] waveOutClose* (hwo : HWAVEOUT) : MMRESULT;
    PROCEDURE [stdcall] waveOutPrepareHeader* (hwo : HWAVEOUT; VAR [nil] pwh : wavehdr_tag_struct; cbwh : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveOutUnprepareHeader* (hwo : HWAVEOUT; VAR [nil] pwh : wavehdr_tag_struct; cbwh : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveOutWrite* (hwo : HWAVEOUT; VAR [nil] pwh : wavehdr_tag_struct; cbwh : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveOutPause* (hwo : HWAVEOUT) : MMRESULT;
    PROCEDURE [stdcall] waveOutRestart* (hwo : HWAVEOUT) : MMRESULT;
    PROCEDURE [stdcall] waveOutReset* (hwo : HWAVEOUT) : MMRESULT;
    PROCEDURE [stdcall] waveOutBreakLoop* (hwo : HWAVEOUT) : MMRESULT;
    PROCEDURE [stdcall] waveOutGetPosition* (hwo : HWAVEOUT; VAR [nil] pmmt : mmtime_tag_struct; cbmmt : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveOutGetPitch* (hwo : HWAVEOUT; VAR [nil] pdwPitch : DWORD) : MMRESULT;
    PROCEDURE [stdcall] waveOutSetPitch* (hwo : HWAVEOUT; dwPitch : DWORD) : MMRESULT;
    PROCEDURE [stdcall] waveOutGetPlaybackRate* (hwo : HWAVEOUT; VAR [nil] pdwRate : DWORD) : MMRESULT;
    PROCEDURE [stdcall] waveOutSetPlaybackRate* (hwo : HWAVEOUT; dwRate : DWORD) : MMRESULT;
    PROCEDURE [stdcall] waveOutGetID* (hwo : HWAVEOUT; VAR [nil] puDeviceID : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveOutMessage* (hwo : HWAVEOUT; uMsg : UINT; dw1 : DWORD; dw2 : DWORD) : MMRESULT;
    PROCEDURE [stdcall] waveInGetNumDevs* () : UINT;
    PROCEDURE [stdcall] waveInGetDevCapsA* (uDeviceID : UINT; VAR [nil] pwic : tagWAVEINCAPSA_struct; cbwic : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveInGetDevCapsW* (uDeviceID : UINT; VAR [nil] pwic : tagWAVEINCAPSW_struct; cbwic : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveInGetErrorTextA* (mmrError : MMRESULT; pszText : LPSTR; cchText : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveInGetErrorTextW* (mmrError : MMRESULT; pszText : LPWSTR; cchText : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveInOpen* (VAR [nil] phwi : HWAVEIN; uDeviceID : UINT; VAR [nil] pwfx : WAVEFORMATEX; dwCallback : DWORD; dwInstance : DWORD; fdwOpen : DWORD) : MMRESULT;
    PROCEDURE [stdcall] waveInClose* (hwi : HWAVEIN) : MMRESULT;
    PROCEDURE [stdcall] waveInPrepareHeader* (hwi : HWAVEIN; VAR [nil] pwh : wavehdr_tag_struct; cbwh : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveInUnprepareHeader* (hwi : HWAVEIN; VAR [nil] pwh : wavehdr_tag_struct; cbwh : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveInAddBuffer* (hwi : HWAVEIN; VAR [nil] pwh : wavehdr_tag_struct; cbwh : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveInStart* (hwi : HWAVEIN) : MMRESULT;
    PROCEDURE [stdcall] waveInStop* (hwi : HWAVEIN) : MMRESULT;
    PROCEDURE [stdcall] waveInReset* (hwi : HWAVEIN) : MMRESULT;
    PROCEDURE [stdcall] waveInGetPosition* (hwi : HWAVEIN; VAR [nil] pmmt : mmtime_tag_struct; cbmmt : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveInGetID* (hwi : HWAVEIN; VAR [nil] puDeviceID : UINT) : MMRESULT;
    PROCEDURE [stdcall] waveInMessage* (hwi : HWAVEIN; uMsg : UINT; dw1 : DWORD; dw2 : DWORD) : MMRESULT;
    PROCEDURE [stdcall] midiOutGetNumDevs* () : UINT;
    PROCEDURE [stdcall] midiStreamOpen* (VAR [nil] phms : HMIDISTRM; VAR [nil] puDeviceID : UINT; cMidi : DWORD; dwCallback : DWORD; dwInstance : DWORD; fdwOpen : DWORD) : MMRESULT;
    PROCEDURE [stdcall] midiStreamClose* (hms : HMIDISTRM) : MMRESULT;
    PROCEDURE [stdcall] midiStreamProperty* (hms : HMIDISTRM; lppropdata : LPBYTE; dwProperty : DWORD) : MMRESULT;
    PROCEDURE [stdcall] midiStreamPosition* (hms : HMIDISTRM; VAR [nil] lpmmt : mmtime_tag_struct; cbmmt : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiStreamOut* (hms : HMIDISTRM; VAR [nil] pmh : midihdr_tag_struct; cbmh : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiStreamPause* (hms : HMIDISTRM) : MMRESULT;
    PROCEDURE [stdcall] midiStreamRestart* (hms : HMIDISTRM) : MMRESULT;
    PROCEDURE [stdcall] midiStreamStop* (hms : HMIDISTRM) : MMRESULT;
    PROCEDURE [stdcall] midiConnect* (hmi : HMIDI; hmo : HMIDIOUT; pReserved : LPVOID) : MMRESULT;
    PROCEDURE [stdcall] midiDisconnect* (hmi : HMIDI; hmo : HMIDIOUT; pReserved : LPVOID) : MMRESULT;
    PROCEDURE [stdcall] midiOutGetDevCapsA* (uDeviceID : UINT; VAR [nil] pmoc : tagMIDIOUTCAPSA_struct; cbmoc : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiOutGetDevCapsW* (uDeviceID : UINT; VAR [nil] pmoc : tagMIDIOUTCAPSW_struct; cbmoc : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiOutGetVolume* (hmo : HMIDIOUT; VAR [nil] pdwVolume : DWORD) : MMRESULT;
    PROCEDURE [stdcall] midiOutSetVolume* (hmo : HMIDIOUT; dwVolume : DWORD) : MMRESULT;
    PROCEDURE [stdcall] midiOutGetErrorTextA* (mmrError : MMRESULT; pszText : LPSTR; cchText : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiOutGetErrorTextW* (mmrError : MMRESULT; pszText : LPWSTR; cchText : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiOutOpen* (VAR [nil] phmo : HMIDIOUT; uDeviceID : UINT; dwCallback : DWORD; dwInstance : DWORD; fdwOpen : DWORD) : MMRESULT;
    PROCEDURE [stdcall] midiOutClose* (hmo : HMIDIOUT) : MMRESULT;
    PROCEDURE [stdcall] midiOutPrepareHeader* (hmo : HMIDIOUT; VAR [nil] pmh : midihdr_tag_struct; cbmh : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiOutUnprepareHeader* (hmo : HMIDIOUT; VAR [nil] pmh : midihdr_tag_struct; cbmh : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiOutShortMsg* (hmo : HMIDIOUT; dwMsg : DWORD) : MMRESULT;
    PROCEDURE [stdcall] midiOutLongMsg* (hmo : HMIDIOUT; VAR [nil] pmh : midihdr_tag_struct; cbmh : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiOutReset* (hmo : HMIDIOUT) : MMRESULT;
    PROCEDURE [stdcall] midiOutCachePatches* (hmo : HMIDIOUT; uBank : UINT; VAR [nil] pwpa : WORD; fuCache : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiOutCacheDrumPatches* (hmo : HMIDIOUT; uPatch : UINT; VAR [nil] pwkya : WORD; fuCache : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiOutGetID* (hmo : HMIDIOUT; VAR [nil] puDeviceID : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiOutMessage* (hmo : HMIDIOUT; uMsg : UINT; dw1 : DWORD; dw2 : DWORD) : MMRESULT;
    PROCEDURE [stdcall] midiInGetNumDevs* () : UINT;
    PROCEDURE [stdcall] midiInGetDevCapsA* (uDeviceID : UINT; VAR [nil] pmic : tagMIDIINCAPSA_struct; cbmic : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiInGetDevCapsW* (uDeviceID : UINT; VAR [nil] pmic : tagMIDIINCAPSW_struct; cbmic : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiInGetErrorTextA* (mmrError : MMRESULT; pszText : LPSTR; cchText : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiInGetErrorTextW* (mmrError : MMRESULT; pszText : LPWSTR; cchText : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiInOpen* (VAR [nil] phmi : HMIDIIN; uDeviceID : UINT; dwCallback : DWORD; dwInstance : DWORD; fdwOpen : DWORD) : MMRESULT;
    PROCEDURE [stdcall] midiInClose* (hmi : HMIDIIN) : MMRESULT;
    PROCEDURE [stdcall] midiInPrepareHeader* (hmi : HMIDIIN; VAR [nil] pmh : midihdr_tag_struct; cbmh : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiInUnprepareHeader* (hmi : HMIDIIN; VAR [nil] pmh : midihdr_tag_struct; cbmh : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiInAddBuffer* (hmi : HMIDIIN; VAR [nil] pmh : midihdr_tag_struct; cbmh : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiInStart* (hmi : HMIDIIN) : MMRESULT;
    PROCEDURE [stdcall] midiInStop* (hmi : HMIDIIN) : MMRESULT;
    PROCEDURE [stdcall] midiInReset* (hmi : HMIDIIN) : MMRESULT;
    PROCEDURE [stdcall] midiInGetID* (hmi : HMIDIIN; VAR [nil] puDeviceID : UINT) : MMRESULT;
    PROCEDURE [stdcall] midiInMessage* (hmi : HMIDIIN; uMsg : UINT; dw1 : DWORD; dw2 : DWORD) : MMRESULT;
    PROCEDURE [stdcall] auxGetNumDevs* () : UINT;
    PROCEDURE [stdcall] auxGetDevCapsA* (uDeviceID : UINT; VAR [nil] pac : tagAUXCAPSA_struct; cbac : UINT) : MMRESULT;
    PROCEDURE [stdcall] auxGetDevCapsW* (uDeviceID : UINT; VAR [nil] pac : tagAUXCAPSW_struct; cbac : UINT) : MMRESULT;
    PROCEDURE [stdcall] auxSetVolume* (uDeviceID : UINT; dwVolume : DWORD) : MMRESULT;
    PROCEDURE [stdcall] auxGetVolume* (uDeviceID : UINT; VAR [nil] pdwVolume : DWORD) : MMRESULT;
    PROCEDURE [stdcall] auxOutMessage* (uDeviceID : UINT; uMsg : UINT; dw1 : DWORD; dw2 : DWORD) : MMRESULT;
    PROCEDURE [stdcall] mixerGetNumDevs* () : UINT;
    PROCEDURE [stdcall] mixerGetDevCapsA* (uMxId : UINT; VAR [nil] pmxcaps : tagMIXERCAPSA_struct; cbmxcaps : UINT) : MMRESULT;
    PROCEDURE [stdcall] mixerGetDevCapsW* (uMxId : UINT; VAR [nil] pmxcaps : tagMIXERCAPSW_struct; cbmxcaps : UINT) : MMRESULT;
    PROCEDURE [stdcall] mixerOpen* (VAR [nil] phmx : HMIXER; uMxId : UINT; dwCallback : DWORD; dwInstance : DWORD; fdwOpen : DWORD) : MMRESULT;
    PROCEDURE [stdcall] mixerClose* (hmx : HMIXER) : MMRESULT;
    PROCEDURE [stdcall] mixerMessage* (hmx : HMIXER; uMsg : UINT; dwParam1 : DWORD; dwParam2 : DWORD) : DWORD;
    PROCEDURE [stdcall] mixerGetLineInfoA* (hmxobj : HMIXEROBJ; VAR [nil] pmxl : tagMIXERLINEA_struct; fdwInfo : DWORD) : MMRESULT;
    PROCEDURE [stdcall] mixerGetLineInfoW* (hmxobj : HMIXEROBJ; VAR [nil] pmxl : tagMIXERLINEW_struct; fdwInfo : DWORD) : MMRESULT;
    PROCEDURE [stdcall] mixerGetID* (hmxobj : HMIXEROBJ; VAR [nil] puMxId : UINT; fdwId : DWORD) : MMRESULT;
    PROCEDURE [stdcall] mixerGetLineControlsA* (hmxobj : HMIXEROBJ; VAR [nil] pmxlc : tagMIXERLINECONTROLSA_struct; fdwControls : DWORD) : MMRESULT;
    PROCEDURE [stdcall] mixerGetLineControlsW* (hmxobj : HMIXEROBJ; VAR [nil] pmxlc : tagMIXERLINECONTROLSW_struct; fdwControls : DWORD) : MMRESULT;
    PROCEDURE [stdcall] mixerGetControlDetailsA* (hmxobj : HMIXEROBJ; VAR [nil] pmxcd : tMIXERCONTROLDETAILS_struct; fdwDetails : DWORD) : MMRESULT;
    PROCEDURE [stdcall] mixerGetControlDetailsW* (hmxobj : HMIXEROBJ; VAR [nil] pmxcd : tMIXERCONTROLDETAILS_struct; fdwDetails : DWORD) : MMRESULT;
    PROCEDURE [stdcall] mixerSetControlDetails* (hmxobj : HMIXEROBJ; VAR [nil] pmxcd : tMIXERCONTROLDETAILS_struct; fdwDetails : DWORD) : MMRESULT;
    PROCEDURE [stdcall] timeGetSystemTime* (VAR [nil] pmmt : mmtime_tag_struct; cbmmt : UINT) : MMRESULT;
    PROCEDURE [stdcall] timeGetTime* () : DWORD;
    PROCEDURE [stdcall] timeSetEvent* (uDelay : UINT; uResolution : UINT; fptc : LPTIMECALLBACK; dwUser : DWORD; fuEvent : UINT) : MMRESULT;
    PROCEDURE [stdcall] timeKillEvent* (uTimerID : UINT) : MMRESULT;
    PROCEDURE [stdcall] timeGetDevCaps* (VAR [nil] ptc : timecaps_tag_struct; cbtc : UINT) : MMRESULT;
    PROCEDURE [stdcall] timeBeginPeriod* (uPeriod : UINT) : MMRESULT;
    PROCEDURE [stdcall] timeEndPeriod* (uPeriod : UINT) : MMRESULT;
    PROCEDURE [stdcall] joyGetNumDevs* () : UINT;
    PROCEDURE [stdcall] joyGetDevCapsA* (uJoyID : UINT; VAR [nil] pjc : tagJOYCAPSA_struct; cbjc : UINT) : MMRESULT;
    PROCEDURE [stdcall] joyGetDevCapsW* (uJoyID : UINT; VAR [nil] pjc : tagJOYCAPSW_struct; cbjc : UINT) : MMRESULT;
    PROCEDURE [stdcall] joyGetPos* (uJoyID : UINT; VAR [nil] pji : joyinfo_tag_struct) : MMRESULT;
    PROCEDURE [stdcall] joyGetPosEx* (uJoyID : UINT; VAR [nil] pji : joyinfoex_tag_struct) : MMRESULT;
    PROCEDURE [stdcall] joyGetThreshold* (uJoyID : UINT; VAR [nil] puThreshold : UINT) : MMRESULT;
    PROCEDURE [stdcall] joyReleaseCapture* (uJoyID : UINT) : MMRESULT;
    PROCEDURE [stdcall] joySetCapture* (hwnd : HWND; uJoyID : UINT; uPeriod : UINT; fChanged : BOOL) : MMRESULT;
    PROCEDURE [stdcall] joySetThreshold* (uJoyID : UINT; uThreshold : UINT) : MMRESULT;
    PROCEDURE [stdcall] mmioStringToFOURCCA* (sz : LPCSTR; uFlags : UINT) : FOURCC;
    PROCEDURE [stdcall] mmioStringToFOURCCW* (sz : LPCWSTR; uFlags : UINT) : FOURCC;
    PROCEDURE [stdcall] mmioInstallIOProcA* (fccIOProc : FOURCC; pIOProc : LPMMIOPROC; dwFlags : DWORD) : LPMMIOPROC;
    PROCEDURE [stdcall] mmioInstallIOProcW* (fccIOProc : FOURCC; pIOProc : LPMMIOPROC; dwFlags : DWORD) : LPMMIOPROC;
    PROCEDURE [stdcall] mmioOpenA* (pszFileName : LPSTR; VAR [nil] pmmioinfo : _MMIOINFO_struct; fdwOpen : DWORD) : HMMIO;
    PROCEDURE [stdcall] mmioOpenW* (pszFileName : LPWSTR; VAR [nil] pmmioinfo : _MMIOINFO_struct; fdwOpen : DWORD) : HMMIO;
    PROCEDURE [stdcall] mmioRenameA* (pszFileName : LPCSTR; pszNewFileName : LPCSTR; VAR [nil] pmmioinfo : MMIOINFO; fdwRename : DWORD) : MMRESULT;
    PROCEDURE [stdcall] mmioRenameW* (pszFileName : LPCWSTR; pszNewFileName : LPCWSTR; VAR [nil] pmmioinfo : MMIOINFO; fdwRename : DWORD) : MMRESULT;
    PROCEDURE [stdcall] mmioClose* (hmmio : HMMIO; fuClose : UINT) : MMRESULT;
    PROCEDURE [stdcall] mmioRead* (hmmio : HMMIO; pch : HPSTR; cch : LONG) : LONG;
    PROCEDURE [stdcall] mmioWrite* (hmmio : HMMIO; pch : va_list; cch : LONG) : LONG;
    PROCEDURE [stdcall] mmioSeek* (hmmio : HMMIO; lOffset : LONG; iOrigin : LONGINT) : LONG;
    PROCEDURE [stdcall] mmioGetInfo* (hmmio : HMMIO; VAR [nil] pmmioinfo : _MMIOINFO_struct; fuInfo : UINT) : MMRESULT;
    PROCEDURE [stdcall] mmioSetInfo* (hmmio : HMMIO; VAR [nil] pmmioinfo : MMIOINFO; fuInfo : UINT) : MMRESULT;
    PROCEDURE [stdcall] mmioSetBuffer* (hmmio : HMMIO; pchBuffer : LPSTR; cchBuffer : LONG; fuBuffer : UINT) : MMRESULT;
    PROCEDURE [stdcall] mmioFlush* (hmmio : HMMIO; fuFlush : UINT) : MMRESULT;
    PROCEDURE [stdcall] mmioAdvance* (hmmio : HMMIO; VAR [nil] pmmioinfo : _MMIOINFO_struct; fuAdvance : UINT) : MMRESULT;
    PROCEDURE [stdcall] mmioSendMessage* (hmmio : HMMIO; uMsg : UINT; lParam1 : LPARAM; lParam2 : LPARAM) : LRESULT;
    PROCEDURE [stdcall] mmioDescend* (hmmio : HMMIO; VAR [nil] pmmcki : _MMCKINFO_struct; VAR [nil] pmmckiParent : MMCKINFO; fuDescend : UINT) : MMRESULT;
    PROCEDURE [stdcall] mmioAscend* (hmmio : HMMIO; VAR [nil] pmmcki : _MMCKINFO_struct; fuAscend : UINT) : MMRESULT;
    PROCEDURE [stdcall] mmioCreateChunk* (hmmio : HMMIO; VAR [nil] pmmcki : _MMCKINFO_struct; fuCreate : UINT) : MMRESULT;
    PROCEDURE [stdcall] mciSendCommandA* (mciId : MCIDEVICEID; uMsg : UINT; dwParam1 : DWORD; dwParam2 : DWORD) : MCIERROR;
    PROCEDURE [stdcall] mciSendCommandW* (mciId : MCIDEVICEID; uMsg : UINT; dwParam1 : DWORD; dwParam2 : DWORD) : MCIERROR;
    PROCEDURE [stdcall] mciSendStringA* (lpstrCommand : LPCSTR; lpstrReturnString : LPSTR; uReturnLength : UINT; hwndCallback : HWND) : MCIERROR;
    PROCEDURE [stdcall] mciSendStringW* (lpstrCommand : LPCWSTR; lpstrReturnString : LPWSTR; uReturnLength : UINT; hwndCallback : HWND) : MCIERROR;
    PROCEDURE [stdcall] mciGetDeviceIDA* (pszDevice : LPCSTR) : MCIDEVICEID;
    PROCEDURE [stdcall] mciGetDeviceIDW* (pszDevice : LPCWSTR) : MCIDEVICEID;
    PROCEDURE [stdcall] mciGetDeviceIDFromElementIDA* (dwElementID : DWORD; lpstrType : LPCSTR) : MCIDEVICEID;
    PROCEDURE [stdcall] mciGetDeviceIDFromElementIDW* (dwElementID : DWORD; lpstrType : LPCWSTR) : MCIDEVICEID;
    PROCEDURE [stdcall] mciGetErrorStringA* (mcierr : MCIERROR; pszText : LPSTR; cchText : UINT) : BOOL;
    PROCEDURE [stdcall] mciGetErrorStringW* (mcierr : MCIERROR; pszText : LPWSTR; cchText : UINT) : BOOL;
    PROCEDURE [stdcall] mciSetYieldProc* (mciId : MCIDEVICEID; fpYieldProc : YIELDPROC; dwYieldData : DWORD) : BOOL;
    PROCEDURE [stdcall] mciGetCreatorTask* (mciId : MCIDEVICEID) : HTASK;
    PROCEDURE [stdcall] mciGetYieldProc* (mciId : MCIDEVICEID; VAR [nil] pdwYieldData : DWORD) : YIELDPROC;
