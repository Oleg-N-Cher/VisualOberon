...
SET CC=gcc.exe -m64 -fPIC -Os -g0 -I..\..\..\src\Ofront -fomit-frame-pointer -finline-small-functions -fno-exceptions -fno-unwind-tables -fno-asynchronous-unwind-tables -ffunction-sections -Wfatal-errors -c
